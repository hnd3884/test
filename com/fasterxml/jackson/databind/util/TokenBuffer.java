...
public class TokenBuffer extends JsonGenerator
{
    ...
    public JsonParser asParser(final ObjectCodec codec) {
        return (JsonParser)new Parser(this._first, codec, this._hasNativeTypeIds, this._hasNativeObjectIds, this._parentContext);
    }
    ...
    public final void writeStartArray(final int size) throws IOException {
        this._writeContext.writeValue();
        this._appendStartMarker(JsonToken.START_ARRAY);
        this._writeContext = this._writeContext.createChildArrayContext();
    }
