...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable
{
    ...
    protected ObjectMapper(final ObjectMapper src) {
        ...
        (this._jsonFactory = src._jsonFactory.copy()).setCodec((ObjectCodec)this);
    ...
    public void writeValue(final File resultFile, final Object value) throws IOException, JsonGenerationException, JsonMappingException {
        this._configAndWriteValue(this.createGenerator(resultFile, JsonEncoding.UTF8), value);
    }
    ...
    public String writeValueAsString(final Object value) throws JsonProcessingException {
        ...
        try {
            this._configAndWriteValue(this.createGenerator((Writer)sw), value);
        }
        catch (final JsonProcessingException e) {
            throw e;
        }
    ...
    public byte[] writeValueAsBytes(final Object value) throws JsonProcessingException {
        ...
        try {
            this._configAndWriteValue(this.createGenerator((OutputStream)bb, JsonEncoding.UTF8), value);
        }
        catch (final JsonProcessingException e) {
            throw e;
        }
    ...
    protected JsonNode _readTreeAndClose(final JsonParser p0) throws IOException {
        try (final JsonParser p = p0) {
            ...
            if (t == JsonToken.VALUE_NULL) {
                ...
                final JsonDeserializer<Object> deser = this._findRootDeserializer(ctxt, valueType);
                if (cfg.useRootWrapping()) {
                    resultNode = (JsonNode)this._unwrapAndDeserialize(p, ctxt, cfg, valueType, deser);
                }
                else {
    ...
    static {
        ...
        DEFAULT_BASE = new BaseSettings(null, ObjectMapper.DEFAULT_ANNOTATION_INTROSPECTOR, null, TypeFactory.defaultInstance(), null, StdDateFormat.instance, null, Locale.getDefault(), null, Base64Variants.getDefaultVariant(), LaissezFaireSubTypeValidator.instance);
    }
