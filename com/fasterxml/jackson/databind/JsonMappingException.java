...
public class JsonMappingException extends JsonProcessingException
{
    ...
    public static JsonMappingException from(final DeserializationContext ctxt, final String msg) {
        return new JsonMappingException((Closeable)ctxt.getParser(), msg);
    }
    ...
    public static JsonMappingException from(final SerializerProvider ctxt, final String msg) {
        return new JsonMappingException((Closeable)ctxt.getGenerator(), msg);
    }
        ...
        public String getDescription() {
            if (this._desc == null) {
                ...
                if (this._from == null) {
                    ...
                    Class<?> cls;
                    int arrays;
                    for (cls = ((this._from instanceof Class) ? ((Class)this._from) : this._from.getClass()), arrays = 0; cls.isArray(); cls = cls.getComponentType(), ++arrays) {}
