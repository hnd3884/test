...
final class AnnotatedCreatorCollector extends CollectorBase
{
    ...
    public static AnnotatedClass.Creators collectCreators(final AnnotationIntrospector intr, final TypeResolutionContext tc, final JavaType type, final Class<?> primaryMixIn, final boolean collectAnnotations) {
        final boolean checkClassAnnotations = intr != null && !ClassUtil.isJDKClass(type.getRawClass());
