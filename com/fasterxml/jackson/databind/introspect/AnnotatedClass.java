...
public final class AnnotatedClass extends Annotated implements TypeResolutionContext
{
    ...
    AnnotatedClass(final JavaType type, final Class<?> rawType, final List<JavaType> superTypes, final Class<?> primaryMixIn, final Annotations classAnnotations, final TypeBindings bindings, final AnnotationIntrospector aintr, final ClassIntrospector.MixInResolver mir, final TypeFactory tf, final boolean collectAnnotations) {
        this._type = type;
        this._class = rawType;
    ...
    private final Creators _creators() {
        ...
        if (c == null) {
            if (this._type == null) {
                ...
                c = AnnotatedCreatorCollector.collectCreators(this._annotationIntrospector, this, this._type, this._primaryMixIn, this._collectAnnotations);
            }
            this._creators = c;
        }
        return c;
