...
public class StdValueInstantiator extends ValueInstantiator implements Serializable
{
    ...
    public Object createUsingDefault(final DeserializationContext ctxt) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._valueClass, null, (Throwable)this.rewrapCtorProblem(ctxt, e));
        }
    }
    ...
    public Object createFromObjectWith(final DeserializationContext ctxt, final Object[] args) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._valueClass, args, (Throwable)this.rewrapCtorProblem(ctxt, e));
        }
    }
    ...
    public Object createFromString(final DeserializationContext ctxt, final String value) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._fromStringCreator.getDeclaringClass(), value, (Throwable)this.rewrapCtorProblem(ctxt, t));
        }
    }
    ...
    public Object createFromInt(final DeserializationContext ctxt, final int value) throws IOException {
        if (this._fromIntCreator != null) {
            ...
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromIntCreator.getDeclaringClass(), arg, (Throwable)this.rewrapCtorProblem(ctxt, t0));
            }
        }
        if (this._fromLongCreator != null) {
            ...
            try {
                ...
                return ctxt.handleInstantiationProblem(this._fromLongCreator.getDeclaringClass(), arg, (Throwable)this.rewrapCtorProblem(ctxt, t0));
            }
        }
    ...
    public Object createFromDouble(final DeserializationContext ctxt, final double value) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._fromDoubleCreator.getDeclaringClass(), arg, (Throwable)this.rewrapCtorProblem(ctxt, t0));
        }
    }
    ...
    public Object createFromBoolean(final DeserializationContext ctxt, final boolean value) throws IOException {
        ...
        try {
            ...
            return ctxt.handleInstantiationProblem(this._fromBooleanCreator.getDeclaringClass(), arg, (Throwable)this.rewrapCtorProblem(ctxt, t0));
        }
    }
