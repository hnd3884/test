...
public class DateDeserializers
{
    ...
    public static boolean hasDeserializerFor(final Class<?> rawType) {
        return DateDeserializers._classNames.contains(rawType.getName());
    }
    
    static {
        _classNames = new HashSet<String>();
        final Class[] array;
        final Class<?>[] numberTypes = array = new Class[] { Calendar.class, GregorianCalendar.class, java.sql.Date.class, Date.class, Timestamp.class };
