...
public class DataFormatReaders
{
    ...
    private Match _findFormat(final AccessorForReader acc) throws IOException {
        ...
        for (final ObjectReader f : this._readers) {
            acc.reset();
            final MatchStrength strength = f.getFactory().hasFormat((InputAccessor)acc);
            if (strength != null) {
    ...
    public static class Match
    {
        ...
        public InputStream getDataStream() {
            ...
            return (InputStream)new MergedStream((IOContext)null, this._originalStream, this._bufferedData, this._bufferedStart, this._bufferedLength);
        }
    }
}
