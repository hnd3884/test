...
public abstract class DeserializationContext extends DatabindContext implements Serializable
{
    ...
    public Object handleUnexpectedToken(final JavaType targetType, final JsonToken t, final JsonParser p, String msg, final Object... msgArgs) throws IOException {
        ...
        if (msg == null) {
            if (t == null) {
                msg = String.format("Unexpected end-of-input when binding data into %s", ClassUtil.getTypeDescription(targetType));
            }
            else {
                msg = String.format("Cannot deserialize instance of %s out of %s token", ClassUtil.getTypeDescription(targetType), t);
            }
        }
