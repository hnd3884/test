...
public abstract class ProviderBase<THIS extends ProviderBase<THIS, MAPPER, EP_CONFIG, MAPPER_CONFIG>, MAPPER extends ObjectMapper, EP_CONFIG extends EndpointConfigBase<EP_CONFIG>, MAPPER_CONFIG extends MapperConfiguratorBase<MAPPER_CONFIG, MAPPER>> implements MessageBodyReader<Object>, MessageBodyWriter<Object>, Versioned
{
    ...
    protected final NoContentExceptionSupplier noContentExceptionSupplier;
    ...
    private static NoContentExceptionSupplier _createNoContentExceptionSupplier() {
        try {
            final Class<?> cls = Class.forName("javax.ws.rs.core.NoContentException", false, getClassLoader());
            Constructor<?> ctor;
            if (System.getSecurityManager() == null) {
                ctor = cls.getDeclaredConstructor(String.class);
            }
            else {
                ctor = AccessController.doPrivileged((PrivilegedAction<Constructor<?>>)new PrivilegedAction<Constructor<?>>() {
                    @Override
