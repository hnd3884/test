...
public interface CTShape extends XmlObject
{
    ...
    CTInk getInkArray(final int p0);
    
    int sizeOfInkArray();
    
    void setInkArray(final CTInk[] p0);
    
    void setInkArray(final int p0, final CTInk p1);
    
    CTInk insertNewInk(final int p0);
    
    CTInk addNewInk();
    
    void removeInk(final int p0);
    ...
    CTEmpty getIscommentArray(final int p0);
    
    int sizeOfIscommentArray();
    
    void setIscommentArray(final CTEmpty[] p0);
    
    void setIscommentArray(final int p0, final CTEmpty p1);
    
    CTEmpty insertNewIscomment(final int p0);
    
    CTEmpty addNewIscomment();
    
    void removeIscomment(final int p0);
    ...
    void setGfxdata(final byte[] p0);
    
    void xsetGfxdata(final XmlBase64Binary p0);
    ...
    void setEquationxml(final String p0);
    
    void xsetEquationxml(final XmlString p0);
