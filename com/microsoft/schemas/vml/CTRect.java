    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTRect.class.getClassLoader());
        ...
        public static CTRect newInstance() {
            return (CTRect)getTypeLoader().newInstance(CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect newInstance(final XmlOptions xmlOptions) {
            return (CTRect)getTypeLoader().newInstance(CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final String s) throws XmlException {
            return (CTRect)getTypeLoader().parse(s, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTRect)getTypeLoader().parse(s, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final File file) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(file, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(file, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final URL url) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(url, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(url, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(inputStream, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(inputStream, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final Reader reader) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(reader, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTRect)getTypeLoader().parse(reader, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTRect)getTypeLoader().parse(xmlStreamReader, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTRect)getTypeLoader().parse(xmlStreamReader, CTRect.type, xmlOptions);
        }
        
        public static CTRect parse(final Node node) throws XmlException {
            return (CTRect)getTypeLoader().parse(node, CTRect.type, (XmlOptions)null);
        }
        
        public static CTRect parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTRect)getTypeLoader().parse(node, CTRect.type, xmlOptions);
        }
        
        @Deprecated
        public static CTRect parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTRect)getTypeLoader().parse(xmlInputStream, CTRect.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTRect parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTRect)getTypeLoader().parse(xmlInputStream, CTRect.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTRect.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTRect.type, xmlOptions);
        }
