...
public class RoleDetailViewController extends DCTableRetrieverAction
{
    ...
    public void setCriteria(final SelectQuery selectQuery, final ViewContext viewCtx) {
        try {
            ...
            RoleDetailViewController.logger.log(Level.INFO, RoleDetailViewController.className + ":setCritetia:: Exception while setting license Criteria.", e);
        }
        super.setCriteria(selectQuery, viewCtx);
    }
    
    static {
        RoleDetailViewController.className = RoleDetailViewController.class.getName();
        RoleDetailViewController.logger = Logger.getLogger("UserManagementLogger");
    }
}
