...
public class AdvSearchViewRetriever extends DMViewRetrieverAction
{
    ...
    public void setCriteria(SelectQuery selectQuery, final ViewContext viewCtx) {
        AdvSearchViewRetriever.logger.log(Level.FINE, "Advanced Search : setCriteria in AdvSearchController");
        ...
        try {
            ...
            AdvSearchViewRetriever.advSearchErrorLogger.log(Level.SEVERE, "AdvSearchController : Exception occurred - setCriteria() :  ", ex);
        }
    ...
    private SelectQuery applySearchCriteria(final SelectQuery selectQuery, final String table_name, final String column_name, String searchText) {
        try {
            ...
            AdvSearchViewRetriever.advSearchErrorLogger.log(Level.SEVERE, "AdvSearchController : Exception occurred - applySearchCriteria() :  ", ex);
        }
        return selectQuery;
    }
    ...
    private SelectQuery setCorrespondingCriteria(final SelectQuery selectQuery, final ViewContext viewCtx, final String view_name) {
        try {
            ...
            AdvSearchViewRetriever.advSearchErrorLogger.log(Level.SEVERE, "AdvSearchController : Exception occurred - setCorrespondingCriteria() :  ", ex);
        }
        return selectQuery;
    }
    
    static {
        AdvSearchViewRetriever.className = AdvSearchViewRetriever.class.getName();
        AdvSearchViewRetriever.logger = Logger.getLogger(AdvSearchViewRetriever.className);
        AdvSearchViewRetriever.advSearchErrorLogger = Logger.getLogger("AdvSearchError");
    }
}
