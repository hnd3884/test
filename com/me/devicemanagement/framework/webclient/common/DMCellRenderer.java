...
public class DMCellRenderer
{
    public static String getHTML(final HashMap<String, Object> props, final TableViewModel viewModel) throws Exception {
        ...
        final String tempString = "<script> var autolink='" + IAMEncoder.encodeJavaScript(autoLink) + "';</script>";
        ...
        if (props.get("PREFIX_LINK") != null && props.get("PREFIX_LINK_CSS") != null) {
            sb.append(IAMEncoder.encodeHTML((String)props.get("PREFIX_LINK")));
        }
        ...
        if (props.get("ACTUAL_VALUE") != null) {
            ...
            sb.append("<Script>" + IAMEncoder.encodeJavaScript(String.valueOf(props.get("MESSAGE_DISPLAYER"))) + "('" + IAMEncoder.encodeJavaScript(String.valueOf(props.get("TRIMMED_VALUE"))) + "','" + HTMLUtil.encode(String.valueOf(props.get("ACTUAL_VALUE"))) + "','" + key + "','" + IAMEncoder.encodeJavaScript(String.valueOf(props.get("ACTION_LINK"))) + "',document);" + "</Script>");
        }
        ...
        if (props.get("SUFFIX_TEXT") != null && props.get("SUFFIX_TEXT_CSS") != null) {
            sb.append(IAMEncoder.encodeHTML((String)props.get("SUFFIX_TEXT")));
        }
        if (props.get("SUFFIX_LINK") != null && props.get("SUFFIX_LINK_CSS") != null) {
            sb.append(IAMEncoder.encodeHTML((String)props.get("SUFFIX_LINK")));
        }
        if (suffixIcon != null) {
