...
public class DCBackupLogFormatter extends Formatter
{
    Date dat;
    ...
    public synchronized String format(final LogRecord record) {
        if (DCBackupLogFormatter.enableUniformLogFormatter.equalsIgnoreCase("true")) {
    ...
    static {
        DCBackupLogFormatter.enableUniformLogFormatter = System.getProperty("uniformlogformatter.enable", "false");
    }
}
