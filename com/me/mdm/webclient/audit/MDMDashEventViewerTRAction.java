...
public class MDMDashEventViewerTRAction extends MDMEmberEventViewerTRAction
{
    Logger logger;
    
    public MDMDashEventViewerTRAction() {
    ...
    public void setCriteria(final SelectQuery selectQuery, final ViewContext viewCtx) {
        try {
            ...
            else if (eventModule != null && !eventModule.equals("") && !eventModule.equals("all")) {
                final String[] module = eventModule.split(";");
                criteria = new Criteria(Column.getColumn("EventCode", "EVENT_MODULE"), (Object)"MDM", 0);
                final Criteria cri2 = new Criteria(Column.getColumn("EventCode", "SUB_MODULE"), (Object)module, 8);
