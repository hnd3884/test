...
public class AdminEnrollADAuthAPIRequestHandler extends ApiRequestHandler
{
    AdminEnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public AdminEnrollADAuthAPIRequestHandler() {
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.getAdminEnrollADAuthSettings(apiRequest.toJSONObject()));
            return responseJSON;
        }
