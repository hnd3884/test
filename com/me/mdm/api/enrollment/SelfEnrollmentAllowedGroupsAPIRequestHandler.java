...
public class SelfEnrollmentAllowedGroupsAPIRequestHandler extends ApiRequestHandler
{
    EnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public SelfEnrollmentAllowedGroupsAPIRequestHandler() {
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.getSelectedADGroupsListForSelfEnrollment(apiRequest.toJSONObject()));
            return responseJSON;
        }
