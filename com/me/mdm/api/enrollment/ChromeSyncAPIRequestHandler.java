...
public class ChromeSyncAPIRequestHandler extends ApiRequestHandler
{
    AdminEnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public ChromeSyncAPIRequestHandler() {
    ...
    public Object doPost(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.syncChromeDevice(apiRequest.toJSONObject()));
            return responseJSON;
        }
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            final JSONObject responseJSON = new JSONObject();
            responseJSON.put("status", 200);
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.getSyncChromeDeviceStatus(apiRequest.toJSONObject()));
            return responseJSON;
        }
        catch (final APIHTTPException ex) {
