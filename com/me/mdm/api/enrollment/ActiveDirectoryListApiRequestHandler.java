...
public class ActiveDirectoryListApiRequestHandler extends ApiRequestHandler
{
    EnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public ActiveDirectoryListApiRequestHandler() {
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.getDomainList(apiRequest.toJSONObject()));
            return responseJSON;
        }
