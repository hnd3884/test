...
public class AdminEnrollUserRuleAPIRequestHandler extends ApiRequestHandler
{
    AdminEnrollmentFacade enrollmentFacade;
    
    public AdminEnrollUserRuleAPIRequestHandler() {
    ...
    public Object doPost(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.createAssignUserSettings(apiRequest.toJSONObject()));
            return responseJSON;
        }
