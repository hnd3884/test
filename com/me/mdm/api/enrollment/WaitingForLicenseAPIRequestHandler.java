...
public class WaitingForLicenseAPIRequestHandler extends ApiRequestHandler
{
    EnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public WaitingForLicenseAPIRequestHandler() {
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseJSON.put("RESPONSE", (Object)this.enrollmentFacade.getWaitingForLicenseDeviceCount(apiRequest.toJSONObject()));
            return responseJSON;
        }
