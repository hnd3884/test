...
public class RemoveDeprovisoninedDeviceAPIRequestHandler extends ApiRequestHandler
{
    EnrollmentFacade enrollmentFacade;
    Logger logger;
    
    public RemoveDeprovisoninedDeviceAPIRequestHandler() {
    ...
    public Object doDelete(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            this.enrollmentFacade.removeMultipleDevice(apiRequest.toJSONObject());
