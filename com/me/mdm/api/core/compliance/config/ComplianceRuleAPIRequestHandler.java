...
public class ComplianceRuleAPIRequestHandler extends ApiRequestHandler
{
    public Logger logger;
    private ComplianceFacade compliance;
    
    public ComplianceRuleAPIRequestHandler() {
    ...
    public Object doGet(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            final JSONObject distributionJSON = this.compliance.getRulePolicyDetails(requestJSON);
