...
public class AppLowerVersionsAPIRequestHandler extends ApiRequestHandler
{
    private AppFacade app;
    
    public AppLowerVersionsAPIRequestHandler() {
    ...
    public JSONObject doGet(final APIRequest apiRequest) {
        try {
            ...
            response.put("RESPONSE", (Object)this.app.getLowerVersionApps(apiRequest.toJSONObject()));
            return response;
        }
