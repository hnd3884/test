...
public class BlacklistAppDeviceTreeAPIRequestHandler extends ApiRequestHandler
{
    BlacklistPolicyFacade blacklistPolicyFacade;
    private Logger logger;
    
    public BlacklistAppDeviceTreeAPIRequestHandler() {
    ...
    public Object doPost(final APIRequest apiRequest) throws APIHTTPException {
        try {
            ...
            responseDetails.put("RESPONSE", (Object)this.blacklistPolicyFacade.getDeviceTreeDataForAppGroups(apiRequest.toJSONObject(), 1));
