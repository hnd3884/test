...
public class IndividualAccountRequestHandler extends ApiRequestHandler
{
    AccountFacade account;
    
    public IndividualAccountRequestHandler() {
        this.account = null;
    ...
    public Object doGet(final APIRequest request) throws APIHTTPException {
        try {
            ...
            response.put("RESPONSE", (Object)this.account.getComputerAccount(request.toJSONObject()));
            return response;
        }
    ...
    public Object doDelete(final APIRequest request) throws APIHTTPException {
        try {
            ...
            this.account.deleteAccountDetails(request.toJSONObject());
            return response;
        }
        catch (final APIHTTPException e) {
            throw e;
