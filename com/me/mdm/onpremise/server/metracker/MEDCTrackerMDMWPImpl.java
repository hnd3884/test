...
public class MEDCTrackerMDMWPImpl extends MEMDMTrackerConstants implements MEDMTracker
{
    ...
    public Properties getTrackerProperties() {
        try {
            ...
            this.mdmWPTrackerProperties.putAll(new com.me.mdm.server.metracker.MEDCTrackerMDMWPImpl().getTrackerProperties());
    ...
    private void addWindowsNotificationCounts() {
        try {
            ...
            jsonObject.put("Win_ChannelUri_NotObtained_Count", MEMDMTrackerUtil.getChannelURINotObtainedCount());
