...
public class WindowsRestrictionResponseListener implements MDMProfileResponseListener
{
    private static final Logger LOGGER;
    boolean isNotify;
    
    public WindowsRestrictionResponseListener() {
        this.isNotify = false;
    }
    ...
    public JSONObject successHandler(final JSONObject params) {
        ...
        try {
            ...
            WindowsRestrictionResponseListener.LOGGER.log(Level.SEVERE, "Exception while handling windows restriction response listener", ex);
        }
