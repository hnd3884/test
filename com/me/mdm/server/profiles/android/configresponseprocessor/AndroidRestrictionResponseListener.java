...
public class AndroidRestrictionResponseListener implements MDMProfileResponseListener
{
    private static final Logger LOGGER;
    boolean isNotify;
    
    public AndroidRestrictionResponseListener() {
        this.isNotify = false;
    }
    ...
    public JSONObject successHandler(final JSONObject params) {
        ...
        try {
            ...
            AndroidRestrictionResponseListener.LOGGER.log(Level.SEVERE, "Exception while handling android restriction response listener", ex);
        }
