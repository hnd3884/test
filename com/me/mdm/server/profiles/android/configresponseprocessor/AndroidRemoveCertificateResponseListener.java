...
public class AndroidRemoveCertificateResponseListener implements MDMProfileResponseListener
{
    private static final Logger LOGGER;
    boolean isNotify;
    
    public AndroidRemoveCertificateResponseListener() {
        this.isNotify = false;
    }
    ...
    public JSONObject successHandler(final JSONObject params) {
        ...
        try {
            ...
            AndroidRemoveCertificateResponseListener.LOGGER.log(Level.SEVERE, "Exception while handling android certificate response listener", ex);
        }
