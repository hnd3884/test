...
public class WindowsWifiConfigHandler extends DefaultConfigHandler
{
    public static final int SECURITY_TYPE_NONE = 0;
    public static final int SECURITY_TYPE_WPA = 1;
    public static final int SECURITY_TYPE_EAP = 2;
    ...
    protected JSONArray DOToAPIJSON(final DataObject dataObject, final String configName, final String tableName) throws APIHTTPException {
        try {
            ...
            for (int index = 0; index < result.length(); ++index) {
                ...
                else if (securityType == 2 && jsonObject.has("wifi_non_enterprise")) {
