...
public class IOSRemoveSingleWebKioskSeqCmd implements PolicySpecificSeqCommand
{
    @Override
    public JSONObject getSequentialCommandForPolicy(final List configDoList, final JSONObject policyParams) throws Exception {
        ...
        try {
            ...
            if (needToCreateRemoveCommand) {
                new IOSRemoveAppLockSeqCmd().addRemoveSingleWebAppKioskCommand(policyParams, metaDataList, collectionArray);
            }
