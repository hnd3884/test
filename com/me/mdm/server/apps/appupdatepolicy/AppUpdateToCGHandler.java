...
public class AppUpdateToCGHandler extends BaseAppUpdateToResourceHandler
{
    @Override
    public List<Long> getResourceListForWhichTheAppToBeScheduled(final List resourceList, final Long profileId, final Long collectionId) throws Exception {
        ...
        selectQuery.addJoin(new Join("MdAppCatalogToGroup", "MdAppToCollection", new String[] { "PUBLISHED_APP_ID" }, new String[] { "APP_ID" }, 2));
        selectQuery.addJoin(new Join("MdAppToCollection", "ProfileToCollection", new String[] { "COLLECTION_ID" }, new String[] { "COLLECTION_ID" }, 2));
        selectQuery.addJoin(new Join("MdAppCatalogToGroup", "RecentProfileForGroup", new String[] { "RESOURCE_ID" }, new String[] { "GROUP_ID" }, 2));
        selectQuery.addJoin(new Join("RecentProfileForGroup", "AutoAppUpdateConfigToCollection", new String[] { "COLLECTION_ID" }, new String[] { "COLLECTION_ID" }, 2));
        ...
        final Criteria resourceCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourceList.toArray(), 8);
        ...
        final Criteria policyMarkedForDeleteCriteria = new Criteria(Column.getColumn("RecentProfileForGroup", "MARKED_FOR_DELETE"), (Object)false, 0);
        final SelectQuery subQuery = (SelectQuery)new SelectQueryImpl(Table.getTable("RecentProfileForGroup"));
        final Criteria recentProfileCriteria = new Criteria(Column.getColumn("RecentProfileForGroup", "PROFILE_ID"), (Object)profileId, 0);
        final Criteria groupListCriteria = new Criteria(Column.getColumn("RecentProfileForGroup", "GROUP_ID"), (Object)resourceList.toArray(), 8);
        final Criteria markedForDeleteCriteria = new Criteria(Column.getColumn("RecentProfileForGroup", "MARKED_FOR_DELETE"), (Object)true, 0);
        subQuery.setCriteria(recentProfileCriteria.and(groupListCriteria).and(markedForDeleteCriteria));
        subQuery.addSelectColumn(Column.getColumn("RecentProfileForGroup", "GROUP_ID"));
        final DerivedColumn derivedColumn = new DerivedColumn("DC", subQuery);
        final Criteria notInGroupCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)derivedColumn, 9);
        selectQuery.setCriteria(profileCriteria.and(resourceCriteria).and(collectionCriteria).and(notInGroupCriteria).and(policyAppCollectionCriteria).and(policyMarkedForDeleteCriteria));
        ...
        if (!dataObject.isEmpty()) {
            final Iterator<Row> iterator = dataObject.getRows("MdAppCatalogToGroup");
    ...
    public void updateApprovedAppIdAndItsStatus(final Criteria criteria, final Long approvedAppId, final Integer associatedAppStatus) throws DataAccessException {
        this.configLogger.log(Level.INFO, "Setting approved app Id {0} Status {1} criteria {2} fro CG", new Object[] { approvedAppId, associatedAppStatus, criteria });
        final UpdateQuery updateQuery = (UpdateQuery)new UpdateQueryImpl("MdAppCatalogToGroup");
        updateQuery.addJoin(new Join("MdAppCatalogToGroup", "MdAppToCollection", new String[] { "APPROVED_APP_ID" }, new String[] { "APP_ID" }, 2));
    ...
    public DerivedColumn getResourcesForWhichAppUpdatePolicyIsConfiguredForGivenApp(final Long appGroupId) {
        ...
        selectQuery.setCriteria(new Criteria(Column.getColumn("MdPackageToAppGroup", "APP_GROUP_ID"), (Object)appGroupId, 0).and(new Criteria(Column.getColumn("RecentProfileForGroup", "MARKED_FOR_DELETE"), (Object)false, 0)));
        selectQuery.addSelectColumn(Column.getColumn("RecentProfileForGroup", "GROUP_ID").distinct());
        return new DerivedColumn("DC", selectQuery);
    }
    
    private Criteria getAppGroupCriteria(final Long appGroupId) {
        return new Criteria(Column.getColumn("MdAppCatalogToGroup", "APP_GROUP_ID"), (Object)appGroupId, 0);
    }
    ...
    private Criteria getGroupIdCriteria(final List deviceList) {
        return new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)deviceList.toArray(), 8);
    }
    
    @Override
    public void setIsUpdateAvailable(final Long appGroupId, final List resourceIds) throws Exception {
        this.profileDistLogger.log(Level.INFO, "[Setting App Update True] for group {0} appGroup {1}", new Object[] { resourceIds, appGroupId });
        final UpdateQuery updateQuery = (UpdateQuery)new UpdateQueryImpl("MdAppCatalogToGroup");
        updateQuery.setCriteria(new Criteria(Column.getColumn("MdAppCatalogToGroup", "APP_GROUP_ID"), (Object)appGroupId, 0).and(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourceIds.toArray(), 8));
    ...
    public Criteria getCriteria(final Long appGroupId, final List resourceIds) {
        return this.getAppGroupCriteria(appGroupId).and(this.getGroupIdCriteria(resourceIds));
    }
    ...
    public Criteria getCriteria(final DerivedColumn resourcesWithPolicy, final Long appGroupId, final List releaseLabelIds, final Boolean includeResourcesWithPolicy) {
        final Criteria resourceWithPolicy = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourcesWithPolicy, ((boolean)includeResourcesWithPolicy) ? 8 : 9);
    ...
    public Criteria getCriteria(final List appGroupIds, final List resourceIds, final Boolean isUpdateAvailable) {
        final Criteria appGroupCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "APP_GROUP_ID"), (Object)appGroupIds.toArray(), 8);
        final Criteria resourceCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourceIds.toArray(), 8);
        final Criteria isUpdateAvailableCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "IS_UPDATE_AVAILABLE"), (Object)isUpdateAvailable, 0);
    ...
    public Criteria getCriteria(final Long appGroupId, final List resourceIds, final DerivedColumn resourcesWithPolicy, final Boolean isUpdateAvailable) throws Exception {
        ...
        final Criteria resourceCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourceIds.toArray(), 8);
        final Criteria isUpdateAvailableCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "IS_UPDATE_AVAILABLE"), (Object)isUpdateAvailable, 0);
        final Criteria resourcesWithPolicyCriteria = new Criteria(Column.getColumn("MdAppCatalogToGroup", "RESOURCE_ID"), (Object)resourcesWithPolicy, 9);
