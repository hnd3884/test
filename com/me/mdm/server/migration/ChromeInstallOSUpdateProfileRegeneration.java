...
public class ChromeInstallOSUpdateProfileRegeneration extends MigrationFileRegeneration
{
    @Override
    public String generateFile(final Matcher scheduleOsUpdateMatcher) throws Exception {
        ...
        if (dataObject != null) {
            ...
            if (platformType == 4 && profileType == 3) {
                ...
                ChromeInstallOSUpdateProfileRegeneration.LOGGER.log(Level.INFO, "Chrome Install OS Update profile regeneration Collection Id : {0}", new Object[] { collectionId });
                final ChromeCommandPayload commandPayload = payloadHdlr.createScheduleOSUpdateCommand(collectionId);
                final String commandUUID = "ChromeOsUpdatePolicy;Collection=" + collectionId.toString();
