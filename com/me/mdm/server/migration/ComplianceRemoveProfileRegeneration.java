...
public class ComplianceRemoveProfileRegeneration extends MigrationFileRegeneration
{
    @Override
    public String generateFile(final Matcher complianceProfileMmatcher) throws Exception {
        ...
        if (dataObject != null) {
            ...
            if (profileType == 5) {
                ...
                requestJSON.put("remove_compliance_file_name_path", (Object)complianceProfileMmatcher.group(0));
                ComplianceRemoveProfileRegeneration.LOGGER.log(Level.INFO, "Compliance profile regeneration Collection Id : {0}", new Object[] { collectionId });
                final JSONObject complianceJSON = ComplianceHandler.getInstance().generateRemoveComplianceProfileJson(requestJSON);
