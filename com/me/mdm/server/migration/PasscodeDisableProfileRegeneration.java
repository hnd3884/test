...
public class PasscodeDisableProfileRegeneration extends MigrationFileRegeneration
{
    @Override
    public String generateFile(final Matcher matcher) throws Exception {
        ...
        if (dataObject != null) {
            ...
            PasscodeDisableProfileRegeneration.LOGGER.log(Level.INFO, "Remove passcode disable profile regeneration Collection Id : {0} Platform Type: {1} profile type: {2}", new Object[] { collectionId, platformType, profileType });
            if (platformType == 1 || platformType == 6 || platformType == 7) {
                ...
                final IOSCommandPayload commandPayload = payloadHdlr.generatePasscodeDisableRestriction(collectionId, payloadIdentifier);
