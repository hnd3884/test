...
public class ApiBlackListListViewDataHandler extends ApiListViewDataHandler
{
    @Override
    ...
    protected SelectQuery setCriteria() throws APIHTTPException {
        ...
        Criteria profileTypeCriteria = this.getProfileTypeCriteria(4);
    ...
    protected JSONObject fetchResultObject() throws APIHTTPException {
        try {
            ...
            ApiBlackListListViewDataHandler.logger.log(Level.FINE, "Query formation for BlackList App filtered values completed with result");
            ...
            ApiBlackListListViewDataHandler.logger.log(Level.SEVERE, "Exception while fetching filter data for profiles", ex);
