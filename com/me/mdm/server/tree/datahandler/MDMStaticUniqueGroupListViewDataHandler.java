...
public class MDMStaticUniqueGroupListViewDataHandler extends DefaultListViewNodeDataObject
{
    Logger logger;
    
    public MDMStaticUniqueGroupListViewDataHandler() {
    ...
    private List createChildTreeNodeList(final Map requestMap) {
        ...
        try {
            ...
            final List customGroupsList = CustomGroupingHandler.getCustomGroupsList(cri);
            ...
            while (groupItr.hasNext()) {
                ...
                groupCategory = groupDetails.get("CUSTOM_GP_CATEGORY");
                childNode.child = false;
                childNode.nocheckbox = false;
                String title = I18N.getMsg("dc.admin.cg.group_static", new Object[0]);
                if (groupCategory == 5) {
                    title = I18N.getMsg("dc.admin.cg.group_unique", new Object[0]);
                }
                ...
                ((Hashtable<String, Integer>)userDataProperties).put("platform", 6);
