        ...
        try {
            ...
            if (map == null || map.isEmpty()) {
                ...
                for (final String domainName : domainList) {
                    final List<Properties> groupList = this.getADGroupList(domainName, null, customerID);
                    if (groupList != null) {
                        map.put(domainName, groupList);
                    }
                }
                if (map != null && !map.isEmpty()) {
                    ApiFactoryProvider.getCacheAccessAPI().putCache("MDMADGroups", (Object)map, 2, 120);
                }
            }
            for (final String domainName2 : map.keySet()) {
                ...
                for (final Properties groupDetails : groupList2) {
                    ...
                    try {
                        ...
                        Logger.getLogger(ADGroupsTreeNodeDataHandler.class.getName()).log(Level.SEVERE, null, e);
                    }
                }
            }
        }
