package com.me.mdm.agent.nativeapp.payload;

import java.util.UUID;
import org.json.JSONException;
import org.json.JSONObject;

public class NativeAppPayload
{
    private JSONObject json;
    
    public NativeAppPayload() {
        this.json = null;
    ...
    public NativeAppPayload(final String payloadVersion, final String payloadType, final String payloadIdentifier, final String payloadDisplayName) throws JSONException {
        this();
