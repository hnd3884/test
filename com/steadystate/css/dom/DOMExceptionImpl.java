...
public class DOMExceptionImpl extends DOMException
{
    ...
    private static String constructMessage(final int key, final String info) {
        ...
        String message = DOMExceptionImpl.ExceptionResource_.getString(messageKey);
    ...
    static {
        DOMExceptionImpl.ExceptionResource_ = ResourceBundle.getBundle("com.steadystate.css.parser.ExceptionResource", Locale.getDefault());
    }
}
