...
public class AndroidEmailPayload extends AndroidPayload
{
    public AndroidEmailPayload(final String payloadVersion, final String payloadIdentifier, final String payloadDisplayName) throws JSONException {
    ...
    public void setDisplyName(final String displyName) throws JSONException {
        this.getPayloadJSON().put("DisplayName", (Object)displyName);
    }
    
    public void setSenderName(final String senderName) throws JSONException {
        this.getPayloadJSON().put("SenderName", (Object)senderName);
    }
    ...
    public void setIncomingServerUseTLS(final boolean useTLS) throws JSONException {
        this.getPayloadJSON().put("IncomingMailServerUseTLS", useTLS);
    }
    ...
    public void setOutgoingServerUseTLS(final boolean useTLS) throws JSONException {
        this.getPayloadJSON().put("OutGoingMailServerUseTLS", useTLS);
    }
    ...
    public void setAllowHTMLContent(final boolean allowHTML) throws JSONException {
        this.getPayloadJSON().put("AllowHTMLMail", allowHTML);
    }
    
    public void setAllowUserToChangeSettings(final boolean allowUserChangeSetting) throws JSONException {
        this.getPayloadJSON().put("AllowMailSettingsChange", allowUserChangeSetting);
    }
}
