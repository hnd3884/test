...
public class VpnPayload extends IOSPayload
{
    int connectionType;
    ...
    public VpnPayload(final int payloadVersion, final String payloadOrganization, final String payloadIdentifier, final String payloadDisplayName) {
    ...
    public void setSharedSecret(final String sharedSecret) {
        final NSData data = new NSData(sharedSecret.getBytes());
        if (this.connectionType == 1) {
            this.getVPNDict(3).put("SharedSecret", (NSObject)data);
        }
        else {
            this.getVPNDict(this.connectionType).put("SharedSecret", (NSObject)data);
        }
    }
    ...
    public void setHTTPProxy(final String httpProxy) {
        this.getProxyDict().put("HTTPPort", (Object)httpProxy);
        this.getProxyDict().put("HTTPSPort", (Object)httpProxy);
    }
