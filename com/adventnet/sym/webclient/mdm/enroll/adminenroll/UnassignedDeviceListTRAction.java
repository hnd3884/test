...
public class UnassignedDeviceListTRAction extends DCTableRetrieverAction
{
    public Logger logger;
    
    public UnassignedDeviceListTRAction() {
    ...
    public void setCriteria(final SelectQuery query, final ViewContext viewCtx) {
        try {
            ...
            request.setAttribute("isDeviceProvisioningUser", (Object)ManagedDeviceHandler.getInstance().isDeviceProvisioningUser());
            ...
            if (enrollmentTemplateStr != null && !enrollmentTemplateStr.isEmpty()) {
                ...
                switch (enrollmentTemplate) {
                    ...
                    case 12: {
                        templatecriteria = new Criteria(new Column("MacMgmtDeviceForEnrollment", "ENROLLMENT_DEVICE_ID"), (Object)null, 1);
                        break;
                    }
                    case 33: {
                ...
                if (viewname.equalsIgnoreCase("UnassignedDeviceListView") || viewname.equalsIgnoreCase("UnassignedDeviceExportView")) {
            ...
            if (loginID != null) {
                ...
                if (!isMDMAdmin && enrollmentTemplateStr != null && !enrollmentTemplateStr.isEmpty()) {
                    ...
                    try {
                        ...
                        Logger.getLogger(UnassignedDeviceListTRAction.class.getName()).log(Level.SEVERE, "{0}", ex);
                    }
                }
            }
            ...
            viewCtx.setStateOrURLStateParam("SEARCH_COLUMN", (Object)searchColumns);
            viewCtx.setStateOrURLStateParam("SEARCH_VALUE", (Object)searchValues);
        }
        catch (final Exception e) {
            this.logger.log(Level.WARNING, "Exception in  : UnassignedDeviceListTRAction:setCriteria()", e);
        }
    }
    ...
    private Criteria overrideColumnSearch(final ViewContext viewCtx, final String[] searchColumnsArray, final String[] searchValueArray) {
        ...
        if ((viewname.equalsIgnoreCase("UnassignedDeviceListView") || viewname.equalsIgnoreCase("depManagedDeviceView")) && searchColumnsArray != null && searchColumnsArray.length != 0 && (Arrays.stream(searchColumnsArray).anyMatch("DeviceForEnrollment.IMEI"::equals) || Arrays.stream(searchColumnsArray).anyMatch("DeviceForEnrollment.SERIAL_NUMBER"::equals) || Arrays.stream(searchColumnsArray).anyMatch("UserResource.NAME"::equals) || Arrays.stream(searchColumnsArray).anyMatch("ManagedUser.EMAIL_ADDRESS"::equals))) {
            ...
            for (int i = 0; i < searchColumns.length; ++i) {
                ...
                else if (searchColumns[i].equals("ManagedDeviceExtn.NAME")) {
                    searchValuesMap.put("device_name", searchValues[i]);
                }
                else {
        ...
        for (final Object key : searchValuesMap.keySet()) {
            ...
            if (searchValue != null && !searchValue.isEmpty()) {
                if (key.equals("imei")) {
                    ...
                    columnCriteria = new Criteria(Column.getColumn("ManagedDeviceExtn", "NAME"), (Object)searchValue, 12).or(new Criteria(Column.getColumn("DeviceEnrollmentProps", "ASSIGNED_DEVICE_NAME"), (Object)searchValue, 12));
                }
