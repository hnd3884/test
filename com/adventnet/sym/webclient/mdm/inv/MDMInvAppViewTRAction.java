...
public class MDMInvAppViewTRAction extends MDMEmberTableRetrieverAction
{
    @Override
    ...
    public void setCriteria(SelectQuery query, final ViewContext viewCtx) {
        ...
        if (unique.equalsIgnoreCase("MDMDevByAppSummary")) {
            ...
            if (resId != null && !resId.equalsIgnoreCase("")) {
                viewCtx.getRequest().setAttribute("RESOURCE_ID", (Object)resId);
                if (criteria == null) {
                    criteria = new Criteria(new Column("MdInstalledAppResourceRel", "RESOURCE_ID"), (Object)Long.parseLong(resId), 0);
                }
                else {
            ...
            if (status != null && !status.equalsIgnoreCase("") && !status.equalsIgnoreCase("0") && !status.equals("all")) {
                ...
                viewCtx.getRequest().setAttribute("status", (Object)status);
                if (criteria != null) {
            ...
            if (installedInVal != null && !installedInVal.equals("-1") && !installedInVal.equals("all")) {
                viewCtx.getRequest().setAttribute("installedIn", (Object)installedInVal);
        ...
        if (unique.equalsIgnoreCase("MDMNewAppList")) {
            ...
            viewCtx.getRequest().setAttribute("period", (Object)period);
            if (period != null) {
