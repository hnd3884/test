...
public class MDMEmberSqlViewController extends DMSqlViewRetrieverAction
{
    public String getVariableValue(final ViewContext viewCtx, final String variableName) {
        ...
        if (associatedValue == null) {
            ...
            if (loginID != null) {
                ...
                if (variableName.equalsIgnoreCase("MANAGEMENTTYPEPROFILEJOIN")) {
                    associatedValue = ManagementUtil.getManagementJoinAsString(1);
                }
            }
        }
