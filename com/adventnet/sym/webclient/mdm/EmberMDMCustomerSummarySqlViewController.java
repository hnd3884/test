...
public class EmberMDMCustomerSummarySqlViewController extends MDMEmberSqlViewController
{
    private Logger logger;
    
    public EmberMDMCustomerSummarySqlViewController() {
                ...
                try {
                    ...
                    if (searchcol != null && searchcol.length != 0) {
                        ...
                        for (int i = 0; i < searchcol.length; ++i) {
                            MDMEnrollmentUtil.getInstance().validateEnrollmentViewSearchText(searchcol[i], searchval[i]);
                    ...
                    this.logger.log(Level.SEVERE, "Exception while validate search text!", (Throwable)exp);
                }
            }
        }
