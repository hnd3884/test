...
public class BridgeBoxCreator extends DefaultBoxCreator
{
    @Override
    public String getHtmlForBoxPrefix() {
        ...
        boxPrefix.append("<TR>");
        boxPrefix.append("<TD colspan='4' id='").append(IAMEncoder.encodeHTMLAttribute(this.getBoxMaxContentId())).append("' class='").append(this.getBoxMaxContentClass()).append("'>");
    ...
    public String getHtmlForBoxSuffix() {
        ...
        boxSuffix.append("</TD></TR><TR><TD class='boxBL'>&nbsp;</td><TD colspan='2' class='boxBC'>&nbsp;</TD><TD class='boxBR'>&nbsp;</TD></TR></TABLE>");
