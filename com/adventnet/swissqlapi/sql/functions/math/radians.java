...
public class radians extends FunctionCalls
{
    ...
    public void toOracle(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        final StringBuffer radians = new StringBuffer();
        if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
            radians.append(this.functionArguments.elementAt(0).toOracleSelect(to_sqs, from_sqs).toString());
        }
        else {
            radians.append(this.functionArguments.elementAt(0).toString());
        }
        this.functionName.setColumnName("(" + (Object)radians + ")" + " * (3.14159265358979/180)");
    ...
    public void toInformix(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        final StringBuffer radians = new StringBuffer();
        if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
            radians.append(this.functionArguments.elementAt(0).toInformixSelect(to_sqs, from_sqs).toString());
        }
        else {
            radians.append(this.functionArguments.elementAt(0).toString());
        }
    ...
    public void toTimesTen(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        final StringBuffer radians = new StringBuffer();
        if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
            radians.append(this.functionArguments.elementAt(0).toTimesTenSelect(to_sqs, from_sqs).toString());
        }
        else {
            radians.append(this.functionArguments.elementAt(0).toString());
        }
    ...
    public void toVectorWise(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        final StringBuffer radians = new StringBuffer();
        if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
            radians.append(this.functionArguments.elementAt(0).toVectorWiseSelect(to_sqs, from_sqs).toString());
        }
        else {
            radians.append(this.functionArguments.elementAt(0).toString());
        }
