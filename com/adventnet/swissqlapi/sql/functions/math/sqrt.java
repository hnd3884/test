...
public class sqrt extends FunctionCalls
{
    ...
    public void toMSSQLServer(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        ...
        final String qry = "Case when " + arguments.get(0).toString() + " > 0 then sqrt(" + arguments.get(0).toString() + ") else null end";
    ...
    public void toPostgreSQL(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        ...
        final String argumentsNew = "CASE WHEN " + arguments.get(0).toString() + " < 0 THEN NULL ELSE " + arguments.get(0).toString() + " END";
    ...
    public void toVectorWise(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        ...
        if (this.functionArguments.elementAt(0) instanceof SelectColumn) {
            arguments += this.functionArguments.elementAt(0).toVectorWiseSelect(to_sqs, from_sqs);
        }
        else {
            arguments += this.functionArguments.elementAt(0);
        }
        final String funName = " if((" + arguments + "<0),null,SQRT(" + arguments + "))";
