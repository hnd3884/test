...
public class space extends FunctionCalls
{
    ...
    public void toPostgreSQL(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        ...
        this.functionName.setColumnName("repeat(' '::text," + arguments.get(0).toString() + ")");
        final Integer number = StringFunctions.getIntegerValue(arguments.get(0).toString());
        if (number != null) {
            this.functionName.setColumnName("repeat(' '::text," + number + ")");
        }
        else if (from_sqs != null && from_sqs.canUseUDFFunctionsForText() && !from_sqs.isAmazonRedShift()) {
