...
public class hextoraw extends FunctionCalls
{
    ...
    public void toTeradata(final SelectQueryStatement to_sqs, final SelectQueryStatement from_sqs) throws ConvertException {
        ...
        final SelectColumn arg = this.functionArguments.elementAt(0);
        if (arg.getColumnExpression().size() != 1 || !(arg.getColumnExpression().get(0) instanceof FunctionCalls)) {
            return;
        }
        final FunctionCalls fc = arg.getColumnExpression().get(0);
        ...
        final String fcSecondArg = fc.getFunctionArguments().get(1).toString().toUpperCase();
