...
public class MssqlUuidDTSQLGenerator implements DTSQLGenerator
{
    @Override
    public String getDefaultValue(final Object defVal) {
        throw new IllegalArgumentException("Default value for UUID column is not supported in Mssql.");
    }
