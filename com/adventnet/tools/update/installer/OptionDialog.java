...
public class OptionDialog extends JDialog implements ActionListener, WindowListener, OptionDialogConstants
{
    ...
    public OptionDialog(final BuilderResourceBundle bundle) {
        this((Frame)null, "", false, bundle);
    }
    
    public OptionDialog(final Frame owner, final String title, final boolean modal) {
        this(owner, title, modal, (BuilderResourceBundle)null);
    }
    
    public OptionDialog(final Frame owner, final String title, final boolean modal, final BuilderResourceBundle bundle) {
    ...
    public OptionDialog(final Dialog owner, final String title, final boolean modal, final BuilderResourceBundle bundle) {
        super(owner, title, modal);
        this.dialogType = 0;
        this.clickedState = -1;
        this.detailsNeeded = true;
    ...
    public void doInit() {
        ...
        this.setInformIcon(Utility.findImage("com/adventnet/tools/update/installer/images/info.png", null, true));
        this.setWarnIcon(Utility.findImage("com/adventnet/tools/update/installer/images/warning.png", null, true));
        this.setErrorIcon(Utility.findImage("com/adventnet/tools/update/installer/images/error.png", null, true));
        this.dialogSize = new Dimension();
        this.lblicon = new JLabel("");
        this.errMsg = new String();
        this.detMsg = new String();
        (this.btnDetails = new JButton(this.getString("Details >>"))).setFont(UpdateManagerUtil.getFont());
        (this.btnYes = new JButton(this.getString("Yes"))).setFont(UpdateManagerUtil.getFont());
        (this.btnCancel = new JButton(this.getString("Cancel"))).setFont(UpdateManagerUtil.getFont());
        (this.btnNo = new JButton(this.getString("No"))).setFont(UpdateManagerUtil.getFont());
    ...
    public void windowClosing(final WindowEvent e) {
        this.btnDetails.setText(this.getString("Details >>"));
    ...
    public void actionPerformed(final ActionEvent e) {
        if (e.getSource() == this.btnDetails) {
            if (this.btnDetails.getText() == this.getString("Details >>")) {
    ...
    private void setUp() {
        ...
        switch (state) {
            case 0: {
                this.process();
                this.yesDetails();
                this.btnYes.setText(this.getString("OK"));
                break;
            }
            case 2: {
                this.process();
    ...
    private void yesNoDetails() {
        ...
        this.g.setConstraints(this.btnYes, this.ct);
        this.btnPanel.add(this.btnYes);
        this.btnYes.setText(this.getString("Yes"));
        this.ct.gridx = 3;
        this.ct.gridy = 1;
        this.ct.gridwidth = 1;
        this.ct.gridheight = 1;
