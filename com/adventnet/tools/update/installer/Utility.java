...
public class Utility
{
    ...
    public static ImageIcon getResizedIcon(final ImageIcon icon, final int width, final int height) {
        ...
        final Image dimg = icon.getImage().getScaledInstance(width, height, 4);
    ...
    public static ImageIcon getFileFromAbsolutePath(final String nameArg) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting Image from Absoulte Path");
        }
        return imgIcon;
    }
    ...
    public static URL getURLFromAbsolutePath(final String nameArg) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting Resource from Absoulte Path");
        }
        return url;
    }
    ...
    public static URL getURLFromGetResource(final String fileName) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting Resource from : " + str);
            ex.printStackTrace();
        }
        return url;
    }
    ...
    public static ImageIcon getFileNameFromJar(final String imageFile) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting image from the Component Jar");
        }
        return imgIcon;
    }
    ...
    public static URL getURLFromCodeBase(final String fileName, final Applet appletArg) {
        ...
        try {
            ...
            if (index1 != -1) {
                codeBaseString = codeBaseString.substring(0, index1);
            }
            url = new URL(codeBaseString + "/" + fileName);
        }
        catch (final Exception eee1) {
            ConsoleOut.println("Exception getting fileName " + fileName + " from CodeBase");
        }
        return url;
    }
    ...
    public static URL getURLFromDocumentBase(final String fileName, final Applet appletArg) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting fileName " + fileName + " from Document Base");
        }
        return url;
    }
    ...
    public static URL getURLFromWebServerBase(final String fileName, final Applet appletArg) {
        ...
        try {
            ...
            ConsoleOut.println("Exception getting fileName " + fileName + " from WebServer Base!");
        }
        return url;
    }
    ...
    static void usage_error() {
        ...
        ConsoleOut.println("Usage: " + Utility.usage);
    }
