...
public final class TREEQUERYIDENTIFIERCOLUMNS
{
    public static final String TABLE = "TreeQueryIdentifierColumns";
    ...
    public static final int COLUMNVALUE_IDX = 4;
    
    private TREEQUERYIDENTIFIERCOLUMNS() {
    }
}
