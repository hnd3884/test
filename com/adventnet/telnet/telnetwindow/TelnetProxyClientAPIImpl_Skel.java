...
public final class TelnetProxyClientAPIImpl_Skel implements Skeleton
{
    ...
    public void dispatch(final Remote remote, final RemoteCall remoteCall, int n, final long n2) throws Exception {
        ...
        final TelnetProxyClientAPIImpl telnetProxyClientAPIImpl = (TelnetProxyClientAPIImpl)remote;
        switch (n) {
            case 0: {
                try {
            ...
            case 1: {
                Label_0364: {
                    ...
                    final String s;
                    final int int1;
                    final int connect = telnetProxyClientAPIImpl.connect(s, int1);
                    try {
            ...
            case 2: {
                Label_0522: {
                    ...
                    final int int2;
                    final String s3;
                    final int connect2 = telnetProxyClientAPIImpl.connect(s2, int2, s3);
                    try {
            ...
            case 3: {
                Label_0626: {
                    break Label_0626;
                    final int int3;
                    telnetProxyClientAPIImpl.disconnect(int3);
                    try {
            ...
            case 4: {
                Label_0784: {
                    ...
                    final String s4;
                    final String s5;
                    final String login = telnetProxyClientAPIImpl.login(int4, s4, s5);
                    try {
            ...
            case 5: {
                Label_0928: {
                    ...
                    final int int5;
                    final byte[] array;
                    final int read = telnetProxyClientAPIImpl.read(int5, array);
                    try {
            ...
            case 6: {
                Label_1044: {
                    break Label_1044;
                    final int int6;
                    final byte[] asByteArray = telnetProxyClientAPIImpl.readAsByteArray(int6);
                    try {
            ...
            case 7: {
                Label_1159: {
                    ...
                    final int int7;
                    final int int8;
                    telnetProxyClientAPIImpl.setSocketTimeout(int7, int8);
                    try {
                        remoteCall.getResultStream(true);
                        return;
                    }
            ...
            case 8: {
                ...
                Label_1274: {
                    ...
                    final int int9;
                    final byte byte1;
                    telnetProxyClientAPIImpl.write(int9, byte1);
                    try {
                        remoteCall.getResultStream(true);
                        return;
                    }
                ...
                telnetProxyClientAPIImpl.write(int10, array2);
                try {
                    remoteCall.getResultStream(true);
                    return;
                }
    ...
    public Operation[] getOperations() {
        return TelnetProxyClientAPIImpl_Skel.operations.clone();
    }
}
