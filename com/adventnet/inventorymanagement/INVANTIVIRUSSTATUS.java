...
public final class INVANTIVIRUSSTATUS
{
    public static final String TABLE = "InvAntivirusStatus";
    ...
    public static final int ANTIVIRUS_NAME_IDX = 2;
    ...
    public static final int LICENSE_STATUS_IDX = 5;
    public static final String PROTECTION_STATUS = "PROTECTION_STATUS";
    public static final int PROTECTION_STATUS_IDX = 6;
    public static final String INSTALLATION_PATH = "INSTALLATION_PATH";
    public static final int INSTALLATION_PATH_IDX = 7;
    public static final String LAST_ACCESS_TIME = "LAST_ACCESS_TIME";
    public static final int LAST_ACCESS_TIME_IDX = 8;
    
    private INVANTIVIRUSSTATUS() {
    }
}
