...
public class _ServerManagerStub extends ObjectImpl implements ServerManager
{
    ...
    @Override
    public String[] _ids() {
        return _ServerManagerStub.__ids.clone();
    }
    ...
    static {
        _ServerManagerStub.__ids = new String[] { "IDL:activation/ServerManager:1.0", "IDL:activation/Activator:1.0", "IDL:activation/Locator:1.0" };
    }
}
