...
public abstract class _ActivatorImplBase extends ObjectImpl implements Activator, InvokeHandler
{
    ...
    public OutputStream _invoke(final String s, final InputStream inputStream, final ResponseHandler responseHandler) {
        final Integer n = _ActivatorImplBase._methods.get(s);
        if (n == null) {
    ...
    @Override
    public String[] _ids() {
        return _ActivatorImplBase.__ids.clone();
    }
    
    static {
        (_ActivatorImplBase._methods = new Hashtable()).put("active", new Integer(0));
        _ActivatorImplBase._methods.put("registerEndpoints", new Integer(1));
        _ActivatorImplBase._methods.put("getActiveServers", new Integer(2));
        _ActivatorImplBase._methods.put("activate", new Integer(3));
        _ActivatorImplBase._methods.put("shutdown", new Integer(4));
        _ActivatorImplBase._methods.put("install", new Integer(5));
        _ActivatorImplBase._methods.put("getORBNames", new Integer(6));
        _ActivatorImplBase._methods.put("uninstall", new Integer(7));
        _ActivatorImplBase.__ids = new String[] { "IDL:activation/Activator:1.0" };
    }
}
