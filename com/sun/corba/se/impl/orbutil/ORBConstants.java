...
public class ORBConstants
{
    ...
    public static final int PERSISTENT_SCID;
    public static final int SC_TRANSIENT_SCID = 36;
    public static final int SC_PERSISTENT_SCID;
    public static final int IISC_TRANSIENT_SCID = 40;
    public static final int IISC_PERSISTENT_SCID;
    public static final int MINSC_TRANSIENT_SCID = 44;
    public static final int MINSC_PERSISTENT_SCID;
    ...
    public static int makePersistent(final int n) {
        return n | 0x2;
    }
    
    static {
        PERSISTENT_SCID = makePersistent(32);
        SC_PERSISTENT_SCID = makePersistent(36);
        IISC_PERSISTENT_SCID = makePersistent(40);
        MINSC_PERSISTENT_SCID = makePersistent(44);
    }
}
