...
public class ObjectStreamField implements Comparable
{
    ...
    void setField(final Field field) {
        this.field = field;
        this.fieldID = ObjectStreamField.bridge.objectFieldOffset(field);
    }
    ...
    public boolean typeEquals(final ObjectStreamField objectStreamField) {
        return objectStreamField != null && this.type == objectStreamField.type && ((this.typeString == null && objectStreamField.typeString == null) || ObjectStreamClass.compareClassNames(this.typeString, objectStreamField.typeString, '/'));
    }
