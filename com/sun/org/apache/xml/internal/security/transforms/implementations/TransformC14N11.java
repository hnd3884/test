...
public class TransformC14N11 extends TransformSpi
{
    ...
    protected XMLSignatureInput enginePerformTransform(final XMLSignatureInput xmlSignatureInput, final OutputStream outputStream, final Transform transform) throws CanonicalizationException {
        final Canonicalizer11_OmitComments canonicalizer11_OmitComments = new Canonicalizer11_OmitComments();
        ...
        final XMLSignatureInput xmlSignatureInput2 = new XMLSignatureInput(canonicalizer11_OmitComments.engineCanonicalize(xmlSignatureInput));
