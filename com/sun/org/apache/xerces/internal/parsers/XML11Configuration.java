...
public class XML11Configuration extends ParserConfigurationSettings implements XMLPullParserConfiguration, XML11Configurable
{
    ...
    public XML11Configuration(SymbolTable symbolTable, final XMLGrammarPool grammarPool, final XMLComponentManager parentSettings) {
        ...
        this.fComponents = new ArrayList<XMLComponent>();
        this.fXML11Components = new ArrayList<XMLComponent>();
        this.fCommonComponents = new ArrayList<XMLComponent>();
    ...
    FeatureState getFeatureState0(final String featureId) throws XMLConfigurationException {
        return super.getFeatureState(featureId);
    }
}
