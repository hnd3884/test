...
public class EncodingMap
{
    ...
    static {
        final Map<String, String> aIANA2JavaMap = new HashMap<String, String>();
        final Map<String, String> aJava2IANAMap = new HashMap<String, String>();
        ...
        fIANA2JavaMap = Collections.unmodifiableMap((Map<? extends String, ? extends String>)aIANA2JavaMap);
        ...
        fJava2IANAMap = Collections.unmodifiableMap((Map<? extends String, ? extends String>)aIANA2JavaMap);
    }
}
