...
public final class ErrorMsg
{
    ...
    public ErrorMsg(final String code, final Throwable e) {
        this._message = null;
        this._url = null;
        this._params = null;
        this._code = code;
    ...
    public String toString() {
        final String suffix = (this._params == null) ? ((null != this._code) ? this.getErrorMessage() : this._message) : MessageFormat.format(this.getErrorMessage(), this._params);
    ...
    static {
        ErrorMsg._bundle = SecuritySupport.getResourceBundle("com.sun.org.apache.xalan.internal.xsltc.compiler.util.ErrorMessages", Locale.getDefault());
    }
}
