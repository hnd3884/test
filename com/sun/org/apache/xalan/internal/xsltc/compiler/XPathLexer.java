...
class XPathLexer implements Scanner
{
    ...
    Symbol disambiguateAxisOrFunction(final int ss) throws Exception {
        ...
        return ((this.yy_buffer[index] == ':' && this.yy_buffer[index + 1] == ':') || this.yy_buffer[index] == '(') ? this.newSymbol(ss) : this.newSymbol(27, this.yytext());
    }
    ...
    Symbol disambiguateOperator(final int ss) throws Exception {
        switch (this.last) {
            case 9: {
                ...
                return this.newSymbol(27, this.yytext());
            }
            case -1:
            case 2:
            case 4:
        ...
        while (true) {
            ...
            if (-1 != yy_next_state) {
                ...
                switch (yy_last_accept_state) {
                    ...
                    case 21: {
                        return this.newSymbol(51, new Long(this.yytext()));
                    }
                    case 22: {
                    ...
                    case 28: {
                        return this.newSymbol(50, new Double(this.yytext()));
                    }
                    case 29: {
                    ...
                    case 32: {
                        return this.newSymbol(26, this.yytext().substring(1, this.yytext().length() - 1));
                    }
                    case 33: {
                        return this.newSymbol(26, this.yytext().substring(1, this.yytext().length() - 1));
                    }
