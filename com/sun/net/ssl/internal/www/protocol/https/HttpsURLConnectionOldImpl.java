...
public class HttpsURLConnectionOldImpl extends HttpsURLConnection
{
    ...
    HttpsURLConnectionOldImpl(final URL url, final Handler handler) throws IOException {
    ...
    HttpsURLConnectionOldImpl(final URL url, final Proxy proxy, final Handler handler) throws IOException {
        super(checkURL(url));
