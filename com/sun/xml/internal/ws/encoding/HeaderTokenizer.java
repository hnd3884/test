...
class HeaderTokenizer
{
    ...
    HeaderTokenizer(final String header, final String delimiters, final boolean skipComments) {
    ...
    HeaderTokenizer(final String header, final String delimiters) {
        this(header, delimiters, true);
    }
    
    HeaderTokenizer(final String header) {
        this(header, "()<>@,;:\\\"\t .[]");
    }
