...
public class ClientSOAPHandlerTube extends HandlerTube
{
    ...
    public ClientSOAPHandlerTube(final WSBinding binding, final WSDLPort port, final Tube next) {
        super(next, port, binding);
        if (binding.getSOAPVersion() != null) {}
    }
    
    public ClientSOAPHandlerTube(final WSBinding binding, final Tube next, final HandlerTube cousinTube) {
        super(next, cousinTube, binding);
    }
    
    private ClientSOAPHandlerTube(final ClientSOAPHandlerTube that, final TubeCloner cloner) {
        super(that, cloner);
    }
