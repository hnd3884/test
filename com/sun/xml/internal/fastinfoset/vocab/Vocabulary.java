...
public abstract class Vocabulary
{
    ...
    protected void setInitialReadOnlyVocabulary(final boolean hasInitialReadOnlyVocabulary) {
    ...
    protected void setExternalVocabularyURI(final String referencedVocabularyURI) {
