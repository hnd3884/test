...
public class JmxProperties
{
    ...
    static {
        MBEANSERVER_LOGGER = Logger.getLogger("javax.management.mbeanserver");
        MLET_LOGGER = Logger.getLogger("javax.management.mlet");
        MONITOR_LOGGER = Logger.getLogger("javax.management.monitor");
        TIMER_LOGGER = Logger.getLogger("javax.management.timer");
        NOTIFICATION_LOGGER = Logger.getLogger("javax.management.notification");
        RELATION_LOGGER = Logger.getLogger("javax.management.relation");
        MODELMBEAN_LOGGER = Logger.getLogger("javax.management.modelmbean");
        MISC_LOGGER = Logger.getLogger("javax.management.misc");
        SNMP_LOGGER = Logger.getLogger("javax.management.snmp");
        SNMP_ADAPTOR_LOGGER = Logger.getLogger("javax.management.snmp.daemon");
    }
}
