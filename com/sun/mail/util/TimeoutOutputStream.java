...
class TimeoutOutputStream extends OutputStream
{
    ...
    public TimeoutOutputStream(final OutputStream os0, final ScheduledExecutorService ses, final int timeout) throws IOException {
        this.os = os0;
        this.ses = ses;
    ...
    @Override
    public synchronized void write(final byte[] bs, final int off, final int len) throws IOException {
