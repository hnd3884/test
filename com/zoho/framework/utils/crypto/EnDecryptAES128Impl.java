...
public class EnDecryptAES128Impl implements EnDecrypt
{
    ...
    public String encrypt(final String plainText, final String cryptTag) {
        try {
            ...
            final PBEKeySpec spec = new PBEKeySpec(encryptionKey.toCharArray(), saltBytes, 65556, 128);
            ...
            EnDecryptAES128Impl.LOGGER.log(Level.SEVERE, "Key generation failed" + nsa.getMessage());
    ...
    public String decrypt(final String cipherText, final String cryptTag) {
        try {
            ...
            EnDecryptAES128Impl.LOGGER.log(Level.SEVERE, "Decryption failed" + e.getMessage());
        }
        return cipherText;
    }
    
    static {
        LOGGER = Logger.getLogger(EnDecryptAES128Impl.class.getName());
    }
}
