...
public class Credential implements HttpExecuteInterceptor, HttpRequestInitializer, HttpUnsuccessfulResponseHandler
{
    ...
    protected Credential(final Builder builder) {
        ...
        this.method = (AccessMethod)Preconditions.checkNotNull((Object)builder.method);
    ...
    public boolean handleResponse(final HttpRequest request, final HttpResponse response, final boolean supportsRetry) {
        ...
        if (refreshToken) {
            try {
                this.lock.lock();
                try {
                    return !Objects.equal((Object)this.accessToken, (Object)this.method.getAccessTokenFromRequest(request)) || this.refreshToken();
                }
                finally {
                    this.lock.unlock();
                }
