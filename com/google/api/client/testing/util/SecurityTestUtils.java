...
public final class SecurityTestUtils
{
    ...
    public static byte[] newEncodedRsaPrivateKeyBytes() {
        return SecurityTestUtils.ENCODED_PRIVATE_KEY.clone();
    }
    
    public static byte[] newEncodedRsaPublicKeyBytes() {
        return SecurityTestUtils.ENCODED_PUBLIC_KEY.clone();
    }
    ...
    public static RSAPrivateKey newRsaPrivateKey() throws GeneralSecurityException {
        ...
        final KeySpec keySpec = new PKCS8EncodedKeySpec(SecurityTestUtils.ENCODED_PRIVATE_KEY);
        return (RSAPrivateKey)keyFactory.generatePrivate(keySpec);
    }
    
    public static RSAPublicKey newRsaPublicKey() throws GeneralSecurityException {
        final KeyFactory keyFactory = SecurityUtils.getRsaKeyFactory();
        final KeySpec keySpec = new X509EncodedKeySpec(SecurityTestUtils.ENCODED_PUBLIC_KEY);
