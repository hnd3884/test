...
public class UriTemplate
{
    ...
    public static String expand(final String pathUri, final Object parameters, final boolean addUnusedParamsAsQueryParams) {
        ...
        while (cur < length) {
            ...
            if (next == -1) {
                ...
                final ListIterator<String> templateIterator = Splitter.on(',').splitToList((CharSequence)templates).listIterator();
    ...
    private static String getSimpleValue(final String name, final String value, final CompositeOutput compositeOutput) {
