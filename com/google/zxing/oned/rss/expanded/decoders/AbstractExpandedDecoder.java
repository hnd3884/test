...
public abstract class AbstractExpandedDecoder
{
    ...
    public static AbstractExpandedDecoder createDecoder(final BitArray information) {
        ...
        final int fourBitEncodationMethod = GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 4);
        switch (fourBitEncodationMethod) {
            ...
            default: {
                final int fiveBitEncodationMethod = GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 5);
                switch (fiveBitEncodationMethod) {
                    ...
                    default: {
                        final int sevenBitEncodationMethod = GeneralAppIdDecoder.extractNumericValueFromBitArray(information, 1, 7);
