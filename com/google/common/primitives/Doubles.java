...
public final class Doubles extends DoublesMethodsForWeb
{
    ...
    private static Pattern fpPattern() {
        ...
        final String hex = "(?:[0-9a-fA-F]+#(?:\\.[0-9a-fA-F]*#)?|\\.[0-9a-fA-F]+#)";
        final String completeHex = new StringBuilder(25 + String.valueOf(hex).length()).append("0[xX]").append(hex).append("[pP][+-]?\\d+#[fFdD]?").toString();
