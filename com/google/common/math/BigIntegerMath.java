...
public final class BigIntegerMath
{
    ...
    @GwtIncompatible
    public static double roundToDouble(final BigInteger x, final RoundingMode mode) {
    ...
    private static class BigIntegerToDoubleRounder extends ToDoubleRounder<BigInteger>
    {
        ...
        @Override
        double roundToDoubleArbitrarily(final BigInteger bigInteger) {
            return DoubleUtils.bigToDouble(bigInteger);
        }
        
        @Override
        int sign(final BigInteger bigInteger) {
            return bigInteger.signum();
        }
        
        @Override
        BigInteger toX(final double d, final RoundingMode mode) {
            return DoubleMath.roundToBigInteger(d, mode);
        }
        
        @Override
        BigInteger minus(final BigInteger a, final BigInteger b) {
            return a.subtract(b);
        }
