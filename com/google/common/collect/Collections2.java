...
public final class Collections2
{
    ...
    static boolean safeContains(final Collection<?> collection, @CheckForNull final Object object) {
    ...
    static boolean safeRemove(final Collection<?> collection, @CheckForNull final Object object) {
        Preconditions.checkNotNull(collection);
        try {
    ...
    static class FilteredCollection<E> extends AbstractCollection<E>
    {
        ...
        public void forEach(final Consumer<? super E> action) {
            ...
            this.unfiltered.forEach(e -> {
                if (this.predicate.test((Object)e)) {
                    action.accept(e);
                }
            });
        }
        ...
        public boolean removeIf(final java.util.function.Predicate<? super E> filter) {
            ...
            return this.unfiltered.removeIf(element -> this.predicate.apply((Object)element) && filter.test(element));
        }
        
        @Override
        public int size() {
            int size = 0;
            for (final E e : this.unfiltered) {
    ...
    static class TransformedCollection<F, T> extends AbstractCollection<T>
    {
        ...
        public Spliterator<T> spliterator() {
            return CollectSpliterators.map(this.fromCollection.spliterator(), (java.util.function.Function<? super F, ? extends T>)this.function);
        }
    ...
    private static final class OrderedPermutationCollection<E> extends AbstractCollection<List<E>>
    {
        ...
        OrderedPermutationCollection(final Iterable<E> input, final Comparator<? super E> comparator) {
            this.inputList = ImmutableList.sortedCopyOf(comparator, (Iterable<? extends E>)input);
