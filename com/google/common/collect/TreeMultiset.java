...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable
{
    ...
    public int count(@CheckForNull final Object element) {
        ...
        catch (final ClassCastException | NullPointerException e2) {
            return 0;
        }
    }
    ...
    public void clear() {
        if (!this.range.hasLowerBound() && !this.range.hasUpperBound()) {
            AvlNode<E> next;
            for (AvlNode<E> current = ((AvlNode<Object>)this.header).succ(); current != this.header; current = next) {
                next = ((AvlNode<Object>)current).succ();
    ...
    private AvlNode<E> firstNode() {
        ...
        if (this.range.hasLowerBound()) {
            ...
            if (this.range.getLowerBoundType() == BoundType.OPEN && this.comparator().compare(endpoint, node.getElement()) == 0) {
                node = ((AvlNode<Object>)node).succ();
            }
        }
        else {
            node = ((AvlNode<Object>)this.header).succ();
        }
    ...
    private AvlNode<E> lastNode() {
        ...
        if (this.range.hasUpperBound()) {
            ...
            if (this.range.getUpperBoundType() == BoundType.OPEN && this.comparator().compare(endpoint, node.getElement()) == 0) {
                node = ((AvlNode<Object>)node).pred();
            }
        }
        else {
            node = ((AvlNode<Object>)this.header).pred();
        }
        return (node == this.header || !this.range.contains(node.getElement())) ? null : node;
    }
    ...
    Iterator<Multiset.Entry<E>> entryIterator() {
        return new Iterator<Multiset.Entry<E>>() {
            ...
            public Multiset.Entry<E> next() {
                ...
                final Multiset.Entry<E> result = TreeMultiset.this.wrapEntry(Objects.requireNonNull(this.current));
                this.prevEntry = result;
                if (((AvlNode<Object>)this.current).succ() == TreeMultiset.this.header) {
                    this.current = null;
                }
                else {
                    this.current = ((AvlNode<Object>)this.current).succ();
                }
                return result;
            }
        ...
        return new Iterator<Multiset.Entry<E>>() {
            ...
            public Multiset.Entry<E> next() {
                ...
                if (((AvlNode<Object>)this.current).pred() == TreeMultiset.this.header) {
                    ...
                    this.current = ((AvlNode<Object>)this.current).pred();
                }
                return result;
            }
    ...
    public void forEachEntry(final ObjIntConsumer<? super E> action) {
        ...
        for (AvlNode<E> node = this.firstNode(); node != this.header && node != null && !this.range.tooHigh(node.getElement()); node = ((AvlNode<Object>)node).succ()) {
    ...
    private static final class AvlNode<E>
    {
        ...
        int count(final Comparator<? super E> comparator, @ParametricNullness final E e) {
            final int cmp = comparator.compare(e, this.getElement());
            if (cmp < 0) {
