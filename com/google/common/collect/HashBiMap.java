...
public final class HashBiMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V> implements BiMap<K, V>, Serializable
{
    ...
    private final class KeySet extends Maps.KeySet<K, V>
    {
        ...
        public boolean remove(@CheckForNull final Object o) {
            final BiEntry<K, V> entry = HashBiMap.this.seekByKey(o, Hashing.smearedHash(o));
            if (entry == null) {
                return false;
            }
    ...
    private final class Inverse extends Maps.IteratorBasedAbstractMap<V, K> implements BiMap<V, K>, Serializable
    {
        ...
        public K remove(@CheckForNull final Object value) {
            final BiEntry<K, V> entry = HashBiMap.this.seekByValue(value, Hashing.smearedHash(value));
            if (entry == null) {
                return null;
            }
            HashBiMap.this.delete(entry);
        ...
        private final class InverseKeySet extends Maps.KeySet<V, K>
        {
            ...
            @Override
            public boolean remove(@CheckForNull final Object o) {
                final BiEntry<K, V> entry = HashBiMap.this.seekByValue(o, Hashing.smearedHash(o));
                if (entry == null) {
                    return false;
                }
                HashBiMap.this.delete(entry);
