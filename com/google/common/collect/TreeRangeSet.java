...
public class TreeRangeSet<C extends Comparable<?>> extends AbstractRangeSet<C> implements Serializable
{
    ...
    public static <C extends Comparable<?>> TreeRangeSet<C> create(final Iterable<Range<C>> ranges) {
        final TreeRangeSet<C> result = create();
    ...
    public Set<Range<C>> asDescendingSetOfRanges() {
        final Set<Range<C>> result = this.asDescendingSetOfRanges;
    ...
    public boolean intersects(final Range<C> range) {
        ...
        final Map.Entry<Cut<C>, Range<C>> priorEntry = this.rangesByLowerBound.lowerEntry(range.lowerBound);
    ...
    final class AsRanges extends ForwardingCollection<Range<C>> implements Set<Range<C>>
    {
        ...
        AsRanges(final TreeRangeSet this$0, final Collection<Range<C>> delegate) {
    ...
    static final class RangesByUpperBound<C extends Comparable<?>> extends AbstractNavigableMap<Cut<C>, Range<C>>
    {
        ...
        @CheckForNull
        @Override
        public Range<C> get(@CheckForNull final Object key) {
