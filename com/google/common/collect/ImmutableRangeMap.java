    ...
    public static final class Builder<K extends Comparable<?>, V>
    {
        ...
        public ImmutableRangeMap<K, V> build() {
            ...
            for (int i = 0; i < this.entries.size(); ++i) {
                final Range<K> range = (Range<K>)this.entries.get(i).getKey();
                if (i > 0) {
                    final Range<K> prevRange = (Range<K>)this.entries.get(i - 1).getKey();
                ...
                valuesBuilder.add((V)this.entries.get(i).getValue());
            }
            return new ImmutableRangeMap<K, V>(rangesBuilder.build(), valuesBuilder.build());
        }
    }
