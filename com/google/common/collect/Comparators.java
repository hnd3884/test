...
public final class Comparators
{
    ...
    public static <T> Collector<T, ?, List<T>> least(final int k, final Comparator<? super T> comparator) {
        ...
        Preconditions.checkNotNull(comparator);
        return (Collector<T, ?, List<T>>)Collector.of(() -> TopKSelector.least(k, comparator), TopKSelector::offer, TopKSelector::combine, TopKSelector::topK, Collector.Characteristics.UNORDERED);
    }
