...
public abstract class ComparisonChain
{
    ...
    public abstract <T> ComparisonChain compare(@ParametricNullness final T p0, @ParametricNullness final T p1, final Comparator<T> p2);
    ...
    static {
        ACTIVE = new ComparisonChain() {
            ...
            @Override
            public <T> ComparisonChain compare(@ParametricNullness final T left, @ParametricNullness final T right, final Comparator<T> comparator) {
