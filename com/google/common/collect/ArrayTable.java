...
public final class ArrayTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable
{
    ...
    Spliterator<Table.Cell<R, C, V>> cellSpliterator() {
        return (Spliterator<Table.Cell<R, C, V>>)CollectSpliterators.indexed(this.size(), 273, this::getCell);
    }
    ...
    private abstract static class ArrayMap<K, V> extends Maps.IteratorBasedAbstractMap<K, V>
    {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return (Spliterator<Map.Entry<K, V>>)CollectSpliterators.indexed(this.size(), 16, this::getEntry);
        }
