...
final class RegularImmutableSortedSet<E> extends ImmutableSortedSet<E>
{
    ...
    public boolean containsAll(Collection<?> targets) {
        ...
        try {
            while (true) {
                final int cmp = this.unsafeCompare(current, target);
                if (cmp < 0) {
                    if (!thisIterator.hasNext()) {
                        return false;
                    }
    ...
    int headIndex(final E toElement, final boolean inclusive) {
        final int index = Collections.binarySearch(this.elements, (Object)Preconditions.checkNotNull((T)toElement), (Comparator<? super Object>)this.comparator());
        if (index >= 0) {
    ...
    int tailIndex(final E fromElement, final boolean inclusive) {
        final int index = Collections.binarySearch(this.elements, (Object)Preconditions.checkNotNull((T)fromElement), (Comparator<? super Object>)this.comparator());
        if (index >= 0) {
    ...
    ImmutableSortedSet<E> createDescendingSet() {
        final Comparator<? super E> reversedOrder = Collections.reverseOrder(this.comparator);
