...
public final class Streams
{
    ...
    public static <T> Stream<T> concat(final Stream<? extends T>... streams) {
        ...
        Spliterator<? extends T> splitr = null;
        ...
        return (Stream)StreamSupport.stream((Spliterator<Object>)CollectSpliterators.flatMap(splitrsBuilder.build().spliterator(), splitr -> splitr, characteristics, estimatedSize), isParallel).onClose(() -> closeAll(streams));
    }
    ...
    public static LongStream concat(final LongStream... streams) {
        ...
        Spliterator.OfLong splitr = null;
    ...
    public static DoubleStream concat(final DoubleStream... streams) {
        ...
        Spliterator.OfDouble splitr = null;
    ...
    public static <T> java.util.Optional<T> findLast(final Stream<T> stream) {
        ...
        while (!splits.isEmpty()) {
            ...
            if (spliterator.hasCharacteristics(16384)) {
                ...
                final OptionalState optionalState = state;
                Objects.requireNonNull(optionalState);
            ...
            if (prefix == null || prefix.getExactSizeIfKnown() == 0L) {
                ...
                final OptionalState optionalState2 = state;
                Objects.requireNonNull(optionalState2);
                spliterator3.forEachRemaining(optionalState2::set);
                if (state.set) {
                    return java.util.Optional.of(state.get());
                }
                continue;
