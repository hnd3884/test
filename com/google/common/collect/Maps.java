...
public final class Maps
{
    ...
    public static <K extends Enum<K>, V> ImmutableMap<K, V> immutableEnumMap(final Map<K, ? extends V> map) {
        ...
        final Iterator<? extends Map.Entry<K, ? extends V>> entryItr = map.entrySet().iterator();
        if (!entryItr.hasNext()) {
            return ImmutableMap.of();
        }
        final Map.Entry<K, ? extends V> entry1 = (Map.Entry<K, ? extends V>)entryItr.next();
        final K key1 = entry1.getKey();
        final V value1 = (V)entry1.getValue();
        CollectPreconditions.checkEntryNotNull(key1, value1);
        final Class<K> clazz = key1.getDeclaringClass();
        final EnumMap<K, V> enumMap = new EnumMap<K, V>(clazz);
        enumMap.put(key1, value1);
        while (entryItr.hasNext()) {
            final Map.Entry<K, ? extends V> entry2 = (Map.Entry<K, ? extends V>)entryItr.next();
            final K key2 = entry2.getKey();
            final V value2 = (V)entry2.getValue();
    ...
    public static <C, K extends C, V> TreeMap<K, V> newTreeMap(@CheckForNull final Comparator<C> comparator) {
    ...
    public static <K, V> MapDifference<K, V> difference(final Map<? extends K, ? extends V> left, final Map<? extends K, ? extends V> right) {
        if (left instanceof SortedMap) {
            ...
            return (MapDifference<K, V>)difference((SortedMap<K, ?>)sortedLeft, (Map<? extends K, ?>)right);
        }
        final MapDifference<K, V> result = difference(left, right, (Equivalence<? super V>)Equivalence.equals());
        return result;
    }
    ...
    public static <K, V> MapDifference<K, V> difference(final Map<? extends K, ? extends V> left, final Map<? extends K, ? extends V> right, final Equivalence<? super V> valueEquivalence) {
        ...
        final Map<K, V> onlyOnLeft = (Map<K, V>)newLinkedHashMap();
        final Map<K, V> onlyOnRight = new LinkedHashMap<K, V>(right);
        final Map<K, V> onBoth = (Map<K, V>)newLinkedHashMap();
        final Map<K, MapDifference.ValueDifference<V>> differences = (Map<K, MapDifference.ValueDifference<V>>)newLinkedHashMap();
    ...
    private static <K, V> void doDifference(final Map<? extends K, ? extends V> left, final Map<? extends K, ? extends V> right, final Equivalence<? super V> valueEquivalence, final Map<K, V> onlyOnLeft, final Map<K, V> onlyOnRight, final Map<K, V> onBoth, final Map<K, MapDifference.ValueDifference<V>> differences) {
        for (final Map.Entry<? extends K, ? extends V> entry : left.entrySet()) {
            ...
            if (right.containsKey(leftKey)) {
                final V rightValue = NullnessCasts.uncheckedCastNullableTToT(onlyOnRight.remove(leftKey));
    ...
    static <E> Comparator<? super E> orNaturalOrder(@CheckForNull final Comparator<? super E> comparator) {
        if (comparator != null) {
            return comparator;
        }
    ...
    public static <K, V> ImmutableMap<K, V> uniqueIndex(final Iterator<V> values, final Function<? super V, K> keyFunction) {
        ...
        catch (final IllegalArgumentException duplicateKeys) {
    ...
    public static ImmutableMap<String, String> fromProperties(final Properties properties) {
        ...
        while (e.hasMoreElements()) {
            final String key = Objects.requireNonNull(e.nextElement());
    ...
    @GwtCompatible(serializable = true)
    public static <K, V> Map.Entry<K, V> immutableEntry(@ParametricNullness final K key, @ParametricNullness final V value) {
    ...
    static <K, V> UnmodifiableIterator<Map.Entry<K, V>> unmodifiableEntryIterator(final Iterator<Map.Entry<K, V>> entryIterator) {
        return new UnmodifiableIterator<Map.Entry<K, V>>() {
            ...
            public Map.Entry<K, V> next() {
                return Maps.unmodifiableEntry((Map.Entry<? extends K, ? extends V>)entryIterator.next());
            }
        };
    }
    ...
    static <K, V1, V2> EntryTransformer<K, V1, V2> asEntryTransformer(final Function<? super V1, V2> function) {
        ...
        return new EntryTransformer<K, V1, V2>() {
            @ParametricNullness
            @Override
            public V2 transformEntry(@ParametricNullness final K key, @ParametricNullness final V1 value) {
    ...
    static <K, V1, V2> Function<V1, V2> asValueToValueFunction(final EntryTransformer<? super K, V1, V2> transformer, @ParametricNullness final K key) {
        ...
        return new Function<V1, V2>() {
            @ParametricNullness
            @Override
            public V2 apply(@ParametricNullness final V1 v1) {
    ...
    @CheckForNull
    private static <K, V> Map.Entry<K, V> unmodifiableOrNull(@CheckForNull final Map.Entry<K, ? extends V> entry) {
    ...
    @CheckForNull
    static <V> V safeGet(final Map<?, V> map, @CheckForNull final Object key) {
        Preconditions.checkNotNull(map);
        try {
            return map.get(key);
        }
    ...
    static boolean safeContainsKey(final Map<?, ?> map, @CheckForNull final Object key) {
        Preconditions.checkNotNull(map);
        try {
    ...
    @CheckForNull
    static <V> V safeRemove(final Map<?, V> map, @CheckForNull final Object key) {
        Preconditions.checkNotNull(map);
        try {
    ...
    static boolean containsKeyImpl(final Map<?, ?> map, @CheckForNull final Object key) {
        return Iterators.contains(keyIterator(map.entrySet().iterator()), key);
    }
    
    static boolean containsValueImpl(final Map<?, ?> map, @CheckForNull final Object value) {
        return Iterators.contains(valueIterator(map.entrySet().iterator()), value);
    }
    
    static <K, V> boolean containsEntryImpl(final Collection<Map.Entry<K, V>> c, @CheckForNull final Object o) {
        return o instanceof Map.Entry && c.contains(unmodifiableEntry((Map.Entry<?, ?>)o));
    }
    
    static <K, V> boolean removeEntryImpl(final Collection<Map.Entry<K, V>> c, @CheckForNull final Object o) {
        return o instanceof Map.Entry && c.remove(unmodifiableEntry((Map.Entry<?, ?>)o));
    }
    
    static boolean equalsImpl(final Map<?, ?> map, @CheckForNull final Object object) {
        if (map == object) {
            return true;
        }
    ...
    @CheckForNull
    static <K> K keyOrNull(@CheckForNull final Map.Entry<K, ?> entry) {
        return (entry == null) ? null : entry.getKey();
    }
    
    @CheckForNull
    static <V> V valueOrNull(@CheckForNull final Map.Entry<?, V> entry) {
    ...
    static class MapDifferenceImpl<K, V> implements MapDifference<K, V>
    {
        ...
        MapDifferenceImpl(final Map<K, V> onlyOnLeft, final Map<K, V> onlyOnRight, final Map<K, V> onBoth, final Map<K, ValueDifference<V>> differences) {
            this.onlyOnLeft = (Map<K, V>)unmodifiableMap((Map<Object, ?>)onlyOnLeft);
            this.onlyOnRight = (Map<K, V>)unmodifiableMap((Map<Object, ?>)onlyOnRight);
            this.onBoth = (Map<K, V>)unmodifiableMap((Map<Object, ?>)onBoth);
            this.differences = (Map<K, ValueDifference<V>>)unmodifiableMap((Map<Object, ?>)differences);
        }
    ...
    static class ValueDifferenceImpl<V> implements MapDifference.ValueDifference<V>
    {
        ...
        static <V> MapDifference.ValueDifference<V> create(@ParametricNullness final V left, @ParametricNullness final V right) {
            return new ValueDifferenceImpl<V>(left, right);
        }
        
        private ValueDifferenceImpl(@ParametricNullness final V left, @ParametricNullness final V right) {
            this.left = left;
            this.right = right;
        }
    ...
    private static final class NavigableAsMapView<K, V> extends AbstractNavigableMap<K, V>
    {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return CollectSpliterators.map(this.set.spliterator(), e -> Maps.immutableEntry(e, this.function.apply((Object)e)));
        }
    ...
    private static class UnmodifiableBiMap<K, V> extends ForwardingMap<K, V> implements BiMap<K, V>, Serializable
    {
        ...
        UnmodifiableBiMap(final BiMap<? extends K, ? extends V> delegate, @CheckForNull final BiMap<V, K> inverse) {
    ...
    static class TransformedEntriesMap<K, V1, V2> extends IteratorBasedAbstractMap<K, V2>
    {
        ...
        @CheckForNull
        @Override
        public V2 get(@CheckForNull final Object key) {
            return this.getOrDefault(key, null);
        }
        
        @CheckForNull
        @Override
        public V2 getOrDefault(@CheckForNull final Object key, @CheckForNull final V2 defaultValue) {
            final V1 value = this.fromMap.get(key);
            if (value != null || this.fromMap.containsKey(key)) {
                return this.transformer.transformEntry((Object)key, (Object)NullnessCasts.uncheckedCastNullableTToT(value));
            }
            return defaultValue;
        }
        ...
        @CheckForNull
        @Override
        public V2 remove(@CheckForNull final Object key) {
            return this.fromMap.containsKey(key) ? this.transformer.transformEntry((Object)key, (Object)NullnessCasts.uncheckedCastNullableTToT(this.fromMap.remove(key))) : null;
        }
        ...
        Iterator<Map.Entry<K, V2>> entryIterator() {
            return Iterators.transform(this.fromMap.entrySet().iterator(), (Function<? super Map.Entry<K, V1>, ? extends Map.Entry<K, V2>>)Maps.asEntryToEntryFunction((EntryTransformer<? super Object, ? super Object, V2>)this.transformer));
        }
        
        @Override
        Spliterator<Map.Entry<K, V2>> entrySpliterator() {
            return CollectSpliterators.map(this.fromMap.entrySet().spliterator(), (java.util.function.Function<? super Map.Entry<K, V1>, ? extends Map.Entry<K, V2>>)Maps.asEntryToEntryFunction((EntryTransformer<? super Object, ? super Object, V2>)this.transformer));
        }
    ...
    static class TransformedEntriesSortedMap<K, V1, V2> extends TransformedEntriesMap<K, V1, V2> implements SortedMap<K, V2>
    {
        ...
        @Override
        public SortedMap<K, V2> headMap(@ParametricNullness final K toKey) {
        ...
        @Override
        public SortedMap<K, V2> subMap(@ParametricNullness final K fromKey, @ParametricNullness final K toKey) {
            return Maps.transformEntries(this.fromMap().subMap(fromKey, toKey), this.transformer);
        }
        
        @Override
        public SortedMap<K, V2> tailMap(@ParametricNullness final K fromKey) {
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2>
    {
        ...
        @CheckForNull
        @Override
        public Map.Entry<K, V2> ceilingEntry(@ParametricNullness final K key) {
        ...
        @CheckForNull
        @Override
        public Map.Entry<K, V2> floorEntry(@ParametricNullness final K key) {
        ...
        @Override
        public NavigableMap<K, V2> headMap(@ParametricNullness final K toKey) {
            return this.headMap(toKey, false);
        }
        
        @Override
        public NavigableMap<K, V2> headMap(@ParametricNullness final K toKey, final boolean inclusive) {
            return Maps.transformEntries(this.fromMap().headMap(toKey, inclusive), this.transformer);
        }
        
        @CheckForNull
        @Override
        public Map.Entry<K, V2> higherEntry(@ParametricNullness final K key) {
        ...
        @CheckForNull
        @Override
        public Map.Entry<K, V2> lowerEntry(@ParametricNullness final K key) {
        ...
        @Override
        public NavigableMap<K, V2> subMap(@ParametricNullness final K fromKey, final boolean fromInclusive, @ParametricNullness final K toKey, final boolean toInclusive) {
            return Maps.transformEntries(this.fromMap().subMap(fromKey, fromInclusive, toKey, toInclusive), this.transformer);
        }
        
        @Override
        public NavigableMap<K, V2> subMap(@ParametricNullness final K fromKey, @ParametricNullness final K toKey) {
            return this.subMap(fromKey, true, toKey, false);
        }
        
        @Override
        public NavigableMap<K, V2> tailMap(@ParametricNullness final K fromKey) {
            return this.tailMap(fromKey, true);
        }
        
        @Override
        public NavigableMap<K, V2> tailMap(@ParametricNullness final K fromKey, final boolean inclusive) {
            return Maps.transformEntries(this.fromMap().tailMap(fromKey, inclusive), this.transformer);
        }
        
        @CheckForNull
        private Map.Entry<K, V2> transformEntry(@CheckForNull final Map.Entry<K, V1> entry) {
    ...
    private abstract static class AbstractFilteredMap<K, V> extends ViewCachingAbstractMap<K, V>
    {
        ...
        boolean apply(@CheckForNull final Object key, @ParametricNullness final V value) {
            final K k = (K)key;
    ...
    private static final class FilteredMapValues<K, V> extends Values<K, V>
    {
        ...
        public boolean remove(@CheckForNull final Object o) {
            final Iterator<Map.Entry<K, V>> entryItr = this.unfiltered.entrySet().iterator();
            while (entryItr.hasNext()) {
                final Map.Entry<K, V> entry = entryItr.next();
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V>
    {
        ...
        static <K, V> boolean removeAllKeys(final Map<K, V> map, final Predicate<? super Map.Entry<K, V>> entryPredicate, final Collection<?> keyCollection) {
            final Iterator<Map.Entry<K, V>> entryItr = map.entrySet().iterator();
            boolean result = false;
            while (entryItr.hasNext()) {
                final Map.Entry<K, V> entry = entryItr.next();
        ...
        static <K, V> boolean retainAllKeys(final Map<K, V> map, final Predicate<? super Map.Entry<K, V>> entryPredicate, final Collection<?> keyCollection) {
            final Iterator<Map.Entry<K, V>> entryItr = map.entrySet().iterator();
            boolean result = false;
            while (entryItr.hasNext()) {
                final Map.Entry<K, V> entry = entryItr.next();
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V>
    {
        ...
        public NavigableSet<K> navigableKeySet() {
            return new NavigableKeySet<K, V>(this) {
                @Override
                public boolean removeAll(final Collection<?> collection) {
                    return FilteredEntryMap.removeAllKeys((Map<Object, Object>)FilteredEntryNavigableMap.this.unfiltered, FilteredEntryNavigableMap.this.entryPredicate, collection);
                }
                
                @Override
                public boolean retainAll(final Collection<?> collection) {
                    return FilteredEntryMap.retainAllKeys((Map<Object, Object>)FilteredEntryNavigableMap.this.unfiltered, FilteredEntryNavigableMap.this.entryPredicate, collection);
                }
            };
        }
    ...
    static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable
    {
        ...
        public Map.Entry<K, V> lowerEntry(@ParametricNullness final K key) {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.lowerEntry(key));
        }
        ...
        public Map.Entry<K, V> floorEntry(@ParametricNullness final K key) {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.floorEntry(key));
        }
        ...
        public Map.Entry<K, V> ceilingEntry(@ParametricNullness final K key) {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.ceilingEntry(key));
        }
        ...
        public Map.Entry<K, V> higherEntry(@ParametricNullness final K key) {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.higherEntry(key));
        }
        ...
        public Map.Entry<K, V> firstEntry() {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.firstEntry());
        }
        
        @CheckForNull
        @Override
        public Map.Entry<K, V> lastEntry() {
            return (Map.Entry<K, V>)unmodifiableOrNull((Map.Entry<Object, ?>)this.delegate.lastEntry());
        }
    ...
    abstract static class IteratorBasedAbstractMap<K, V> extends AbstractMap<K, V>
    {
        ...
        Spliterator<Map.Entry<K, V>> entrySpliterator() {
            return Spliterators.spliterator((Iterator<? extends Map.Entry<K, V>>)this.entryIterator(), (long)this.size(), 65);
        }
    ...
    static class NavigableKeySet<K, V> extends SortedKeySet<K, V> implements NavigableSet<K>
    {
        ...
        @CheckForNull
        @Override
        public K lower(@ParametricNullness final K e) {
            return this.map().lowerKey(e);
        }
        
        @CheckForNull
        @Override
        public K floor(@ParametricNullness final K e) {
            return this.map().floorKey(e);
        }
        
        @CheckForNull
        @Override
        public K ceiling(@ParametricNullness final K e) {
            return this.map().ceilingKey(e);
        }
        
        @CheckForNull
        @Override
        public K higher(@ParametricNullness final K e) {
    ...
    {
        V2 transformEntry(@ParametricNullness final K p0, @ParametricNullness final V1 p1);
    }
}
