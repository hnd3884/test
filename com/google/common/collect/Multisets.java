...
public final class Multisets
{
    ...
    public static <T, E, M extends Multiset<E>> Collector<T, ?, M> toMultiset(final Function<? super T, E> elementFunction, final ToIntFunction<? super T> countFunction, final Supplier<M> multisetSupplier) {
    ...
    public static <E> Multiset.Entry<E> immutableEntry(@ParametricNullness final E e, final int n) {
    ...
    public static boolean removeOccurrences(final Multiset<?> multisetToModify, final Multiset<?> occurrencesToRemove) {
        ...
        while (entryIterator.hasNext()) {
            final Multiset.Entry<?> entry = (Multiset.Entry<?>)entryIterator.next();
    ...
    static boolean equalsImpl(final Multiset<?> multiset, @CheckForNull final Object object) {
        if (object == multiset) {
            return true;
        }
    ...
    static <E> boolean addAllImpl(final Multiset<E> self, final Collection<? extends E> elements) {
        ...
        if (elements instanceof Multiset) {
            return addAllImpl(self, (Multiset<? extends E>)cast((Iterable<? extends E>)elements));
        }
        return !elements.isEmpty() && Iterators.addAll(self, elements.iterator());
    }
    
    private static <E> boolean addAllImpl(final Multiset<E> self, final Multiset<? extends E> elements) {
        if (elements.isEmpty()) {
            return false;
        }
    ...
    static <E> int setCountImpl(final Multiset<E> self, @ParametricNullness final E element, final int count) {
    ...
    static <E> boolean setCountImpl(final Multiset<E> self, @ParametricNullness final E element, final int oldCount, final int newCount) {
    ...
    static <E> Iterator<E> elementIterator(final Iterator<Multiset.Entry<E>> entryIterator) {
    ...
    static <E> Spliterator<E> spliteratorImpl(final Multiset<E> multiset) {
        final Spliterator<Multiset.Entry<E>> entrySpliterator = multiset.entrySet().spliterator();
    ...
    static int linearTimeSizeImpl(final Multiset<?> multiset) {
        long size = 0L;
    ...
    public static <E> ImmutableMultiset<E> copyHighestCountFirst(final Multiset<E> multiset) {
        final Multiset.Entry<E>[] entries = multiset.entrySet().toArray(new Multiset.Entry[0]);
        Arrays.sort(entries, DecreasingCount.INSTANCE);
        return ImmutableMultiset.copyFromEntries((Collection<? extends Multiset.Entry<? extends E>>)Arrays.asList(entries));
    }
    ...
    static class UnmodifiableMultiset<E> extends ForwardingMultiset<E> implements Serializable
    {
        ...
        public Iterator<E> iterator() {
            return (Iterator<E>)Iterators.unmodifiableIterator((Iterator<?>)this.delegate.iterator());
        }
        ...
        @Override
        public boolean remove(@CheckForNull final Object element) {
            throw new UnsupportedOperationException();
        }
    ...
    static class ImmutableEntry<E> extends AbstractEntry<E> implements Serializable
    {
        ...
        ImmutableEntry(@ParametricNullness final E element, final int count) {
    ...
    abstract static class AbstractEntry<E> implements Multiset.Entry<E>
    {
        ...
        public String toString() {
            ...
            return (n == 1) ? text : new StringBuilder(14 + String.valueOf(text).length()).append(text).append(" x ").append(n).toString();
        }
    }
