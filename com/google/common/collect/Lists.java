...
public final class Lists
{
    ...
    public static <E> CopyOnWriteArrayList<E> newCopyOnWriteArrayList(final Iterable<? extends E> elements) {
        final Collection<? extends E> elementsCollection = (Collection<? extends E>)((elements instanceof Collection) ? ((Iterable<? extends E>)elements) : newArrayList((Iterable<?>)elements));
        return new CopyOnWriteArrayList<E>(elementsCollection);
    }
    
    public static <E> List<E> asList(@ParametricNullness final E first, final E[] rest) {
        return new OnePlusArrayList<E>(first, rest);
    }
    
    public static <E> List<E> asList(@ParametricNullness final E first, @ParametricNullness final E second, final E[] rest) {
    ...
    public static <T> List<T> reverse(final List<T> list) {
        if (list instanceof ImmutableList) {
            final List<T> result;
            final List<?> reversed = result = ((ImmutableList)list).reverse();
            return result;
        }
    ...
    static boolean equalsImpl(final List<?> thisList, @CheckForNull final Object other) {
    ...
    static int indexOfImpl(final List<?> list, @CheckForNull final Object element) {
        if (list instanceof RandomAccess) {
    ...
    private static int indexOfRandomAccess(final List<?> list, @CheckForNull final Object element) {
    ...
    static int lastIndexOfImpl(final List<?> list, @CheckForNull final Object element) {
        if (list instanceof RandomAccess) {
    ...
    private static int lastIndexOfRandomAccess(final List<?> list, @CheckForNull final Object element) {
        if (element == null) {
    ...
    private static class OnePlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess
    {
        ...
        OnePlusArrayList(@ParametricNullness final E first, final E[] rest) {
            this.first = first;
    ...
    private static class TwoPlusArrayList<E> extends AbstractList<E> implements Serializable, RandomAccess
    {
        ...
        TwoPlusArrayList(@ParametricNullness final E first, @ParametricNullness final E second, final E[] rest) {
            this.first = first;
            this.second = second;
            this.rest = Preconditions.checkNotNull(rest);
        }
    ...
    private static class ReverseList<T> extends AbstractList<T>
    {
        ...
        @Override
        public void add(final int index, @ParametricNullness final T element) {
        ...
        @ParametricNullness
        @Override
        public T set(final int index, @ParametricNullness final T element) {
        ...
        public ListIterator<T> listIterator(final int index) {
            ...
            return new ListIterator<T>() {
                ...
                @Override
                public void add(@ParametricNullness final T e) {
                ...
                @Override
                public void set(@ParametricNullness final T e) {
