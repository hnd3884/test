...
public final class Iterables
{
    ...
    public static <T> boolean addAll(final Collection<T> addTo, final Iterable<? extends T> elementsToAdd) {
        if (elementsToAdd instanceof Collection) {
            final Collection<? extends T> c = (Collection)elementsToAdd;
    ...
    public static <T> Iterable<T> cycle(final Iterable<T> iterable) {
        ...
        return new FluentIterable<T>() {
            ...
            public Spliterator<T> spliterator() {
                return (Spliterator<T>)Stream.generate(() -> {
                    final Object val$iterable = iterable;
                    return iterable;
                }).flatMap((Function<? super Iterable, ? extends Stream<?>>)Streams::stream).spliterator();
            }
        ...
        return new FluentIterable<T>() {
            ...
            public void forEach(final Consumer<? super T> action) {
                ...
                unfiltered.forEach(a -> {
                    final Object val$retainIfTrue = retainIfTrue;
    ...
    public static <T> T getLast(final Iterable<? extends T> iterable, @ParametricNullness final T defaultValue) {
        if (iterable instanceof Collection) {
            final Collection<? extends T> c = (Collection)iterable;
            if (c.isEmpty()) {
                return defaultValue;
            }
            if (iterable instanceof List) {
