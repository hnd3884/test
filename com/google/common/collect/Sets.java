...
public final class Sets
{
    ...
    public static <E> CopyOnWriteArraySet<E> newCopyOnWriteArraySet(final Iterable<? extends E> elements) {
        final Collection<? extends E> elementsCollection = (Collection<? extends E>)((elements instanceof Collection) ? ((Iterable<? extends E>)elements) : Lists.newArrayList((Iterable<?>)elements));
    ...
    public static <E> SetView<E> union(final Set<? extends E> set1, final Set<? extends E> set2) {
        ...
        return new SetView<E>() {
            ...
            public Stream<E> stream() {
                return Stream.concat((Stream<? extends E>)set1.stream(), (Stream<? extends E>)set2.stream().filter(e -> {
                    final Object val$set1 = set1;
