...
class FilteredEntryMultimap<K, V> extends AbstractMultimap<K, V> implements FilteredMultimap<K, V>
{
    ...
    private boolean satisfies(@ParametricNullness final K key, @ParametricNullness final V value) {
    ...
    final class ValuePredicate implements Predicate<V>
    {
        ...
        @Override
        public boolean apply(@ParametricNullness final V value) {
    ...
    class AsMap extends Maps.ViewCachingAbstractMap<K, Collection<V>>
    {
        ...
        Set<Map.Entry<K, Collection<V>>> createEntrySet() {
            ...
            return (Set<Map.Entry<K, Collection<V>>>)new EntrySetImpl();
        }
    ...
    class Keys extends Multimaps.Keys<K, V>
    {
        ...
        @Override
        public int remove(@CheckForNull final Object key, final int occurrences) {
