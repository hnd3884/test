...
final class CollectCollectors
{
    ...
    static <T, E> Collector<T, ?, ImmutableMultiset<E>> toImmutableMultiset(final Function<? super T, ? extends E> elementFunction, final ToIntFunction<? super T> countFunction) {
        ...
        return Collector.of((Supplier<?>)LinkedHashMultiset::create, (multiset, t) -> multiset.add(Preconditions.checkNotNull(elementFunction.apply(t)), countFunction.applyAsInt(t)), (multiset1, multiset2) -> {
    ...
    static <T, E, M extends Multiset<E>> Collector<T, ?, M> toMultiset(final Function<? super T, E> elementFunction, final ToIntFunction<? super T> countFunction, final Supplier<M> multisetSupplier) {
        ...
        return (Collector<T, ?, M>)Collector.of((Supplier<?>)multisetSupplier, (ms, t) -> ms.add(elementFunction.apply(t), countFunction.applyAsInt(t)), (ms1, ms2) -> {
            ms1.addAll(ms2);
            return ms1;
    ...
    public static <T, K, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableMap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction) {
        ...
        return (Collector<T, ?, ImmutableMap<K, V>>)Collectors.collectingAndThen((Collector<T, ?, Map>)Collectors.toMap((Function<? super T, ?>)keyFunction, valueFunction, mergeFunction, (Supplier<R>)LinkedHashMap::new), ImmutableMap::copyOf);
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableSortedMap<K, V>> toImmutableSortedMap(final Comparator<? super K> comparator, final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction) {
        ...
        Preconditions.checkNotNull(valueFunction);
        Preconditions.checkNotNull(mergeFunction);
        return (Collector<T, ?, ImmutableSortedMap<K, V>>)Collectors.collectingAndThen((Collector<T, ?, SortedMap>)Collectors.toMap((Function<? super T, ?>)keyFunction, valueFunction, mergeFunction, () -> new TreeMap(comparator)), ImmutableSortedMap::copyOfSorted);
    }
    ...
    static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        Preconditions.checkNotNull(keyFunction);
        Preconditions.checkNotNull(valueFunction);
        return (Collector<T, ?, ImmutableMap<K, V>>)Collector.of(() -> new EnumMapAccumulator((v1, v2) -> {
            ...
            final Enum key = keyFunction.apply(t);
            final Object newValue = valueFunction.apply(t);
    ...
    static <T, K extends Enum<K>, V> Collector<T, ?, ImmutableMap<K, V>> toImmutableEnumMap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction, final BinaryOperator<V> mergeFunction) {
        ...
        Preconditions.checkNotNull(valueFunction);
        Preconditions.checkNotNull(mergeFunction);
        return (Collector<T, ?, ImmutableMap<K, V>>)Collector.of(() -> new EnumMapAccumulator(mergeFunction), (accum, t) -> {
            final Enum key = keyFunction.apply(t);
            final Object newValue = valueFunction.apply(t);
            accum.put(Preconditions.checkNotNull(key, "Null key for input %s", t), Preconditions.checkNotNull(newValue, "Null value for input %s", t));
    ...
    static <T, K extends Comparable<? super K>, V> Collector<T, ?, ImmutableRangeMap<K, V>> toImmutableRangeMap(final Function<? super T, Range<K>> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        Preconditions.checkNotNull(keyFunction);
        Preconditions.checkNotNull(valueFunction);
        return (Collector<T, ?, ImmutableRangeMap<K, V>>)Collector.of(ImmutableRangeMap::builder, (builder, input) -> builder.put(keyFunction.apply(input), valueFunction.apply(input)), ImmutableRangeMap.Builder::combine, ImmutableRangeMap.Builder::build, new Collector.Characteristics[0]);
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> toImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        ...
        return (Collector<T, ?, ImmutableListMultimap<K, V>>)Collector.of(ImmutableListMultimap::builder, (builder, t) -> builder.put(keyFunction.apply(t), valueFunction.apply(t)), ImmutableListMultimap.Builder::combine, ImmutableListMultimap.Builder::build, new Collector.Characteristics[0]);
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableListMultimap<K, V>> flatteningToImmutableListMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valuesFunction) {
        ...
        final Function<Object, Object> keyFunction2 = input -> Preconditions.checkNotNull(keyFunction.apply(input));
        final Function<Object, Stream> valueFunction = input -> valuesFunction.apply(input).peek(Preconditions::checkNotNull);
        ...
        return (Collector<T, ?, ImmutableListMultimap<K, V>>)Collectors.collectingAndThen((Collector<T, ?, Multimap>)flatteningToMultimap((Function<? super Object, ?>)keyFunction2, (Function<? super Object, ? extends Stream<?>>)valueFunction, (Supplier<R>)arrayListValues::build), ImmutableListMultimap::copyOf);
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> toImmutableSetMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction) {
        Preconditions.checkNotNull(keyFunction, (Object)"keyFunction");
        Preconditions.checkNotNull(valueFunction, (Object)"valueFunction");
        return (Collector<T, ?, ImmutableSetMultimap<K, V>>)Collector.of(ImmutableSetMultimap::builder, (builder, t) -> builder.put(keyFunction.apply(t), valueFunction.apply(t)), ImmutableSetMultimap.Builder::combine, ImmutableSetMultimap.Builder::build, new Collector.Characteristics[0]);
    }
    ...
    static <T, K, V> Collector<T, ?, ImmutableSetMultimap<K, V>> flatteningToImmutableSetMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valuesFunction) {
        ...
        return (Collector<T, ?, ImmutableSetMultimap<K, V>>)Collectors.collectingAndThen((Collector<T, ?, Multimap>)flatteningToMultimap((Function<? super Object, ?>)keyFunction2, (Function<? super Object, ? extends Stream<?>>)valueFunction, (Supplier<R>)linkedHashSetValues::build), ImmutableSetMultimap::copyOf);
    }
    ...
    static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> toMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends V> valueFunction, final Supplier<M> multimapSupplier) {
        ...
        return (Collector<T, ?, M>)Collector.of((Supplier<?>)multimapSupplier, (multimap, input) -> multimap.put(keyFunction.apply(input), valueFunction.apply(input)), (multimap1, multimap2) -> {
    ...
    static <T, K, V, M extends Multimap<K, V>> Collector<T, ?, M> flatteningToMultimap(final Function<? super T, ? extends K> keyFunction, final Function<? super T, ? extends Stream<? extends V>> valueFunction, final Supplier<M> multimapSupplier) {
        ...
        return (Collector<T, ?, M>)Collector.of((Supplier<?>)multimapSupplier, (multimap, input) -> {
            final Object key = keyFunction.apply(input);
            final Collection<Object> valuesForKey = multimap.get(key);
            final Stream stream = valueFunction.apply(input);
