...
public abstract class ImmutableSortedSet<E> extends ImmutableSortedSetFauxverideShim<E> implements NavigableSet<E>, SortedIterable<E>
{
    ...
    public static <E> ImmutableSortedSet<E> copyOf(final Comparator<? super E> comparator, final Iterable<? extends E> elements) {
        ...
        if (hasSameComparator && elements instanceof ImmutableSortedSet) {
            final ImmutableSortedSet<E> original = (ImmutableSortedSet)elements;
    ...
    int unsafeCompare(final Object a, @CheckForNull final Object b) {
        return unsafeCompare(this.comparator, a, b);
    }
    
    static int unsafeCompare(final Comparator<?> comparator, final Object a, @CheckForNull final Object b) {
    ...
    abstract int indexOf(@CheckForNull final Object p0);
    
    private void readObject(final ObjectInputStream unused) throws InvalidObjectException {
    ...
    public static final class Builder<E> extends ImmutableSet.Builder<E>
    {
        ...
        private void sortAndDedup() {
            ...
            for (int i = 1; i < this.n; ++i) {
                final int cmp = this.comparator.compare((Object)this.elements[unique - 1], (Object)this.elements[i]);
                if (cmp < 0) {
                    this.elements[unique++] = this.elements[i];
                }
                else if (cmp > 0) {
                    final String value = String.valueOf(this.comparator);
                    throw new AssertionError((Object)new StringBuilder(48 + String.valueOf(value).length()).append("Comparator ").append(value).append(" compare method violates its contract").toString());
                }
            }
        ...
        public Builder<E> add(final E element) {
            ...
            if (this.n == this.elements.length) {
                this.sortAndDedup();
                final int newLength = ImmutableCollection.Builder.expandedCapacity(this.n, this.n + 1);
        ...
        @CanIgnoreReturnValue
        @Override
        Builder<E> combine(final ImmutableSet.Builder<E> builder) {
            this.copyIfNecessary();
            final Builder<E> other = (Builder)builder;
        ...
        public ImmutableSortedSet<E> build() {
            this.sortAndDedup();
            if (this.n == 0) {
                return (ImmutableSortedSet<E>)ImmutableSortedSet.emptySet((Comparator<? super Object>)this.comparator);
            }
            this.forceCopy = true;
