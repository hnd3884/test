...
public abstract class CharMatcher implements Predicate<Character>
{
    ...
    CharMatcher precomputedInternal() {
        ...
        if (description.endsWith(suffix)) {
            substring = description.substring(0, description.length() - suffix.length());
        }
        else {
    ...
    private static final class Digit extends RangesMatcher
    {
        ...
        private static char[] nines() {
            final char[] nines = new char["0\u0660\u06f0\u07c0\u0966\u09e6\u0a66\u0ae6\u0b66\u0be6\u0c66\u0ce6\u0d66\u0de6\u0e50\u0ed0\u0f20\u1040\u1090\u17e0\u1810\u1946\u19d0\u1a80\u1a90\u1b50\u1bb0\u1c40\u1c50\ua620\ua8d0\ua900\ua9d0\ua9f0\uaa50\uabf0\uff10".length()];
            for (int i = 0; i < "0\u0660\u06f0\u07c0\u0966\u09e6\u0a66\u0ae6\u0b66\u0be6\u0c66\u0ce6\u0d66\u0de6\u0e50\u0ed0\u0f20\u1040\u1090\u17e0\u1810\u1946\u19d0\u1a80\u1a90\u1b50\u1bb0\u1c40\u1c50\ua620\ua8d0\ua900\ua9d0\ua9f0\uaa50\uabf0\uff10".length(); ++i) {
                nines[i] = (char)("0\u0660\u06f0\u07c0\u0966\u09e6\u0a66\u0ae6\u0b66\u0be6\u0c66\u0ce6\u0d66\u0de6\u0e50\u0ed0\u0f20\u1040\u1090\u17e0\u1810\u1946\u19d0\u1a80\u1a90\u1b50\u1bb0\u1c40\u1c50\ua620\ua8d0\ua900\ua9d0\ua9f0\uaa50\uabf0\uff10".charAt(i) + '\t');
            }
            return nines;
        }
    ...
    private static final class Is extends FastMatcher
    {
        ...
        @Override
        public String toString() {
            final String access$100 = showCharacter(this.match);
    ...
    private static final class IsEither extends FastMatcher
    {
        ...
        @Override
        public String toString() {
            final String access$100 = showCharacter(this.match1);
            final String access$101 = showCharacter(this.match2);
    ...
    private static final class InRange extends FastMatcher
    {
        ...
        @Override
        public String toString() {
            final String access$100 = showCharacter(this.startInclusive);
            final String access$101 = showCharacter(this.endInclusive);
