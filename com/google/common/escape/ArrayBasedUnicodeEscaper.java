...
public abstract class ArrayBasedUnicodeEscaper extends UnicodeEscaper
{
    ...
    protected ArrayBasedUnicodeEscaper(final Map<Character, String> replacementMap, final int safeMin, final int safeMax, final String unsafeReplacement) {
        this(ArrayBasedEscaperMap.create(replacementMap), safeMin, safeMax, unsafeReplacement);
    }
    
    protected ArrayBasedUnicodeEscaper(final ArrayBasedEscaperMap escaperMap, int safeMin, int safeMax, final String unsafeReplacement) {
