...
public abstract class FluentFuture<V> extends GwtFluentFutureCatchingSpecialization<V>
{
    ...
    public final <T> FluentFuture<T> transformAsync(final AsyncFunction<? super V, T> function, final Executor executor) {
        return (FluentFuture)Futures.transformAsync((ListenableFuture<Object>)this, (AsyncFunction<? super Object, ? extends T>)function, executor);
    }
    
    public final <T> FluentFuture<T> transform(final Function<? super V, T> function, final Executor executor) {
        return (FluentFuture)Futures.transform((ListenableFuture<Object>)this, (Function<? super Object, ? extends T>)function, executor);
    }
