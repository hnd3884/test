...
public final class ClosingFuture<V>
{
    ...
    @Deprecated
    public static <C extends Object & AutoCloseable> ClosingFuture<C> eventuallyClosing(final ListenableFuture<C> future, final Executor closingExecutor) {
    ...
    public static final class DeferredCloser
    {
        ...
        @ParametricNullness
        @CanIgnoreReturnValue
        public <C extends Object & AutoCloseable> C eventuallyClose(@ParametricNullness final C closeable, final Executor closingExecutor) {
            Preconditions.checkNotNull(closingExecutor);
            if (closeable != null) {
