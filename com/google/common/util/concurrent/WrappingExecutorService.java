...
abstract class WrappingExecutorService implements ExecutorService
{
    ...
    private <T> ImmutableList<Callable<T>> wrapTasks(final Collection<? extends Callable<T>> tasks) {
    ...
    @Override
    public final <T> Future<T> submit(final Runnable task, @ParametricNullness final T result) {
