...
public abstract class ByteSource
{
    ...
    public byte[] read() throws IOException {
        ...
        try {
            final InputStream in = closer.register(this.openStream());
            final Optional<Long> size = this.sizeIfKnown();
    ...
    class AsCharSource extends CharSource
    {
        ...
        public String toString() {
            final String string = ByteSource.this.toString();
            final String value = String.valueOf(this.charset);
            return new StringBuilder(15 + String.valueOf(string).length() + String.valueOf(value).length()).append(string).append(".asCharSource(").append(value).append(")").toString();
        }
    }
    ...
    private final class SlicedByteSource extends ByteSource
    {
        ...
        public String toString() {
            final String string = ByteSource.this.toString();
            return new StringBuilder(50 + String.valueOf(string).length()).append(string).append(".slice(").append(this.offset).append(", ").append(this.length).append(")").toString();
        }
    }
    ...
    private static class ByteArrayByteSource extends ByteSource
    {
        ...
        @Override
        public String toString() {
            final String truncate = Ascii.truncate(BaseEncoding.base16().encode(this.bytes, this.offset, this.length), 30, "...");
