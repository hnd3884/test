...
class AppendableWriter extends Writer
{
    ...
    @Override
    public Writer append(@CheckForNull final CharSequence charSeq) throws IOException {
        this.checkNotClosed();
    ...
    @Override
    public Writer append(@CheckForNull final CharSequence charSeq, final int start, final int end) throws IOException {
        this.checkNotClosed();
