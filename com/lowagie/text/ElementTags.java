...
public class ElementTags
{
    ...
    static {
        SUBSUPSCRIPT = "SUBSUPSCRIPT".toLowerCase(Locale.ROOT);
        LOCALGOTO = "LOCALGOTO".toLowerCase(Locale.ROOT);
        REMOTEGOTO = "REMOTEGOTO".toLowerCase(Locale.ROOT);
        LOCALDESTINATION = "LOCALDESTINATION".toLowerCase(Locale.ROOT);
        GENERICTAG = "GENERICTAG".toLowerCase(Locale.ROOT);
    }
}
