...
public class PdfCopyFields implements PdfViewerPreferences, PdfEncryptionSettings
{
    ...
    public PdfCopyFields(final OutputStream os) throws DocumentException {
        this.fc = new PdfCopyFieldsImp(os);
    }
    
    public PdfCopyFields(final OutputStream os, final char pdfVersion) throws DocumentException {
