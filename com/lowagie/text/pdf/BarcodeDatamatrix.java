...
public class BarcodeDatamatrix
{
    ...
    private static int asciiEncodation(final byte[] text, final int textOffset, int textLength, final byte[] data, final int dataOffset, int dataLength) {
    ...
    private static int b256Encodation(final byte[] text, final int textOffset, final int textLength, final byte[] data, final int dataOffset, final int dataLength) {
        if (textLength == 0) {
            return 0;
        }
    ...
    private static int X12Encodation(final byte[] text, final int textOffset, final int textLength, final byte[] data, final int dataOffset, final int dataLength) {
        if (textLength == 0) {
            return 0;
        }
        int ptrIn = 0;
        int ptrOut = 0;
        final byte[] x = new byte[textLength];
        int count = 0;
        while (ptrIn < textLength) {
    ...
    private static int EdifactEncodation(final byte[] text, final int textOffset, final int textLength, final byte[] data, final int dataOffset, final int dataLength) {
        if (textLength == 0) {
            return 0;
        }
        int ptrIn = 0;
    ...
    private static int C40OrTextEncodation(final byte[] text, final int textOffset, final int textLength, final byte[] data, final int dataOffset, final int dataLength, final boolean c40) {
        if (textLength == 0) {
            return 0;
        }
        int ptrIn = 0;
        ...
        data[ptrOut++] = -2;
        int i = asciiEncodation(text, ptrIn, textLength - ptrIn, data, ptrOut, dataLength - ptrOut);
        if (i < 0) {
            return i;
        }
        return ptrOut + i;
    ...
    private static int getEncodation(final byte[] text, final int textOffset, final int textSize, final byte[] data, final int dataOffset, final int dataSize, int options, final boolean firstMatch) {
        final int[] e1 = new int[6];
        if (dataSize < 0) {
            return -1;
        }
        int e2 = -1;
        ...
        if (options == 0) {
            ...
            if (j == 0) {
                e2 = asciiEncodation(text, textOffset, textSize, data, dataOffset, dataSize);
            }
            else if (j == 1) {
                e2 = C40OrTextEncodation(text, textOffset, textSize, data, dataOffset, dataSize, false);
            }
            else if (j == 2) {
                e2 = C40OrTextEncodation(text, textOffset, textSize, data, dataOffset, dataSize, true);
            }
            else if (j == 3) {
                e2 = b256Encodation(text, textOffset, textSize, data, dataOffset, dataSize);
            }
            else if (j == 4) {
                e2 = X12Encodation(text, textOffset, textSize, data, dataOffset, dataSize);
            }
            return e2;
        }
        else {
    ...
    public int generate(final String text) throws UnsupportedEncodingException {
        final byte[] t = text.getBytes(StandardCharsets.ISO_8859_1);
    ...
    static class Placement
    {
        ...
        static short[] doPlacement(final int nrow, final int ncol) {
            final Integer key = new Integer(nrow * 1000 + ncol);
