...
public final class SCRAMSHA512BindRequest extends SCRAMBindRequest
{
    private static final long serialVersionUID = -4396660110665214258L;
    
    public SCRAMSHA512BindRequest(final String username, final String password, final Control... controls) {
        super(username, new ASN1OctetString(password), controls);
    }
    
    public SCRAMSHA512BindRequest(final String username, final byte[] password, final Control... controls) {
        super(username, new ASN1OctetString(password), controls);
    }
    ...
    @Override
    public SCRAMSHA512BindRequest getRebindRequest(final String host, final int port) {
    ...
    public SCRAMSHA512BindRequest duplicate(final Control[] controls) {
        return new SCRAMSHA512BindRequest(this.getUsername(), this.getPasswordBytes(), controls);
    }
    ...
    public void toCode(final List<String> lineList, final String requestID, final int indentSpaces, final boolean includeProcessing) {
        ...
        ToCodeHelper.generateMethodCall(lineList, indentSpaces, "SCRAMSHA512BindRequest", requestID + "Request", "new SCRAMSHA512BindRequest", constructorArgs);
