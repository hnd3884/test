...
public class DeleteResultAccessLogMessage extends DeleteRequestAccessLogMessage implements OperationResultAccessLogMessage
{
    ...
    public DeleteResultAccessLogMessage(final String s) throws LogException {
        this(new LogMessage(s));
    }
    
    public DeleteResultAccessLogMessage(final LogMessage m) {
        super(m);
        ...
        this.softDeletedEntryDN = this.getNamedValue("softDeleteEntryDN");
