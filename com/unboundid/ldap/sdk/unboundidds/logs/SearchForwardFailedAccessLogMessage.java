...
public final class SearchForwardFailedAccessLogMessage extends SearchRequestAccessLogMessage
{
    private static final long serialVersionUID = -4612332908960932928L;
    ...
    public SearchForwardFailedAccessLogMessage(final String s) throws LogException {
        this(new LogMessage(s));
    }
    
    public SearchForwardFailedAccessLogMessage(final LogMessage m) {
        super(m);
