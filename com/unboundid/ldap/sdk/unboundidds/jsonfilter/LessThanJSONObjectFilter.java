...
public final class LessThanJSONObjectFilter extends JSONObjectFilter
{
    ...
    private LessThanJSONObjectFilter(final List<String> field, final JSONValue value, final boolean allowEquals, final boolean matchAllElements, final boolean caseSensitive) {
        this.field = field;
        this.value = value;
    ...
    public LessThanJSONObjectFilter(final List<String> field, final JSONValue value) {
    ...
    protected Set<String> getRequiredFieldNames() {
        return LessThanJSONObjectFilter.REQUIRED_FIELD_NAMES;
    }
    
    @Override
    protected Set<String> getOptionalFieldNames() {
        return LessThanJSONObjectFilter.OPTIONAL_FIELD_NAMES;
    }
    ...
    public JSONObject toJSONObject() {
        ...
        fields.put("filterType", new JSONString("lessThan"));
    ...
    @Override
    protected LessThanJSONObjectFilter decodeFilter(final JSONObject filterObject) throws JSONException {
        ...
        return new LessThanJSONObjectFilter(fieldPath, filterObject.getField("value"), isAllowEquals, isMatchAllElements, isCaseSensitive);
    }
