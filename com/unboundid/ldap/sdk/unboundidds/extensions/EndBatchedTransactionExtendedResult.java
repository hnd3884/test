...
public final class EndBatchedTransactionExtendedResult extends ExtendedResult
{
    ...
    public EndBatchedTransactionExtendedResult(final ExtendedResult extendedResult) throws LDAPException {
    ...
    public EndBatchedTransactionExtendedResult(final int messageID, final ResultCode resultCode, final String diagnosticMessage, final String matchedDN, final String[] referralURLs, final Integer failedOpMessageID, final Map<Integer, Control[]> opResponseControls, final Control[] responseControls) {
