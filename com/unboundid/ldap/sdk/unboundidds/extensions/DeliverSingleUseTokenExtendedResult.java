...
public final class DeliverSingleUseTokenExtendedResult extends ExtendedResult
{
    ...
    public DeliverSingleUseTokenExtendedResult(final int messageID, final ResultCode resultCode, final String diagnosticMessage, final String matchedDN, final String[] referralURLs, final String deliveryMechanism, final String recipientID, final String deliveryMessage, final Control... responseControls) {
        super(messageID, resultCode, diagnosticMessage, matchedDN, referralURLs, (deliveryMechanism == null) ? null : "1.3.6.1.4.1.30221.2.6.50", encodeValue(deliveryMechanism, recipientID, deliveryMessage), responseControls);
        this.deliveryMechanism = deliveryMechanism;
        this.recipientID = recipientID;
        this.deliveryMessage = deliveryMessage;
    }
    
    public DeliverSingleUseTokenExtendedResult(final ExtendedResult result) throws LDAPException {
        super(result);
