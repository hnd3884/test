...
public final class StartBatchedTransactionExtendedResult extends ExtendedResult
{
    private static final long serialVersionUID = 7661263203064470371L;
    private final ASN1OctetString transactionID;
    
    public StartBatchedTransactionExtendedResult(final ExtendedResult extendedResult) {
        super(extendedResult);
        this.transactionID = extendedResult.getValue();
    }
    
    public StartBatchedTransactionExtendedResult(final int messageID, final ResultCode resultCode, final String diagnosticMessage, final String matchedDN, final String[] referralURLs, final ASN1OctetString transactionID, final Control[] responseControls) {
    ...
    public String getExtendedResultName() {
        return ExtOpMessages.INFO_EXTENDED_RESULT_NAME_START_BATCHED_TXN.get();
    }
