...
public final class AnyAttributesChangeSelectionCriteria extends ChangelogBatchChangeSelectionCriteria
{
    ...
    public AnyAttributesChangeSelectionCriteria(final Collection<String> attributeNames) {
    ...
    static AnyAttributesChangeSelectionCriteria decodeInnerElement(final ASN1Element innerElement) throws LDAPException {
        try {
            ...
            throw new LDAPException(ResultCode.DECODING_ERROR, ExtOpMessages.ERR_ANY_ATTRS_CHANGE_SELECTION_CRITERIA_DECODE_ERROR.get(StaticUtils.getExceptionMessage(e2)), e2);
        }
    }
    ...
    public ASN1Element encodeInnerElement() {
        ...
        return new ASN1Sequence((byte)(-95), elements);
    }
