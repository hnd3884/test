...
public final class StreamDirectoryValuesExtendedRequest extends ExtendedRequest
{
    ...
    public StreamDirectoryValuesExtendedRequest(final String baseDN, final SearchScope dnScope, final boolean returnRelativeDNs, final List<String> attributes, final int valuesPerResponse, final Control... controls) {
        super("1.3.6.1.4.1.30221.2.6.6", encodeValue(baseDN, dnScope, returnRelativeDNs, attributes, valuesPerResponse), controls);
        this.baseDN = baseDN;
    ...
    public StreamDirectoryValuesExtendedRequest(final ExtendedRequest extendedRequest) throws LDAPException {
    ...
    private static ASN1OctetString encodeValue(final String baseDN, final SearchScope scope, final boolean relativeDNs, final List<String> attributes, final int valuesPerResponse) {
    ...
    @Override
    public StreamDirectoryValuesExtendedRequest duplicate(final Control[] controls) {
        final StreamDirectoryValuesExtendedRequest r = new StreamDirectoryValuesExtendedRequest(this.baseDN, this.dnScope, this.returnRelativeDNs, this.attributes, this.valuesPerResponse, controls);
