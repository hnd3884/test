...
enum MonitorMessages
{
    ...
    INFO_SYSTEM_INFO_DESC_USED_MEMORY("The amount of memory in bytes currently used the the JVM used to run the Directory Server."), 
    ...
    INFO_VERSION_DESC_FIX_IDS("The list of fix IDs for any bugfixes that have been applied to the Directory Server."), 
    ...
    private static final ConcurrentHashMap<MonitorMessages, String> MESSAGE_STRINGS;
    private static final ConcurrentHashMap<MonitorMessages, MessageFormat> MESSAGES;
    ...
    public String get(final Object... args) {
        MessageFormat f = MonitorMessages.MESSAGES.get(this);
        if (f == null) {
            if (MonitorMessages.RESOURCE_BUNDLE == null) {
                ...
                try {
                    f = new MessageFormat(MonitorMessages.RESOURCE_BUNDLE.getString(this.name()));
                }
                catch (final Exception e) {
                    f = new MessageFormat(this.defaultText);
                }
            }
            MonitorMessages.MESSAGES.putIfAbsent(this, f);
        }
    ...
    static {
        ...
        RESOURCE_BUNDLE = rb;
        MESSAGE_STRINGS = new ConcurrentHashMap<MonitorMessages, String>(100);
        MESSAGES = new ConcurrentHashMap<MonitorMessages, MessageFormat>(100);
    }
}
