...
public final class PostReadRequestControl extends Control
{
    ...
    public PostReadRequestControl(final boolean isCritical, final String... attributes) {
        super("1.3.6.1.1.13.2", isCritical, encodeValue(attributes));
        if (attributes == null) {
            this.attributes = PostReadRequestControl.NO_ATTRIBUTES;
        }
        else {
    ...
    public PostReadRequestControl(final Control control) throws LDAPException {
        super(control);
