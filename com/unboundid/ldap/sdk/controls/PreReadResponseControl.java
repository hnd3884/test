...
public final class PreReadResponseControl extends Control implements DecodeableControl
{
    ...
    public PreReadResponseControl(final ReadOnlyEntry entry) {
        super("1.3.6.1.1.13.1", false, encodeValue(entry));
        this.entry = entry;
    }
    
    public PreReadResponseControl(final String oid, final boolean isCritical, final ASN1OctetString value) throws LDAPException {
        ...
        try {
            ...
            throw new LDAPException(ResultCode.DECODING_ERROR, ControlMessages.ERR_PRE_READ_RESPONSE_ATTRIBUTES_NOT_SEQUENCE.get(ae2), ae2);
        }
        ...
        for (int i = 0; i < attrElements.length; ++i) {
            try {
                ...
                throw new LDAPException(ResultCode.DECODING_ERROR, ControlMessages.ERR_PRE_READ_RESPONSE_ATTR_NOT_SEQUENCE.get(ae3), ae3);
            }
        }
    ...
    @Override
    public PreReadResponseControl decodeControl(final String oid, final boolean isCritical, final ASN1OctetString value) throws LDAPException {
        return new PreReadResponseControl(oid, isCritical, value);
    }
    
    public static PreReadResponseControl get(final LDAPResult result) throws LDAPException {
        final Control c = result.getResponseControl("1.3.6.1.1.13.1");
        if (c == null) {
            return null;
        }
        ...
        return new PreReadResponseControl(c.getOID(), c.isCritical(), c.getValue());
    }
