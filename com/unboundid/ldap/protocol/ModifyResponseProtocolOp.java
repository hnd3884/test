...
public final class ModifyResponseProtocolOp extends GenericResponseProtocolOp
{
    ...
    public ModifyResponseProtocolOp(final int resultCode, final String matchedDN, final String diagnosticMessage, final List<String> referralURLs) {
    ...
    ModifyResponseProtocolOp(final ASN1StreamReader reader) throws LDAPException {
        super(reader);
    }
    ...
    public ASN1Element encodeProtocolOp() {
        ...
        return new ASN1Sequence((byte)103, elements);
    }
    
    public static ModifyResponseProtocolOp decodeProtocolOp(final ASN1Element element) throws LDAPException {
        try {
            ...
            throw new LDAPException(ResultCode.DECODING_ERROR, ProtocolMessages.ERR_MODIFY_RESPONSE_CANNOT_DECODE.get(StaticUtils.getExceptionMessage(e2)), e2);
        }
    }
}
