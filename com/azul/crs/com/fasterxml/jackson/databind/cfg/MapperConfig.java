...
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.DefaultBaseTypeLimitingValidator;
...
public abstract class MapperConfig<T extends MapperConfig<T>> implements ClassIntrospector.MixInResolver, Serializable
{
    ...
    public static <F extends Enum<F> & ConfigFeature> int collectFeatureDefaults(final Class<F> enumClass) {
        int flags = 0;
    ...
    public abstract JsonIncludeProperties.Value getDefaultPropertyInclusions(final Class<?> p0, final AnnotatedClass p1);
