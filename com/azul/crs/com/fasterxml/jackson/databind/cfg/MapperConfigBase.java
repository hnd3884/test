...
public abstract class MapperConfigBase<CFG extends ConfigFeature, T extends MapperConfigBase<CFG, T>> extends MapperConfig<T> implements Serializable
{
    ...
    protected MapperConfigBase(final MapperConfigBase<CFG, T> src, final SubtypeResolver str, final SimpleMixInResolver mixins, final RootNameLookup rootNames, final ConfigOverrides configOverrides) {
    ...
    public final T with(final AccessorNamingStrategy.Provider p) {
    ...
    public final JsonIgnoreProperties.Value getDefaultPropertyIgnorals(final Class<?> baseType, final AnnotatedClass actualClass) {
        ...
        final JsonIgnoreProperties.Value base = (intr == null) ? null : intr.findPropertyIgnoralByName(this, actualClass);
    ...
    @Override
    public final JsonIncludeProperties.Value getDefaultPropertyInclusions(final Class<?> baseType, final AnnotatedClass actualClass) {
        final AnnotationIntrospector intr = this.getAnnotationIntrospector();
