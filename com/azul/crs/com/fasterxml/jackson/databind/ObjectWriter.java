...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.TypeWrappedSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.TypeSerializer;
import com.azul.crs.com.fasterxml.jackson.core.util.Instantiatable;
import com.azul.crs.com.fasterxml.jackson.core.io.SerializedString;
import com.azul.crs.com.fasterxml.jackson.core.util.MinimalPrettyPrinter;
...
public class ObjectWriter implements Versioned, Serializable
{
    ...
    public ObjectWriter with(final StreamWriteFeature feature) {
        return this._new(this, this._config.with(feature.mappedFeature()));
    }
    
    public ObjectWriter without(final StreamWriteFeature feature) {
    ...
    public SequenceWriter writeValues(final JsonGenerator g) throws IOException {
    ...
    public void writeValue(final JsonGenerator g, final Object value) throws IOException {
        this._assertNotNull("g", g);
    ...
    protected final void _writeValueAndClose(final JsonGenerator gen, final Object value) throws IOException {
        if (this._config.isEnabled(SerializationFeature.CLOSE_CLOSEABLE) && value instanceof Closeable) {
    ...
    protected final JsonGenerator _configureGenerator(final JsonGenerator gen) {
