...
public class TypeBindings implements Serializable
{
    ...
    public static TypeBindings create(final Class<?> erasedType, final List<JavaType> typeList) {
        final JavaType[] types = (typeList == null || typeList.isEmpty()) ? TypeBindings.NO_TYPES : typeList.toArray(TypeBindings.NO_TYPES);
    ...
    public static TypeBindings create(final List<String> names, final List<JavaType> types) {
        if (names == null || names.isEmpty() || types == null || types.isEmpty()) {
            return TypeBindings.EMPTY;
        }
        return new TypeBindings(names.toArray(TypeBindings.NO_STRINGS), types.toArray(TypeBindings.NO_TYPES), null);
    }
