...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.FailingSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.UnknownSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.NullSerializer;
import java.text.DateFormat;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.ReadOnlyClassToSerializerMap;
import com.azul.crs.com.fasterxml.jackson.databind.cfg.ContextAttributes;
import com.azul.crs.com.fasterxml.jackson.databind.ser.SerializerCache;
...
public abstract class SerializerProvider extends DatabindContext
{
    ...
    public JsonSerializer<Object> findContentValueSerializer(final JavaType valueType, final BeanProperty property) throws JsonMappingException {
        JsonSerializer<Object> ser = this._knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
            ser = this._serializerCache.untypedValueSerializer(valueType);
            if (ser == null) {
    ...
    public JsonSerializer<Object> findContentValueSerializer(final Class<?> valueType, final BeanProperty property) throws JsonMappingException {
        JsonSerializer<Object> ser = this._knownSerializers.untypedValueSerializer(valueType);
        if (ser == null) {
            ser = this._serializerCache.untypedValueSerializer(valueType);
            if (ser == null) {
    ...
    public JsonSerializer<Object> findKeySerializer(final JavaType keyType, final BeanProperty property) throws JsonMappingException {
        final JsonSerializer<Object> ser = this._serializerFactory.createKeySerializer(this, keyType, this._keySerializer);
