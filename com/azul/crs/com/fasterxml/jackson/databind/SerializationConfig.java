...
import com.azul.crs.com.fasterxml.jackson.core.util.DefaultPrettyPrinter;
...
public final class SerializationConfig extends MapperConfigBase<SerializationFeature, SerializationConfig> implements Serializable
{
    ...
    public SerializationConfig(final BaseSettings base, final SubtypeResolver str, final SimpleMixInResolver mixins, final RootNameLookup rootNames, final ConfigOverrides configOverrides) {
        ...
        this._serFeatures = SerializationConfig.SER_FEATURE_DEFAULTS;
    ...
    protected SerializationConfig(final SerializationConfig src, final SubtypeResolver str, final SimpleMixInResolver mixins, final RootNameLookup rootNames, final ConfigOverrides configOverrides) {
    ...
    private SerializationConfig _withJsonWriteFeatures(final FormatFeature... features) {
        ...
        for (final FormatFeature f : features) {
            ...
            if (f instanceof JsonWriteFeature) {
                final JsonGenerator.Feature oldF = ((JsonWriteFeature)f).mappedFeature();
                if (oldF != null) {
    ...
    private SerializationConfig _withoutJsonWriteFeatures(final FormatFeature... features) {
        int parserSet = this._generatorFeatures;
        int parserMask = this._generatorFeaturesToChange;
        int newSet = this._formatWriteFeatures;
        int newMask = this._formatWriteFeaturesToChange;
