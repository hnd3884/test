...
import com.azul.crs.com.fasterxml.jackson.databind.introspect.AnnotatedClassResolver;
...
public class StdSubtypeResolver extends SubtypeResolver implements Serializable
{
    ...
    protected StdSubtypeResolver(final StdSubtypeResolver src) {
        final LinkedHashSet<NamedType> reg = src._registeredSubtypes;
    ...
    protected void _collectAndResolve(final AnnotatedClass annotatedType, NamedType namedType, final MapperConfig<?> config, final AnnotationIntrospector ai, final HashMap<NamedType, NamedType> collectedSubtypes) {
        ...
        final NamedType typeOnlyNamedType = new NamedType(namedType.getType());
        if (collectedSubtypes.containsKey(typeOnlyNamedType)) {
            if (namedType.hasName()) {
                final NamedType prev = collectedSubtypes.get(typeOnlyNamedType);
                if (!prev.hasName()) {
