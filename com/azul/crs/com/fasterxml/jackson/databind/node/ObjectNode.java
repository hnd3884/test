...
import com.azul.crs.com.fasterxml.jackson.databind.util.RawValue;
...
public class ObjectNode extends ContainerNode<ObjectNode> implements Serializable
{
    ...
    public JsonNode required(final String fieldName) {
        ...
        return this._reportRequiredViolation("No value for property '%s' of `ObjectNode`", fieldName);
    }
    ...
    public <T extends JsonNode> T set(final String fieldName, JsonNode value) {
        if (value == null) {
            value = this.nullNode();
        }
    ...
    public <T extends JsonNode> T setAll(final ObjectNode other) {
    ...
    public <T extends JsonNode> T without(final String fieldName) {
