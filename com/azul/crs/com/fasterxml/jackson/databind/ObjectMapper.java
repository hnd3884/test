...
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.impl.StdTypeResolverBuilder;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.DefaultAccessorNamingStrategy;
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.impl.LaissezFaireSubTypeValidator;
...
import com.azul.crs.com.fasterxml.jackson.databind.introspect.JacksonAnnotationIntrospector;
...
import com.azul.crs.com.fasterxml.jackson.core.io.CharacterEscapes;
import com.azul.crs.com.fasterxml.jackson.core.util.ByteArrayBuilder;
import com.azul.crs.com.fasterxml.jackson.core.io.SegmentedStringWriter;
import java.util.concurrent.atomic.AtomicReference;
import com.azul.crs.com.fasterxml.jackson.databind.util.TokenBuffer;
import com.azul.crs.com.fasterxml.jackson.databind.node.POJONode;
import com.azul.crs.com.fasterxml.jackson.databind.node.TreeTraversingParser;
import com.azul.crs.com.fasterxml.jackson.databind.node.ArrayNode;
import com.azul.crs.com.fasterxml.jackson.databind.node.ObjectNode;
import com.azul.crs.com.fasterxml.jackson.core.JsonGenerationException;
...
import com.azul.crs.com.fasterxml.jackson.core.StreamWriteFeature;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.FilterProvider;
...
import com.azul.crs.com.fasterxml.jackson.databind.cfg.MutableCoercionConfig;
...
import com.azul.crs.com.fasterxml.jackson.annotation.PropertyAccessor;
...
import com.azul.crs.com.fasterxml.jackson.core.JsonEncoding;
...
import com.azul.crs.com.fasterxml.jackson.databind.type.TypeModifier;
import com.azul.crs.com.fasterxml.jackson.databind.ser.BeanSerializerModifier;
import com.azul.crs.com.fasterxml.jackson.databind.ser.Serializers;
import com.azul.crs.com.fasterxml.jackson.databind.deser.BeanDeserializerModifier;
...
import com.azul.crs.com.fasterxml.jackson.databind.cfg.MutableConfigOverride;
...
import com.azul.crs.com.fasterxml.jackson.core.PrettyPrinter;
import com.azul.crs.com.fasterxml.jackson.core.FormatSchema;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.BasicClassIntrospector;
import com.azul.crs.com.fasterxml.jackson.databind.ser.BeanSerializerFactory;
import com.azul.crs.com.fasterxml.jackson.databind.deser.DeserializerFactory;
import com.azul.crs.com.fasterxml.jackson.databind.deser.BeanDeserializerFactory;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.ClassIntrospector;
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.impl.StdSubtypeResolver;
import java.util.Collection;
import java.util.LinkedHashSet;
import com.azul.crs.com.fasterxml.jackson.databind.util.RootNameLookup;
import java.util.concurrent.ConcurrentHashMap;
import java.util.Set;
import com.azul.crs.com.fasterxml.jackson.databind.deser.DefaultDeserializationContext;
import com.azul.crs.com.fasterxml.jackson.databind.ser.SerializerFactory;
import com.azul.crs.com.fasterxml.jackson.databind.ser.DefaultSerializerProvider;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.SimpleMixInResolver;
import com.azul.crs.com.fasterxml.jackson.databind.cfg.CoercionConfigs;
import com.azul.crs.com.fasterxml.jackson.databind.cfg.ConfigOverrides;
import com.azul.crs.com.fasterxml.jackson.databind.jsontype.SubtypeResolver;
...
import com.azul.crs.com.fasterxml.jackson.databind.cfg.BaseSettings;
...
public class ObjectMapper extends ObjectCodec implements Versioned, Serializable
{
    ...
    public Set<Object> getRegisteredModuleIds() {
        return (this._registeredModuleTypes == null) ? Collections.emptySet() : Collections.unmodifiableSet((Set<?>)this._registeredModuleTypes);
    }
    ...
    public JsonGenerator createGenerator(final OutputStream out) throws IOException {
        ...
        final JsonGenerator g = this._jsonFactory.createGenerator(out, JsonEncoding.UTF8);
    ...
    public JsonGenerator createGenerator(final OutputStream out, final JsonEncoding enc) throws IOException {
        this._assertNotNull("out", out);
        final JsonGenerator g = this._jsonFactory.createGenerator(out, enc);
        this._serializationConfig.initialize(g);
        return g;
    }
    ...
    public JsonGenerator createGenerator(final Writer w) throws IOException {
        ...
        final JsonGenerator g = this._jsonFactory.createGenerator(w);
        this._serializationConfig.initialize(g);
        return g;
    }
    ...
    public JsonGenerator createGenerator(final File outputFile, final JsonEncoding enc) throws IOException {
        ...
        final JsonGenerator g = this._jsonFactory.createGenerator(outputFile, enc);
        this._serializationConfig.initialize(g);
        return g;
    }
    ...
    public JsonGenerator createGenerator(final DataOutput out) throws IOException {
        this._assertNotNull("out", out);
        final JsonGenerator g = this._jsonFactory.createGenerator(out);
        this._serializationConfig.initialize(g);
        return g;
    }
    ...
    public ObjectMapper setAccessorNaming(final AccessorNamingStrategy.Provider s) {
        this._serializationConfig = ((MapperConfigBase<CFG, SerializationConfig>)this._serializationConfig).with(s);
        this._deserializationConfig = ((MapperConfigBase<CFG, DeserializationConfig>)this._deserializationConfig).with(s);
        return this;
    }
    ...
    public ObjectMapper setPolymorphicTypeValidator(final PolymorphicTypeValidator ptv) {
        final BaseSettings s = this._deserializationConfig.getBaseSettings().with(ptv);
    ...
    public ObjectMapper setDefaultLeniency(final Boolean b) {
    ...
    public ObjectMapper activateDefaultTyping(final PolymorphicTypeValidator ptv) {
        return this.activateDefaultTyping(ptv, DefaultTyping.OBJECT_AND_NON_CONCRETE);
    }
    
    public ObjectMapper activateDefaultTyping(final PolymorphicTypeValidator ptv, final DefaultTyping applicability) {
        return this.activateDefaultTyping(ptv, applicability, JsonTypeInfo.As.WRAPPER_ARRAY);
    }
    
    public ObjectMapper activateDefaultTyping(final PolymorphicTypeValidator ptv, final DefaultTyping applicability, final JsonTypeInfo.As includeAs) {
    ...
    public ObjectMapper activateDefaultTypingAsProperty(final PolymorphicTypeValidator ptv, final DefaultTyping applicability, final String propertyName) {
        TypeResolverBuilder<?> typer = this._constructDefaultTypeResolverBuilder(applicability, ptv);
        typer = (TypeResolverBuilder<?>)typer.init(JsonTypeInfo.Id.CLASS, null);
    ...
    public MutableCoercionConfig coercionConfigFor(final Class<?> physicalType) {
    ...
    public ObjectMapper setConstructorDetector(final ConstructorDetector cd) {
    ...
    @Override
    public <T> T readValue(final JsonParser p, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("p", p);
    ...
    @Override
    public <T> MappingIterator<T> readValues(final JsonParser p, final TypeReference<T> valueTypeRef) throws IOException, JsonProcessingException {
    ...
    public JsonNode readTree(final String content) throws JsonProcessingException, JsonMappingException {
        this._assertNotNull("content", content);
        try {
    ...
    public JsonNode readTree(final byte[] content, final int offset, final int len) throws IOException {
        this._assertNotNull("content", content);
    ...
    @Override
    public void writeTree(final JsonGenerator g, final TreeNode rootNode) throws IOException, JsonProcessingException {
        this._assertNotNull("g", g);
        final SerializationConfig config = this.getSerializationConfig();
    ...
    public void writeTree(final JsonGenerator g, final JsonNode rootNode) throws IOException, JsonProcessingException {
        this._assertNotNull("g", g);
        final SerializationConfig config = this.getSerializationConfig();
        this._serializerProvider(config).serializeValue(g, rootNode);
        if (config.isEnabled(SerializationFeature.FLUSH_AFTER_WRITE_VALUE)) {
    ...
    @Override
    public <T> T treeToValue(final TreeNode n, final Class<T> valueType) throws IllegalArgumentException, JsonProcessingException {
        if (n == null) {
            return null;
        }
        try {
    ...
    public <T> T readValue(final File src, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
    ...
    public <T> T readValue(final URL src, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src), this._typeFactory.constructType(valueTypeRef));
    }
    ...
    public <T> T readValue(final String content, final Class<T> valueType) throws JsonProcessingException, JsonMappingException {
        this._assertNotNull("content", content);
    ...
    public <T> T readValue(final String content, final JavaType valueType) throws JsonProcessingException, JsonMappingException {
        this._assertNotNull("content", content);
        try {
    ...
    public <T> T readValue(final Reader src, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src), this._typeFactory.constructType(valueTypeRef));
    }
    ...
    public <T> T readValue(final InputStream src, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src), this._typeFactory.constructType(valueTypeRef));
    }
    ...
    public <T> T readValue(final byte[] src, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
        return (T)this._readMapAndClose(this._jsonFactory.createParser(src), this._typeFactory.constructType(valueTypeRef));
    }
    
    public <T> T readValue(final byte[] src, final int offset, final int len, final TypeReference<T> valueTypeRef) throws IOException, JsonParseException, JsonMappingException {
        this._assertNotNull("src", src);
    ...
    public ObjectReader readerForArrayOf(final Class<?> type) {
    ...
    public ObjectReader readerForListOf(final Class<?> type) {
    ...
    public ObjectReader readerForMapOf(final Class<?> type) {
    ...
    public <T> T convertValue(final Object fromValue, final TypeReference<T> toValueTypeRef) throws IllegalArgumentException {
    ...
    protected TypeResolverBuilder<?> _constructDefaultTypeResolverBuilder(final DefaultTyping applicability, final PolymorphicTypeValidator ptv) {
    ...
    protected final void _writeValueAndClose(final JsonGenerator g, final Object value) throws IOException {
    ...
    private final void _writeCloseable(final JsonGenerator g, final Object value, final SerializationConfig cfg) throws IOException {
    ...
    protected Object _readValue(final DeserializationConfig cfg, final JsonParser p, final JavaType valueType) throws IOException {
        ...
        final DefaultDeserializationContext ctxt = this.createDeserializationContext(p, cfg);
        Object result;
        if (t == JsonToken.VALUE_NULL) {
    ...
    protected JsonNode _readTreeAndClose(final JsonParser p0) throws IOException {
        try (final JsonParser p = p0) {
            final JavaType valueType = this.constructType(JsonNode.class);
            final DeserializationConfig cfg = this.getDeserializationConfig();
            cfg.initialize(p);
            JsonToken t = p.currentToken();
            if (t == null) {
    ...
    static {
        ...
        DEFAULT_BASE = new BaseSettings(null, ObjectMapper.DEFAULT_ANNOTATION_INTROSPECTOR, null, TypeFactory.defaultInstance(), null, StdDateFormat.instance, null, Locale.getDefault(), null, Base64Variants.getDefaultVariant(), LaissezFaireSubTypeValidator.instance, new DefaultAccessorNamingStrategy.Provider());
    }
    ...
    public static class DefaultTypeResolverBuilder extends StdTypeResolverBuilder implements Serializable
    {
        ...
        public DefaultTypeResolverBuilder(final DefaultTyping t, final PolymorphicTypeValidator ptv) {
        ...
        private static <T> T _requireNonNull(final T value, final String msg) {
            if (value == null) {
        ...
        public static DefaultTypeResolverBuilder construct(final DefaultTyping t, final PolymorphicTypeValidator ptv) {
