...
public class UntypedObjectDeserializer extends StdDeserializer<Object> implements ResolvableDeserializer, ContextualDeserializer
{
    ...
    protected Object mapObject(final JsonParser p, final DeserializationContext ctxt) throws IOException {
        ...
        if (key3 == null) {
            ...
            if (result2.put(key2, value2) != null) {
                return this._mapObjectWithDups(p, ctxt, result2, key1, value1, value2, key3);
            }
            return result2;
        }
        else {
            ...
            do {
                p.nextToken();
                final Object newValue = this.deserialize(p, ctxt);
                final Object oldValue = result2.put(key3, newValue);
                if (oldValue != null) {
                    return this._mapObjectWithDups(p, ctxt, result2, key3, oldValue, newValue, p.nextFieldName());
                }
    ...
    protected Object _mapObjectWithDups(final JsonParser p, final DeserializationContext ctxt, final Map<String, Object> result, final String key, Object oldValue, Object newValue, String nextKey) throws IOException {
    ...
    private void _squashDups(final Map<String, Object> result, final String key, final Object oldValue, final Object newValue) {
