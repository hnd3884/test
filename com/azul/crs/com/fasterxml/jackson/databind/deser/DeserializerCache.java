...
public final class DeserializerCache implements Serializable
{
    ...
    public DeserializerCache(final int maxSize) {
        this._incompleteDeserializers = new HashMap<JavaType, JsonDeserializer<Object>>(8);
        final int initial = Math.min(64, maxSize >> 2);
        this._cachedDeserializers = new LRUMap<JavaType, JsonDeserializer<Object>>(initial, maxSize);
    }
