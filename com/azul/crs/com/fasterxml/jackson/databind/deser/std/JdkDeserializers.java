...
public class JdkDeserializers
{
    ...
    static {
        ...
        final Class[] array;
        final Class<?>[] types = array = new Class[] { UUID.class, AtomicBoolean.class, AtomicInteger.class, AtomicLong.class, StackTraceElement.class, ByteBuffer.class, Void.class };
