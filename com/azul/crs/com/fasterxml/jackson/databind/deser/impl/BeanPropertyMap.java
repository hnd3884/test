...
public class BeanPropertyMap implements Iterable<SettableBeanProperty>, Serializable
{
    ...
    public BeanPropertyMap(final boolean caseInsensitive, final Collection<SettableBeanProperty> props, final Map<String, List<PropertyName>> aliasDefs, final Locale locale) {
    ...
    public static BeanPropertyMap construct(final MapperConfig<?> config, final Collection<SettableBeanProperty> props, final Map<String, List<PropertyName>> aliasMapping, final boolean caseInsensitive) {
        return new BeanPropertyMap(caseInsensitive, props, aliasMapping, config.getLocale());
    }
    
    @Deprecated
    public static BeanPropertyMap construct(final MapperConfig<?> config, final Collection<SettableBeanProperty> props, final Map<String, List<PropertyName>> aliasMapping) {
    ...
    public BeanPropertyMap withoutProperties(final Collection<String> toExclude, final Collection<String> toInclude) {
    ...
    private Map<String, String> _buildAliasMapping(final Map<String, List<PropertyName>> defs, final boolean caseInsensitive, final Locale loc) {
