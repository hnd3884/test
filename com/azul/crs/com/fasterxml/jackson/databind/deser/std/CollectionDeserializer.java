...
public class CollectionDeserializer extends ContainerDeserializerBase<Collection<Object>> implements ContextualDeserializer
{
    ...
    protected Collection<Object> _deserializeFromString(final JsonParser p, final DeserializationContext ctxt, final String value) throws IOException {
        ...
        if (value.isEmpty()) {
            ...
            act = this._checkCoercionFail(ctxt, act, rawTargetType, value, "empty String (\"\")");
            if (act != null) {
    ...
    protected Collection<Object> _deserializeFromArray(final JsonParser p, final DeserializationContext ctxt, final Collection<Object> result) throws IOException {
