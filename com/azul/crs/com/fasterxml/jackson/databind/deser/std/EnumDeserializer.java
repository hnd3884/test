...
import com.azul.crs.com.fasterxml.jackson.databind.util.CompactStringObjectMap;
...
public class EnumDeserializer extends StdScalarDeserializer<Object> implements ContextualDeserializer
{
    ...
    protected Object _fromString(final JsonParser p, final DeserializationContext ctxt, final String text) throws IOException {
    ...
    protected Object _fromInteger(final JsonParser p, final DeserializationContext ctxt, final int index) throws IOException {
        final CoercionAction act = ctxt.findCoercionAction(this.logicalType(), this.handledType(), CoercionInputShape.Integer);
    ...
    private final Object _deserializeAltString(final JsonParser p, final DeserializationContext ctxt, final CompactStringObjectMap lookup, final String nameOrig) throws IOException {
        final String name = nameOrig.trim();
        if (name.isEmpty()) {
            CoercionAction act;
            if (nameOrig.isEmpty()) {
