...
public abstract class JavaUtilCollectionsDeserializers
{
    ...
    public static JsonDeserializer<?> findForCollection(final DeserializationContext ctxt, final JavaType type) throws JsonMappingException {
        ...
        else if (type.hasRawClass(JavaUtilCollectionsDeserializers.CLASS_UNMODIFIABLE_LIST) || type.hasRawClass(JavaUtilCollectionsDeserializers.CLASS_UNMODIFIABLE_LIST_ALIAS)) {
    ...
    static {
        ...
        CLASS_UNMODIFIABLE_LIST_ALIAS = Collections.unmodifiableList((List<?>)new LinkedList<Object>()).getClass();
    ...
    private static class JavaUtilCollectionsConverter implements Converter<Object, Object>
    {
        ...
        JavaUtilCollectionsConverter(final int kind, final JavaType inputType) {
