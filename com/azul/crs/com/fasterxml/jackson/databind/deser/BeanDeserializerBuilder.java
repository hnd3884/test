...
public class BeanDeserializerBuilder
{
    ...
    public void addIncludable(final String propName) {
        if (this._includableProps == null) {
            this._includableProps = new HashSet<String>();
        }
    ...
    protected JsonDeserializer<?> createBuilderBasedDeserializer(final JavaType valueType, final BeanPropertyMap propertyMap, final boolean anyViews) {
    ...
    protected boolean _findCaseInsensitivity() {
        final JsonFormat.Value format = this._beanDesc.findExpectedFormat(null);
