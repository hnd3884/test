...
import com.azul.crs.com.fasterxml.jackson.databind.exc.InvalidNullException;
...
public class NullsFailProvider implements NullValueProvider, Serializable
{
    ...
    public static NullsFailProvider constructForProperty(final BeanProperty prop, final JavaType type) {
