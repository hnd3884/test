...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.BeanAsArraySerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.UnwrappingBeanSerializer;
...
public class BeanSerializer extends BeanSerializerBase
{
    ...
    protected BeanSerializer(final BeanSerializerBase src, final Set<String> toIgnore, final Set<String> toInclude) {
        super(src, toIgnore, toInclude);
    }
    
    protected BeanSerializer(final BeanSerializerBase src, final BeanPropertyWriter[] properties, final BeanPropertyWriter[] filteredProperties) {
    ...
    public static BeanSerializer createDummy(final JavaType forType, final BeanSerializerBuilder builder) {
        return new BeanSerializer(forType, builder, BeanSerializer.NO_PROPS, null);
    }
