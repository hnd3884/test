...
public abstract class AsArraySerializerBase<T> extends ContainerSerializer<T> implements ContextualSerializer
{
    ...
    protected AsArraySerializerBase(final Class<?> cls, final JavaType elementType, final boolean staticTyping, final TypeSerializer vts, final BeanProperty property, final JsonSerializer<?> elementSerializer, final Boolean unwrapSingle) {
        super(cls, false);
