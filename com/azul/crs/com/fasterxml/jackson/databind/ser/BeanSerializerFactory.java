...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.UnsupportedTypeSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.FilteredBeanPropertyWriter;
...
public class BeanSerializerFactory extends BasicSerializerFactory implements Serializable
{
    ...
    public JsonSerializer<Object> findBeanOrAddOnSerializer(final SerializerProvider prov, final JavaType type, final BeanDescription beanDesc, final boolean staticTyping) throws JsonMappingException {
    ...
    protected JsonSerializer<Object> constructBeanOrAddOnSerializer(final SerializerProvider prov, final JavaType type, final BeanDescription beanDesc, final boolean staticTyping) throws JsonMappingException {
        ...
        if (anyGetter != null) {
            final JavaType anyType = anyGetter.getType();
            final JavaType valueType = anyType.getContentType();
    ...
    protected List<BeanPropertyWriter> filterBeanProperties(final SerializationConfig config, final BeanDescription beanDesc, final List<BeanPropertyWriter> props) {
        ...
        final JsonIncludeProperties.Value inclusions = config.getDefaultPropertyInclusions(beanDesc.getBeanClass(), beanDesc.getClassInfo());
    ...
    protected JsonSerializer<?> _findUnsupportedTypeSerializer(final SerializerProvider ctxt, final JavaType type, final BeanDescription beanDesc) throws JsonMappingException {
