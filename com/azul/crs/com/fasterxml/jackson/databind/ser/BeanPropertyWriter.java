...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.UnwrappingBeanPropertyWriter;
...
public class BeanPropertyWriter extends PropertyWriter implements Serializable
{
    ...
    protected boolean _handleSelfReference(final Object bean, final JsonGenerator gen, final SerializerProvider prov, final JsonSerializer<?> ser) throws IOException {
        if (!ser.usesObjectId()) {
