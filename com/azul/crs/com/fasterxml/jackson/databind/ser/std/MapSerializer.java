...
import com.azul.crs.com.fasterxml.jackson.databind.jsonFormatVisitors.JsonMapFormatVisitor;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.PropertyWriter;
import com.azul.crs.com.fasterxml.jackson.databind.ser.PropertyFilter;
...
public class MapSerializer extends ContainerSerializer<Map<?, ?>> implements ContextualSerializer
{
    ...
    protected MapSerializer(final Set<String> ignoredEntries, final Set<String> includedEntries, final JavaType keyType, final JavaType valueType, final boolean valueTypeIsStatic, final TypeSerializer vts, final JsonSerializer<?> keySerializer, final JsonSerializer<?> valueSerializer) {
    ...
    protected MapSerializer(final MapSerializer src, final BeanProperty property, final JsonSerializer<?> keySerializer, final JsonSerializer<?> valueSerializer, final Set<String> ignoredEntries, final Set<String> includedEntries) {
        super(Map.class, false);
        this._ignoredEntries = ((ignoredEntries == null || ignoredEntries.isEmpty()) ? null : ignoredEntries);
        this._includedEntries = includedEntries;
    ...
    public MapSerializer withResolved(final BeanProperty property, final JsonSerializer<?> keySerializer, final JsonSerializer<?> valueSerializer, final Set<String> ignored, final Set<String> included, final boolean sortKeys) {
    ...
    public static MapSerializer construct(final Set<String> ignoredEntries, final Set<String> includedEntries, final JavaType mapType, boolean staticValueType, final TypeSerializer vts, final JsonSerializer<Object> keySerializer, final JsonSerializer<Object> valueSerializer, final Object filterId) {
        JavaType keyType;
        JavaType valueType;
        if (mapType == null) {
    ...
    public static MapSerializer construct(final Set<String> ignoredEntries, final JavaType mapType, final boolean staticValueType, final TypeSerializer vts, final JsonSerializer<Object> keySerializer, final JsonSerializer<Object> valueSerializer, final Object filterId) {
    ...
    public JsonSerializer<?> createContextual(final SerializerProvider provider, final BeanProperty property) throws JsonMappingException {
        ...
        if (StdSerializer._neitherNull(propertyAcc, intr)) {
            ...
            final Set<String> newIgnored = intr.findPropertyIgnoralByName(config, propertyAcc).findIgnoredForSerialization();
            ...
            final Set<String> newIncluded = intr.findPropertyInclusionByName(config, propertyAcc).getIncluded();
            if (newIncluded != null) {
                included = ((included == null) ? new HashSet<String>() : new HashSet<String>(included));
                for (final String str2 : newIncluded) {
                    included.add(str2);
                }
            }
        ...
        if (propertyAcc != null) {
            final Object filterId = intr.findFilterId(propertyAcc);
            if (filterId != null) {
                mser = mser.withFilterId(filterId);
            }
        }
        final JsonInclude.Value inclV = this.findIncludeOverrides(provider, property, Map.class);
        if (inclV != null) {
    ...
    @Override
    public void serialize(final Map<?, ?> value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
    ...
    @Override
    public void serializeWithType(final Map<?, ?> value, final JsonGenerator gen, final SerializerProvider provider, final TypeSerializer typeSer) throws IOException {
    ...
    public void serializeWithoutTypeInfo(Map<?, ?> value, final JsonGenerator gen, final SerializerProvider provider) throws IOException {
        if (!value.isEmpty()) {
