...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.TokenBufferSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.util.TokenBuffer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.StdJdkSerializers;
import java.math.BigDecimal;
import java.math.BigInteger;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.BooleanSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.NumberSerializers;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.StringSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonSerialize;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.EnumSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.BasicBeanDescription;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.IterableSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.IteratorSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.AtomicReferenceSerializer;
import java.util.concurrent.atomic.AtomicReference;
import com.azul.crs.com.fasterxml.jackson.databind.type.ReferenceType;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.ObjectArraySerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.StdArraySerializers;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.StringArraySerializer;
import com.azul.crs.com.fasterxml.jackson.databind.BeanProperty;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.MapEntrySerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.MapSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.EnumSetSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.CollectionSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.IndexedListSerializer;
import java.util.RandomAccess;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.StringCollectionSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.IndexedStringListSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.StdDelegatingSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.NumberSerializer;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonFormat;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.ToStringSerializer;
import java.nio.charset.Charset;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.TimeZoneSerializer;
import java.util.TimeZone;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.InetSocketAddressSerializer;
import java.net.InetSocketAddress;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.InetAddressSerializer;
import java.net.InetAddress;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.ByteBufferSerializer;
import java.nio.ByteBuffer;
import java.util.Map;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.DateSerializer;
import java.util.Date;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.CalendarSerializer;
import java.util.Calendar;
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.SerializableSerializer;
import com.azul.crs.com.fasterxml.jackson.databind.JsonSerializable;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.JsonValueSerializer;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.StdKeySerializers;
...
import com.azul.crs.com.fasterxml.jackson.databind.cfg.SerializerFactoryConfig;
...
public abstract class BasicSerializerFactory extends SerializerFactory implements Serializable
{
    ...
    @Override
    public JsonSerializer<Object> createKeySerializer(final SerializerProvider ctxt, final JavaType keyType, final JsonSerializer<Object> defaultImpl) throws JsonMappingException {
        final SerializationConfig config = ctxt.getConfig();
        final BeanDescription beanDesc = config.introspect(keyType);
            ...
            if (ser == null) {
                ...
                if (ser == null) {
                    ...
                    if (ser == null) {
                        ...
                        if (acc != null) {
                            final JsonSerializer<?> delegate = this.createKeySerializer(ctxt, acc.getType(), defaultImpl);
    ...
    protected JsonSerializer<?> buildMapSerializer(final SerializerProvider prov, final MapType type, final BeanDescription beanDesc, final boolean staticTyping, final JsonSerializer<Object> keySerializer, final TypeSerializer elementTypeSerializer, final JsonSerializer<Object> elementValueSerializer) throws JsonMappingException {
        ...
        if (ser == null) {
            ...
            if (ser == null) {
                ...
                final MapSerializer mapSer = MapSerializer.construct(ignored, included, type, staticTyping, elementTypeSerializer, keySerializer, elementValueSerializer, filterId);
