...
import com.azul.crs.com.fasterxml.jackson.databind.jsonFormatVisitors.JsonObjectFormatVisitor;
...
import com.azul.crs.com.fasterxml.jackson.databind.jsonschema.JsonSerializableSchema;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.WritableObjectId;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.PropertyBasedObjectIdGenerator;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.BeanSerializerBuilder;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonFormat;
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.ObjectIdWriter;
import com.azul.crs.com.fasterxml.jackson.databind.introspect.AnnotatedMember;
import com.azul.crs.com.fasterxml.jackson.databind.ser.AnyGetterWriter;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.ResolvableSerializer;
...
public abstract class BeanSerializerBase extends StdSerializer<Object> implements ContextualSerializer, ResolvableSerializer, JsonFormatVisitable, SchemaAware
{
    ...
    protected BeanSerializerBase(final BeanSerializerBase src, final BeanPropertyWriter[] properties, final BeanPropertyWriter[] filteredProperties) {
    ...
    protected BeanSerializerBase(final BeanSerializerBase src, final Set<String> toIgnore, final Set<String> toInclude) {
        super(src._handledType);
        this._beanType = src._beanType;
    ...
    protected abstract BeanSerializerBase withByNameInclusion(final Set<String> p0, final Set<String> p1);
    ...
    protected abstract BeanSerializerBase withProperties(final BeanPropertyWriter[] p0, final BeanPropertyWriter[] p1);
                ...
                if (ser == null) {
                    ...
                    if (type.isContainerType()) {
                        ...
                        if (typeSer != null && ser instanceof ContainerSerializer) {
                            final JsonSerializer<Object> ser2 = ser = ((ContainerSerializer)ser).withValueTypeSerializer(typeSer);
                        }
                    }
                }
                if (i < filteredCount) {
    ...
    public JsonSerializer<?> createContextual(final SerializerProvider provider, final BeanProperty property) throws JsonMappingException {
        ...
        final JsonFormat.Value format = this.findFormatOverrides(provider, property, this._handledType);
        ...
        if (accessor != null) {
            ...
            if (objectIdInfo == null) {
                ...
                if (implClass == ObjectIdGenerators.PropertyGenerator.class) {
                    ...
                    final ObjectIdGenerator<?> gen2 = provider.objectIdGeneratorInstance(accessor, objectIdInfo);
                    oiw = ObjectIdWriter.construct(idType, objectIdInfo.getPropertyName(), gen2, objectIdInfo.getAlwaysAsId());
                }
            }
        ...
        if (idPropOrigIndex > 0) {
            final BeanPropertyWriter[] newProps = Arrays.copyOf(this._props, this._props.length);
