...
import com.azul.crs.com.fasterxml.jackson.core.StreamWriteCapability;
...
import com.azul.crs.com.fasterxml.jackson.core.json.DupDetector;
import com.azul.crs.com.fasterxml.jackson.core.json.JsonWriteContext;
...
public class TokenBuffer extends JsonGenerator
{
    ...
    public JacksonFeatureSet<StreamWriteCapability> getWriteCapabilities() {
        return TokenBuffer.DEFAULT_WRITE_CAPABILITIES;
    }
    ...
    protected void _copyBufferContents(final JsonParser p) throws IOException {
        int depth = 1;
        JsonToken t;
    ...
    private void _copyBufferValue(final JsonParser p, final JsonToken t) throws IOException {
        if (this._mayHaveNativeIds) {
            this._checkNativeIds(p);
        }
        Label_0269: {
    ...
    private final void _checkNativeIds(final JsonParser p) throws IOException {
    ...
    protected final void _appendFieldName(final Object value) {
        Segment next;
        if (this._hasNativeId) {
    ...
    protected final void _appendStartMarker(final JsonToken type) {
        Segment next;
        if (this._hasNativeId) {
            next = this._last.append(this._appendAt, type, this._objectId, this._typeId);
        }
    ...
    protected final void _appendEndMarker(final JsonToken type) {
        final Segment next = this._last.append(this._appendAt, type);
        if (next == null) {
            ++this._appendAt;
        }
        else {
    ...
    protected static final class Parser extends ParserMinimalBase
    {
        ...
        public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
            return Parser.DEFAULT_READ_CAPABILITIES;
        }
