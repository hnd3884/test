...
public final class ClassUtil
{
    ...
    public static String getTypeDescription(final JavaType fullType) {
        if (fullType == null) {
            return "[null]";
        }
    ...
    public static String classNameOf(final Object inst) {
        ...
        final Class<?> raw = (inst instanceof Class) ? ((Class)inst) : inst.getClass();
        return nameOf(raw);
    }
    ...
    public static String name(final PropertyName name) {
        if (name == null) {
            return "[null]";
        }
    ...
    public static String apostrophed(final String text) {
        if (text == null) {
            return "[null]";
        }
        return new StringBuilder(text.length() + 2).append('\'').append(text).append('\'').toString();
    ...
    public static boolean isEnumType(final Class<?> rawType) {
    ...
    public static Class<? extends Enum<?>> findEnumType(final Enum<?> en) {
        return (Class<? extends Enum<?>>)en.getDeclaringClass();
    }
    ...
    public static <T extends Annotation> Enum<?> findFirstAnnotatedEnumValue(final Class<Enum<?>> enumClass, final Class<T> annotationClass) {
        ...
        final Field[] fields = declaredFields = enumClass.getDeclaredFields();
    ...
    public static boolean isJDKClass(final Class<?> rawType) {
