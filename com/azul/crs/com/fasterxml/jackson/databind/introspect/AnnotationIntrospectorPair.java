...
public class AnnotationIntrospectorPair extends AnnotationIntrospector implements Serializable
{
    ...
    public JsonIgnoreProperties.Value findPropertyIgnoralByName(final MapperConfig<?> config, final Annotated ann) {
        final JsonIgnoreProperties.Value v2 = this._secondary.findPropertyIgnoralByName(config, ann);
        final JsonIgnoreProperties.Value v3 = this._primary.findPropertyIgnoralByName(config, ann);
    ...
    public JsonIncludeProperties.Value findPropertyInclusionByName(final MapperConfig<?> config, final Annotated a) {
        final JsonIncludeProperties.Value v2 = this._secondary.findPropertyInclusionByName(config, a);
        final JsonIncludeProperties.Value v3 = this._primary.findPropertyInclusionByName(config, a);
        return (v2 == null) ? v3 : v2.withOverrides(v3);
    }
