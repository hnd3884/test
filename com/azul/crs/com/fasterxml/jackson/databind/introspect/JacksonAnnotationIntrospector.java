...
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonTypeIdResolver;
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonTypeResolver;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonMerge;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonAnySetter;
...
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonValueInstantiator;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonAnyGetter;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonValue;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonKey;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonGetter;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.impl.AttributePropertyWriter;
...
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonAppend;
import com.azul.crs.com.fasterxml.jackson.databind.ser.BeanPropertyWriter;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonPropertyOrder;
...
import com.azul.crs.com.fasterxml.jackson.databind.ser.std.RawSerializer;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonRawValue;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonIdentityReference;
import com.azul.crs.com.fasterxml.jackson.annotation.ObjectIdGenerators;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonIdentityInfo;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonTypeId;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonTypeName;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonSubTypes;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonView;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonBackReference;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonManagedReference;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonFormat;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonPropertyDescription;
import java.util.ArrayList;
import java.util.Collections;
import java.util.List;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonAutoDetect;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonClassDescription;
import com.azul.crs.com.fasterxml.jackson.databind.annotation.JsonNaming;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonFilter;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonIgnoreType;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonRootName;
...
import com.azul.crs.com.fasterxml.jackson.annotation.JsonEnumDefaultValue;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonAlias;
import java.util.HashMap;
import java.lang.reflect.Field;
import com.azul.crs.com.fasterxml.jackson.annotation.JsonProperty;
import com.azul.crs.com.fasterxml.jackson.annotation.JacksonAnnotationsInside;
...
import com.azul.crs.com.fasterxml.jackson.databind.util.LRUMap;
import com.azul.crs.com.fasterxml.jackson.databind.ext.Java7Support;
...
public class JacksonAnnotationIntrospector extends AnnotationIntrospector implements Serializable
{
    ...
    public String findEnumValue(final Enum<?> value) {
        try {
            final Field f = value.getDeclaringClass().getField(value.name());
            if (f != null) {
    ...
    public String[] findEnumValues(final Class<?> enumType, final Enum<?>[] enumValues, final String[] names) {
        ...
        for (final Field f : enumType.getDeclaredFields()) {
            if (f.isEnumConstant()) {
                final JsonProperty prop = f.getAnnotation(JsonProperty.class);
                if (prop != null) {
                    final String n = prop.value();
    ...
    @Override
    public void findEnumAliases(final Class<?> enumType, final Enum<?>[] enumValues, final String[][] aliasList) {
        for (final Field f : enumType.getDeclaredFields()) {
            if (f.isEnumConstant()) {
                final JsonAlias aliasAnnotation = f.getAnnotation(JsonAlias.class);
    ...
    @Override
    public JsonIncludeProperties.Value findPropertyInclusionByName(final MapperConfig<?> config, final Annotated a) {
        final JsonIncludeProperties v = this._findAnnotation(a, JsonIncludeProperties.class);
        if (v == null) {
    ...
    public List<NamedType> findSubtypes(final Annotated a) {
        ...
        for (final JsonSubTypes.Type type : types) {
            ...
            for (final String name : type.names()) {
    ...
    public Boolean hasAsKey(final MapperConfig<?> config, final Annotated a) {
        final JsonKey ann = this._findAnnotation(a, JsonKey.class);
        if (ann == null) {
            return null;
        }
        return ann.value();
