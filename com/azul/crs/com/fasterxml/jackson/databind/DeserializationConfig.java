...
public final class DeserializationConfig extends MapperConfigBase<DeserializationFeature, DeserializationConfig> implements Serializable
{
    ...
    public DeserializationConfig(final BaseSettings base, final SubtypeResolver str, final SimpleMixInResolver mixins, final RootNameLookup rootNames, final ConfigOverrides configOverrides, final CoercionConfigs coercionConfigs) {
        super(base, str, mixins, rootNames, configOverrides);
        this._deserFeatures = DeserializationConfig.DESER_FEATURE_DEFAULTS;
    ...
    protected DeserializationConfig(final DeserializationConfig src, final SubtypeResolver str, final SimpleMixInResolver mixins, final RootNameLookup rootNames, final ConfigOverrides configOverrides, final CoercionConfigs coercionConfigs) {
    ...
    private DeserializationConfig(final DeserializationConfig src, final ConstructorDetector ctorDetector) {
        super(src);
        this._deserFeatures = src._deserFeatures;
        this._problemHandlers = src._problemHandlers;
        this._nodeFactory = src._nodeFactory;
    ...
    private DeserializationConfig _withJsonReadFeatures(final FormatFeature... features) {
        ...
        for (final FormatFeature f : features) {
            ...
            if (f instanceof JsonReadFeature) {
                final JsonParser.Feature oldF = ((JsonReadFeature)f).mappedFeature();
                if (oldF != null) {
    ...
    private DeserializationConfig _withoutJsonReadFeatures(final FormatFeature... features) {
        int parserSet = this._parserFeatures;
        int parserMask = this._parserFeaturesToChange;
        int newSet = this._formatReadFeatures;
        int newMask = this._formatReadFeaturesToChange;
    ...
    public DeserializationConfig with(final ConstructorDetector ctorDetector) {
    ...
    public JsonParser initialize(final JsonParser p) {
    ...
    public JsonParser initialize(final JsonParser p, final FormatSchema schema) {
        if (this._parserFeaturesToChange != 0) {
            p.overrideStdFeatures(this._parserFeatures, this._parserFeaturesToChange);
        }
        if (this._formatReadFeaturesToChange != 0) {
    ...
    public BeanDescription introspect(final JavaType type) {
        return this.getClassIntrospector().forDeserialization(this, type, this);
    }
    
    public BeanDescription introspectForCreation(final JavaType type) {
        return this.getClassIntrospector().forCreation(this, type, this);
    }
    
    public BeanDescription introspectForBuilder(final JavaType builderType, final BeanDescription valueTypeDesc) {
        return this.getClassIntrospector().forDeserializationWithBuilder(this, builderType, this, valueTypeDesc);
    }
    
    @Deprecated
    public BeanDescription introspectForBuilder(final JavaType type) {
    ...
    static {
        DESER_FEATURE_DEFAULTS = MapperConfig.collectFeatureDefaults(DeserializationFeature.class);
    }
}
