...
import com.azul.crs.com.fasterxml.jackson.core.io.JsonEOFException;
...
public abstract class ParserMinimalBase extends JsonParser
{
    ...
    protected void reportOverflowInt(final String numDesc) throws IOException {
        this.reportOverflowInt(numDesc, this.currentToken());
    }
    
    protected void reportOverflowInt(final String numDesc, final JsonToken inputType) throws IOException {
    ...
    protected void reportOverflowLong(final String numDesc) throws IOException {
        this.reportOverflowLong(numDesc, this.currentToken());
    }
    
    protected void reportOverflowLong(final String numDesc, final JsonToken inputType) throws IOException {
    ...
    protected void _reportInputCoercion(final String msg, final JsonToken inputType, final Class<?> targetType) throws InputCoercionException {
