package com.azul.crs.com.fasterxml.jackson.core.base;
...
import com.azul.crs.com.fasterxml.jackson.core.json.JsonReadContext;
...
public abstract class ParserBase extends ParserMinimalBase
{
    ...
    protected void _reportTooLongIntegral(final int expType, final String rawNum) throws IOException {
        if (expType == 1) {
    ...
    protected void _throwUnquotedSpace(final int i, final String ctxtDesc) throws JsonParseException {
        if (!this.isEnabled(Feature.ALLOW_UNQUOTED_CONTROL_CHARS) || i > 32) {
            final char c = (char)i;
            final String msg = "Illegal unquoted character (" + ParserMinimalBase._getCharDesc(c) + "): has to be escaped using backslash to be included in " + ctxtDesc;
    ...
    static {
        JSON_READ_CAPABILITIES = ParserBase.DEFAULT_READ_CAPABILITIES;
    }
}
