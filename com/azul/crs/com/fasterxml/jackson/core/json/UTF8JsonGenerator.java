...
public class UTF8JsonGenerator extends JsonGeneratorImpl
{
    ...
    public UTF8JsonGenerator(final IOContext ctxt, final int features, final ObjectCodec codec, final OutputStream out, final char quoteChar, final byte[] outputBuffer, final int outputOffset, final boolean bufferRecyclable) {
        super(ctxt, features, codec);
        this._outputStream = out;
        this._quoteChar = (byte)quoteChar;
        if (quoteChar != '\"') {
    ...
    @Override
    public final void writeStartArray(final Object currentValue) throws IOException {
        this._verifyValueWrite("start an array");
    ...
    public void writeRaw(final SerializableString text) throws IOException {
        final int len = text.appendUnquotedUTF8(this._outputBuffer, this._outputTail);
        if (len < 0) {
