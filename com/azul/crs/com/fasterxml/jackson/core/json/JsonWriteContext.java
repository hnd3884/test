...
public class JsonWriteContext extends JsonStreamContext
{
    ...
    protected JsonWriteContext(final int type, final JsonWriteContext parent, final DupDetector dups, final Object currValue) {
        this._type = type;
        this._parent = parent;
        this._dups = dups;
        this._index = -1;
    ...
    public JsonWriteContext reset(final int type) {
        this._type = type;
        this._index = -1;
    ...
    public JsonWriteContext reset(final int type, final Object currValue) {
        this._type = type;
        this._index = -1;
        this._currentName = null;
        this._gotName = false;
    ...
    public JsonWriteContext createChildArrayContext(final Object currValue) {
        JsonWriteContext ctxt = this._child;
        if (ctxt == null) {
            ctxt = (this._child = new JsonWriteContext(1, this, (this._dups == null) ? null : this._dups.child(), currValue));
            return ctxt;
        }
    ...
    public JsonWriteContext createChildObjectContext(final Object currValue) {
        JsonWriteContext ctxt = this._child;
        if (ctxt == null) {
            ctxt = (this._child = new JsonWriteContext(2, this, (this._dups == null) ? null : this._dups.child(), currValue));
            return ctxt;
        }
