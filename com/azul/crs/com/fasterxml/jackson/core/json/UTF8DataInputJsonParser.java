...
public class UTF8DataInputJsonParser extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return UTF8DataInputJsonParser.JSON_READ_CAPABILITIES;
    }
    ...
    public JsonToken nextToken() throws IOException {
        ...
        if (this._parsingContext.expectComma()) {
            ...
            i = this._skipWS();
            if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_TRAILING_COMMA) != 0x0 && (i == 93 || i == 125)) {
                this._closeScope(i);
                return this._currToken;
            }
        }
    ...
    private final int _handleLeadingZeroes() throws IOException {
        ...
        if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_LEADING_ZEROS) == 0x0) {
    ...
    protected String _handleOddName(int ch) throws IOException {
        if (ch == 39 && (this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
            return this._parseAposName();
        }
        if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_UNQUOTED_NAMES) == 0x0) {
    ...
    protected JsonToken _handleUnexpectedValue(final int c) throws IOException {
        switch (c) {
            ...
            case 44: {
                if (!this._parsingContext.inRoot() && (this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_MISSING) != 0x0) {
                    this._nextByte = c;
            ...
            case 39: {
                if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
            ...
            case 78: {
                ...
                if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_NON_NUM_NUMBERS) != 0x0) {
    ...
    private final void _skipComment() throws IOException {
        if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_JAVA_COMMENTS) == 0x0) {
    ...
    private final boolean _skipYAMLComment() throws IOException {
        if ((this._features & UTF8DataInputJsonParser.FEAT_MASK_ALLOW_YAML_COMMENTS) == 0x0) {
            return false;
        }
        this._skipLine();
        return true;
