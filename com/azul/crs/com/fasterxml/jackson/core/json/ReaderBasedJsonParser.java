...
import com.azul.crs.com.fasterxml.jackson.core.util.TextBuffer;
...
public class ReaderBasedJsonParser extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return ReaderBasedJsonParser.JSON_READ_CAPABILITIES;
    }
    ...
    private final JsonToken _nextTokenNotInObject(final int i) throws IOException {
        ...
        switch (i) {
            ...
            case 46: {
                return this._currToken = this._parseFloatThatStartsWithPeriod();
            }
            case 48:
            case 49:
            case 50:
            ...
            case 44: {
                if (!this._parsingContext.inRoot() && (this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_MISSING) != 0x0) {
                    --this._inputPtr;
                    return this._currToken = JsonToken.VALUE_NULL;
                }
                break;
    ...
    private char _verifyNLZ2() throws IOException {
        ...
        if ((this._features & ReaderBasedJsonParser.FEAT_MASK_LEADING_ZEROS) == 0x0) {
    ...
    protected JsonToken _handleInvalidNumberStart(int ch, final boolean negative) throws IOException {
        if (ch == 73) {
            ...
            if (ch == 78) {
                ...
                if ((this._features & ReaderBasedJsonParser.FEAT_MASK_NON_NUM_NUMBERS) != 0x0) {
    ...
    protected String _handleOddName(final int i) throws IOException {
        if (i == 39 && (this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
            return this._parseAposName();
        }
        if ((this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_UNQUOTED_NAMES) == 0x0) {
    ...
    protected JsonToken _handleOddValue(final int i) throws IOException {
        switch (i) {
            case 39: {
                if ((this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
    ...
    private void _skipComment() throws IOException {
        if ((this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_JAVA_COMMENTS) == 0x0) {
    ...
    private boolean _skipYAMLComment() throws IOException {
        if ((this._features & ReaderBasedJsonParser.FEAT_MASK_ALLOW_YAML_COMMENTS) == 0x0) {
            return false;
        }
        this._skipLine();
        return true;
    ...
    static {
        ...
        FEAT_MASK_NON_NUM_NUMBERS = Feature.ALLOW_NON_NUMERIC_NUMBERS.getMask();
