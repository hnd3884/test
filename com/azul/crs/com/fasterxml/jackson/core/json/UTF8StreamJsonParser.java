...
public class UTF8StreamJsonParser extends ParserBase
{
    ...
    public JacksonFeatureSet<StreamReadCapability> getReadCapabilities() {
        return UTF8StreamJsonParser.JSON_READ_CAPABILITIES;
    }
    ...
    protected void _releaseBuffers() throws IOException {
        ...
        if (this._bufferRecyclable) {
            ...
            if (buf != null && buf != UTF8StreamJsonParser.NO_BYTES) {
    ...
    private final int _verifyNoLeadingZeroes() throws IOException {
        ...
        if ((this._features & UTF8StreamJsonParser.FEAT_MASK_LEADING_ZEROS) == 0x0) {
    ...
    protected String _handleOddName(int ch) throws IOException {
        if (ch == 39 && (this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
            return this._parseAposName();
        }
        if ((this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_UNQUOTED_NAMES) == 0x0) {
    ...
    protected JsonToken _handleUnexpectedValue(final int c) throws IOException {
        switch (c) {
            ...
            case 44: {
                if (!this._parsingContext.inRoot() && (this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_MISSING) != 0x0) {
                    --this._inputPtr;
            ...
            case 39: {
                if ((this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_SINGLE_QUOTES) != 0x0) {
            ...
            case 78: {
                ...
                if ((this._features & UTF8StreamJsonParser.FEAT_MASK_NON_NUM_NUMBERS) != 0x0) {
    ...
    private final void _skipComment() throws IOException {
        if ((this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_JAVA_COMMENTS) == 0x0) {
    ...
    private final boolean _skipYAMLComment() throws IOException {
        if ((this._features & UTF8StreamJsonParser.FEAT_MASK_ALLOW_YAML_COMMENTS) == 0x0) {
            return false;
        }
        this._skipLine();
        return true;
