...
import com.azul.crs.com.fasterxml.jackson.core.io.NumberOutput;
...
public class WriterBasedJsonGenerator extends JsonGeneratorImpl
{
    ...
    public WriterBasedJsonGenerator(final IOContext ctxt, final int features, final ObjectCodec codec, final Writer w, final char quoteChar) {
    ...
    protected final void _writeFieldName(final SerializableString name, final boolean commaBefore) throws IOException {
        ...
        this._outputBuffer[this._outputTail++] = this._quoteChar;
        final int len = name.appendQuoted(this._outputBuffer, this._outputTail);
        if (len < 0) {
    ...
    private final void _writeFieldNameTail(final SerializableString name) throws IOException {
    ...
    @Override
    public void writeStartArray(final Object currentValue) throws IOException {
        this._verifyValueWrite("start an array");
    ...
    @Override
    public void writeStartArray(final Object currentValue, final int size) throws IOException {
        this._verifyValueWrite("start an array");
        this._writeContext = this._writeContext.createChildArrayContext(currentValue);
        if (this._cfgPrettyPrinter != null) {
            this._cfgPrettyPrinter.writeStartArray(this);
    ...
    public void writeStartObject(final Object forValue) throws IOException {
        this._verifyValueWrite("start an object");
        final JsonWriteContext ctxt = this._writeContext.createChildObjectContext(forValue);
    ...
    public void writeString(final SerializableString sstr) throws IOException {
        ...
        this._outputBuffer[this._outputTail++] = this._quoteChar;
        final int len = sstr.appendQuoted(this._outputBuffer, this._outputTail);
        if (len < 0) {
    ...
    private void _writeString2(final SerializableString sstr) throws IOException {
    ...
    public void writeRaw(final SerializableString text) throws IOException {
        final int len = text.appendUnquoted(this._outputBuffer, this._outputTail);
        if (len < 0) {
    ...
    public void writeNumber(final double d) throws IOException {
        if (this._cfgNumbersAsStrings || (NumberOutput.notFinite(d) && this.isEnabled(Feature.QUOTE_NON_NUMERIC_NUMBERS))) {
    ...
    public void writeNumber(final float f) throws IOException {
        if (this._cfgNumbersAsStrings || (NumberOutput.notFinite(f) && this.isEnabled(Feature.QUOTE_NON_NUMERIC_NUMBERS))) {
    ...
    @Override
    public void writeNumber(final char[] encodedValueBuffer, final int offset, final int length) throws IOException {
        this._verifyValueWrite("write a number");
        if (this._cfgNumbersAsStrings) {
    ...
    private void _writeQuotedRaw(final char[] text, final int offset, final int length) throws IOException {
        if (this._outputTail >= this._outputEnd) {
            this._flushBuffer();
        }
        this._outputBuffer[this._outputTail++] = this._quoteChar;
