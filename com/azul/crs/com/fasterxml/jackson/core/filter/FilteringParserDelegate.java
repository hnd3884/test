package com.azul.crs.com.fasterxml.jackson.core.filter;
...
import com.azul.crs.com.fasterxml.jackson.core.util.JsonParserDelegate;
...
public class FilteringParserDelegate extends JsonParserDelegate
{
    ...
    public FilteringParserDelegate(final JsonParser p, final TokenFilter f, final TokenFilter.Inclusion inclusion, final boolean allowMultipleMatches) {
        super(p);
        this.rootFilter = f;
        this._itemFilter = f;
        ...
        while (true) {
            ...
            switch (t.id()) {
                ...
                case 5: {
                    ...
                    if (this._verifyAllowedMatches() && this._inclusion == TokenFilter.Inclusion.INCLUDE_ALL_AND_PATH) {
                        return this._currToken = t;
                    }
                    continue;
                }
