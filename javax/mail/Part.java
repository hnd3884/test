...
public interface Part
{
    ...
    Enumeration<Header> getMatchingHeaders(final String[] p0) throws MessagingException;
    
    Enumeration<Header> getNonMatchingHeaders(final String[] p0) throws MessagingException;
}
