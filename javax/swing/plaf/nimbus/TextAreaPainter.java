...
final class TextAreaPainter extends AbstractRegionPainter
{
    ...
    public TextAreaPainter(final PaintContext ctx, final int state) {
    ...
    protected void doPaint(final Graphics2D graphics2D, final JComponent component, final int n, final int n2, final Object[] componentColors) {
        ...
        switch (this.state) {
            ...
            case 3: {
                this.paintBackgroundDisabledAndNotInScrollPane(graphics2D);
                break;
            }
            case 4: {
                this.paintBackgroundEnabledAndNotInScrollPane(graphics2D);
                break;
            }
            case 5: {
            ...
            case 6: {
                this.paintBorderDisabledAndNotInScrollPane(graphics2D);
                break;
            }
            case 7: {
                this.paintBorderFocusedAndNotInScrollPane(graphics2D);
                break;
            }
            case 8: {
                this.paintBorderEnabledAndNotInScrollPane(graphics2D);
                break;
            }
        }
    }
    ...
    private void paintBackgroundDisabledAndNotInScrollPane(final Graphics2D graphics2D) {
        this.rect = this.decodeRect2();
        graphics2D.setPaint(this.color1);
        graphics2D.fill(this.rect);
    }
    
    private void paintBackgroundEnabledAndNotInScrollPane(final Graphics2D graphics2D) {
        this.rect = this.decodeRect2();
        graphics2D.setPaint((Paint)this.componentColors[0]);
        graphics2D.fill(this.rect);
    }
    ...
    private void paintBorderDisabledAndNotInScrollPane(final Graphics2D graphics2D) {
    ...
    private void paintBorderFocusedAndNotInScrollPane(final Graphics2D graphics2D) {
    ...
    private void paintBorderEnabledAndNotInScrollPane(final Graphics2D graphics2D) {
        this.rect = this.decodeRect8();
