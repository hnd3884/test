...
final class ComboBoxTextFieldPainter extends AbstractRegionPainter
{
    ...
    public ComboBoxTextFieldPainter(final PaintContext ctx, final int state) {
        ...
        this.color9 = this.decodeColor("nimbusBlueGrey", 0.055555582f, -0.1048766f, -0.05098039f, 0);
        this.color10 = this.decodeColor("nimbusLightBackground", 0.6666667f, 0.004901961f, -0.19999999f, 0);
        this.color11 = this.decodeColor("nimbusLightBackground", 0.0f, 0.0f, 0.0f, 0);
    ...
    private Paint decodeGradient4(final Shape shape) {
        ...
        final float n3 = (float)bounds2D.getWidth();
        final float n4 = (float)bounds2D.getHeight();
        return this.decodeGradient(0.5f * n3 + n, 0.0f * n4 + n2, 0.5f * n3 + n, 1.0f * n4 + n2, new float[] { 0.1f, 0.49999997f, 0.9f }, new Color[] { this.color10, this.decodeColor(this.color10, this.color11, 0.5f), this.color11 });
    }
}
