...
final class SeparatorPainter extends AbstractRegionPainter
{
    ...
    public SeparatorPainter(final PaintContext ctx, final int state) {
    ...
    private Rectangle2D decodeRect1() {
        this.rect.setRect(this.decodeX(0.0f), this.decodeY(1.3333334f), this.decodeX(3.0f) - this.decodeX(0.0f), this.decodeY(1.6666667f) - this.decodeY(1.3333334f));
        return this.rect;
    }
}
