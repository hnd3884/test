...
public class SynthMenuItemUI extends BasicMenuItemUI implements PropertyChangeListener, SynthUI
{
    ...
    private void updateStyle(final JMenuItem menuItem) {
        ...
        if (style != this.style) {
            ...
            final Object value = this.style.get(context, propertyPrefix + ".textIconGap");
            if (value != null) {
                LookAndFeel.installProperty(menuItem, "iconTextGap", value);
            }
            this.defaultTextIconGap = menuItem.getIconTextGap();
    ...
    void paintBackground(final SynthContext synthContext, final Graphics graphics, final JComponent component) {
        SynthGraphicsUtils.paintBackground(synthContext, graphics, component);
    }
