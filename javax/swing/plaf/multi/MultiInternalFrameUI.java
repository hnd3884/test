...
public class MultiInternalFrameUI extends InternalFrameUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiInternalFrameUI multiInternalFrameUI = new MultiInternalFrameUI();
        return MultiLookAndFeel.createUIs(multiInternalFrameUI, multiInternalFrameUI.uis, component);
    }
