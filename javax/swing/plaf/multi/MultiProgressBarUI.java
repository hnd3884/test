...
public class MultiProgressBarUI extends ProgressBarUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiProgressBarUI multiProgressBarUI = new MultiProgressBarUI();
        return MultiLookAndFeel.createUIs(multiProgressBarUI, multiProgressBarUI.uis, component);
    }
