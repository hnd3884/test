...
public class MultiColorChooserUI extends ColorChooserUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiColorChooserUI multiColorChooserUI = new MultiColorChooserUI();
        return MultiLookAndFeel.createUIs(multiColorChooserUI, multiColorChooserUI.uis, component);
    }
