...
public class MultiTableHeaderUI extends TableHeaderUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiTableHeaderUI multiTableHeaderUI = new MultiTableHeaderUI();
        return MultiLookAndFeel.createUIs(multiTableHeaderUI, multiTableHeaderUI.uis, component);
    }
