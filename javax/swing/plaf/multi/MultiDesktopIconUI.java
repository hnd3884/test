...
public class MultiDesktopIconUI extends DesktopIconUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiDesktopIconUI multiDesktopIconUI = new MultiDesktopIconUI();
        return MultiLookAndFeel.createUIs(multiDesktopIconUI, multiDesktopIconUI.uis, component);
    }
