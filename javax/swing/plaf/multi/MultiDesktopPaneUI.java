...
public class MultiDesktopPaneUI extends DesktopPaneUI
{
    ...
    public static ComponentUI createUI(final JComponent component) {
        final MultiDesktopPaneUI multiDesktopPaneUI = new MultiDesktopPaneUI();
        return MultiLookAndFeel.createUIs(multiDesktopPaneUI, multiDesktopPaneUI.uis, component);
    }
