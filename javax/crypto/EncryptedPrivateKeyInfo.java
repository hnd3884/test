...
public class EncryptedPrivateKeyInfo
{
    ...
    public PKCS8EncodedKeySpec getKeySpec(final Cipher cipher) throws InvalidKeySpecException {
        ...
        catch (final GeneralSecurityException | IOException | IllegalStateException ex) {
            throw new InvalidKeySpecException("Cannot retrieve the PKCS8EncodedKeySpec", (Throwable)ex);
        }
    ...
    private PKCS8EncodedKeySpec getKeySpecImpl(final Key key, final Provider provider) throws NoSuchAlgorithmException, InvalidKeyException {
        ...
        catch (final GeneralSecurityException | IOException ex2) {
            throw new InvalidKeyException("Cannot retrieve the PKCS8EncodedKeySpec", (Throwable)ex2);
        }
        return new PKCS8EncodedKeySpec(doFinal);
    }
