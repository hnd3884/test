...
final class FactoryFinder
{
    ...
    static Object find(final String s, final String s2) throws ConfigurationError {
        ...
        return find(s, classLoader, s2);
    }
    
    static Object find(final String s, final ClassLoader classLoader, final String s2) throws ConfigurationError {
        if (FactoryFinder.debug) {
        ...
        try {
            final String string = SecuritySupport.getSystemProperty("java.home") + File.separator + "lib" + File.separator + "stax.properties";
            ...
            if (property != null) {
                if (FactoryFinder.debug) {
                    dPrint("found in $java.home/stax.properties, value=" + property);
                }
