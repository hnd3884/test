...
public abstract class SOAPFactory
{
    ...
    public static SOAPFactory newInstance() throws SOAPException {
        try {
            final SOAPFactory factory = (SOAPFactory)FactoryFinder.find("javax.xml.soap.SOAPFactory", "com.sun.xml.internal.messaging.saaj.soap.ver1_1.SOAPFactory1_1Impl", false);
            if (factory != null) {
                return factory;
            }
