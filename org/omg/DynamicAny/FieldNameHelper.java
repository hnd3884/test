...
public abstract class FieldNameHelper
{
    ...
    public static synchronized TypeCode type() {
        if (FieldNameHelper.__typeCode == null) {
            FieldNameHelper.__typeCode = ORB.init().create_string_tc(0);
            FieldNameHelper.__typeCode = ORB.init().create_alias_tc(id(), "FieldName", FieldNameHelper.__typeCode);
        }
        return FieldNameHelper.__typeCode;
    }
    
    public static String id() {
        return FieldNameHelper._id;
    }
    ...
    static {
        FieldNameHelper._id = "IDL:omg.org/DynamicAny/FieldName:1.0";
        FieldNameHelper.__typeCode = null;
    }
}
