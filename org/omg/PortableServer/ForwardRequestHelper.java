...
public abstract class ForwardRequestHelper
{
        ...
        if (ForwardRequestHelper.__typeCode == null) {
            synchronized (TypeCode.class) {
                if (ForwardRequestHelper.__typeCode == null) {
                    ...
                    ForwardRequestHelper.__typeCode = ORB.init().create_exception_tc(id(), "ForwardRequest", new StructMember[] { new StructMember("forward_reference", ObjectHelper.type(), null) });
    ...
    static {
        ForwardRequestHelper._id = "IDL:omg.org/PortableServer/ForwardRequest:1.0";
