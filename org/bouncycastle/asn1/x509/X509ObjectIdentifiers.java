...
public interface X509ObjectIdentifiers
{
    ...
    public static final ASN1ObjectIdentifier id_pe = X509ObjectIdentifiers.id_pkix.branch("1");
    public static final ASN1ObjectIdentifier id_ce = new ASN1ObjectIdentifier("2.5.29");
    public static final ASN1ObjectIdentifier id_ad = X509ObjectIdentifiers.id_pkix.branch("48");
    public static final ASN1ObjectIdentifier id_ad_caIssuers = X509ObjectIdentifiers.id_ad.branch("2").intern();
    public static final ASN1ObjectIdentifier id_ad_ocsp = X509ObjectIdentifiers.id_ad.branch("1").intern();
    public static final ASN1ObjectIdentifier ocspAccessMethod = X509ObjectIdentifiers.id_ad_ocsp;
    public static final ASN1ObjectIdentifier crlAccessMethod = X509ObjectIdentifiers.id_ad_caIssuers;
}
