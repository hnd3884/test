...
public interface OCSPObjectIdentifiers
{
    ...
    public static final ASN1ObjectIdentifier id_pkix_ocsp_pref_sig_algs = OCSPObjectIdentifiers.id_pkix_ocsp.branch("8");
    public static final ASN1ObjectIdentifier id_pkix_ocsp_extended_revoke = OCSPObjectIdentifiers.id_pkix_ocsp.branch("9");
}
