...
public final class RC6
{
    ...
    public static class AlgParamGen extends BaseAlgorithmParameterGenerator
    {
        ...
        protected AlgorithmParameters engineGenerateParameters() {
            ...
            try {
                parametersInstance = this.createParametersInstance("RC6");
    ...
    public static class Mappings extends SymmetricAlgorithmProvider
    {
        ...
        public void configure(final ConfigurableProvider configurableProvider) {
            configurableProvider.addAlgorithm("Cipher.RC6", Mappings.PREFIX + "$ECB");
            configurableProvider.addAlgorithm("KeyGenerator.RC6", Mappings.PREFIX + "$KeyGen");
            configurableProvider.addAlgorithm("AlgorithmParameters.RC6", Mappings.PREFIX + "$AlgParams");
            this.addGMacAlgorithm(configurableProvider, "RC6", Mappings.PREFIX + "$GMAC", Mappings.PREFIX + "$KeyGen");
            this.addPoly1305Algorithm(configurableProvider, "RC6", Mappings.PREFIX + "$Poly1305", Mappings.PREFIX + "$Poly1305KeyGen");
        }
