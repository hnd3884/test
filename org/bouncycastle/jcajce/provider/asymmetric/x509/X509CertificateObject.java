...
class X509CertificateObject extends X509Certificate implements PKCS12BagAttributeCarrier
{
    ...
    public X509CertificateObject(final JcaJceHelper bcHelper, final org.bouncycastle.asn1.x509.Certificate c) throws CertificateParsingException {
    ...
    public boolean equals(final Object o) {
        ...
        if (o instanceof X509CertificateObject) {
            final X509CertificateObject x509CertificateObject = (X509CertificateObject)o;
            return (!this.hashValueSet || !x509CertificateObject.hashValueSet || this.hashValue == x509CertificateObject.hashValue) && this.c.equals(x509CertificateObject.c);
        }
