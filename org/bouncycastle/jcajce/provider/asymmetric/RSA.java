...
public class RSA
{
    ...
    public static class Mappings extends AsymmetricAlgorithmProvider
    {
        ...
        private void addDigestSignature(final ConfigurableProvider configurableProvider, final String s, final String s2, final ASN1ObjectIdentifier asn1ObjectIdentifier) {
            ...
            configurableProvider.addAlgorithm("Signature." + string, s2);
            ...
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + string5, string);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + string6, string);
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + string7, string);
        ...
        private void addISO9796Signature(final ConfigurableProvider configurableProvider, final String s, final String s2) {
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "withRSA/ISO9796-2", s + "WITHRSA/ISO9796-2");
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "WithRSA/ISO9796-2", s + "WITHRSA/ISO9796-2");
            configurableProvider.addAlgorithm("Signature." + s + "WITHRSA/ISO9796-2", s2);
        }
        
        private void addPSSSignature(final ConfigurableProvider configurableProvider, final String s, final String s2) {
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "withRSA/PSS", s + "WITHRSAANDMGF1");
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "WithRSA/PSS", s + "WITHRSAANDMGF1");
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "withRSAandMGF1", s + "WITHRSAANDMGF1");
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "WithRSAAndMGF1", s + "WITHRSAANDMGF1");
            configurableProvider.addAlgorithm("Signature." + s + "WITHRSAANDMGF1", s2);
        }
        
        private void addX931Signature(final ConfigurableProvider configurableProvider, final String s, final String s2) {
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "withRSA/X9.31", s + "WITHRSA/X9.31");
            configurableProvider.addAlgorithm("Alg.Alias.Signature." + s + "WithRSA/X9.31", s + "WITHRSA/X9.31");
            configurableProvider.addAlgorithm("Signature." + s + "WITHRSA/X9.31", s2);
        }
    }
}
