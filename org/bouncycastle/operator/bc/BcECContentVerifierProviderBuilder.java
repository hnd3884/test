...
public class BcECContentVerifierProviderBuilder extends BcContentVerifierProviderBuilder
{
    ...
    public BcECContentVerifierProviderBuilder(final DigestAlgorithmIdentifierFinder digestAlgorithmFinder) {
        this.digestAlgorithmFinder = digestAlgorithmFinder;
    }
    
    @Override
    protected Signer createSigner(final AlgorithmIdentifier algorithmIdentifier) throws OperatorCreationException {
        return (Signer)new DSADigestSigner((DSA)new ECDSASigner(), (Digest)this.digestProvider.get(this.digestAlgorithmFinder.find(algorithmIdentifier)));
    }
