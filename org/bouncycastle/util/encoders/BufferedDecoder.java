...
public class BufferedDecoder
{
    ...
    public BufferedDecoder(final Translator translator, final int n) {
    ...
    public int processByte(final byte b, final byte[] array, final int n) {
        ...
        if (this.bufOff == this.buf.length) {
            decode = this.translator.decode(this.buf, 0, this.buf.length, array, n);
            this.bufOff = 0;
        }
        return decode;
    }
    ...
    public int processBytes(final byte[] array, int n, int n2, final byte[] array2, int n3) {
        ...
        if (n2 > n5) {
            ...
            final int n6 = n4 + this.translator.decode(this.buf, 0, this.buf.length, array2, n3);
            this.bufOff = 0;
            n2 -= n5;
            n += n5;
            n3 += n6;
            final int n7 = n2 - n2 % this.buf.length;
            n4 = n6 + this.translator.decode(array, n, n7, array2, n3);
            n2 -= n7;
            n += n7;
        }
        if (n2 != 0) {
