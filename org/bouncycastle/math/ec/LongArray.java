...
class LongArray implements Cloneable
{
    ...
    public LongArray(final BigInteger bigInteger) {
        ...
        final int n2 = (length + 7) / 8;
        this.m_ints = new long[n2];
        int i = n2 - 1;
        final int n3 = length % 8 + n;
        long n4 = 0L;
        int j;
        if ((j = n) < n3) {
            while (j < n3) {
                n4 = (n4 << 8 | (long)(byteArray[j] & 0xFF));
                ++j;
            }
            this.m_ints[i--] = n4;
        }
    ...
    void copyTo(final long[] array, final int n) {
        System.arraycopy(this.m_ints, 0, array, n, this.m_ints.length);
    }
    ...
    public int getUsedLengthFrom(int min) {
        final long[] ints = this.m_ints;
        min = Math.min(min, ints.length);
        if (min < 1) {
            return 0;
        }
        if (ints[0] != 0L) {
    ...
    public int degree() {
        ...
        while (i != 0) {
            final long n = this.m_ints[--i];
            if (n != 0L) {
                return (i << 6) + bitLength(n);
            }
        }
        return 0;
    }
    
    private int degreeFrom(final int n) {
        int i = n + 62 >>> 6;
        while (i != 0) {
            final long n2 = this.m_ints[--i];
            if (n2 != 0L) {
                return (i << 6) + bitLength(n2);
            }
        }
        return 0;
    }
    ...
    private static int bitLength(final long n) {
        ...
        if (n4 == 0) {
            final int n5 = n2 >>> 8;
            n6 = ((n5 == 0) ? LongArray.bitLengths[n2] : (8 + LongArray.bitLengths[n5]));
        }
        else {
            final int n7 = n4 >>> 8;
            n6 = ((n7 == 0) ? (16 + LongArray.bitLengths[n4]) : (24 + LongArray.bitLengths[n7]));
        }
        return n3 + n6;
    }
    ...
    private long[] resizedInts(final int n) {
        ...
        System.arraycopy(this.m_ints, 0, array, 0, Math.min(this.m_ints.length, n));
        return array;
    }
    ...
    public BigInteger toBigInteger() {
        ...
        final long n = this.m_ints[usedLength - 1];
        ...
        final byte[] array2 = new byte[8 * (usedLength - 1) + n2];
        for (int j = 0; j < n2; ++j) {
            array2[j] = array[j];
        }
        for (int k = usedLength - 2; k >= 0; --k) {
            final long n4 = this.m_ints[k];
            for (int l = 7; l >= 0; --l) {
                array2[n2++] = (byte)(n4 >>> 8 * l);
            }
        }
    ...
    private static long shiftUp(final long[] array, final int n, final long[] array2, final int n2, final int n3, final int n4) {
        ...
        long n6 = 0L;
        for (int i = 0; i < n3; ++i) {
            final long n7 = array[n + i];
            array2[n2 + i] = (n7 << n4 | n6);
            n6 = n7 >>> n5;
        }
        return n6;
    }
    ...
    public LongArray addOne() {
        ...
        final long[] resizedInts;
        final long[] array = resizedInts = this.resizedInts(Math.max(1, this.getUsedLength()));
        final int n = 0;
        resizedInts[n] ^= 0x1L;
        return new LongArray(array);
    }
    
    private void addShiftedByBitsSafe(final LongArray longArray, final int n, final int n2) {
        final int n3 = n + 63 >>> 6;
        final int n4 = n2 >>> 6;
        final int n5 = n2 & 0x3F;
        if (n5 == 0) {
            add(this.m_ints, n4, longArray.m_ints, 0, n3);
            return;
        }
        final long addShiftedUp = addShiftedUp(this.m_ints, n4, longArray.m_ints, 0, n3, n5);
        if (addShiftedUp != 0L) {
            final long[] ints = this.m_ints;
            final int n6 = n3 + n4;
            ints[n6] ^= addShiftedUp;
        }
    }
    ...
    private static long addShiftedDown(final long[] array, final int n, final long[] array2, final int n2, final int n3, final int n4) {
        final int n5 = 64 - n4;
        long n6 = 0L;
        int n7 = n3;
        while (--n7 >= 0) {
            final long n8 = array2[n2 + n7];
            final int n9 = n + n7;
            array[n9] ^= (n8 >>> n4 | n6);
            n6 = n8 << n5;
        }
    ...
    private static void flipWord(final long[] array, final int n, final int n2, long n3) {
        int n4 = n + (n2 >>> 6);
        final int n5 = n2 & 0x3F;
        if (n5 == 0) {
            final int n6 = n4;
    ...
    public boolean testBitZero() {
        return this.m_ints.length > 0 && (this.m_ints[0] & 0x1L) != 0x0L;
    }
    ...
    private static void flipBit(final long[] array, final int n, final int n2) {
        final int n3 = n2 >>> 6;
        final long n4 = 1L << (n2 & 0x3F);
        final int n5 = n + n3;
        array[n5] ^= n4;
    }
    ...
    public LongArray modMultiplyLD(final LongArray longArray, final int n, final int[] array) {
        ...
        final int n4 = degree2 + 63 >>> 6;
        final int n5 = degree + degree2 + 62 >>> 6;
        if (n3 != 1) {
            final int n6 = degree2 + 7 + 63 >>> 6;
            final int[] array2 = new int[16];
            final long[] array3 = new long[n6 << 4];
            int n7 = n6;
            array2[1] = n7;
            System.arraycopy(longArray3.m_ints, 0, array3, n7, n4);
            for (int i = 2; i < 16; ++i) {
                n7 = (array2[i] = n7 + n6);
                if ((i & 0x1) == 0x0) {
                    shiftUp(array3, n7 >>> 1, array3, n7, n6, 1);
                }
                else {
                    add(array3, n6, array3, n7 - n6, array3, n7, n6);
                }
            }
            final long[] array4 = new long[array3.length];
            ...
            for (int j = 56; j >= 0; j -= 8) {
                for (int k = 1; k < n3; k += 2) {
                    final int n9 = (int)(ints[k] >>> j);
                    addBoth(array5, k - 1, array3, array2[n9 & n8], array4, array2[n9 >>> 4 & n8], n6);
                }
                shiftUp(array5, 0, n5, 8);
            }
            for (int l = 56; l >= 0; l -= 8) {
                for (int n10 = 0; n10 < n3; n10 += 2) {
                    final int n11 = (int)(ints[n10] >>> l);
                    addBoth(array5, n10, array3, array2[n11 & n8], array4, array2[n11 >>> 4 & n8], n6);
                }
                if (l > 0) {
                    shiftUp(array5, 0, n5, 8);
                }
            }
            return reduceResult(array5, 0, n5, n, array);
        }
        final long n12 = longArray2.m_ints[0];
        if (n12 == 1L) {
            return longArray3;
        }
        final long[] array6 = new long[n5];
        multiplyWord(n12, longArray3.m_ints, n4, array6, 0);
        return reduceResult(array6, 0, n5, n, array);
    }
    
    public LongArray modMultiply(final LongArray longArray, final int n, final int[] array) {
        int degree = this.degree();
        if (degree == 0) {
            return this;
        }
        ...
        if (n3 != 1) {
            ...
            shiftUp(array3, 0, array4, 0, array3.length, 4);
            final long[] ints = longArray2.m_ints;
            final long[] array5 = new long[n5 << 3];
            final int n8 = 15;
            for (int j = 0; j < n3; ++j) {
                long n9 = ints[j];
                int n10 = j;
                while (true) {
                    final int n11 = (int)n9 & n8;
                    final long n12 = n9 >>> 4;
                    addBoth(array5, n10, array3, array2[n11], array4, array2[(int)n12 & n8], n6);
                    n9 = n12 >>> 4;
                    if (n9 == 0L) {
                        break;
                    }
            ...
            while ((length -= n5) != 0) {
                addShiftedUp(array5, length - n5, array5, length, n5, 8);
            }
            return reduceResult(array5, 0, n5, n, array);
        }
        ...
        final long[] array6 = new long[n5];
        multiplyWord(n13, longArray3.m_ints, n4, array6, 0);
        return reduceResult(array6, 0, n5, n, array);
    }
    
    public LongArray modMultiplyAlt(final LongArray longArray, final int n, final int[] array) {
        int degree = this.degree();
        if (degree == 0) {
            return this;
        }
        ...
        if (n3 != 1) {
            ...
            final int n8 = 64;
            final int n9 = 8;
            final int n10 = degree2 + ((n8 < 64) ? n7 : (n7 - 1)) + 63 >>> 6;
            final int n11 = n10 * n9;
            final int n12 = n6 * n9;
            final int[] array2 = new int[1 << n6];
            final int n13 = n3;
            array2[0] = n13;
            int n14 = n13 + n11;
            array2[1] = n14;
            ...
            int n15 = n14 + n5;
            final long[] array3 = new long[++n15];
            interleave(longArray2.m_ints, 0, array3, 0, n3, n6);
            int n16 = n3;
            System.arraycopy(longArray3.m_ints, 0, array3, n16, n4);
            for (int j = 1; j < n9; ++j) {
                shiftUp(array3, n3, array3, n16 += n10, n10, j);
            }
            int n17 = (1 << n6) - 1;
            int n18 = 0;
            while (true) {
                int n19 = 0;
                do {
                    long n20 = array3[n19] >>> n18;
                    int n21 = 0;
                    int n22 = n3;
                    while (true) {
                        final int n23 = (int)n20 & n17;
                        if (n23 != 0) {
                            add(array3, n19 + array2[n23], array3, n22, n10);
                        }
                        if (++n21 == n9) {
                            break;
                        }
                ...
                shiftUp(array3, n3, n11, n9);
            }
            int length = array2.length;
            while (--length > 1) {
                if (((long)length & 0x1L) == 0x0L) {
                    addShiftedUp(array3, array2[length >>> 1], array3, array2[length], n5, n7);
                }
                else {
                    distribute(array3, array2[length], array2[length - 1], array2[1], n5);
                }
            }
        ...
        multiplyWord(n24, longArray3.m_ints, n4, array4, 0);
    ...
    public LongArray multiply(final LongArray longArray, final int n, final int[] array) {
        int degree = this.degree();
        if (degree == 0) {
            return this;
        }
        ...
        if (n3 != 1) {
            ...
            return new LongArray(array5, 0, n5);
        }
        final long n13 = longArray2.m_ints[0];
        if (n13 == 1L) {
            return longArray3;
        ...
        final long[] array6 = new long[n5];
        multiplyWord(n13, longArray3.m_ints, n4, array6, 0);
        return new LongArray(array6, 0, n5);
    }
    
    public void reduce(final int n, final int[] array) {
        final long[] ints = this.m_ints;
        final int reduceInPlace = reduceInPlace(ints, 0, ints.length, n, array);
    ...
    private static int reduceInPlace(final long[] array, final int n, int i, final int n2, final int[] array2) {
        ...
        int min = Math.min(i << 6, (n2 << 1) - 1);
        int j;
        for (j = (i << 6) - min; j >= 64; j -= 64) {
            --i;
        }
        final int length = array2.length;
        final int n4 = array2[length - 1];
        final int n5 = (length > 1) ? array2[length - 2] : 0;
        final int max = Math.max(n2, n4 + 64);
        final int n6 = j + Math.min(min - max, n2 - n5) >> 6;
        if (n6 > 1) {
            final int n7 = i - n6;
            reduceVectorWise(array, n, i, n7, n2, array2);
            while (i > n7) {
                array[n + --i] = 0L;
            }
            min = n7 << 6;
        ...
        if (min > max) {
            reduceWordWise(array, n, i, max, n2, array2);
            min = max;
        }
        if (min > n2) {
            reduceBitWise(array, n, min, n2, array2);
        }
        return n3;
    }
    ...
    private static void reduceBitWise(final long[] array, final int n, int n2, final int n3, final int[] array2) {
        while (--n2 >= n3) {
            if (testBit(array, n, n2)) {
                reduceBit(array, n, n2, n3, array2);
            }
        }
    }
    
    private static void reduceBit(final long[] array, final int n, final int n2, final int n3, final int[] array2) {
        flipBit(array, n, n2);
        final int n4 = n2 - n3;
        int length = array2.length;
        while (--length >= 0) {
            flipBit(array, n, array2[length] + n4);
        }
        flipBit(array, n, n4);
    }
    ...
    private static void reduceWordWise(final long[] array, final int n, int n2, final int n3, final int n4, final int[] array2) {
        final int n5 = n3 >>> 6;
        while (--n2 > n5) {
            final long n6 = array[n + n2];
            if (n6 != 0L) {
                array[n + n2] = 0L;
                reduceWord(array, n, n2 << 6, n6, n4, array2);
            }
        }
        final int n7 = n3 & 0x3F;
        final long n8 = array[n + n5] >>> n7;
        if (n8 != 0L) {
            final int n9 = n + n5;
            array[n9] ^= n8 << n7;
            reduceWord(array, n, n3, n8, n4, array2);
        }
    }
    
    private static void reduceWord(final long[] array, final int n, final int n2, final long n3, final int n4, final int[] array2) {
        final int n5 = n2 - n4;
        int length = array2.length;
        while (--length >= 0) {
            flipWord(array, n, n5 + array2[length], n3);
        }
        flipWord(array, n, n5, n3);
    }
    
    private static void reduceVectorWise(final long[] array, final int n, final int n2, final int n3, final int n4, final int[] array2) {
        final int n5 = (n3 << 6) - n4;
        int length = array2.length;
        while (--length >= 0) {
            flipVector(array, n, array, n + n3, n2 - n3, n5 + array2[length]);
        }
        flipVector(array, n, array, n + n3, n2 - n3, n5);
    }
    ...
    private static void flipVector(final long[] array, int n, final long[] array2, final int n2, final int n3, int n4) {
        ...
        if (n4 == 0) {
            ...
            final long addShiftedDown = addShiftedDown(array, n + 1, array2, n2, n3, 64 - n4);
            final int n5 = n;
            array[n5] ^= addShiftedDown;
        }
    }
    ...
    public LongArray modSquare(final int n, final int[] array) {
        ...
        long n3;
        for (int i = 0; i < n2; array2[i++] = interleave2_32to64((int)n3), array2[i++] = interleave2_32to64((int)(n3 >>> 32))) {
            n3 = this.m_ints[i >>> 1];
        }
        return new LongArray(array2, 0, reduceInPlace(array2, 0, array2.length, n, array));
    }
    
    public LongArray modSquareN(int n, final int n2, final int[] array) {
        int n3 = this.getUsedLength();
        if (n3 == 0) {
            return this;
        }
        final long[] array2 = new long[n2 + 63 >>> 6 << 1];
        System.arraycopy(this.m_ints, 0, array2, 0, n3);
        while (--n >= 0) {
            squareInPlace(array2, n3, n2, array);
            n3 = reduceInPlace(array2, 0, array2.length, n2, array);
        }
        return new LongArray(array2, 0, n3);
    }
    
    public LongArray square(final int n, final int[] array) {
        final int usedLength = this.getUsedLength();
        if (usedLength == 0) {
            return this;
        }
        ...
        return new LongArray(array2, 0, array2.length);
    }
    
    private static void squareInPlace(final long[] array, int n, final int n2, final int[] array2) {
        int n3 = n << 1;
        while (--n >= 0) {
            final long n4 = array[n];
            array[--n3] = interleave2_32to64((int)(n4 >>> 32));
            array[--n3] = interleave2_32to64((int)n4);
        }
    }
    ...
    private static long interleave3(final long n) {
        return (n & Long.MIN_VALUE) | interleave3_21to63((int)n & 0x1FFFFF) | interleave3_21to63((int)(n >>> 21) & 0x1FFFFF) << 1 | interleave3_21to63((int)(n >>> 42) & 0x1FFFFF) << 2;
    }
    
    private static long interleave3_21to63(final int n) {
        return ((long)LongArray.INTERLEAVE3_TABLE[n >>> 14] & 0xFFFFFFFFL) << 42 | ((long)LongArray.INTERLEAVE3_TABLE[n >>> 7 & 0x7F] & 0xFFFFFFFFL) << 21 | ((long)LongArray.INTERLEAVE3_TABLE[n & 0x7F] & 0xFFFFFFFFL);
    }
    ...
    private static long interleave5(final long n) {
        return interleave3_13to65((int)n & 0x1FFF) | interleave3_13to65((int)(n >>> 13) & 0x1FFF) << 1 | interleave3_13to65((int)(n >>> 26) & 0x1FFF) << 2 | interleave3_13to65((int)(n >>> 39) & 0x1FFF) << 3 | interleave3_13to65((int)(n >>> 52) & 0x1FFF) << 4;
    }
    
    private static long interleave3_13to65(final int n) {
        return ((long)LongArray.INTERLEAVE5_TABLE[n >>> 7] & 0xFFFFFFFFL) << 35 | ((long)LongArray.INTERLEAVE5_TABLE[n & 0x7F] & 0xFFFFFFFFL);
    }
    ...
    private static long interleave2_n(long n, int i) {
        while (i > 1) {
            i -= 2;
            n = (interleave4_16to64((int)n & 0xFFFF) | interleave4_16to64((int)(n >>> 16) & 0xFFFF) << 1 | interleave4_16to64((int)(n >>> 32) & 0xFFFF) << 2 | interleave4_16to64((int)(n >>> 48) & 0xFFFF) << 3);
        }
        if (i > 0) {
            n = (interleave2_32to64((int)n) | interleave2_32to64((int)(n >>> 32)) << 1);
        }
        return n;
    }
    
    private static long interleave4_16to64(final int n) {
        return ((long)LongArray.INTERLEAVE4_TABLE[n >>> 8] & 0xFFFFFFFFL) << 32 | ((long)LongArray.INTERLEAVE4_TABLE[n & 0xFF] & 0xFFFFFFFFL);
    }
    
    private static long interleave2_32to64(final int n) {
        return ((long)(LongArray.INTERLEAVE2_TABLE[n >>> 16 & 0xFF] | LongArray.INTERLEAVE2_TABLE[n >>> 24] << 16) & 0xFFFFFFFFL) << 32 | ((long)(LongArray.INTERLEAVE2_TABLE[n & 0xFF] | LongArray.INTERLEAVE2_TABLE[n >>> 8 & 0xFF] << 16) & 0xFFFFFFFFL);
    }
    
    public LongArray modInverse(final int n, final int[] array) {
        ...
        final int n2 = n + 63 >>> 6;
        final LongArray longArray2 = new LongArray(n2);
        reduceBit(longArray2.m_ints, 0, n, n, array);
        final LongArray longArray3 = new LongArray(n2);
        longArray3.m_ints[0] = 1L;
        final LongArray longArray4 = new LongArray(n2);
        final int[] array2 = { degree, n + 1 };
        final LongArray[] array3 = { longArray, longArray2 };
        final int[] array4 = { 1, 0 };
        final LongArray[] array5 = { longArray3, longArray4 };
        int n3 = 1;
        int n4 = array2[n3];
        int degree2 = array4[n3];
        int n5 = n4 - array2[1 - n3];
        while (true) {
            if (n5 < 0) {
                n5 = -n5;
                array2[n3] = n4;
            ...
            array3[n3].addShiftedByBitsSafe(array3[1 - n3], array2[1 - n3], n5);
            final int degree3 = array3[n3].degreeFrom(n4);
            if (degree3 == 0) {
                break;
            }
            final int n6 = array4[1 - n3];
            array5[n3].addShiftedByBitsSafe(array5[1 - n3], n6, n5);
            final int n7 = n6 + n5;
            if (n7 > degree2) {
                degree2 = n7;
            }
            else if (n7 == degree2) {
                degree2 = array5[n3].degreeFrom(degree2);
            }
            n5 += degree3 - n4;
            n4 = degree3;
        }
    ...
    public String toString() {
        ...
        final StringBuffer sb = new StringBuffer(Long.toBinaryString(this.m_ints[--usedLength]));
        while (--usedLength >= 0) {
            final String binaryString = Long.toBinaryString(this.m_ints[usedLength]);
