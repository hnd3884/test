...
public class Curve25519Field
{
    ...
    public static void reduce(final int[] array, final int[] array2) {
        ...
        final int n2 = Nat256.mulByWordAddTo(19, array, array2) << 1;
        final int n3 = array2[7];
        array2[7] = (n3 & Integer.MAX_VALUE) + Nat.addWordTo(7, (n2 + ((n3 >>> 31) - (n >>> 31))) * 19, array2);
        if (Nat256.gte(array2, Curve25519Field.P)) {
            subPFrom(array2);
        }
    }
    ...
    public static void reduce27(final int n, final int[] array) {
        ...
        array[7] = (n2 & Integer.MAX_VALUE) + Nat.addWordTo(7, (n << 1 | n2 >>> 31) * 19, array);
