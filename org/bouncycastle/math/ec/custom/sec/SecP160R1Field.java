...
public class SecP160R1Field
{
    ...
    public static void addExt(final int[] array, final int[] array2, final int[] array3) {
        if ((Nat.add(10, array, array2, array3) != 0 || (array3[9] == -1 && Nat.gte(10, array3, SecP160R1Field.PExt))) && Nat.addTo(SecP160R1Field.PExtInv.length, SecP160R1Field.PExtInv, array3) != 0) {
            Nat.incAt(10, array3, SecP160R1Field.PExtInv.length);
        }
    }
    ...
    public static void multiplyAddToExt(final int[] array, final int[] array2, final int[] array3) {
        if ((Nat160.mulAddTo(array, array2, array3) != 0 || (array3[9] == -1 && Nat.gte(10, array3, SecP160R1Field.PExt))) && Nat.addTo(SecP160R1Field.PExtInv.length, SecP160R1Field.PExtInv, array3) != 0) {
            Nat.incAt(10, array3, SecP160R1Field.PExtInv.length);
        }
    }
    ...
    public static void reduce(final int[] array, final int[] array2) {
        ...
        final long n6 = 0L + (((long)array[0] & 0xFFFFFFFFL) + n + (n << 31));
        array2[0] = (int)n6;
    ...
    public static void subtractExt(final int[] array, final int[] array2, final int[] array3) {
        if (Nat.sub(10, array, array2, array3) != 0 && Nat.subFrom(SecP160R1Field.PExtInv.length, SecP160R1Field.PExtInv, array3) != 0) {
            Nat.decAt(10, array3, SecP160R1Field.PExtInv.length);
        }
    }
