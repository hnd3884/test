...
{
    @Deprecated
    public SecT409K1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2) {
        this(ecCurve, ecFieldElement, ecFieldElement2, false);
    }
    
    @Deprecated
    public SecT409K1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final boolean withCompression) {
    ...
    SecT409K1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final ECFieldElement[] array, final boolean withCompression) {
    ...
    public ECPoint add(final ECPoint ecPoint) {
        ...
        if (x.isZero()) {
            ...
            if (!add2.isZero()) {
                ...
                return new SecT409K1Point(curve, ecFieldElement2, ecFieldElement3, new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        if (ecFieldElement3.isZero()) {
            return new SecT409K1Point(curve, ecFieldElement3, curve.getB(), this.withCompression);
        }
        ...
        return new SecT409K1Point(curve, square, square2.add(ecFieldElement3).add(ecFieldElement2).multiply(square2).add(one ? ecFieldElement : ecFieldElement2.square()).add(square).add(ecFieldElement4), new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
    }
    ...
    public ECPoint negate() {
        ...
        final ECFieldElement y = this.y;
        final ECFieldElement ecFieldElement = this.zs[0];
        return new SecT409K1Point(this.curve, x, y.add(ecFieldElement), new ECFieldElement[] { ecFieldElement }, this.withCompression);
    }
}
