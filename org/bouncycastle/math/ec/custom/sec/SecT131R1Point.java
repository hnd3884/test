...
{
    @Deprecated
    public SecT131R1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2) {
        this(ecCurve, ecFieldElement, ecFieldElement2, false);
    }
    
    @Deprecated
    public SecT131R1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final boolean withCompression) {
    ...
    SecT131R1Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final ECFieldElement[] array, final boolean withCompression) {
    ...
    public ECPoint add(final ECPoint ecPoint) {
        ...
        if (x.isZero()) {
            ...
            if (!add2.isZero()) {
                ...
                return new SecT131R1Point(curve, ecFieldElement2, ecFieldElement3, new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        return new SecT131R1Point(curve, square, (one ? x : x.multiply(ecFieldElement)).squarePlusProduct(add, ecFieldElement2).add(square).add(ecFieldElement4), new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
    }
    ...
    public ECPoint negate() {
        ...
        final ECFieldElement y = this.y;
        final ECFieldElement ecFieldElement = this.zs[0];
        return new SecT131R1Point(this.curve, x, y.add(ecFieldElement), new ECFieldElement[] { ecFieldElement }, this.withCompression);
    }
}
