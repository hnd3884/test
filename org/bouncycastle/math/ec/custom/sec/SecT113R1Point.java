...
public class SecT113R1Point extends AbstractF2m
{
    ...
    public ECPoint add(final ECPoint ecPoint) {
        ...
        if (x.isZero()) {
            ...
            if (!add2.isZero()) {
                ...
                return new SecT113R1Point(curve, ecFieldElement2, ecFieldElement3, new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
            }
            if (add.isZero()) {
                return this.twice();
            }
    ...
    public ECPoint twice() {
        ...
        return new SecT113R1Point(curve, square, (one ? x : x.multiply(ecFieldElement)).squarePlusProduct(add, ecFieldElement2).add(square).add(ecFieldElement4), new ECFieldElement[] { ecFieldElement4 }, this.withCompression);
    }
