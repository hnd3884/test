...
{
    @Deprecated
    public SecP160R2Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2) {
        this(ecCurve, ecFieldElement, ecFieldElement2, false);
    }
    
    @Deprecated
    public SecP160R2Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final boolean withCompression) {
    ...
    SecP160R2Point(final ECCurve ecCurve, final ECFieldElement ecFieldElement, final ECFieldElement ecFieldElement2, final ECFieldElement[] array, final boolean withCompression) {
    ...
    public ECPoint twice() {
        ...
        final boolean one = secP160R2FieldElement3.isOne();
        int[] x = secP160R2FieldElement3.x;
        if (!one) {
            x = create2;
            SecP160R2Field.square(secP160R2FieldElement3.x, x);
        }
        SecP160R2Field.subtract(secP160R2FieldElement2.x, x, create);
        final int[] array = create2;
        SecP160R2Field.add(secP160R2FieldElement2.x, x, array);
        SecP160R2Field.multiply(array, create, array);
        SecP160R2Field.reduce32(Nat160.addBothTo(array, array, array), array);
        final int[] array2 = create3;
        SecP160R2Field.multiply(create3, secP160R2FieldElement2.x, array2);
        SecP160R2Field.reduce32(Nat.shiftUpBits(5, array2, 2, 0), array2);
        SecP160R2Field.reduce32(Nat.shiftUpBits(5, create4, 3, 0, create), create);
        final SecP160R2FieldElement secP160R2FieldElement4 = new SecP160R2FieldElement(create4);
        SecP160R2Field.square(array, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, array2, secP160R2FieldElement4.x);
        SecP160R2Field.subtract(secP160R2FieldElement4.x, array2, secP160R2FieldElement4.x);
        final SecP160R2FieldElement secP160R2FieldElement5 = new SecP160R2FieldElement(array2);
        SecP160R2Field.subtract(array2, secP160R2FieldElement4.x, secP160R2FieldElement5.x);
        SecP160R2Field.multiply(secP160R2FieldElement5.x, array, secP160R2FieldElement5.x);
        SecP160R2Field.subtract(secP160R2FieldElement5.x, create, secP160R2FieldElement5.x);
        final SecP160R2FieldElement secP160R2FieldElement6 = new SecP160R2FieldElement(array);
