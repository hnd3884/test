...
public class CreateSignedMultipartMail
{
    ...
    static X509Certificate makeCertificate(final KeyPair keyPair, final String s, final KeyPair keyPair2, final String s2) throws GeneralSecurityException, IOException, OperatorCreationException {
        ...
        final JcaX509v3CertificateBuilder jcaX509v3CertificateBuilder = new JcaX509v3CertificateBuilder(new X500Name(s2), BigInteger.valueOf(CreateSignedMultipartMail.serialNo++), new Date(System.currentTimeMillis()), new Date(System.currentTimeMillis() + 8640000000L), new X500Name(s), public1);
    ...
    public static void main(final String[] array) throws Exception {
        ...
        content.addBodyPart((BodyPart)mimeBodyPart);
        content.addBodyPart((BodyPart)mimeBodyPart2);
        final MimeBodyPart mimeBodyPart3 = new MimeBodyPart();
        mimeBodyPart3.setContent((Multipart)content);
        final MimeMultipart generate = smimeSignedGenerator.generate(mimeBodyPart3);
    ...
    static {
        CreateSignedMultipartMail.serialNo = 1;
    }
}
