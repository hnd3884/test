...
public class RIPEMD256Digest extends GeneralDigest
{
    ...
    public RIPEMD256Digest(final RIPEMD256Digest ripemd256Digest) {
        super(ripemd256Digest);
        this.X = new int[16];
        this.copyIn(ripemd256Digest);
    }
    
    private void copyIn(final RIPEMD256Digest ripemd256Digest) {
    ...
    protected void processBlock() {
        ...
        final int ff4 = this.FF4(h5, h6, h7, h8, this.X[5], 8);
        final int ff5 = this.FF4(h8, ff4, h6, h7, this.X[14], 9);
        final int ff6 = this.FF4(h7, ff5, ff4, h6, this.X[7], 9);
        final int ff7 = this.FF4(h6, ff6, ff5, ff4, this.X[0], 11);
        ...
        final int n2 = ff16;
        final int n3 = n;
        final int f17 = this.F2(n2, f16, f15, f14, this.X[7], 7);
        ...
        final int ff20 = this.FF3(n3, ff19, ff18, ff17, this.X[6], 9);
        ...
        final int n5 = ff35;
        final int n6 = n4;
        final int f33 = this.F3(f29, n5, f31, f30, this.X[3], 11);
        final int f34 = this.F3(f30, f33, n5, f31, this.X[10], 13);
        final int f35 = this.F3(f31, f34, f33, n5, this.X[14], 6);
        final int f36 = this.F3(n5, f35, f34, f33, this.X[4], 7);
        ...
        final int ff36 = this.FF2(ff32, n6, ff34, ff33, this.X[15], 9);
        final int ff37 = this.FF2(ff33, ff36, n6, ff34, this.X[5], 7);
        final int ff38 = this.FF2(ff34, ff37, ff36, n6, this.X[1], 15);
        final int ff39 = this.FF2(n6, ff38, ff37, ff36, this.X[3], 11);
        ...
        final int n8 = ff50;
        final int n9 = n7;
        final int f49 = this.F4(f45, f48, n8, f46, this.X[1], 11);
        final int f50 = this.F4(f46, f49, f48, n8, this.X[9], 12);
        final int f51 = this.F4(n8, f50, f49, f48, this.X[11], 14);
        ...
        final int ff52 = this.FF1(ff48, ff51, n9, ff49, this.X[8], 15);
        final int ff53 = this.FF1(ff49, ff52, ff51, n9, this.X[6], 5);
        final int ff54 = this.FF1(n9, ff53, ff52, ff51, this.X[4], 8);
