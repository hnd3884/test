...
public class RIPEMD128Digest extends GeneralDigest
{
    ...
    protected void processBlock() {
        ...
        final int ff4 = this.FF4(h0, n, n2, n3, this.X[5], 8);
        final int ff5 = this.FF4(n3, ff4, n, n2, this.X[14], 9);
        final int ff6 = this.FF4(n2, ff5, ff4, n, this.X[7], 9);
        final int ff7 = this.FF4(n, ff6, ff5, ff4, this.X[0], 11);
