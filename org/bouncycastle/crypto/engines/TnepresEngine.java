...
public final class TnepresEngine extends SerpentEngineBase
{
    ...
    protected int[] makeWorkingKey(final byte[] array) throws IllegalArgumentException {
        ...
        if (i == 0) {
            ...
            for (int j = 8; j < 16; ++j) {
                array2[j] = SerpentEngineBase.rotateLeft(array2[j - 8] ^ array2[j - 5] ^ array2[j - 3] ^ array2[j - 1] ^ 0x9E3779B9 ^ j - 8, 11);
            }
    ...
    protected void decryptBlock(final byte[] array, final int n, final byte[] array2, final int n2) {
        ...
        this.ib7(this.X0 = (this.wKey[128] ^ Pack.bigEndianToInt(array, n + 12)), this.X1, this.X2, this.X3);
