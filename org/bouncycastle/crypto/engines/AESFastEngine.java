...
public class AESFastEngine implements BlockCipher
{
    ...
    private static int subWord(final int n) {
        return (AESFastEngine.S[n & 0xFF] & 0xFF) | (AESFastEngine.S[n >>> 8 & 0xFF] & 0xFF) << 8 | (AESFastEngine.S[n >>> 16 & 0xFF] & 0xFF) << 16 | (AESFastEngine.S[n >>> 24 & 0xFF] & 0xFF) << 24;
    }
    ...
    private int[][] generateWorkingKey(final byte[] array, final boolean b) {
        ...
        switch (n) {
            case 4: {
                ...
                for (int i = 1; i <= 10; ++i) {
                    littleEndianToInt ^= (subWord(shift(littleEndianToInt4, 8)) ^ AESFastEngine.rcon[i - 1]);
    ...
    private void unpackBlock(final byte[] array, final int n) {
        this.C0 = Pack.littleEndianToInt(array, n);
        this.C1 = Pack.littleEndianToInt(array, n + 4);
        this.C2 = Pack.littleEndianToInt(array, n + 8);
        this.C3 = Pack.littleEndianToInt(array, n + 12);
    }
    
    private void packBlock(final byte[] array, final int n) {
        Pack.intToLittleEndian(this.C0, array, n);
        Pack.intToLittleEndian(this.C1, array, n + 4);
        Pack.intToLittleEndian(this.C2, array, n + 8);
        Pack.intToLittleEndian(this.C3, array, n + 12);
    }
    ...
    private void encryptBlock(final int[][] array) {
        ...
        int n7;
        int n8;
        for (n = (this.C0 ^ array[0][0]), n2 = (this.C1 ^ array[0][1]), n3 = (this.C2 ^ array[0][2]), i = 1, n4 = (this.C3 ^ array[0][3]); i < this.ROUNDS - 1; n8 = (AESFastEngine.T[n4 & 0xFF] ^ AESFastEngine.T[256 + (n >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n2 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n3 >>> 24 & 0xFF)] ^ array[i++][3]), n = (AESFastEngine.T[n5 & 0xFF] ^ AESFastEngine.T[256 + (n6 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n7 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n8 >>> 24 & 0xFF)] ^ array[i][0]), n2 = (AESFastEngine.T[n6 & 0xFF] ^ AESFastEngine.T[256 + (n7 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n8 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n5 >>> 24 & 0xFF)] ^ array[i][1]), n3 = (AESFastEngine.T[n7 & 0xFF] ^ AESFastEngine.T[256 + (n8 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n5 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n6 >>> 24 & 0xFF)] ^ array[i][2]), n4 = (AESFastEngine.T[n8 & 0xFF] ^ AESFastEngine.T[256 + (n5 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n6 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n7 >>> 24 & 0xFF)] ^ array[i++][3])) {
            n5 = (AESFastEngine.T[n & 0xFF] ^ AESFastEngine.T[256 + (n2 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n3 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n4 >>> 24 & 0xFF)] ^ array[i][0]);
            n6 = (AESFastEngine.T[n2 & 0xFF] ^ AESFastEngine.T[256 + (n3 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n4 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n >>> 24 & 0xFF)] ^ array[i][1]);
            n7 = (AESFastEngine.T[n3 & 0xFF] ^ AESFastEngine.T[256 + (n4 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n2 >>> 24 & 0xFF)] ^ array[i][2]);
        }
        final int n9 = AESFastEngine.T[n & 0xFF] ^ AESFastEngine.T[256 + (n2 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n3 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n4 >>> 24 & 0xFF)] ^ array[i][0];
        final int n10 = AESFastEngine.T[n2 & 0xFF] ^ AESFastEngine.T[256 + (n3 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n4 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n >>> 24 & 0xFF)] ^ array[i][1];
        final int n11 = AESFastEngine.T[n3 & 0xFF] ^ AESFastEngine.T[256 + (n4 >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n2 >>> 24 & 0xFF)] ^ array[i][2];
        final int n12 = AESFastEngine.T[n4 & 0xFF] ^ AESFastEngine.T[256 + (n >>> 8 & 0xFF)] ^ AESFastEngine.T[512 + (n2 >>> 16 & 0xFF)] ^ AESFastEngine.T[768 + (n3 >>> 24 & 0xFF)] ^ array[i++][3];
        this.C0 = ((AESFastEngine.S[n9 & 0xFF] & 0xFF) ^ (AESFastEngine.S[n10 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.S[n11 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.S[n12 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[i][0]);
        this.C1 = ((AESFastEngine.S[n10 & 0xFF] & 0xFF) ^ (AESFastEngine.S[n11 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.S[n12 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.S[n9 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[i][1]);
        this.C2 = ((AESFastEngine.S[n11 & 0xFF] & 0xFF) ^ (AESFastEngine.S[n12 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.S[n9 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.S[n10 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[i][2]);
        this.C3 = ((AESFastEngine.S[n12 & 0xFF] & 0xFF) ^ (AESFastEngine.S[n9 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.S[n10 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.S[n11 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[i][3]);
    }
    ...
    private void decryptBlock(final int[][] array) {
        ...
        int n7;
        int n8;
        for (n = (this.C0 ^ array[this.ROUNDS][0]), n2 = (this.C1 ^ array[this.ROUNDS][1]), n3 = (this.C2 ^ array[this.ROUNDS][2]), i = this.ROUNDS - 1, n4 = (this.C3 ^ array[this.ROUNDS][3]); i > 1; n8 = (AESFastEngine.Tinv[n4 & 0xFF] ^ AESFastEngine.Tinv[256 + (n3 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n2 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n >>> 24 & 0xFF)] ^ array[i--][3]), n = (AESFastEngine.Tinv[n5 & 0xFF] ^ AESFastEngine.Tinv[256 + (n8 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n7 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n6 >>> 24 & 0xFF)] ^ array[i][0]), n2 = (AESFastEngine.Tinv[n6 & 0xFF] ^ AESFastEngine.Tinv[256 + (n5 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n8 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n7 >>> 24 & 0xFF)] ^ array[i][1]), n3 = (AESFastEngine.Tinv[n7 & 0xFF] ^ AESFastEngine.Tinv[256 + (n6 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n5 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n8 >>> 24 & 0xFF)] ^ array[i][2]), n4 = (AESFastEngine.Tinv[n8 & 0xFF] ^ AESFastEngine.Tinv[256 + (n7 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n6 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n5 >>> 24 & 0xFF)] ^ array[i--][3])) {
            n5 = (AESFastEngine.Tinv[n & 0xFF] ^ AESFastEngine.Tinv[256 + (n4 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n3 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n2 >>> 24 & 0xFF)] ^ array[i][0]);
            n6 = (AESFastEngine.Tinv[n2 & 0xFF] ^ AESFastEngine.Tinv[256 + (n >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n4 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n3 >>> 24 & 0xFF)] ^ array[i][1]);
            n7 = (AESFastEngine.Tinv[n3 & 0xFF] ^ AESFastEngine.Tinv[256 + (n2 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n4 >>> 24 & 0xFF)] ^ array[i][2]);
        }
        final int n9 = AESFastEngine.Tinv[n & 0xFF] ^ AESFastEngine.Tinv[256 + (n4 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n3 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n2 >>> 24 & 0xFF)] ^ array[1][0];
        final int n10 = AESFastEngine.Tinv[n2 & 0xFF] ^ AESFastEngine.Tinv[256 + (n >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n4 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n3 >>> 24 & 0xFF)] ^ array[1][1];
        final int n11 = AESFastEngine.Tinv[n3 & 0xFF] ^ AESFastEngine.Tinv[256 + (n2 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n4 >>> 24 & 0xFF)] ^ array[1][2];
        final int n12 = AESFastEngine.Tinv[n4 & 0xFF] ^ AESFastEngine.Tinv[256 + (n3 >>> 8 & 0xFF)] ^ AESFastEngine.Tinv[512 + (n2 >>> 16 & 0xFF)] ^ AESFastEngine.Tinv[768 + (n >>> 24 & 0xFF)] ^ array[1][3];
        this.C0 = ((AESFastEngine.Si[n9 & 0xFF] & 0xFF) ^ (AESFastEngine.Si[n12 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.Si[n11 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.Si[n10 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[0][0]);
        this.C1 = ((AESFastEngine.Si[n10 & 0xFF] & 0xFF) ^ (AESFastEngine.Si[n9 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.Si[n12 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.Si[n11 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[0][1]);
        this.C2 = ((AESFastEngine.Si[n11 & 0xFF] & 0xFF) ^ (AESFastEngine.Si[n10 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.Si[n9 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.Si[n12 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[0][2]);
        this.C3 = ((AESFastEngine.Si[n12 & 0xFF] & 0xFF) ^ (AESFastEngine.Si[n11 >>> 8 & 0xFF] & 0xFF) << 8 ^ (AESFastEngine.Si[n10 >>> 16 & 0xFF] & 0xFF) << 16 ^ (AESFastEngine.Si[n9 >>> 24 & 0xFF] & 0xFF) << 24 ^ array[0][3]);
    }
