...
public final class LittleEndianConversions
{
    ...
    public static long OS2LIP(final byte[] array, int n) {
        return (long)(array[n++] & 0xFF) | (long)((array[n++] & 0xFF) << 8) | (long)((array[n++] & 0xFF) << 16) | ((long)array[n++] & 0xFFL) << 24 | ((long)array[n++] & 0xFFL) << 32 | ((long)array[n++] & 0xFFL) << 40 | ((long)array[n++] & 0xFFL) << 48 | ((long)array[n++] & 0xFFL) << 56;
    }
