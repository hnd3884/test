...
public class RainbowPrivateKey extends ASN1Object
{
    ...
    private RainbowPrivateKey(final ASN1Sequence asn1Sequence) {
        ...
        for (int n6 = 0; n6 < n5; ++n6) {
            this.layers[n6] = new Layer(this.vi[n6], this.vi[n6 + 1], RainbowUtil.convertArray(array[n6]), RainbowUtil.convertArray(array2[n6]), RainbowUtil.convertArray(array3[n6]), RainbowUtil.convertArray(array4[n6]));
        }
    }
