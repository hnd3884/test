...
public class XMSSMTPrivateKey extends ASN1Object
{
    ...
    public XMSSMTPrivateKey(final int index, final byte[] array, final byte[] array2, final byte[] array3, final byte[] array4, final byte[] array5) {
        this.index = index;
    ...
    private XMSSMTPrivateKey(final ASN1Sequence asn1Sequence) {
    ...
    public static XMSSMTPrivateKey getInstance(final Object o) {
