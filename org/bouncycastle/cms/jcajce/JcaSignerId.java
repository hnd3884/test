...
{
    public JcaSignerId(final X509Certificate x509Certificate) {
    ...
    public JcaSignerId(final X500Principal x500Principal, final BigInteger bigInteger) {
        super(convertPrincipal(x500Principal), bigInteger);
    }
    
    public JcaSignerId(final X500Principal x500Principal, final BigInteger bigInteger, final byte[] array) {
