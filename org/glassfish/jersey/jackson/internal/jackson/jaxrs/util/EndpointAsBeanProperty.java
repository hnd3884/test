...
public class EndpointAsBeanProperty extends BeanProperty.Std
{
    ...
    public EndpointAsBeanProperty(final PropertyName name, final JavaType type, final Annotation[] annotations) {
        super(name, type, (PropertyName)null, (Annotations)null, (AnnotatedMember)null, PropertyMetadata.STD_OPTIONAL);
    ...
    public BeanProperty.Std withType(final JavaType type) {
        ...
        return new BeanProperty.Std(this._name, type, this._wrapperName, this._contextAnnotations, this._member, this._metadata);
    }
