...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable
{
    ...
    AbstractMapBasedMultimap(final Map<K, Collection<V>> map) {
    ...
    private List<V> wrapList(final K key, final List<V> list, final WrappedCollection ancestor) {
    ...
    {
        WrappedSortedSet(final K key, final SortedSet<V> delegate, final WrappedCollection ancestor) {
    ...
    {
        WrappedNavigableSet(final K key, final NavigableSet<V> delegate, final WrappedCollection ancestor) {
            super(key, delegate, ancestor);
        }
    ...
    {
        WrappedList(final K key, final List<V> delegate, final WrappedCollection ancestor) {
            super(key, delegate, ancestor);
        }
    ...
    {
        RandomAccessWrappedList(final K key, final List<V> delegate, final WrappedCollection ancestor) {
            super(key, delegate, ancestor);
        }
    }
