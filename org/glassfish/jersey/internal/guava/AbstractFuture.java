...
public abstract class AbstractFuture<V> implements ListenableFuture<V>
{
    ...
    private static CancellationException cancellationExceptionWithCause(final Throwable cause) {
        final CancellationException exception = new CancellationException("Task was cancelled.");
    ...
    boolean setException(final Throwable throwable) {
    ...
    static final class Sync<V> extends AbstractQueuedSynchronizer
    {
        ...
        private V getValue() throws CancellationException, ExecutionException {
            ...
            switch (state) {
                ...
                case 4:
                case 8: {
                    throw cancellationExceptionWithCause(this.exception);
                }
                default: {
        ...
        private boolean complete(final V v, final Throwable t, final int finalState) {
