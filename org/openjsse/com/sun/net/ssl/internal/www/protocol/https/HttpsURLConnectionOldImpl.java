...
public class HttpsURLConnectionOldImpl extends HttpsURLConnection
{
    ...
    HttpsURLConnectionOldImpl(final URL u, final Handler handler) throws IOException {
        this(u, null, handler);
    }
    ...
    HttpsURLConnectionOldImpl(final URL u, final Proxy p, final Handler handler) throws IOException {
        super(checkURL(u));
