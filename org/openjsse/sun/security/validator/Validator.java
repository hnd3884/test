...
public abstract class Validator
{
    ...
    public final X509Certificate[] validate(X509Certificate[] chain, final Collection<X509Certificate> otherCerts, final List<byte[]> responseList, final AlgorithmConstraints constraints, final Object parameter) throws CertificateException {
        chain = this.engineValidate(chain, otherCerts, responseList, constraints, parameter);
        if (chain.length > 1) {
