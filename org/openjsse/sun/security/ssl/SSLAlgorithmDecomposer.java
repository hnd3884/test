...
class SSLAlgorithmDecomposer extends AlgorithmDecomposer
{
    ...
    private Set<String> decomposes(final SSLCipher bulkCipher) {
        final Set<String> components = new HashSet<String>();
    ...
    private Set<String> decomposes(final CipherSuite.MacAlg macAlg, final SSLCipher cipher) {
        final Set<String> components = new HashSet<String>();
    ...
    private Set<String> decompose(final CipherSuite.KeyExchange keyExchange, final SSLCipher cipher, final CipherSuite.MacAlg macAlg, final CipherSuite.HashAlg hashAlg) {
        final Set<String> components = new HashSet<String>();
        if (keyExchange != null) {
