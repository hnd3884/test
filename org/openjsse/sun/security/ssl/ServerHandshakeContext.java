...
class ServerHandshakeContext extends HandshakeContext
{
    ...
    ServerHandshakeContext(final SSLContextImpl sslContext, final TransportContext conContext) throws IOException {
        super(sslContext, conContext);
        final long respTimeOut = AccessController.doPrivileged((PrivilegedAction<Long>)new GetLongAction("jdk.tls.stapling.responseTimeout", 5000L));
