...
public final class LongRange extends Range
{
    ...
    public LongRange(final String label, long minIn, final boolean minInclusive, long maxIn, final boolean maxInclusive) {
        super(label);
        this.min = minIn;
        this.max = maxIn;
    ...
    private static class ValueSourceQuery extends Query
    {
        ...
        ValueSourceQuery(final LongRange range, final Query fastMatchQuery, final ValueSource valueSource) {
            this.range = range;
