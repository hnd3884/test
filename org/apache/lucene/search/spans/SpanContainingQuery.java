...
{
    public SpanContainingQuery(final SpanQuery big, final SpanQuery little) {
        super(big, little);
    }
    ...
    public SpanWeight createWeight(final IndexSearcher searcher, final boolean needsScores) throws IOException {
        ...
        return new SpanContainingWeight(searcher, needsScores ? SpanQuery.getTermContexts(bigWeight, littleWeight) : null, bigWeight, littleWeight);
    }
    
    public class SpanContainingWeight extends SpanContainWeight
    {
        public SpanContainingWeight(final IndexSearcher searcher, final Map<Term, TermContext> terms, final SpanWeight bigWeight, final SpanWeight littleWeight) throws IOException {
