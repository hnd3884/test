...
public final class NorwegianAnalyzer extends StopwordAnalyzerBase
{
    ...
    public NorwegianAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public NorwegianAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SnowballFilter(result, new NorwegianStemmer());
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader((Class)SnowballFilter.class, "norwegian_stop.txt", StandardCharsets.UTF_8));
            }
