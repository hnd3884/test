...
public final class FinnishAnalyzer extends StopwordAnalyzerBase
{
    ...
    public FinnishAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public FinnishAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SnowballFilter(result, new FinnishStemmer());
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader((Class)SnowballFilter.class, "finnish_stop.txt", StandardCharsets.UTF_8));
            }
