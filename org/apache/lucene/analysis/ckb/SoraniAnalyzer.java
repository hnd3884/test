...
public final class SoraniAnalyzer extends StopwordAnalyzerBase
{
    ...
    public SoraniAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public SoraniAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SoraniNormalizationFilter(result);
        ...
        result = (TokenStream)new SoraniStemFilter(result);
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getWordSet(IOUtils.getDecodingReader((Class)SoraniAnalyzer.class, "stopwords.txt", StandardCharsets.UTF_8));
            }
