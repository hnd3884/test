...
public final class DanishAnalyzer extends StopwordAnalyzerBase
{
    ...
    public DanishAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public DanishAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SnowballFilter(result, new DanishStemmer());
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = WordlistLoader.getSnowballWordSet(IOUtils.getDecodingReader((Class)SnowballFilter.class, "danish_stop.txt", StandardCharsets.UTF_8));
            }
