...
public final class BasqueAnalyzer extends StopwordAnalyzerBase
{
    ...
    public BasqueAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public BasqueAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SnowballFilter(result, new BasqueStemmer());
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = StopwordAnalyzerBase.loadStopwordSet(false, BasqueAnalyzer.class, "stopwords.txt", "#");
            }
