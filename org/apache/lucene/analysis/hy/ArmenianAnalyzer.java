...
public final class ArmenianAnalyzer extends StopwordAnalyzerBase
{
    ...
    public ArmenianAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public ArmenianAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    protected Analyzer.TokenStreamComponents createComponents(final String fieldName) {
        ...
        result = (TokenStream)new SnowballFilter(result, new ArmenianStemmer());
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = StopwordAnalyzerBase.loadStopwordSet(false, ArmenianAnalyzer.class, "stopwords.txt", "#");
            }
