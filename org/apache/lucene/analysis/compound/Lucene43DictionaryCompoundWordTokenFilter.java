...
{
    public Lucene43DictionaryCompoundWordTokenFilter(final TokenStream input, final CharArraySet dictionary) {
    ...
    public Lucene43DictionaryCompoundWordTokenFilter(final TokenStream input, final CharArraySet dictionary, final int minWordSize, final int minSubwordSize, final int maxSubwordSize, final boolean onlyLongestMatch) {
