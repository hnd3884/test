...
public abstract class Lucene43CompoundWordTokenFilterBase extends TokenFilter
{
    ...
    protected Lucene43CompoundWordTokenFilterBase(final TokenStream input, final CharArraySet dictionary, final boolean onlyLongestMatch) {
        this(input, dictionary, 5, 2, 15, onlyLongestMatch);
    }
    
    protected Lucene43CompoundWordTokenFilterBase(final TokenStream input, final CharArraySet dictionary) {
        this(input, dictionary, 5, 2, 15, false);
    }
    
    protected Lucene43CompoundWordTokenFilterBase(final TokenStream input, final CharArraySet dictionary, final int minWordSize, final int minSubwordSize, final int maxSubwordSize, final boolean onlyLongestMatch) {
        super(input);
    ...
    protected class CompoundToken
    {
        ...
        public CompoundToken(final int offset, final int length) {
            ...
            final int startOff = Lucene43CompoundWordTokenFilterBase.this.offsetAtt.startOffset();
            final int endOff = Lucene43CompoundWordTokenFilterBase.this.offsetAtt.endOffset();
