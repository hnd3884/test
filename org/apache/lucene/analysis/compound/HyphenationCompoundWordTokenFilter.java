...
public class HyphenationCompoundWordTokenFilter extends CompoundWordTokenFilterBase
{
    ...
    public HyphenationCompoundWordTokenFilter(final TokenStream input, final HyphenationTree hyphenator, final CharArraySet dictionary) {
        this(input, hyphenator, dictionary, 5, 2, 15, false);
    }
    
    public HyphenationCompoundWordTokenFilter(final TokenStream input, final HyphenationTree hyphenator, final CharArraySet dictionary, final int minWordSize, final int minSubwordSize, final int maxSubwordSize, final boolean onlyLongestMatch) {
        super(input, dictionary, minWordSize, minSubwordSize, maxSubwordSize, onlyLongestMatch);
        this.hyphenator = hyphenator;
    }
    
    public HyphenationCompoundWordTokenFilter(final TokenStream input, final HyphenationTree hyphenator, final int minWordSize, final int minSubwordSize, final int maxSubwordSize) {
        this(input, hyphenator, null, minWordSize, minSubwordSize, maxSubwordSize, false);
    }
    
    public HyphenationCompoundWordTokenFilter(final TokenStream input, final HyphenationTree hyphenator) {
