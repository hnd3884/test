...
public final class IndonesianAnalyzer extends StopwordAnalyzerBase
{
    ...
    public IndonesianAnalyzer(final CharArraySet stopwords) {
        this(stopwords, CharArraySet.EMPTY_SET);
    }
    
    public IndonesianAnalyzer(final CharArraySet stopwords, final CharArraySet stemExclusionSet) {
        super(stopwords);
    ...
    private static class DefaultSetHolder
    {
        ...
        static {
            try {
                DEFAULT_STOP_SET = StopwordAnalyzerBase.loadStopwordSet(false, IndonesianAnalyzer.class, "stopwords.txt", "#");
            }
