...
public abstract class JavaHexBinaryHolderEx extends JavaHexBinaryHolder
{
    ...
    public JavaHexBinaryHolderEx(final SchemaType type, final boolean complex) {
    ...
    protected void set_text(final String s) {
        ...
        if (this._validateOnSet()) {
            v = JavaHexBinaryHolder.validateLexical(s, this.schemaType(), JavaHexBinaryHolderEx._voorVc);
        }
        else {
            v = JavaHexBinaryHolder.lex(s, JavaHexBinaryHolderEx._voorVc);
        }
    ...
    protected void set_ByteArray(final byte[] v) {
        if (this._validateOnSet()) {
            validateValue(v, this.schemaType(), JavaHexBinaryHolderEx._voorVc);
        }
        super.set_ByteArray(v);
    }
    ...
    protected void validate_simpleval(final String lexical, final ValidationContext ctx) {
        JavaHexBinaryHolder.validateLexical(lexical, this.schemaType(), ctx);
