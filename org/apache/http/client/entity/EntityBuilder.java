...
public class EntityBuilder
{
    ...
    public HttpEntity build() {
        ...
        if (this.text != null) {
            e = (AbstractHttpEntity)new StringEntity(this.text, this.getContentOrDefault(ContentType.DEFAULT_TEXT));
        }
        else if (this.binary != null) {
            e = (AbstractHttpEntity)new ByteArrayEntity(this.binary, this.getContentOrDefault(ContentType.DEFAULT_BINARY));
        }
        else if (this.stream != null) {
            e = (AbstractHttpEntity)new InputStreamEntity(this.stream, -1L, this.getContentOrDefault(ContentType.DEFAULT_BINARY));
        }
        else if (this.parameters != null) {
            e = (AbstractHttpEntity)new UrlEncodedFormEntity(this.parameters, (this.contentType != null) ? this.contentType.getCharset() : null);
        }
        else if (this.serializable != null) {
            e = (AbstractHttpEntity)new SerializableEntity(this.serializable);
            e.setContentType(ContentType.DEFAULT_BINARY.toString());
        }
        else if (this.file != null) {
            e = (AbstractHttpEntity)new FileEntity(this.file, this.getContentOrDefault(ContentType.DEFAULT_BINARY));
        }
        else {
            e = (AbstractHttpEntity)new BasicHttpEntity();
        }
        ...
        if (this.gzipCompress) {
            return (HttpEntity)new GzipCompressingEntity((HttpEntity)e);
        }
        return (HttpEntity)e;
    }
}
