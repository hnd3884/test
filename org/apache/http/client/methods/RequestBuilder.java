...
public class RequestBuilder
{
    ...
    public static RequestBuilder create(final String method) {
        Args.notBlank((CharSequence)method, "HTTP method");
    ...
    public RequestBuilder addParameter(final NameValuePair nvp) {
        Args.notNull((Object)nvp, "Name value pair");
    ...
    public HttpUriRequest build() {
        ...
        if (this.parameters != null && !this.parameters.isEmpty()) {
            if (entityCopy == null && ("POST".equalsIgnoreCase(this.method) || "PUT".equalsIgnoreCase(this.method))) {
                entityCopy = (HttpEntity)new UrlEncodedFormEntity(this.parameters, (this.charset != null) ? this.charset : HTTP.DEF_CONTENT_CHARSET);
            }
            else {
                try {
