...
public class NetscapeDraftHeaderParser
{
    ...
    public HeaderElement parseHeader(final CharArrayBuffer buffer, final ParserCursor cursor) throws ParseException {
        Args.notNull((Object)buffer, "Char array buffer");
        Args.notNull((Object)cursor, "Parser cursor");
        ...
        return (HeaderElement)new BasicHeaderElement(nvp.getName(), nvp.getValue(), (NameValuePair[])params.toArray(new NameValuePair[params.size()]));
    }
    ...
    private NameValuePair parseNameValuePair(final CharArrayBuffer buffer, final ParserCursor cursor) {
        ...
        if (cursor.atEnd()) {
            return (NameValuePair)new BasicNameValuePair(name, (String)null);
        }
