...
public class HttpAuthenticator
{
    ...
    public HttpAuthenticator(final Log log) {
        this.log = ((log != null) ? log : LogFactory.getLog((Class)this.getClass()));
    }
        ...
        if (authScheme != null) {
            try {
                ...
                if (this.log.isErrorEnabled()) {
                    this.log.error((Object)(authScheme + " authentication error: " + ex2.getMessage()));
                }
            }
        }
    }
    ...
    private void ensureAuthScheme(final AuthScheme authScheme) {
        Asserts.notNull((Object)authScheme, "Auth scheme");
    }
