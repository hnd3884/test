...
public class DefaultHttpClient extends AbstractHttpClient
{
    ...
    protected HttpParams createHttpParams() {
        final HttpParams params = (HttpParams)new SyncBasicHttpParams();
    ...
    public static void setDefaultHttpParams(final HttpParams params) {
        ...
        HttpProtocolParams.setUserAgent(params, VersionInfo.getUserAgent("Apache-HttpClient", "org.apache.http.client", (Class)DefaultHttpClient.class));
    }
