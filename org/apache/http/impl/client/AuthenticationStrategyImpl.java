...
abstract class AuthenticationStrategyImpl implements AuthenticationStrategy
{
    ...
    public Queue<AuthOption> select(final Map<String, Header> challenges, final HttpHost authhost, final HttpResponse response, final HttpContext context) throws MalformedChallengeException {
        Args.notNull((Object)challenges, "Map of auth challenges");
        Args.notNull((Object)authhost, "Host");
        Args.notNull((Object)response, "HTTP response");
        ...
        for (final String id : authPrefs) {
            ...
            if (challenge != null) {
                final AuthSchemeProvider authSchemeProvider = (AuthSchemeProvider)registry.lookup(id);
