...
public class HttpClientBuilder
{
    ...
    public CloseableHttpClient build() {
        ...
        if (connManagerCopy == null) {
            ...
            final PoolingHttpClientConnectionManager poolingmgr = new PoolingHttpClientConnectionManager((Registry<ConnectionSocketFactory>)RegistryBuilder.create().register("http", (Object)PlainConnectionSocketFactory.getSocketFactory()).register("https", (Object)sslSocketFactoryCopy).build(), null, null, this.dnsResolver, this.connTimeToLive, (this.connTimeToLiveTimeUnit != null) ? this.connTimeToLiveTimeUnit : TimeUnit.MILLISECONDS);
        ...
        if (reuseStrategyCopy == null) {
            if (this.systemProperties) {
                ...
                if ("true".equalsIgnoreCase(s2)) {
                    reuseStrategyCopy = (ConnectionReuseStrategy)DefaultClientConnectionReuseStrategy.INSTANCE;
                }
                else {
                    reuseStrategyCopy = (ConnectionReuseStrategy)NoConnectionReuseStrategy.INSTANCE;
                }
            }
            else {
                reuseStrategyCopy = (ConnectionReuseStrategy)DefaultClientConnectionReuseStrategy.INSTANCE;
        ...
        if (userAgentCopy == null) {
            ...
            if (userAgentCopy == null && !this.defaultUserAgentDisabled) {
                userAgentCopy = VersionInfo.getUserAgent("Apache-HttpClient", "org.apache.http.client", (Class)this.getClass());
            }
        }
        ClientExecChain execChain = this.createMainExec(requestExecCopy, connManagerCopy, reuseStrategyCopy, keepAliveStrategyCopy, (HttpProcessor)new ImmutableHttpProcessor(new HttpRequestInterceptor[] { (HttpRequestInterceptor)new RequestTargetHost(), (HttpRequestInterceptor)new RequestUserAgent(userAgentCopy) }), targetAuthStrategyCopy, proxyAuthStrategyCopy, userTokenHandlerCopy);
        ...
        if (httpprocessorCopy == null) {
            ...
            if (!this.contentCompressionDisabled) {
                if (this.contentDecoderMap != null) {
                    final RegistryBuilder<InputStreamFactory> b2 = (RegistryBuilder<InputStreamFactory>)RegistryBuilder.create();
                    for (final Map.Entry<String, InputStreamFactory> entry : this.contentDecoderMap.entrySet()) {
                        b2.register((String)entry.getKey(), (Object)entry.getValue());
                    }
