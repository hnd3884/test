...
public class ProxyClient
{
    ...
    public Socket tunnel(final HttpHost proxy, final HttpHost target, final Credentials credentials) throws IOException, HttpException {
        Args.notNull((Object)proxy, "Proxy host");
        Args.notNull((Object)target, "Target host");
        Args.notNull((Object)credentials, "Credentials");
        ...
        final HttpContext context = (HttpContext)new BasicHttpContext();
        final HttpRequest connect = (HttpRequest)new BasicHttpRequest("CONNECT", host.toHostString(), (ProtocolVersion)HttpVersion.HTTP_1_1);
        ...
        while (true) {
            ...
            final HttpResponse response = this.requestExec.execute(connect, (HttpClientConnection)conn, context);
