...
public class NTCredentials implements Credentials, Serializable
{
    ...
    public NTCredentials(final String usernamePassword) {
        Args.notNull((Object)usernamePassword, "Username:password string");
    ...
    public int hashCode() {
        int hash = 17;
        hash = LangUtils.hashCode(hash, (Object)this.principal);
        hash = LangUtils.hashCode(hash, (Object)this.workstation);
        return hash;
    }
