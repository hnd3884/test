...
public class AuthScope
{
    ...
    public AuthScope(final HttpHost origin, final String realm, final String schemeName) {
        Args.notNull((Object)origin, "Host");
    ...
    public AuthScope(final AuthScope authscope) {
        Args.notNull((Object)authscope, "Scope");
    ...
    public int hashCode() {
        int hash = 17;
        hash = LangUtils.hashCode(hash, (Object)this.host);
        hash = LangUtils.hashCode(hash, this.port);
        hash = LangUtils.hashCode(hash, (Object)this.realm);
        hash = LangUtils.hashCode(hash, (Object)this.scheme);
        return hash;
    }
