                ...
                if (PublicSuffixMatcherLoader.DEFAULT_INSTANCE == null) {
                    ...
                    if (url != null) {
                        try {
                            ...
                            final Log log = LogFactory.getLog((Class)PublicSuffixMatcherLoader.class);
                        ...
                        PublicSuffixMatcherLoader.DEFAULT_INSTANCE = new PublicSuffixMatcher(DomainType.ICANN, Arrays.asList("com"), null);
                    }
                }
            }
        }
