...
public final class HttpRoute implements RouteInfo, Cloneable
{
    ...
    public HttpRoute(final HttpHost target, final InetAddress local, final HttpHost proxy, final boolean secure) {
        this(target, local, Collections.singletonList(Args.notNull((Object)proxy, "Proxy host")), secure, secure ? TunnelType.TUNNELLED : TunnelType.PLAIN, secure ? LayerType.LAYERED : LayerType.PLAIN);
    }
    ...
    public final int hashCode() {
        int hash = 17;
        hash = LangUtils.hashCode(hash, (Object)this.targetHost);
        hash = LangUtils.hashCode(hash, (Object)this.localAddress);
