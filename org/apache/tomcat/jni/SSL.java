...
public final class SSL
{
    ...
    public static native int renegotiatePending(final long p0);
    
    public static native int verifyClientPostHandshake(final long p0);
    
    public static native int getPostHandshakeAuthInProgress(final long p0);
