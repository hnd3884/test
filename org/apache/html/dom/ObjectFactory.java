...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$html$dom$ObjectFactory;
            if (ObjectFactory.class$org$apache$html$dom$ObjectFactory == null) {
                class$org$apache$html$dom$ObjectFactory = (ObjectFactory.class$org$apache$html$dom$ObjectFactory = (class$ = class$("org.apache.html.dom.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$html$dom$ObjectFactory = ObjectFactory.class$org$apache$html$dom$ObjectFactory);
            }
            final Class clazz = class$org$apache$html$dom$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
