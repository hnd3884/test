...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$xerces$xinclude$ObjectFactory;
            if (ObjectFactory.class$org$apache$xerces$xinclude$ObjectFactory == null) {
                class$org$apache$xerces$xinclude$ObjectFactory = (ObjectFactory.class$org$apache$xerces$xinclude$ObjectFactory = (class$ = class$("org.apache.xerces.xinclude.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$xerces$xinclude$ObjectFactory = ObjectFactory.class$org$apache$xerces$xinclude$ObjectFactory);
            }
            final Class clazz = class$org$apache$xerces$xinclude$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
