...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$xerces$parsers$ObjectFactory;
            if (ObjectFactory.class$org$apache$xerces$parsers$ObjectFactory == null) {
                class$org$apache$xerces$parsers$ObjectFactory = (ObjectFactory.class$org$apache$xerces$parsers$ObjectFactory = (class$ = class$("org.apache.xerces.parsers.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$xerces$parsers$ObjectFactory = ObjectFactory.class$org$apache$xerces$parsers$ObjectFactory);
            }
            final Class clazz = class$org$apache$xerces$parsers$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
