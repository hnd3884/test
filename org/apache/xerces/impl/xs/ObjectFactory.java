...
final class ObjectFactory
{
    ...
    static /* synthetic */ Class class$org$apache$xerces$impl$xs$ObjectFactory;
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$xerces$impl$xs$ObjectFactory;
            if (ObjectFactory.class$org$apache$xerces$impl$xs$ObjectFactory == null) {
                class$org$apache$xerces$impl$xs$ObjectFactory = (ObjectFactory.class$org$apache$xerces$impl$xs$ObjectFactory = (class$ = class$("org.apache.xerces.impl.xs.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$xerces$impl$xs$ObjectFactory = ObjectFactory.class$org$apache$xerces$impl$xs$ObjectFactory);
            }
            final Class clazz = class$org$apache$xerces$impl$xs$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
