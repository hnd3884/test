...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$xerces$dom$ObjectFactory;
            if (ObjectFactory.class$org$apache$xerces$dom$ObjectFactory == null) {
                class$org$apache$xerces$dom$ObjectFactory = (ObjectFactory.class$org$apache$xerces$dom$ObjectFactory = (class$ = class$("org.apache.xerces.dom.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$xerces$dom$ObjectFactory = ObjectFactory.class$org$apache$xerces$dom$ObjectFactory);
            }
            final Class clazz = class$org$apache$xerces$dom$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
