...
public class FunctionUtils
{
    ...
    public static double[] sample(final UnivariateFunction f, final double min, final double max, final int n) throws NumberIsTooLargeException, NotStrictlyPositiveException {
        if (n <= 0) {
