...
import org.apache.axiom.core.CoreCDATASectionSupport;
...
public class CDATASectionImpl extends OMTextImpl implements AxiomCDATASection
{
    ...
    public final NodeType coreGetNodeType() {
        return CoreCDATASectionSupport.ajc$interMethod$org_apache_axiom_core_CoreCDATASectionSupport$org_apache_axiom_core_CoreCDATASection$coreGetNodeType(this);
    }
    ...
    public final int getType() {
        return AxiomCDATASectionSupport.ajc$interMethod$org_apache_axiom_om_impl_common_AxiomCDATASectionSupport$org_apache_axiom_om_impl_intf_AxiomCDATASection$getType(this);
    }
    
    public final <T> void init(final ClonePolicy<T> policy, final T options, final CoreNode other) {
        CoreCDATASectionSupport.ajc$interMethod$org_apache_axiom_core_CoreCDATASectionSupport$org_apache_axiom_core_CoreCDATASection$init(this, policy, options, other);
    }
