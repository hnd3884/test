...
public class QueryTag extends QueryTagSupport
{
    ...
    public void setStartRow(final String startRowEL) {
        this.startRowEL = startRowEL;
    }
    
    public void setMaxRows(final String maxRowsEL) {
    ...
    private void evaluateExpressions() throws JspException {
        ...
        if (this.startRowEL != null) {
            tempInt = (Integer)ExpressionEvaluatorManager.evaluate("startRow", this.startRowEL, Integer.class, (Tag)this, this.pageContext);
            if (tempInt != null) {
                this.startRow = tempInt;
            }
        }
        if (this.maxRowsEL != null) {
            tempInt = (Integer)ExpressionEvaluatorManager.evaluate("maxRows", this.maxRowsEL, Integer.class, (Tag)this, this.pageContext);
            if (tempInt != null) {
