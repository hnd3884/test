...
public class XMLSecurityException extends Exception
{
    ...
    public XMLSecurityException(final Exception originalException) {
    ...
    public XMLSecurityException(final String msgID, final Exception originalException) {
    ...
    public XMLSecurityException(final String msgID, final Object[] array, final Exception originalException) {
        super(MessageFormat.format(I18n.getExceptionMessage(msgID), array));
        this.originalException = null;
        this.msgID = msgID;
        this.originalException = originalException;
