...
final class ObjectFactory
{
    ...
    static Object createObject(final String s, String string, final String s2) throws ConfigurationError {
        ...
        if (string == null) {
            ...
            Class class$;
            Class class$org$apache$xml$serialize$ObjectFactory;
            if (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory == null) {
                class$org$apache$xml$serialize$ObjectFactory = (ObjectFactory.class$org$apache$xml$serialize$ObjectFactory = (class$ = class$("org.apache.xml.serialize.ObjectFactory")));
            }
            else {
                class$ = (class$org$apache$xml$serialize$ObjectFactory = ObjectFactory.class$org$apache$xml$serialize$ObjectFactory);
            }
            final Class clazz = class$org$apache$xml$serialize$ObjectFactory;
            synchronized (class$) {
                boolean b = false;
