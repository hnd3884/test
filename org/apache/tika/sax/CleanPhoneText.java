...
public class CleanPhoneText
{
    ...
    public static ArrayList<String> extractPhoneNumbers(String text) {
        text = clean(text);
        int idx = 0;
        final Pattern p = Pattern.compile("([2-9]\\d{2}[2-9]\\d{6})");
    ...
    public static String clean(String text) {
        ...
        for (final String[][] array : CleanPhoneText.cleanSubstitutions) {
            final String[][] group = array;
            for (final String[] sub : array) {
