    ...
    public static class ChannelTypePropertyConverter
    {
        ...
        public static String convert(final Object value) {
            ...
            if (value instanceof Integer) {
                final int channelCount = (int)value;
                if (channelCount == 1) {
                    return "Mono";
                }
                if (channelCount == 2) {
        ...
        public static void convertAndSet(final Metadata metadata, final Object value) {
            if (value instanceof Integer || value instanceof Long) {
                metadata.set(ChannelTypePropertyConverter.property, convert(value));
            }
            if (value instanceof Date) {
                metadata.set(ChannelTypePropertyConverter.property, (Date)value);
            }
            if (value instanceof String) {
                metadata.set(ChannelTypePropertyConverter.property, (String)value);
            }
        }
