...
public enum FormulaError
{
    ...
    public static boolean isValidCode(final int errorCode) {
    ...
    public static FormulaError forInt(final byte type) throws IllegalArgumentException {
    ...
    public static FormulaError forInt(final int type) throws IllegalArgumentException {
    ...
    public static FormulaError forString(final String code) throws IllegalArgumentException {
