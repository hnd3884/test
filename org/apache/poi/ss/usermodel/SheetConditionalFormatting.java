...
public interface SheetConditionalFormatting
{
    ...
    ConditionalFormattingRule createConditionalFormattingRule(final ExtendedColor p0);
    
    ConditionalFormattingRule createConditionalFormattingRule(final IconMultiStateFormatting.IconSet p0);
