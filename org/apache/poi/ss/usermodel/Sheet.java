...
public interface Sheet extends Iterable<Row>
{
    ...
    int addMergedRegionUnsafe(final CellRangeAddress p0);
    ...
    void removeMergedRegions(final Collection<Integer> p0);
    ...
    void setPrintRowAndColumnHeadings(final boolean p0);
    ...
    void shiftColumns(final int p0, final int p1, final int p2);
    ...
    Comment getCellComment(final CellAddress p0);
    ...
    Hyperlink getHyperlink(final int p0, final int p1);
    
    Hyperlink getHyperlink(final CellAddress p0);
    
    List<? extends Hyperlink> getHyperlinkList();
    
    CellAddress getActiveCell();
    
    void setActiveCell(final CellAddress p0);
}
