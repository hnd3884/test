...
public abstract class AreaPtgBase extends OperandPtg implements AreaI
{
    ...
    protected AreaPtgBase(final AreaPtgBase other) {
        super(other);
    ...
    public void sortTopLeftToBottomRight() {
        if (this.getFirstRow() > this.getLastRow()) {
            final int firstRow = this.getFirstRow();
            final boolean firstRowRel = this.isFirstRowRelative();
        ...
        if (this.getFirstColumn() > this.getLastColumn()) {
            final int firstCol = this.getFirstColumn();
            final boolean firstColRel = this.isFirstColRelative();
