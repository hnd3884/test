...
public final class ArrayPtg extends Ptg
{
    ...
    ArrayPtg(final int reserved0, final int reserved1, final int reserved2, final int nColumns, final int nRows, final Object[] arrayValues) {
        ...
        this._nRows = nRows;
        this._arrayValues = arrayValues.clone();
    }
    
    public ArrayPtg(final ArrayPtg other) {
        ...
        this._arrayValues = (Object[])((other._arrayValues == null) ? null : ((Object[])other._arrayValues.clone()));
    }
    ...
    public String toString() {
        final StringBuilder sb = new StringBuilder("[ArrayPtg]\n");
