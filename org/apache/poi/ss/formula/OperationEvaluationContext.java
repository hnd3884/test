...
public final class OperationEvaluationContext
{
    ...
    public OperationEvaluationContext(final WorkbookEvaluator bookEvaluator, final EvaluationWorkbook workbook, final int sheetIndex, final int srcRowNum, final int srcColNum, final EvaluationTracker tracker, final boolean isSingleValue) {
    ...
    public void setArrayMode(final boolean value) {
    ...
    SheetRangeEvaluator createExternSheetRefEvaluator(final EvaluationWorkbook.ExternalSheet externalSheet) {
        ...
        if (externalSheet == null || externalSheet.getWorkbookName() == null) {
            ...
            catch (final CollaboratingWorkbooksEnvironment.WorkbookNotFoundException e) {
    ...
    public ValueEval getDynamicReference(final String workbookName, final String sheetName, final String refStrPart1, final String refStrPart2, final boolean isA1Style) {
        ...
        final SpreadsheetVersion ssVersion = this._workbook.getSpreadsheetVersion();
        ...
        switch (part1refType) {
            ...
            case NAMED_RANGE: {
                final EvaluationName nm = this._workbook.getName(refStrPart1, this._sheetIndex);
                if (!nm.isRange()) {
    ...
    public ValueEval getAreaValueEval(final int firstRowIndex, final int firstColumnIndex, final int lastRowIndex, final int lastColumnIndex, final Object[][] tokens) {
        final ValueEval[] values = new ValueEval[tokens.length * tokens[0].length];
        int index = 0;
    ...
    private ValueEval convertObjectEval(final Object token) {
        if (token == null) {
    ...
    private ValueEval getExternalNameXEval(final EvaluationWorkbook.ExternalName externName, final String workbookName) {
        ...
        catch (final CollaboratingWorkbooksEnvironment.WorkbookNotFoundException wnfe) {
            return ErrorEval.REF_INVALID;
        }
    }
