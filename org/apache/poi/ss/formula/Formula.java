...
public class Formula
{
    ...
    public Formula(final Formula other) {
        this._byteEncoding = (byte[])((other._byteEncoding == null) ? null : ((byte[])other._byteEncoding.clone()));
        this._encodedTokenLen = other._encodedTokenLen;
    }
    
    private Formula(final byte[] byteEncoding, final int encodedTokenLen) {
        this._byteEncoding = byteEncoding.clone();
    ...
    public static Formula read(final int encodedTokenLen, final LittleEndianInput in, final int totalEncodedLen) {
        final byte[] byteEncoding = IOUtils.safelyAllocate(totalEncodedLen, 100000);
