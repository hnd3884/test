...
public final class Counta implements Function
{
    ...
    private static final CountUtils.I_MatchPredicate subtotalVisibleOnlyPredicate;
    ...
    public static Counta subtotalInstance(final boolean includeHiddenRows) {
        return new Counta(includeHiddenRows ? Counta.subtotalPredicate : Counta.subtotalVisibleOnlyPredicate);
    }
    ...
    static {
        ...
        subtotalVisibleOnlyPredicate = new CountUtils.I_MatchAreaPredicate() {
            @Override
            public boolean matches(final ValueEval valueEval) {
                return Counta.defaultPredicate.matches(valueEval);
            }
