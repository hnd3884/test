...
public final class Count implements Function
{
    ...
    public static Count subtotalInstance(final boolean includeHiddenRows) {
        return new Count(includeHiddenRows ? Count.subtotalPredicate : Count.subtotalVisibleOnlyPredicate);
    }
