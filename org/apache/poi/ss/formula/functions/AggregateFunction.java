...
public abstract class AggregateFunction extends MultiOperandNumericFunction
{
    ...
    static Function subtotalInstance(final Function func, final boolean countHiddenRows) {
    ...
    private static final class LargeSmall extends Fixed2ArgFunction
    {
        ...
        public ValueEval evaluate(final int srcRowIndex, final int srcColumnIndex, final ValueEval arg0, final ValueEval arg1) {
            ...
            catch (final EvaluationException e1) {
    ...
    {
        Product() {
            this.setMissingArgPolicy(Policy.SKIP);
        }
    ...
    {
        Geomean() {
            this.setMissingArgPolicy(Policy.COERCE);
        }
