...
public abstract class NumericFunction implements Function
{
    ...
    protected static double singleOperandEvaluate(final ValueEval arg, final int srcRowIndex, final int srcColumnIndex) throws EvaluationException {
        if (arg == null) {
    ...
    public static void checkValue(final double result) throws EvaluationException {
    ...
    private static final class Log extends Var1or2ArgFunction
    {
        ...
        public ValueEval evaluate(final int srcRowIndex, final int srcColumnIndex, final ValueEval arg0, final ValueEval arg1) {
            ...
            try {
                ...
                if (Double.compare(d2, 2.718281828459045) == 0) {
                    result = logE;
                }
                else {
                    result = logE / Math.log(d2);
                }
                NumericFunction.checkValue(result);
            }
            catch (final EvaluationException e) {
