...
public class Rate implements Function
{
    ...
    public ValueEval evaluate(final ValueEval[] args, final int srcRowIndex, final int srcColumnIndex) {
        ...
        try {
            ...
            Rate.LOG.log(7, "Can't evaluate rate function", e);
    ...
    static void checkValue(final double result) throws EvaluationException {
    ...
    static {
        LOG = POILogFactory.getLogger(Rate.class);
    }
}
