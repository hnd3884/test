        ...
        switch (args.length) {
            ...
            case 4: {
                ...
                if (arg3 == MissingArgEval.instance) {
                    arg3 = FinanceFunction.DEFAULT_ARG3;
                }
                return this.evaluate(srcRowIndex, srcColumnIndex, args[0], args[1], args[2], arg3, FinanceFunction.DEFAULT_ARG4);
            }
            case 5: {
                ValueEval arg3 = args[3];
                if (arg3 == MissingArgEval.instance) {
                ...
                if (arg4 == MissingArgEval.instance) {
                    arg4 = FinanceFunction.DEFAULT_ARG4;
                }
