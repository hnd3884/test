...
final class EvaluationTracker
{
    ...
    public void acceptPlainValueDependency(final EvaluationWorkbook evalWorkbook, final int bookIndex, final int sheetIndex, final int rowIndex, final int columnIndex, final ValueEval value) {
        final int prevFrameIndex = this._evaluationFrames.size() - 1;
        if (prevFrameIndex >= 0) {
            final CellEvaluationFrame consumingFrame = this._evaluationFrames.get(prevFrameIndex);
