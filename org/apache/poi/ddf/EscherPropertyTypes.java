...
public enum EscherPropertyTypes
{
    ...
    private EscherPropertyTypes(final int propNumber, final String name) {
        this(propNumber, name, EscherPropertyTypesHolder.UNKNOWN);
    }
    
    private EscherPropertyTypes(final int propNumber, final String propName, final EscherPropertyTypesHolder holder) {
    ...
    public static EscherPropertyTypes forPropertyID(final int propertyId) {
        final EscherPropertyTypes rt = EscherPropertyTypes.LOOKUP.get((short)(propertyId & 0x3FFF));
        return (rt != null) ? rt : EscherPropertyTypes.UNKNOWN;
    }
    
    static {
        LOOKUP = Stream.of(values()).collect(Collectors.toMap((Function<? super EscherPropertyTypes, ? extends Short>)EscherPropertyTypes::getPropertyId, (Function<? super EscherPropertyTypes, ? extends EscherPropertyTypes>)Function.identity()));
    }
}
