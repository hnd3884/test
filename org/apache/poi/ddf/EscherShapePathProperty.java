...
public class EscherShapePathProperty extends EscherSimpleProperty
{
    ...
    public EscherShapePathProperty(final short propertyNumber, final int shapePath) {
        super(propertyNumber, false, false, shapePath);
    }
    
    public EscherShapePathProperty(final EscherPropertyTypes type, final int shapePath) {
