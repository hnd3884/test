...
public class POIFSViewEngine
{
    ...
    private static String indent(final int indentLevel, final String indentString, final String data) {
        ...
        final StringBuilder indentPrefix = new StringBuilder();
        ...
        try {
            for (String line = reader.readLine(); line != null; line = reader.readLine()) {
                finalBuffer.append((CharSequence)indentPrefix).append(line).append(POIFSViewEngine._EOL);
            }
        }
        catch (final IOException e) {
            finalBuffer.append((CharSequence)indentPrefix).append(e.getMessage()).append(POIFSViewEngine._EOL);
        }
