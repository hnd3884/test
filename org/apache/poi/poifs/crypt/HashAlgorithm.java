...
public enum HashAlgorithm
{
    ...
    private HashAlgorithm(final String jceId, final int ecmaId, final String ecmaString, final int hashSize, final String jceHmacId, final boolean needsBouncyCastle, final String rsaOid) {
        this.jceId = jceId;
        this.ecmaId = ecmaId;
