...
public final class TickRecord extends StandardRecord
{
    ...
    private static final BitField autoTextColor;
    private static final BitField autoTextBackground;
    private static final BitField rotation;
    private static final BitField autorotate;
    ...
    public TickRecord(final TickRecord other) {
        super(other);
    ...
    public TickRecord(final RecordInputStream in) {
    ...
    public void setMajorTickType(final byte field_1_majorTickType) {
    ...
    public void setMinorTickType(final byte field_2_minorTickType) {
    ...
    public void setLabelPosition(final byte field_3_labelPosition) {
    ...
    public void setBackground(final byte field_4_background) {
    ...
    public void setLabelColorRgb(final int field_5_labelColorRgb) {
    ...
    public void setZero1(final int field_6_zero1) {
    ...
    public void setZero2(final int field_7_zero2) {
    ...
    public void setOptions(final short field_10_options) {
    ...
    public void setTickColor(final short field_11_tickColor) {
    ...
    public void setZero3(final short field_12_zero3) {
        this.field_12_zero5 = field_12_zero3;
    }
    
    public void setAutoTextColor(final boolean value) {
        this.field_10_options = TickRecord.autoTextColor.setShortBoolean(this.field_10_options, value);
    }
    
    public boolean isAutoTextColor() {
        return TickRecord.autoTextColor.isSet(this.field_10_options);
    }
    
    public void setAutoTextBackground(final boolean value) {
        this.field_10_options = TickRecord.autoTextBackground.setShortBoolean(this.field_10_options, value);
    }
    
    public boolean isAutoTextBackground() {
        return TickRecord.autoTextBackground.isSet(this.field_10_options);
    }
    
    public void setRotation(final short value) {
        this.field_10_options = TickRecord.rotation.setShortValue(this.field_10_options, value);
    }
    
    public short getRotation() {
        return TickRecord.rotation.getShortValue(this.field_10_options);
    }
    
    public void setAutorotate(final boolean value) {
        this.field_10_options = TickRecord.autorotate.setShortBoolean(this.field_10_options, value);
    }
    
    public boolean isAutorotate() {
        return TickRecord.autorotate.isSet(this.field_10_options);
    }
    
    static {
        autoTextColor = BitFieldFactory.getInstance(1);
        autoTextBackground = BitFieldFactory.getInstance(2);
        rotation = BitFieldFactory.getInstance(28);
        autorotate = BitFieldFactory.getInstance(32);
    }
}
