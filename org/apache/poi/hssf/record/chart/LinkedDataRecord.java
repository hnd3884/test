...
public final class LinkedDataRecord extends StandardRecord
{
    ...
    public LinkedDataRecord(final LinkedDataRecord other) {
        super(other);
    ...
    public LinkedDataRecord(final RecordInputStream in) {
    ...
    public String toString() {
        ...
        final Ptg[] ptgs = this.field_5_formulaOfLink.getTokens();
    ...
    public void setLinkType(final byte field_1_linkType) {
    ...
    public void setReferenceType(final byte field_2_referenceType) {
    ...
    public void setOptions(final short field_3_options) {
    ...
    public void setIndexNumberFmtRecord(final short field_4_indexNumberFmtRecord) {
    ...
    public void setFormulaOfLink(final Ptg[] ptgs) {
        this.field_5_formulaOfLink = Formula.create(ptgs);
    }
    
    public void setCustomNumberFormat(final boolean value) {
        this.field_3_options = LinkedDataRecord.customNumberFormat.setShortBoolean(this.field_3_options, value);
    }
    
    public boolean isCustomNumberFormat() {
        return LinkedDataRecord.customNumberFormat.isSet(this.field_3_options);
    }
    
    static {
        customNumberFormat = BitFieldFactory.getInstance(1);
    }
}
