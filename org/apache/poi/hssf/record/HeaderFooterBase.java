...
public abstract class HeaderFooterBase extends StandardRecord
{
    ...
    protected HeaderFooterBase(final String text) {
        this.setText(text);
    }
    
    protected HeaderFooterBase(final HeaderFooterBase other) {
        super(other);
        this.field_2_hasMultibyte = other.field_2_hasMultibyte;
        this.field_3_text = other.field_3_text;
    }
    
    protected HeaderFooterBase(final RecordInputStream in) {
        if (in.remaining() > 0) {
            final int field_1_footer_len = in.readShort();
