...
public final class ExtendedPivotTableViewFieldsRecord extends StandardRecord
{
    ...
    public ExtendedPivotTableViewFieldsRecord(final ExtendedPivotTableViewFieldsRecord other) {
        super(other);
    ...
    public ExtendedPivotTableViewFieldsRecord(final RecordInputStream in) {
        ...
        switch (in.remaining()) {
            ...
            case 10: {
                final int cchSubName = in.readUShort();
