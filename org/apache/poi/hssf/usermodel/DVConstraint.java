...
public class DVConstraint implements DataValidationConstraint
{
    ...
    private DVConstraint(final int validationType, final int comparisonOperator, final String formulaA, final String formulaB, final Double value1, final Double value2, final String[] explicitListValues) {
        ...
        this._value1 = value1;
        this._value2 = value2;
        this._explicitListValues = (String[])((explicitListValues == null) ? null : ((String[])explicitListValues.clone()));
    }
    
    private DVConstraint(final String listFormula, final String[] explicitListValues) {
    ...
    private Ptg[] createListFormula(final HSSFSheet sheet) {
        ...
        final StringBuilder sb = new StringBuilder(this._explicitListValues.length * 16);
    ...
    static final class FormulaPair
    {
        ...
        FormulaPair(final Ptg[] formula1, final Ptg[] formula2) {
            this._formula1 = (Ptg[])((formula1 == null) ? null : ((Ptg[])formula1.clone()));
            this._formula2 = (Ptg[])((formula2 == null) ? null : ((Ptg[])formula2.clone()));
        }
