...
public class HSSFPatternFormatting implements PatternFormatting
{
    ...
    protected HSSFPatternFormatting(final CFRuleBase cfRuleRecord, final HSSFWorkbook workbook) {
    ...
    public void setFillBackgroundColor(final Color bg) {
        final HSSFColor hcolor = HSSFColor.toHSSFColor(bg);
        if (hcolor == null) {
    ...
    public void setFillForegroundColor(final Color fg) {
        final HSSFColor hcolor = HSSFColor.toHSSFColor(fg);
        if (hcolor == null) {
