...
public final class HSSFClientAnchor extends HSSFAnchor implements ClientAnchor
{
    ...
    public HSSFClientAnchor(final int dx1, final int dy1, final int dx2, final int dy2, final short col1, final int row1, final short col2, final int row2) {
        ...
        this.checkRange(col1, 0, HSSFClientAnchor.MAX_COL, "col1");
        this.checkRange(col2, 0, HSSFClientAnchor.MAX_COL, "col2");
        this.checkRange(row1, 0, HSSFClientAnchor.MAX_ROW, "row1");
        this.checkRange(row2, 0, HSSFClientAnchor.MAX_ROW, "row2");
    ...
    public void setAnchor(final short col1, final int row1, final int x1, final int y1, final short col2, final int row2, final int x2, final int y2) {
        ...
        this.checkRange(this.getCol1(), 0, HSSFClientAnchor.MAX_COL, "col1");
        this.checkRange(this.getCol2(), 0, HSSFClientAnchor.MAX_COL, "col2");
        this.checkRange(this.getRow1(), 0, HSSFClientAnchor.MAX_ROW, "row1");
        this.checkRange(this.getRow2(), 0, HSSFClientAnchor.MAX_ROW, "row2");
        this.setCol1(col1);
        this.setRow1(row1);
        this.setDx1(x1);
        this.setDy1(y1);
