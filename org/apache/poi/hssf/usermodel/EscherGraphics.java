...
public class EscherGraphics extends Graphics
{
    ...
    private HSSFFont matchFont(final Font matchFont) {
        ...
        final boolean bold = (matchFont.getStyle() & 0x1) != 0x0;
        final boolean italic = (matchFont.getStyle() & 0x2) != 0x0;
    ...
    static {
        logger = POILogFactory.getLogger(EscherGraphics.class);
    }
}
