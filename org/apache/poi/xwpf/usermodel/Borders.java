...
public enum Borders
{
    ...
    private Borders(final int val) {
        this.value = val;
    }
    
    public static Borders valueOf(final int type) {
        final Borders pBorder = Borders.imap.get(type);
        if (pBorder == null) {
    ...
    static {
        Borders.imap = new HashMap<Integer, Borders>();
        for (final Borders p : values()) {
            Borders.imap.put(p.getValue(), p);
        }
    }
}
