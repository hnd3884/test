...
public class PropertyIDMap implements Map<Long, String>
{
    ...
    private PropertyIDMap(final Object[][] idValues) {
        final Map<Long, String> m = new HashMap<Long, String>(idValues.length);
        for (final Object[] idValue : idValues) {
            m.put((Long)idValue[0], (String)idValue[1]);
        }
        this.idMap = Collections.unmodifiableMap((Map<? extends Long, ? extends String>)m);
    }
    
    public static synchronized PropertyIDMap getSummaryInformationProperties() {
        if (PropertyIDMap.summaryInformationProperties == null) {
            PropertyIDMap.summaryInformationProperties = new PropertyIDMap(PropertyIDMap.summaryInformationIdValues);
        }
    ...
    public static synchronized PropertyIDMap getDocumentSummaryInformationProperties() {
        if (PropertyIDMap.documentSummaryInformationProperties == null) {
            PropertyIDMap.documentSummaryInformationProperties = new PropertyIDMap(PropertyIDMap.documentSummaryInformationIdValues);
        }
        return PropertyIDMap.documentSummaryInformationProperties;
    }
    
    public static synchronized PropertyIDMap getFallbackProperties() {
        if (PropertyIDMap.fallbackProperties == null) {
            PropertyIDMap.fallbackProperties = new PropertyIDMap(PropertyIDMap.fallbackIdValues);
        }
        return PropertyIDMap.fallbackProperties;
    }
    ...
    public static void main(final String[] args) {
        final PropertyIDMap s1 = getSummaryInformationProperties();
        final PropertyIDMap s2 = getDocumentSummaryInformationProperties();
