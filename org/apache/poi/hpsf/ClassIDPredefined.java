...
public enum ClassIDPredefined
{
    ...
    EXCEL_V3_CHART("{00030001-0000-0000-C000-000000000046}", (String)null, (String)null), 
    EXCEL_V3_MACRO("{00030002-0000-0000-C000-000000000046}", (String)null, (String)null), 
    EXCEL_V7("{00020810-0000-0000-C000-000000000046}", ".xls", "application/vnd.ms-excel"), 
    EXCEL_V7_WORKBOOK("{00020841-0000-0000-C000-000000000046}", (String)null, (String)null), 
    EXCEL_V7_CHART("{00020811-0000-0000-C000-000000000046}", (String)null, (String)null), 
    EXCEL_V8("{00020820-0000-0000-C000-000000000046}", ".xls", "application/vnd.ms-excel"), 
    EXCEL_V8_CHART("{00020821-0000-0000-C000-000000000046}", (String)null, (String)null), 
    ...
    EXCEL_V14_WORKBOOK("{000208D5-0000-0000-C000-000000000046}", (String)null, (String)null), 
    EXCEL_V14_CHART("{00024505-0014-0000-C000-000000000046}", (String)null, (String)null), 
    ...
    POWERPOINT_V7_SLIDE("{EA7BAE71-FB3B-11CD-A903-00AA00510EA3}", (String)null, (String)null), 
    ...
    EQUATION_V3("{0002CE02-0000-0000-C000-000000000046}", (String)null, (String)null), 
    PDF("{B801CA65-A1FC-11D0-85AD-444553540000}", ".pdf", "application/pdf"), 
    TXT_ONLY("{5e941d80-bf96-11cd-b579-08002b30bfeb}", ".txt", "text/plain"), 
    PAINT("{0003000A-0000-0000-C000-000000000046}", (String)null, (String)null), 
    STD_MONIKER("{79EAC9D0-BAF9-11CE-8C82-00AA004BA90B}", (String)null, (String)null), 
    URL_MONIKER("{79EAC9E0-BAF9-11CE-8C82-00AA004BA90B}", (String)null, (String)null), 
    FILE_MONIKER("{00000303-0000-0000-C000-000000000046}", (String)null, (String)null), 
    DOC_SUMMARY("{D5CDD502-2E9C-101B-9397-08002B2CF9AE}", (String)null, (String)null), 
    USER_PROPERTIES("{D5CDD505-2E9C-101B-9397-08002B2CF9AE}", (String)null, (String)null), 
    SUMMARY_PROPERTIES("{F29F85E0-4FF9-1068-AB91-08002B27B3D9}", (String)null, (String)null);
    ...
    private ClassIDPredefined(final String externalForm, final String fileExtension, final String contentType) {
    ...
    public static ClassIDPredefined lookup(final String externalForm) {
        return ClassIDPredefined.LOOKUP.get(externalForm);
    }
    
    public static ClassIDPredefined lookup(final ClassID classID) {
        return (classID == null) ? null : ClassIDPredefined.LOOKUP.get(classID.toString());
    }
    
    public boolean equals(final ClassID classID) {
        return this.getClassID().equals(classID);
    }
    
    static {
        LOOKUP = new HashMap<String, ClassIDPredefined>();
        for (final ClassIDPredefined p : values()) {
            ClassIDPredefined.LOOKUP.put(p.externalForm, p);
        }
    }
}
