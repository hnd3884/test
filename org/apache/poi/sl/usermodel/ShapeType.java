...
public enum ShapeType
{
    ...
    NON_ISOSCELES_TRAPEZOID(9, -1, (String)null), 
    PENTAGON(10, 56, "Pentagon"), 
    HEXAGON(11, 9, "Hexagon"), 
    HEPTAGON(12, -1, (String)null), 
    OCTAGON(13, 10, "Octagon"), 
    DECAGON(14, -1, (String)null), 
    DODECAGON(15, -1, (String)null), 
    STAR_4(16, 187, "Star4"), 
    STAR_5(17, 12, "Star"), 
    STAR_6(18, -1, (String)null), 
    STAR_7(19, -1, (String)null), 
    STAR_8(20, 58, "Star8"), 
    STAR_10(21, -1, (String)null), 
    STAR_12(22, -1, (String)null), 
    STAR_16(23, 59, "Star16"), 
    SEAL(23, 18, "Seal"), 
    STAR_24(24, 92, "Star24"), 
    STAR_32(25, 60, "Star32"), 
    ROUND_RECT(26, 2, "RoundRectangle"), 
    ROUND_1_RECT(27, -1, (String)null), 
    ROUND_2_SAME_RECT(28, -1, (String)null), 
    ROUND_2_DIAG_RECT(29, -1, (String)null), 
    SNIP_ROUND_RECT(30, -1, (String)null), 
    SNIP_1_RECT(31, -1, (String)null), 
    SNIP_2_SAME_RECT(32, -1, (String)null), 
    SNIP_2_DIAG_RECT(33, -1, (String)null), 
    PLAQUE(34, 21, "Plaque"), 
    ELLIPSE(35, 3, "Ellipse"), 
    TEARDROP(36, -1, (String)null), 
    HOME_PLATE(37, 15, "HomePlate"), 
    CHEVRON(38, 55, "Chevron"), 
    PIE_WEDGE(39, -1, (String)null), 
    PIE(40, -1, (String)null), 
    ...
    LEFT_CIRCULAR_ARROW(66, -1, (String)null), 
    LEFT_RIGHT_CIRCULAR_ARROW(67, -1, (String)null), 
    ...
    HALF_FRAME(85, -1, (String)null), 
    CORNER(86, -1, (String)null), 
    DIAG_STRIPE(87, -1, (String)null), 
    CHORD(88, -1, (String)null), 
    ARC(89, 19, "Arc"), 
    ...
    GEAR_6(173, -1, (String)null), 
    GEAR_9(174, -1, (String)null), 
    FUNNEL(175, -1, (String)null), 
    MATH_PLUS(176, -1, (String)null), 
    MATH_MINUS(177, -1, (String)null), 
    MATH_MULTIPLY(178, -1, (String)null), 
    MATH_DIVIDE(179, -1, (String)null), 
    MATH_EQUAL(180, -1, (String)null), 
    MATH_NOT_EQUAL(181, -1, (String)null), 
    CORNER_TABS(182, -1, (String)null), 
    SQUARE_TABS(183, -1, (String)null), 
    PLAQUE_TABS(184, -1, (String)null), 
    CHART_X(185, -1, (String)null), 
    CHART_STAR(186, -1, (String)null), 
    CHART_PLUS(187, -1, (String)null), 
    ...
    private ShapeType(final int ooxmlId, final int nativeId, final String nativeName) {
    ...
    public String getOoxmlName() {
        if (this == ShapeType.SEAL) {
            return ShapeType.STAR_16.getOoxmlName();
        }
        if (this.ooxmlId == -1) {
            return this.name().startsWith("TEXT") ? ShapeType.RECT.getOoxmlName() : null;
        }
        final StringBuilder sb = new StringBuilder();
        boolean toLower = true;
        for (final char ch : this.name().toCharArray()) {
            if (ch == '_') {
                toLower = false;
            }
            else {
    ...
    public static ShapeType forId(final int id, final boolean isOoxmlId) {
        if (!isOoxmlId && id == 4095) {
            return ShapeType.NOT_PRIMITIVE;
        }
