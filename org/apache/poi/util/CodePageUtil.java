...
public class CodePageUtil
{
    ...
    public static String cp950ToString(final byte[] data, final int offset, final int lengthInBytes) {
        final StringBuilder sb = new StringBuilder();
        final LittleEndianCP950Reader reader = new LittleEndianCP950Reader(data, offset, lengthInBytes);
    ...
    static {
        DOUBLE_BYTE_CHARSETS = Collections.singleton(StringUtil.BIG5);
    }
}
