...
public enum LocaleID
{
    ...
    private LocaleID(final int lcid, final String windowsId, final String languageTag, final String description, final int defaultCodepage, final int firstWeekday) {
        this.lcid = lcid;
    ...
    public static LocaleID lookupByLanguageTag(final String languageTag) {
        return LocaleID.languageTagLookup.get(languageTag);
    }
    
    public static LocaleID lookupByLcid(final int lcid) {
        return LocaleID.lcidLookup.get(lcid);
    }
    
    static {
        languageTagLookup = Stream.of(values()).filter(LocaleID::isValid).collect(Collectors.toMap((Function<? super LocaleID, ? extends String>)LocaleID::getLanguageTag, (Function<? super LocaleID, ? extends LocaleID>)Function.identity()));
        lcidLookup = Stream.of(values()).collect(Collectors.toMap((Function<? super LocaleID, ? extends Integer>)LocaleID::getLcid, (Function<? super LocaleID, ? extends LocaleID>)Function.identity()));
    }
}
