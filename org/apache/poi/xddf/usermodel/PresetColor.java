...
public enum PresetColor
{
    ...
    private PresetColor(final STPresetColorVal.Enum color) {
        this.underlying = color;
    }
    
    static PresetColor valueOf(final STPresetColorVal.Enum color) {
        return PresetColor.reverse.get(color);
    }
    
    static {
        reverse = new HashMap<STPresetColorVal.Enum, PresetColor>();
        for (final PresetColor value : values()) {
            PresetColor.reverse.put(value.underlying, value);
        }
    }
}
