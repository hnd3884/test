...
public class XDDFRadarChartData extends XDDFChartData
{
    ...
    @Internal
    protected XDDFRadarChartData(final XDDFChart parent, final CTRadarChart chart, final Map<Long, XDDFChartAxis> categories, final Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
        for (final CTRadarSer series : chart.getSerList()) {
    ...
    public void setStyle(final RadarStyle style) {
    ...
    public class Series extends XDDFChartData.Series
    {
        ...
        protected Series(final CTRadarSer series, final XDDFDataSource<?> category, final XDDFNumericalDataSource<? extends Number> values) {
            super(category, values);
            this.series = series;
        }
        
        protected Series(final CTRadarSer series, final CTAxDataSource category, final CTNumDataSource values) {
