...
public class XDDFSurface3DChartData extends XDDFChartData
{
    ...
    @Internal
    protected XDDFSurface3DChartData(final XDDFChart parent, final CTSurface3DChart chart, final Map<Long, XDDFChartAxis> categories, final Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
