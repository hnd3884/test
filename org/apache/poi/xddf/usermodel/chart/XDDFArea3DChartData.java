...
public class XDDFArea3DChartData extends XDDFChartData
{
    ...
    @Internal
    protected XDDFArea3DChartData(final XDDFChart parent, final CTArea3DChart chart, final Map<Long, XDDFChartAxis> categories, final Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
