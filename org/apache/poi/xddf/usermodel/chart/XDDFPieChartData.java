...
public class XDDFPieChartData extends XDDFChartData
{
    ...
    @Internal
    protected XDDFPieChartData(final XDDFChart parent, final CTPieChart chart) {
        super(parent);
        this.chart = chart;
    ...
    public void setFirstSliceAngle(final Integer angle) {
        if (angle == null) {
            if (this.chart.isSetFirstSliceAng()) {
            ...
            if (this.chart.isSetFirstSliceAng()) {
                this.chart.getFirstSliceAng().setVal((int)angle);
            }
            else {
                this.chart.addNewFirstSliceAng().setVal((int)angle);
            }
        }
    }
