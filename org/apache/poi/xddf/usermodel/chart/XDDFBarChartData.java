...
public class XDDFBarChartData extends XDDFChartData
{
    ...
    @Internal
    protected XDDFBarChartData(final XDDFChart parent, final CTBarChart chart, final Map<Long, XDDFChartAxis> categories, final Map<Long, XDDFValueAxis> values) {
        super(parent);
        this.chart = chart;
    ...
    public void setOverlap(final Byte overlap) {
        if (overlap == null) {
            if (this.chart.isSetOverlap()) {
            ...
            if (this.chart.isSetOverlap()) {
                this.chart.getOverlap().setVal((byte)overlap);
            }
            else {
                this.chart.addNewOverlap().setVal((byte)overlap);
            }
        }
    }
