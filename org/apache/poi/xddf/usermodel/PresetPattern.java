...
public enum PresetPattern
{
    ...
    private PresetPattern(final STPresetPatternVal.Enum pattern) {
        this.underlying = pattern;
    }
    
    static PresetPattern valueOf(final STPresetPatternVal.Enum pattern) {
        return PresetPattern.reverse.get(pattern);
    }
    
    static {
        reverse = new HashMap<STPresetPatternVal.Enum, PresetPattern>();
        for (final PresetPattern value : values()) {
            PresetPattern.reverse.put(value.underlying, value);
        }
    }
}
