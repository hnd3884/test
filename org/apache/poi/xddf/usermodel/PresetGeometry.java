...
public enum PresetGeometry
{
    ...
    private PresetGeometry(final STShapeType.Enum shape) {
        this.underlying = shape;
    }
    
    static PresetGeometry valueOf(final STShapeType.Enum shape) {
        return PresetGeometry.reverse.get(shape);
    }
    
    static {
        reverse = new HashMap<STShapeType.Enum, PresetGeometry>();
        for (final PresetGeometry value : values()) {
            PresetGeometry.reverse.put(value.underlying, value);
        }
    }
}
