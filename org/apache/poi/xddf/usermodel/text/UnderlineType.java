...
public enum UnderlineType
{
    ...
    private UnderlineType(final STTextUnderlineType.Enum underline) {
        this.underlying = underline;
    }
    
    static UnderlineType valueOf(final STTextUnderlineType.Enum underline) {
        return UnderlineType.reverse.get(underline);
    }
    
    static {
        reverse = new HashMap<STTextUnderlineType.Enum, UnderlineType>();
        for (final UnderlineType value : values()) {
            UnderlineType.reverse.put(value.underlying, value);
        }
    }
}
