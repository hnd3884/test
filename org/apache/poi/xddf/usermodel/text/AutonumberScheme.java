...
public enum AutonumberScheme
{
    ...
    private AutonumberScheme(final STTextAutonumberScheme.Enum scheme) {
        this.underlying = scheme;
    }
    
    static AutonumberScheme valueOf(final STTextAutonumberScheme.Enum scheme) {
        return AutonumberScheme.reverse.get(scheme);
    }
    
    static {
        reverse = new HashMap<STTextAutonumberScheme.Enum, AutonumberScheme>();
        for (final AutonumberScheme value : values()) {
            AutonumberScheme.reverse.put(value.underlying, value);
        }
    }
}
