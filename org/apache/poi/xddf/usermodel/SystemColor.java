...
public enum SystemColor
{
    ...
    private SystemColor(final STSystemColorVal.Enum color) {
        this.underlying = color;
    }
    
    static SystemColor valueOf(final STSystemColorVal.Enum color) {
        return SystemColor.reverse.get(color);
    }
    
    static {
        reverse = new HashMap<STSystemColorVal.Enum, SystemColor>();
        for (final SystemColor value : values()) {
            SystemColor.reverse.put(value.underlying, value);
        }
    }
}
