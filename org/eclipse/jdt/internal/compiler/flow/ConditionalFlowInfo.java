...
public class ConditionalFlowInfo extends FlowInfo
{
    ...
    ConditionalFlowInfo(final FlowInfo initsWhenTrue, final FlowInfo initsWhenFalse) {
        this.initsWhenTrue = initsWhenTrue;
        this.initsWhenFalse = initsWhenFalse;
        this.tagBits = (initsWhenTrue.tagBits & initsWhenFalse.tagBits & 0x3);
    }
    
    @Override
    public FlowInfo addInitializationsFrom(final FlowInfo otherInits) {
    ...
    @Override
    public FlowInfo addNullInfoFrom(final FlowInfo otherInits) {
    ...
    @Override
    public FlowInfo addPotentialInitializationsFrom(final FlowInfo otherInits) {
    ...
    public FlowInfo asNegatedCondition() {
        final FlowInfo extra = this.initsWhenTrue;
