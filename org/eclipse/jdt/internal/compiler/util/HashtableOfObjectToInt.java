...
public final class HashtableOfObjectToInt implements Cloneable
{
    ...
    public HashtableOfObjectToInt(final int size) {
        this.elementSize = 0;
        this.threshold = size;
    ...
    public Object clone() throws CloneNotSupportedException {
        final HashtableOfObjectToInt result = (HashtableOfObjectToInt)super.clone();
    ...
    private void rehash() {
        final HashtableOfObjectToInt newHashtable = new HashtableOfObjectToInt(this.elementSize * 2);
