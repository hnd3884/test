...
public class CompilerOptions
{
    ...
    static {
        DEFAULT_NULLABLE_ANNOTATION_NAME = CharOperation.splitOn('.', "org.eclipse.jdt.annotation.Nullable".toCharArray());
        DEFAULT_NONNULL_ANNOTATION_NAME = CharOperation.splitOn('.', "org.eclipse.jdt.annotation.NonNull".toCharArray());
        DEFAULT_NONNULLBYDEFAULT_ANNOTATION_NAME = CharOperation.splitOn('.', "org.eclipse.jdt.annotation.NonNullByDefault".toCharArray());
        NO_STRINGS = new String[0];
        warningTokens = new String[] { "all", "boxing", "cast", "dep-ann", "deprecation", "fallthrough", "finally", "hiding", "incomplete-switch", "javadoc", "nls", "null", "rawtypes", "resource", "restriction", "serial", "static-access", "static-method", "super", "synthetic-access", "sync-override", "unchecked", "unqualified-field-access", "unused" };
    }
    ...
    public CompilerOptions(final Map<String, String> settings) {
        this.nullableAnnotationSecondaryNames = CompilerOptions.NO_STRINGS;
        this.nonNullAnnotationSecondaryNames = CompilerOptions.NO_STRINGS;
        this.nonNullByDefaultAnnotationSecondaryNames = CompilerOptions.NO_STRINGS;
        final String tolerateIllegalAmbiguousVarargs = System.getProperty("tolerateIllegalAmbiguousVarargsInvocation");
        CompilerOptions.tolerateIllegalAmbiguousVarargsInvocation = (tolerateIllegalAmbiguousVarargs != null && tolerateIllegalAmbiguousVarargs.equalsIgnoreCase("true"));
        final String useunspecdtypeinferenceoptimization = System.getProperty("useunspecdtypeinferenceperformanceoptimization");
        CompilerOptions.useunspecdtypeinferenceperformanceoptimization = (useunspecdtypeinferenceoptimization != null && useunspecdtypeinferenceoptimization.equalsIgnoreCase("true"));
    ...
    @Deprecated
    public CompilerOptions(final Map settings, final boolean parseLiteralExpressionsAsConstants) {
        this(settings);
        this.parseLiteralExpressionsAsConstants = parseLiteralExpressionsAsConstants;
    }
    
    public static String optionKeyFromIrritant(final int irritant) {
        switch (irritant) {
            case 1: {
    ...
    public static String versionFromJdkLevel(final long jdkLevel) {
    ...
    public static long versionToJdkLevel(final String versionID) {
        final String version = versionID;
    ...
    public static IrritantSet warningTokenToIrritants(final String warningToken) {
    ...
    public Map<String, String> getMap() {
        final Map<String, String> optionsMap = new HashMap<String, String>(30);
        optionsMap.put("org.eclipse.jdt.core.compiler.debug.localVariable", ((this.produceDebugAttributes & 0x4) != 0x0) ? "generate" : "do not generate");
        optionsMap.put("org.eclipse.jdt.core.compiler.debug.lineNumber", ((this.produceDebugAttributes & 0x2) != 0x0) ? "generate" : "do not generate");
        optionsMap.put("org.eclipse.jdt.core.compiler.debug.sourceFile", ((this.produceDebugAttributes & 0x1) != 0x0) ? "generate" : "do not generate");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.codegen.lambda.genericSignature", this.generateGenericSignatureForLambdaExpressions ? "generate" : "do not generate");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.deprecationWhenOverridingDeprecatedMethod", this.reportDeprecationWhenOverridingDeprecatedMethod ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.invalidJavadocTagsDeprecatedRef", this.reportInvalidJavadocTagsDeprecatedRef ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.invalidJavadocTagsNotVisibleRef", this.reportInvalidJavadocTagsNotVisibleRef ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.missingJavadocTagsMethodTypeParameters", this.reportMissingJavadocTagsMethodTypeParameters ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.missingJavadocCommentsVisibility", this.getVisibilityString(this.reportMissingJavadocCommentsVisibility));
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.missingJavadocCommentsOverriding", this.reportMissingJavadocCommentsOverriding ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionWhenOverriding", this.reportUnusedDeclaredThrownExceptionWhenOverriding ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionIncludeDocCommentReference", this.reportUnusedDeclaredThrownExceptionIncludeDocCommentReference ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedDeclaredThrownExceptionExemptExceptionAndThrowable", this.reportUnusedDeclaredThrownExceptionExemptExceptionAndThrowable ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unqualifiedFieldAccess", this.getSeverityString(4194304));
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unavoidableGenericTypeProblems", this.reportUnavoidableGenericTypeProblems ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.missingOverrideAnnotationForInterfaceMethodImplementation", this.reportMissingOverrideAnnotationForInterfaceMethodImplementation ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.taskTags", (this.taskTags == null) ? Util.EMPTY_STRING : new String(CharOperation.concatWith(this.taskTags, ',')));
        optionsMap.put("org.eclipse.jdt.core.compiler.taskPriorities", (this.taskPriorities == null) ? Util.EMPTY_STRING : new String(CharOperation.concatWith(this.taskPriorities, ',')));
        optionsMap.put("org.eclipse.jdt.core.compiler.taskCaseSensitive", this.isTaskCaseSensitive ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedParameterWhenImplementingAbstract", this.reportUnusedParameterWhenImplementingAbstract ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedParameterWhenOverridingConcrete", this.reportUnusedParameterWhenOverridingConcrete ? "enabled" : "disabled");
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.unusedParameterIncludeDocCommentReference", this.reportUnusedParameterIncludeDocCommentReference ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.annotation.nonnullbydefault", String.valueOf(CharOperation.concatWith(this.nonNullByDefaultAnnotationName, '.')));
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.annotation.nonnullbydefault.secondary", this.nameListToString(this.nonNullByDefaultAnnotationSecondaryNames));
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.syntacticNullAnalysisForFields", this.enableSyntacticNullAnalysisForFields ? "enabled" : "disabled");
        ...
        optionsMap.put("org.eclipse.jdt.core.compiler.problem.uninternedIdentityComparison", this.complainOnUninternedIdentityComparison ? "enabled" : "disabled");
    ...
    public int getSeverity(final int irritant) {
    ...
    public String getSeverityString(final int irritant) {
        if (this.errorThreshold.isSet(irritant)) {
            return "error";
        }
        if (this.warningThreshold.isSet(irritant)) {
    ...
    public String getVisibilityString(final int level) {
        switch (level & 0x7) {
            case 1: {
                return "public";
            }
    ...
    public boolean isAnyEnabled(final IrritantSet irritants) {
    ...
    protected void resetDefaults() {
        ...
        final long n = 3145728L;
        this.originalComplianceLevel = n;
        this.complianceLevel = n;
        final long n2 = 3080192L;
        this.originalSourceLevel = n2;
        this.sourceLevel = n2;
    ...
    public void set(final Map<String, String> optionsMap) {
        ...
        if ((optionValue = optionsMap.get("org.eclipse.jdt.core.compiler.debug.lineNumber")) != null) {
            if ("generate".equals(optionValue)) {
                this.produceDebugAttributes |= 0x2;
            }
            else if ("do not generate".equals(optionValue)) {
        ...
        if ((optionValue = optionsMap.get("org.eclipse.jdt.core.compiler.debug.sourceFile")) != null) {
            if ("generate".equals(optionValue)) {
                this.produceDebugAttributes |= 0x1;
            }
            else if ("do not generate".equals(optionValue)) {
        ...
        if ((optionValue = optionsMap.get("org.eclipse.jdt.core.compiler.compliance")) != null) {
            final long level = versionToJdkLevel(optionValue);
            if (level != 0L) {
                final long n = level;
                this.originalComplianceLevel = n;
                this.complianceLevel = n;
        ...
        if ((optionValue = optionsMap.get("org.eclipse.jdt.core.encoding")) != null) {
            this.defaultEncoding = null;
            final String stringValue = optionValue;
            if (stringValue.length() > 0) {
                try {
                    final InputStreamReader inputStreamReader = new InputStreamReader(new ByteArrayInputStream(new byte[0]), stringValue);
    ...
    private String[] stringToNameList(final String optionValue) {
        final String[] result = optionValue.split(",");
        if (result == null) {
            return CompilerOptions.NO_STRINGS;
        }
    ...
    String nameListToString(final String[] names) {
        if (names == null) {
            return "";
        }
    ...
    public String toString() {
        final StringBuffer buf = new StringBuffer("CompilerOptions:");
        buf.append("\n\t- local variables debug attributes: ").append(((this.produceDebugAttributes & 0x4) != 0x0) ? "ON" : " OFF");
        buf.append("\n\t- line number debug attributes: ").append(((this.produceDebugAttributes & 0x2) != 0x0) ? "ON" : " OFF");
        buf.append("\n\t- source debug attributes: ").append(((this.produceDebugAttributes & 0x1) != 0x0) ? "ON" : " OFF");
    ...
    protected void updateSeverity(final int irritant, final Object severityString) {
