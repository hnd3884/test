...
public class SyntheticArgumentBinding extends LocalVariableBinding
{
    ...
    public SyntheticArgumentBinding(final LocalVariableBinding actualOuterLocalVariable) {
    ...
    public SyntheticArgumentBinding(final ReferenceBinding enclosingType) {
        super(CharOperation.concat(TypeConstants.SYNTHETIC_ENCLOSING_INSTANCE_PREFIX, String.valueOf(enclosingType.depth()).toCharArray()), enclosingType, 16, true);
        this.tagBits |= 0x400L;
        this.useFlag = 1;
    }
}
