...
public abstract class BaseProcessingEnvImpl implements ProcessingEnvironment
{
    ...
    public BaseProcessingEnvImpl() {
        this._addedUnits = new ArrayList<ICompilationUnit>();
        this._addedClassFiles = new ArrayList<ReferenceBinding>();
        this._deletedUnits = new ArrayList<ICompilationUnit>();
    ...
    public ICompilationUnit[] getDeletedUnits() {
        final ICompilationUnit[] result = new ICompilationUnit[this._deletedUnits.size()];
        this._deletedUnits.toArray(result);
        return result;
    }
    
    public ICompilationUnit[] getNewUnits() {
        final ICompilationUnit[] result = new ICompilationUnit[this._addedUnits.size()];
    ...
    public SourceVersion getSourceVersion() {
        ...
        if (this._compiler.options.sourceLevel == 3276800L) {
    ...
    public void setErrorRaised(final boolean b) {
    ...
    public ReferenceBinding[] getNewClassFiles() {
        final ReferenceBinding[] result = new ReferenceBinding[this._addedClassFiles.size()];
