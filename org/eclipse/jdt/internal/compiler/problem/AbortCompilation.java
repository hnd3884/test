...
public class AbortCompilation extends RuntimeException
{
    ...
    public AbortCompilation(final CompilationResult compilationResult, final CategorizedProblem problem) {
        this();
        this.compilationResult = compilationResult;
        this.problem = problem;
    }
    
    public AbortCompilation(final CompilationResult compilationResult, final Throwable exception) {
        this();
        this.compilationResult = compilationResult;
        this.exception = exception;
    }
    
    public AbortCompilation(final boolean isSilent, final RuntimeException silentException) {
        this();
    ...
    public String getMessage() {
        ...
        final StringBuffer buffer = new StringBuffer((message == null) ? Util.EMPTY_STRING : message);
    ...
    public void updateContext(final InvocationSite invocationSite, final CompilationResult unitResult) {
        if (this.problem == null) {
            return;
        }
        ...
        final int[] lineEnds = unitResult.getLineSeparatorPositions();
    ...
    public void updateContext(final ASTNode astNode, final CompilationResult unitResult) {
        if (this.problem == null) {
            return;
        }
        if (this.problem.getSourceStart() != 0 || this.problem.getSourceEnd() != 0) {
