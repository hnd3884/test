...
public abstract class ClassFileStruct
{
    ...
    public ClassFileStruct(final byte[] classFileBytes, final int[] offsets, final int offset) {
        this.reference = classFileBytes;
        this.constantPoolOffsets = offsets;
        this.structOffset = offset;
    }
    
    public double doubleAt(final int relativeOffset) {
        return Double.longBitsToDouble(this.i8At(relativeOffset));
    }
    
    public float floatAt(final int relativeOffset) {
        return Float.intBitsToFloat(this.i4At(relativeOffset));
    }
    
    public int i4At(final int relativeOffset) {
    ...
    public long i8At(final int relativeOffset) {
        int position = relativeOffset + this.structOffset;
    ...
    public char[] utf8At(final int relativeOffset, final int bytesAvailable) {
