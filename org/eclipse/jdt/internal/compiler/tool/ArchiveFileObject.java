        ...
        if (this.getKind() == Kind.SOURCE) {
            ...
            try {
                ...
                try {
                    ...
                    return org.eclipse.jdt.internal.compiler.tool.Util.getCharContents(this, ignoreEncodingErrors, Util.getZipEntryByteContent(zipEntry, zipFile2), this.charset.name());
                }
                finally {
                    if (zipFile2 != null) {
                        zipFile2.close();
