    ...
    public LegendItemCollection getLegendCollection() {
        ...
        if (this.paintIndex != null && this.paintIndex.size() > 0) {
            if (this.paintIndex.size() <= this.paintLimit) {
                final Iterator i = this.paintIndex.entrySet().iterator();
                while (i.hasNext()) {
                ...
                final Iterator j = this.paintIndex.entrySet().iterator();
                while (j.hasNext()) {
                    final Map.Entry entry2 = j.next();
