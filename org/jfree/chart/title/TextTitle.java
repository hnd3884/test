...
public class TextTitle extends Title implements Serializable, Cloneable, PublicCloneable
{
    ...
    protected Size2D arrangeRR(final Graphics2D g2, final Range widthRange, final Range heightRange) {
        ...
        if (position == RectangleEdge.TOP || position == RectangleEdge.BOTTOM) {
            ...
            (this.content = TextUtilities.createTextBlock(this.text, this.font, this.paint, maxWidth, (TextMeasurer)new G2TextMeasurer(g2))).setLineAlignment(this.textAlignment);
    ...
    public boolean equals(final Object obj) {
        ...
        return ObjectUtilities.equal((Object)this.text, (Object)that.text) && ObjectUtilities.equal((Object)this.font, (Object)that.font) && PaintUtilities.equal(this.paint, that.paint) && this.textAlignment == that.textAlignment && PaintUtilities.equal(this.backgroundPaint, that.backgroundPaint);
    }
