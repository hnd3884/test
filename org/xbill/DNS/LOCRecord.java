...
public class LOCRecord extends Record
{
    ...
    private long parseDouble(final Tokenizer st, final String type, final boolean required, final long min, final long max, final long defaultValue) throws IOException {
        ...
        if (token.isEOL()) {
            ...
            try {
                final long value = (long)(100.0 * new Double(s));
    ...
    private String positionToString(final long value, final char pos, final char neg) {
        ...
        temp %= 60000L;
        sb.append(" ");
        sb.append(LOCRecord.w3.format(temp / 1000.0));
        sb.append(" ");
        sb.append(direction);
        return sb.toString();
    }
    ...
    String rrToString() {
        ...
        sb.append(" ");
        sb.append(LOCRecord.w2.format((this.altitude - 10000000L) / 100.0));
        sb.append("m ");
        sb.append(LOCRecord.w2.format(this.size / 100.0));
        sb.append("m ");
        sb.append(LOCRecord.w2.format(this.hPrecision / 100.0));
        sb.append("m ");
        sb.append(LOCRecord.w2.format(this.vPrecision / 100.0));
        sb.append("m");
        return sb.toString();
    }
    ...
    static {
        (LOCRecord.w2 = new DecimalFormat()).setMaximumFractionDigits(2);
        LOCRecord.w2.setGroupingUsed(false);
        (LOCRecord.w3 = new DecimalFormat()).setMaximumFractionDigits(3);
        LOCRecord.w3.setGroupingUsed(false);
    }
}
