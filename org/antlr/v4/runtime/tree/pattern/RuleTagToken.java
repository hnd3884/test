...
public class RuleTagToken implements Token
{
    ...
    public RuleTagToken(final String ruleName, final int bypassTokenType) {
        this(ruleName, bypassTokenType, null);
    }
    
    public RuleTagToken(final String ruleName, final int bypassTokenType, final String label) {
