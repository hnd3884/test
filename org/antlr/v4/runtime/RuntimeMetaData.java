...
public class RuntimeMetaData
{
    ...
    public static void checkVersion(final String generatingToolVersion, final String compileTimeVersion) {
        final String runtimeVersion = "4.5.3";
    ...
    public static String getMajorMinorVersion(final String version) {
        final int firstDot = version.indexOf(46);
        final int secondDot = (firstDot >= 0) ? version.indexOf(46, firstDot + 1) : -1;
        final int firstDash = version.indexOf(45);
