...
public class CTNumFmtsImpl extends XmlComplexContentImpl implements CTNumFmts
{
    ...
    public CTNumFmtsImpl(final SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public List<CTNumFmt> getNumFmtList() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final class NumFmtList extends AbstractList<CTNumFmt>
            {
                @Override
                public CTNumFmt get(final int n) {
                    return CTNumFmtsImpl.this.getNumFmtArray(n);
                }
                
                @Override
                public CTNumFmt set(final int n, final CTNumFmt ctNumFmt) {
                    final CTNumFmt numFmtArray = CTNumFmtsImpl.this.getNumFmtArray(n);
                    CTNumFmtsImpl.this.setNumFmtArray(n, ctNumFmt);
                    return numFmtArray;
                }
                
                @Override
                public void add(final int n, final CTNumFmt ctNumFmt) {
                    CTNumFmtsImpl.this.insertNewNumFmt(n).set((XmlObject)ctNumFmt);
                }
                
                @Override
                public CTNumFmt remove(final int n) {
                    final CTNumFmt numFmtArray = CTNumFmtsImpl.this.getNumFmtArray(n);
    ...
    public CTNumFmt[] getNumFmtArray() {
        synchronized (this.monitor()) {
            ...
            this.get_store().find_all_element_users(CTNumFmtsImpl.NUMFMT$0, (List)list);
    ...
    public void setNumFmtArray(final CTNumFmt[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTNumFmtsImpl.NUMFMT$0);
    }
    
    public void setNumFmtArray(final int n, final CTNumFmt ctNumFmt) {
        this.generatedSetterHelperImpl((XmlObject)ctNumFmt, CTNumFmtsImpl.NUMFMT$0, n, (short)2);
    }
