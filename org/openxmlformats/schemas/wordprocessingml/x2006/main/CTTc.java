    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTTc.class.getClassLoader());
        ...
        public static CTTc newInstance() {
            return (CTTc)getTypeLoader().newInstance(CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc newInstance(final XmlOptions xmlOptions) {
            return (CTTc)getTypeLoader().newInstance(CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final String s) throws XmlException {
            return (CTTc)getTypeLoader().parse(s, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTTc)getTypeLoader().parse(s, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final File file) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(file, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(file, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final URL url) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(url, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(url, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(inputStream, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(inputStream, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final Reader reader) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(reader, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTc)getTypeLoader().parse(reader, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTTc)getTypeLoader().parse(xmlStreamReader, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTTc)getTypeLoader().parse(xmlStreamReader, CTTc.type, xmlOptions);
        }
        
        public static CTTc parse(final Node node) throws XmlException {
            return (CTTc)getTypeLoader().parse(node, CTTc.type, (XmlOptions)null);
        }
        
        public static CTTc parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTTc)getTypeLoader().parse(node, CTTc.type, xmlOptions);
        }
        
        @Deprecated
        public static CTTc parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTTc)getTypeLoader().parse(xmlInputStream, CTTc.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTTc parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTc)getTypeLoader().parse(xmlInputStream, CTTc.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTTc.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTTc.type, xmlOptions);
        }
