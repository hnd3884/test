...
public interface STBorder extends XmlString
{
    ...
    public static final class Factory
    {
        ...
        public static STBorder newValue(final Object o) {
            return (STBorder)STBorder.type.newValue(o);
        }
        
        private static synchronized SchemaTypeLoader getTypeLoader() {
            SchemaTypeLoader typeLoaderForClassLoader = (Factory.typeLoader == null) ? null : Factory.typeLoader.get();
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(STBorder.class.getClassLoader());
        ...
        public static STBorder newInstance() {
            return (STBorder)getTypeLoader().newInstance(STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder newInstance(final XmlOptions xmlOptions) {
            return (STBorder)getTypeLoader().newInstance(STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final String s) throws XmlException {
            return (STBorder)getTypeLoader().parse(s, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (STBorder)getTypeLoader().parse(s, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final File file) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(file, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(file, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final URL url) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(url, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(url, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final InputStream inputStream) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(inputStream, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(inputStream, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final Reader reader) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(reader, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STBorder)getTypeLoader().parse(reader, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (STBorder)getTypeLoader().parse(xmlStreamReader, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (STBorder)getTypeLoader().parse(xmlStreamReader, STBorder.type, xmlOptions);
        }
        
        public static STBorder parse(final Node node) throws XmlException {
            return (STBorder)getTypeLoader().parse(node, STBorder.type, (XmlOptions)null);
        }
        
        public static STBorder parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (STBorder)getTypeLoader().parse(node, STBorder.type, xmlOptions);
        }
        
        @Deprecated
        public static STBorder parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (STBorder)getTypeLoader().parse(xmlInputStream, STBorder.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static STBorder parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STBorder)getTypeLoader().parse(xmlInputStream, STBorder.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STBorder.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STBorder.type, xmlOptions);
        }
