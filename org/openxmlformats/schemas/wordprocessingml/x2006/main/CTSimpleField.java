...
public interface CTSimpleField extends XmlObject
{
    ...
    void setInstr(final String p0);
    
    void xsetInstr(final STString p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSimpleField.class.getClassLoader());
        ...
        public static CTSimpleField newInstance() {
            return (CTSimpleField)getTypeLoader().newInstance(CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField newInstance(final XmlOptions xmlOptions) {
            return (CTSimpleField)getTypeLoader().newInstance(CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final String s) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(s, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(s, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final File file) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(file, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(file, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final URL url) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(url, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(url, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(inputStream, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(inputStream, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final Reader reader) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(reader, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSimpleField)getTypeLoader().parse(reader, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(xmlStreamReader, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(xmlStreamReader, CTSimpleField.type, xmlOptions);
        }
        
        public static CTSimpleField parse(final Node node) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(node, CTSimpleField.type, (XmlOptions)null);
        }
        
        public static CTSimpleField parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSimpleField)getTypeLoader().parse(node, CTSimpleField.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSimpleField parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSimpleField)getTypeLoader().parse(xmlInputStream, CTSimpleField.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSimpleField parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSimpleField)getTypeLoader().parse(xmlInputStream, CTSimpleField.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSimpleField.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSimpleField.type, xmlOptions);
        }
