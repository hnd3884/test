    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTHdrFtr.class.getClassLoader());
        ...
        public static CTHdrFtr newInstance() {
            return (CTHdrFtr)getTypeLoader().newInstance(CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr newInstance(final XmlOptions xmlOptions) {
            return (CTHdrFtr)getTypeLoader().newInstance(CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final String s) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(s, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(s, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final File file) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(file, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(file, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final URL url) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(url, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(url, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(inputStream, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(inputStream, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final Reader reader) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(reader, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHdrFtr)getTypeLoader().parse(reader, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(xmlStreamReader, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(xmlStreamReader, CTHdrFtr.type, xmlOptions);
        }
        
        public static CTHdrFtr parse(final Node node) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(node, CTHdrFtr.type, (XmlOptions)null);
        }
        
        public static CTHdrFtr parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTHdrFtr)getTypeLoader().parse(node, CTHdrFtr.type, xmlOptions);
        }
        
        @Deprecated
        public static CTHdrFtr parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTHdrFtr)getTypeLoader().parse(xmlInputStream, CTHdrFtr.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTHdrFtr parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTHdrFtr)getTypeLoader().parse(xmlInputStream, CTHdrFtr.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTHdrFtr.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTHdrFtr.type, xmlOptions);
        }
