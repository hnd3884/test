...
public interface CTP extends XmlObject
{
    ...
    void setRsidP(final byte[] p0);
    
    void xsetRsidP(final STLongHexNumber p0);
    ...
    void setRsidRDefault(final byte[] p0);
    
    void xsetRsidRDefault(final STLongHexNumber p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTP.class.getClassLoader());
        ...
        public static CTP newInstance() {
            return (CTP)getTypeLoader().newInstance(CTP.type, (XmlOptions)null);
        }
        
        public static CTP newInstance(final XmlOptions xmlOptions) {
            return (CTP)getTypeLoader().newInstance(CTP.type, xmlOptions);
        }
        
        public static CTP parse(final String s) throws XmlException {
            return (CTP)getTypeLoader().parse(s, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTP)getTypeLoader().parse(s, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final File file) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(file, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(file, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final URL url) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(url, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(url, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(inputStream, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(inputStream, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final Reader reader) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(reader, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTP)getTypeLoader().parse(reader, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTP)getTypeLoader().parse(xmlStreamReader, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTP)getTypeLoader().parse(xmlStreamReader, CTP.type, xmlOptions);
        }
        
        public static CTP parse(final Node node) throws XmlException {
            return (CTP)getTypeLoader().parse(node, CTP.type, (XmlOptions)null);
        }
        
        public static CTP parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTP)getTypeLoader().parse(node, CTP.type, xmlOptions);
        }
        
        @Deprecated
        public static CTP parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTP)getTypeLoader().parse(xmlInputStream, CTP.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTP parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTP)getTypeLoader().parse(xmlInputStream, CTP.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTP.type, (XmlOptions)null);
        }
