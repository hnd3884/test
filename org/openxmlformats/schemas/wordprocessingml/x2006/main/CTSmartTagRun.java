...
public interface CTSmartTagRun extends XmlObject
{
    ...
    void xsetUri(final STString p0);
    ...
    void setElement(final String p0);
    
    void xsetElement(final STString p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSmartTagRun.class.getClassLoader());
        ...
        public static CTSmartTagRun newInstance() {
            return (CTSmartTagRun)getTypeLoader().newInstance(CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun newInstance(final XmlOptions xmlOptions) {
            return (CTSmartTagRun)getTypeLoader().newInstance(CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final String s) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(s, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(s, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final File file) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(file, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(file, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final URL url) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(url, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(url, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(inputStream, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(inputStream, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final Reader reader) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(reader, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSmartTagRun)getTypeLoader().parse(reader, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(xmlStreamReader, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(xmlStreamReader, CTSmartTagRun.type, xmlOptions);
        }
        
        public static CTSmartTagRun parse(final Node node) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(node, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        public static CTSmartTagRun parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSmartTagRun)getTypeLoader().parse(node, CTSmartTagRun.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSmartTagRun parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSmartTagRun)getTypeLoader().parse(xmlInputStream, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSmartTagRun parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSmartTagRun)getTypeLoader().parse(xmlInputStream, CTSmartTagRun.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSmartTagRun.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSmartTagRun.type, xmlOptions);
        }
