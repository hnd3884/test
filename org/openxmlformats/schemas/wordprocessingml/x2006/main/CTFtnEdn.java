...
public interface CTFtnEdn extends XmlObject
{
    ...
    void setType(final STFtnEdn.Enum p0);
    
    void xsetType(final STFtnEdn p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTFtnEdn.class.getClassLoader());
        ...
        public static CTFtnEdn newInstance() {
            return (CTFtnEdn)getTypeLoader().newInstance(CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn newInstance(final XmlOptions xmlOptions) {
            return (CTFtnEdn)getTypeLoader().newInstance(CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final String s) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(s, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(s, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final File file) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(file, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(file, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final URL url) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(url, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(url, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(inputStream, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(inputStream, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final Reader reader) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(reader, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTFtnEdn)getTypeLoader().parse(reader, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(xmlStreamReader, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(xmlStreamReader, CTFtnEdn.type, xmlOptions);
        }
        
        public static CTFtnEdn parse(final Node node) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(node, CTFtnEdn.type, (XmlOptions)null);
        }
        
        public static CTFtnEdn parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTFtnEdn)getTypeLoader().parse(node, CTFtnEdn.type, xmlOptions);
        }
        
        @Deprecated
        public static CTFtnEdn parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTFtnEdn)getTypeLoader().parse(xmlInputStream, CTFtnEdn.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTFtnEdn parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTFtnEdn)getTypeLoader().parse(xmlInputStream, CTFtnEdn.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTFtnEdn.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTFtnEdn.type, xmlOptions);
        }
