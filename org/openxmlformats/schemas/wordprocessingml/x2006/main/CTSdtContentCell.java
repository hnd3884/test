...
public interface CTSdtContentCell extends XmlObject
{
    ...
    CTTc getTcArray(final int p0);
    
    int sizeOfTcArray();
    
    void setTcArray(final CTTc[] p0);
    
    void setTcArray(final int p0, final CTTc p1);
    
    CTTc insertNewTc(final int p0);
    ...
    CTCustomXmlCell getCustomXmlArray(final int p0);
    
    int sizeOfCustomXmlArray();
    
    void setCustomXmlArray(final CTCustomXmlCell[] p0);
    
    void setCustomXmlArray(final int p0, final CTCustomXmlCell p1);
    
    CTCustomXmlCell insertNewCustomXml(final int p0);
    ...
    CTSdtCell getSdtArray(final int p0);
    
    int sizeOfSdtArray();
    
    void setSdtArray(final CTSdtCell[] p0);
    
    void setSdtArray(final int p0, final CTSdtCell p1);
    
    CTSdtCell insertNewSdt(final int p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSdtContentCell.class.getClassLoader());
        ...
        public static CTSdtContentCell newInstance() {
            return (CTSdtContentCell)getTypeLoader().newInstance(CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell newInstance(final XmlOptions xmlOptions) {
            return (CTSdtContentCell)getTypeLoader().newInstance(CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final String s) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(s, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(s, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final File file) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(file, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(file, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final URL url) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(url, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(url, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(inputStream, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(inputStream, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final Reader reader) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(reader, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentCell)getTypeLoader().parse(reader, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(xmlStreamReader, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(xmlStreamReader, CTSdtContentCell.type, xmlOptions);
        }
        
        public static CTSdtContentCell parse(final Node node) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(node, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        public static CTSdtContentCell parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentCell)getTypeLoader().parse(node, CTSdtContentCell.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSdtContentCell parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentCell)getTypeLoader().parse(xmlInputStream, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSdtContentCell parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentCell)getTypeLoader().parse(xmlInputStream, CTSdtContentCell.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSdtContentCell.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSdtContentCell.type, xmlOptions);
        }
