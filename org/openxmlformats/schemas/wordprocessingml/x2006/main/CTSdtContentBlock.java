    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSdtContentBlock.class.getClassLoader());
        ...
        public static CTSdtContentBlock newInstance() {
            return (CTSdtContentBlock)getTypeLoader().newInstance(CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock newInstance(final XmlOptions xmlOptions) {
            return (CTSdtContentBlock)getTypeLoader().newInstance(CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final String s) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(s, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(s, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final File file) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(file, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(file, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final URL url) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(url, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(url, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(inputStream, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(inputStream, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final Reader reader) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(reader, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSdtContentBlock)getTypeLoader().parse(reader, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(xmlStreamReader, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(xmlStreamReader, CTSdtContentBlock.type, xmlOptions);
        }
        
        public static CTSdtContentBlock parse(final Node node) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(node, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        public static CTSdtContentBlock parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSdtContentBlock)getTypeLoader().parse(node, CTSdtContentBlock.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSdtContentBlock parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock)getTypeLoader().parse(xmlInputStream, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSdtContentBlock parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSdtContentBlock)getTypeLoader().parse(xmlInputStream, CTSdtContentBlock.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSdtContentBlock.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSdtContentBlock.type, xmlOptions);
        }
