    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTBody.class.getClassLoader());
        ...
        public static CTBody newInstance() {
            return (CTBody)getTypeLoader().newInstance(CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody newInstance(final XmlOptions xmlOptions) {
            return (CTBody)getTypeLoader().newInstance(CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final String s) throws XmlException {
            return (CTBody)getTypeLoader().parse(s, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTBody)getTypeLoader().parse(s, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final File file) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(file, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(file, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final URL url) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(url, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(url, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(inputStream, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(inputStream, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final Reader reader) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(reader, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBody)getTypeLoader().parse(reader, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTBody)getTypeLoader().parse(xmlStreamReader, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTBody)getTypeLoader().parse(xmlStreamReader, CTBody.type, xmlOptions);
        }
        
        public static CTBody parse(final Node node) throws XmlException {
            return (CTBody)getTypeLoader().parse(node, CTBody.type, (XmlOptions)null);
        }
        
        public static CTBody parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTBody)getTypeLoader().parse(node, CTBody.type, xmlOptions);
        }
        
        @Deprecated
        public static CTBody parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTBody)getTypeLoader().parse(xmlInputStream, CTBody.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTBody parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTBody)getTypeLoader().parse(xmlInputStream, CTBody.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTBody.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTBody.type, xmlOptions);
        }
