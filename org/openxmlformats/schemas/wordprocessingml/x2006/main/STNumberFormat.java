...
public interface STNumberFormat extends XmlString
{
    ...
    public static final class Factory
    {
        ...
        public static STNumberFormat newValue(final Object o) {
            return (STNumberFormat)STNumberFormat.type.newValue(o);
        }
        
        private static synchronized SchemaTypeLoader getTypeLoader() {
            SchemaTypeLoader typeLoaderForClassLoader = (Factory.typeLoader == null) ? null : Factory.typeLoader.get();
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(STNumberFormat.class.getClassLoader());
        ...
        public static STNumberFormat newInstance() {
            return (STNumberFormat)getTypeLoader().newInstance(STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat newInstance(final XmlOptions xmlOptions) {
            return (STNumberFormat)getTypeLoader().newInstance(STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final String s) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(s, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(s, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final File file) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(file, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(file, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final URL url) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(url, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(url, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final InputStream inputStream) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(inputStream, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(inputStream, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final Reader reader) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(reader, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STNumberFormat)getTypeLoader().parse(reader, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(xmlStreamReader, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(xmlStreamReader, STNumberFormat.type, xmlOptions);
        }
        
        public static STNumberFormat parse(final Node node) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(node, STNumberFormat.type, (XmlOptions)null);
        }
        
        public static STNumberFormat parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (STNumberFormat)getTypeLoader().parse(node, STNumberFormat.type, xmlOptions);
        }
        
        @Deprecated
        public static STNumberFormat parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (STNumberFormat)getTypeLoader().parse(xmlInputStream, STNumberFormat.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static STNumberFormat parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STNumberFormat)getTypeLoader().parse(xmlInputStream, STNumberFormat.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STNumberFormat.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STNumberFormat.type, xmlOptions);
        }
