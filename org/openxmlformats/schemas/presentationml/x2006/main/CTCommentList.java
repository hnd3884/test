...
public interface CTCommentList extends XmlObject
{
    ...
    CTComment getCmArray(final int p0);
    
    int sizeOfCmArray();
    
    void setCmArray(final CTComment[] p0);
    
    void setCmArray(final int p0, final CTComment p1);
    
    CTComment insertNewCm(final int p0);
    
    CTComment addNewCm();
    
    void removeCm(final int p0);
