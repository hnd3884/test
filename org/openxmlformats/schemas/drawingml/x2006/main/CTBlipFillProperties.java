    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTBlipFillProperties.class.getClassLoader());
        ...
        public static CTBlipFillProperties newInstance() {
            return (CTBlipFillProperties)getTypeLoader().newInstance(CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties newInstance(final XmlOptions xmlOptions) {
            return (CTBlipFillProperties)getTypeLoader().newInstance(CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final String s) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(s, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(s, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final File file) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(file, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(file, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final URL url) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(url, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(url, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(inputStream, CTBlipFillProperties.type, (XmlOptions)null);
        }
        ...
        public static CTBlipFillProperties parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(inputStream, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final Reader reader) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(reader, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTBlipFillProperties)getTypeLoader().parse(reader, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(xmlStreamReader, CTBlipFillProperties.type, (XmlOptions)null);
        }
        ...
        public static CTBlipFillProperties parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(xmlStreamReader, CTBlipFillProperties.type, xmlOptions);
        }
        
        public static CTBlipFillProperties parse(final Node node) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(node, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        public static CTBlipFillProperties parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTBlipFillProperties)getTypeLoader().parse(node, CTBlipFillProperties.type, xmlOptions);
        }
        
        @Deprecated
        public static CTBlipFillProperties parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTBlipFillProperties)getTypeLoader().parse(xmlInputStream, CTBlipFillProperties.type, (XmlOptions)null);
        }
        ...
        public static CTBlipFillProperties parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTBlipFillProperties)getTypeLoader().parse(xmlInputStream, CTBlipFillProperties.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTBlipFillProperties.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTBlipFillProperties.type, xmlOptions);
        }
