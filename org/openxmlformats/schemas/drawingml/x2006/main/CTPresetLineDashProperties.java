    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTPresetLineDashProperties.class.getClassLoader());
        ...
        public static CTPresetLineDashProperties newInstance() {
            return (CTPresetLineDashProperties)getTypeLoader().newInstance(CTPresetLineDashProperties.type, (XmlOptions)null);
        }
        ...
        public static CTPresetLineDashProperties parse(final String s) throws XmlException {
            return (CTPresetLineDashProperties)getTypeLoader().parse(s, CTPresetLineDashProperties.type, (XmlOptions)null);
        }
        
        public static CTPresetLineDashProperties parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTPresetLineDashProperties)getTypeLoader().parse(s, CTPresetLineDashProperties.type, xmlOptions);
        }
        ...
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTPresetLineDashProperties.type, (XmlOptions)null);
        }
