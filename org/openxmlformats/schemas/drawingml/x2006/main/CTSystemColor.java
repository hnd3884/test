...
public interface CTSystemColor extends XmlObject
{
    ...
    void setVal(final STSystemColorVal.Enum p0);
    
    void xsetVal(final STSystemColorVal p0);
    ...
    void setLastClr(final byte[] p0);
    
    void xsetLastClr(final STHexBinary3 p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSystemColor.class.getClassLoader());
        ...
        public static CTSystemColor newInstance() {
            return (CTSystemColor)getTypeLoader().newInstance(CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor newInstance(final XmlOptions xmlOptions) {
            return (CTSystemColor)getTypeLoader().newInstance(CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final String s) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(s, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(s, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final File file) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(file, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(file, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final URL url) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(url, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(url, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(inputStream, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(inputStream, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final Reader reader) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(reader, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSystemColor)getTypeLoader().parse(reader, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(xmlStreamReader, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(xmlStreamReader, CTSystemColor.type, xmlOptions);
        }
        
        public static CTSystemColor parse(final Node node) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(node, CTSystemColor.type, (XmlOptions)null);
        }
        
        public static CTSystemColor parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSystemColor)getTypeLoader().parse(node, CTSystemColor.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSystemColor parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSystemColor)getTypeLoader().parse(xmlInputStream, CTSystemColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSystemColor parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSystemColor)getTypeLoader().parse(xmlInputStream, CTSystemColor.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSystemColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSystemColor.type, xmlOptions);
        }
