    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTTextLineBreak.class.getClassLoader());
        ...
        public static CTTextLineBreak newInstance() {
            return (CTTextLineBreak)getTypeLoader().newInstance(CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak newInstance(final XmlOptions xmlOptions) {
            return (CTTextLineBreak)getTypeLoader().newInstance(CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final String s) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(s, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(s, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final File file) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(file, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(file, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final URL url) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(url, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(url, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(inputStream, CTTextLineBreak.type, (XmlOptions)null);
        }
        ...
        public static CTTextLineBreak parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(inputStream, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final Reader reader) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(reader, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTTextLineBreak)getTypeLoader().parse(reader, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(xmlStreamReader, CTTextLineBreak.type, (XmlOptions)null);
        }
        ...
        public static CTTextLineBreak parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(xmlStreamReader, CTTextLineBreak.type, xmlOptions);
        }
        
        public static CTTextLineBreak parse(final Node node) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(node, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        public static CTTextLineBreak parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTTextLineBreak)getTypeLoader().parse(node, CTTextLineBreak.type, xmlOptions);
        }
        
        @Deprecated
        public static CTTextLineBreak parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTTextLineBreak)getTypeLoader().parse(xmlInputStream, CTTextLineBreak.type, (XmlOptions)null);
        }
        ...
        public static CTTextLineBreak parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTTextLineBreak)getTypeLoader().parse(xmlInputStream, CTTextLineBreak.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTTextLineBreak.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTTextLineBreak.type, xmlOptions);
        }
