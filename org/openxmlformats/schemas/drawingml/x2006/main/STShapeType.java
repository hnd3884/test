...
public interface STShapeType extends XmlToken
{
    ...
    public static final class Factory
    {
        ...
        public static STShapeType newValue(final Object o) {
            return (STShapeType)STShapeType.type.newValue(o);
        }
        
        private static synchronized SchemaTypeLoader getTypeLoader() {
            SchemaTypeLoader typeLoaderForClassLoader = (Factory.typeLoader == null) ? null : Factory.typeLoader.get();
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(STShapeType.class.getClassLoader());
        ...
        public static STShapeType newInstance() {
            return (STShapeType)getTypeLoader().newInstance(STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType newInstance(final XmlOptions xmlOptions) {
            return (STShapeType)getTypeLoader().newInstance(STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final String s) throws XmlException {
            return (STShapeType)getTypeLoader().parse(s, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (STShapeType)getTypeLoader().parse(s, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final File file) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(file, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(file, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final URL url) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(url, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(url, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final InputStream inputStream) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(inputStream, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(inputStream, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final Reader reader) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(reader, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STShapeType)getTypeLoader().parse(reader, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (STShapeType)getTypeLoader().parse(xmlStreamReader, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (STShapeType)getTypeLoader().parse(xmlStreamReader, STShapeType.type, xmlOptions);
        }
        
        public static STShapeType parse(final Node node) throws XmlException {
            return (STShapeType)getTypeLoader().parse(node, STShapeType.type, (XmlOptions)null);
        }
        
        public static STShapeType parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (STShapeType)getTypeLoader().parse(node, STShapeType.type, xmlOptions);
        }
        
        @Deprecated
        public static STShapeType parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (STShapeType)getTypeLoader().parse(xmlInputStream, STShapeType.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static STShapeType parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STShapeType)getTypeLoader().parse(xmlInputStream, STShapeType.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STShapeType.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STShapeType.type, xmlOptions);
        }
