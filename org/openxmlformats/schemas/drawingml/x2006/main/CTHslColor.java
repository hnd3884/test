...
public interface CTHslColor extends XmlObject
{
    ...
    void setHue2(final int p0);
    
    void xsetHue2(final STPositiveFixedAngle p0);
    
    int getSat2();
    
    STPercentage xgetSat2();
    
    void setSat2(final int p0);
    
    void xsetSat2(final STPercentage p0);
    
    int getLum2();
    
    STPercentage xgetLum2();
    
    void setLum2(final int p0);
    
    void xsetLum2(final STPercentage p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTHslColor.class.getClassLoader());
        ...
        public static CTHslColor newInstance() {
            return (CTHslColor)getTypeLoader().newInstance(CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor newInstance(final XmlOptions xmlOptions) {
            return (CTHslColor)getTypeLoader().newInstance(CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final String s) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(s, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(s, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final File file) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(file, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(file, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final URL url) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(url, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(url, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(inputStream, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(inputStream, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final Reader reader) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(reader, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTHslColor)getTypeLoader().parse(reader, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(xmlStreamReader, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(xmlStreamReader, CTHslColor.type, xmlOptions);
        }
        
        public static CTHslColor parse(final Node node) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(node, CTHslColor.type, (XmlOptions)null);
        }
        
        public static CTHslColor parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTHslColor)getTypeLoader().parse(node, CTHslColor.type, xmlOptions);
        }
        
        @Deprecated
        public static CTHslColor parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTHslColor)getTypeLoader().parse(xmlInputStream, CTHslColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTHslColor parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTHslColor)getTypeLoader().parse(xmlInputStream, CTHslColor.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTHslColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTHslColor.type, xmlOptions);
        }
