...
public interface STPresetColorVal extends XmlToken
{
    ...
    public static final class Factory
    {
        ...
        public static STPresetColorVal newValue(final Object o) {
            return (STPresetColorVal)STPresetColorVal.type.newValue(o);
        }
        
        private static synchronized SchemaTypeLoader getTypeLoader() {
            SchemaTypeLoader typeLoaderForClassLoader = (Factory.typeLoader == null) ? null : Factory.typeLoader.get();
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(STPresetColorVal.class.getClassLoader());
        ...
        public static STPresetColorVal newInstance() {
            return (STPresetColorVal)getTypeLoader().newInstance(STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal newInstance(final XmlOptions xmlOptions) {
            return (STPresetColorVal)getTypeLoader().newInstance(STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final String s) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(s, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(s, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final File file) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(file, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(file, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final URL url) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(url, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(url, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final InputStream inputStream) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(inputStream, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(inputStream, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final Reader reader) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(reader, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (STPresetColorVal)getTypeLoader().parse(reader, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(xmlStreamReader, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(xmlStreamReader, STPresetColorVal.type, xmlOptions);
        }
        
        public static STPresetColorVal parse(final Node node) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(node, STPresetColorVal.type, (XmlOptions)null);
        }
        
        public static STPresetColorVal parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (STPresetColorVal)getTypeLoader().parse(node, STPresetColorVal.type, xmlOptions);
        }
        
        @Deprecated
        public static STPresetColorVal parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (STPresetColorVal)getTypeLoader().parse(xmlInputStream, STPresetColorVal.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static STPresetColorVal parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (STPresetColorVal)getTypeLoader().parse(xmlInputStream, STPresetColorVal.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STPresetColorVal.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, STPresetColorVal.type, xmlOptions);
        }
