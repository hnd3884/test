...
public class CTHslColorImpl extends XmlComplexContentImpl implements CTHslColor
{
    ...
    public CTHslColorImpl(final SchemaType schemaType) {
        super(schemaType);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class TintList extends AbstractList<CTPositiveFixedPercentage>
            {
                ...
                public CTPositiveFixedPercentage set(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    final CTPositiveFixedPercentage tintArray = CTHslColorImpl.this.getTintArray(n);
                ...
                public void add(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    CTHslColorImpl.this.insertNewTint(n).set((XmlObject)ctPositiveFixedPercentage);
                }
    ...
    public CTPositiveFixedPercentage[] getTintArray() {
        synchronized (this.monitor()) {
            ...
            this.get_store().find_all_element_users(CTHslColorImpl.TINT$0, (List)list);
    ...
    public void setTintArray(final CTPositiveFixedPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.TINT$0);
    }
    
    public void setTintArray(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPositiveFixedPercentage, CTHslColorImpl.TINT$0, n, (short)2);
    }
    ...
    public List<CTPositiveFixedPercentage> getShadeList() {
        synchronized (this.monitor()) {
            ...
            final class ShadeList extends AbstractList<CTPositiveFixedPercentage>
            {
                ...
                @Override
                public CTPositiveFixedPercentage set(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    final CTPositiveFixedPercentage shadeArray = CTHslColorImpl.this.getShadeArray(n);
                ...
                @Override
                public void add(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    CTHslColorImpl.this.insertNewShade(n).set((XmlObject)ctPositiveFixedPercentage);
                }
    ...
    public CTPositiveFixedPercentage[] getShadeArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.SHADE$2, (List)list);
            final CTPositiveFixedPercentage[] array = new CTPositiveFixedPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setShadeArray(final CTPositiveFixedPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.SHADE$2);
    }
    
    public void setShadeArray(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPositiveFixedPercentage, CTHslColorImpl.SHADE$2, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class CompList extends AbstractList<CTComplementTransform>
            {
                ...
                public CTComplementTransform set(final int n, final CTComplementTransform ctComplementTransform) {
                    final CTComplementTransform compArray = CTHslColorImpl.this.getCompArray(n);
    ...
    public CTComplementTransform[] getCompArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.COMP$4, (List)list);
    ...
    public void setCompArray(final CTComplementTransform[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.COMP$4);
    }
    
    public void setCompArray(final int n, final CTComplementTransform ctComplementTransform) {
        this.generatedSetterHelperImpl((XmlObject)ctComplementTransform, CTHslColorImpl.COMP$4, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class InvList extends AbstractList<CTInverseTransform>
            {
                ...
                public CTInverseTransform set(final int n, final CTInverseTransform ctInverseTransform) {
                    final CTInverseTransform invArray = CTHslColorImpl.this.getInvArray(n);
    ...
    public CTInverseTransform[] getInvArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.INV$6, (List)list);
    ...
    public void setInvArray(final CTInverseTransform[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.INV$6);
    }
    
    public void setInvArray(final int n, final CTInverseTransform ctInverseTransform) {
        this.generatedSetterHelperImpl((XmlObject)ctInverseTransform, CTHslColorImpl.INV$6, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class GrayList extends AbstractList<CTGrayscaleTransform>
            {
                ...
                public CTGrayscaleTransform set(final int n, final CTGrayscaleTransform ctGrayscaleTransform) {
                    final CTGrayscaleTransform grayArray = CTHslColorImpl.this.getGrayArray(n);
    ...
    public CTGrayscaleTransform[] getGrayArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.GRAY$8, (List)list);
    ...
    public void setGrayArray(final CTGrayscaleTransform[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.GRAY$8);
    }
    
    public void setGrayArray(final int n, final CTGrayscaleTransform ctGrayscaleTransform) {
        this.generatedSetterHelperImpl((XmlObject)ctGrayscaleTransform, CTHslColorImpl.GRAY$8, n, (short)2);
    }
    ...
    public List<CTPositiveFixedPercentage> getAlphaList() {
        synchronized (this.monitor()) {
            ...
            final class AlphaList extends AbstractList<CTPositiveFixedPercentage>
            {
                ...
                @Override
                public CTPositiveFixedPercentage set(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    final CTPositiveFixedPercentage alphaArray = CTHslColorImpl.this.getAlphaArray(n);
                ...
                @Override
                public void add(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
                    CTHslColorImpl.this.insertNewAlpha(n).set((XmlObject)ctPositiveFixedPercentage);
                }
    ...
    public CTPositiveFixedPercentage[] getAlphaArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.ALPHA$10, (List)list);
            final CTPositiveFixedPercentage[] array = new CTPositiveFixedPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setAlphaArray(final CTPositiveFixedPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.ALPHA$10);
    }
    
    public void setAlphaArray(final int n, final CTPositiveFixedPercentage ctPositiveFixedPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPositiveFixedPercentage, CTHslColorImpl.ALPHA$10, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class AlphaOffList extends AbstractList<CTFixedPercentage>
            {
                ...
                public CTFixedPercentage set(final int n, final CTFixedPercentage ctFixedPercentage) {
                    final CTFixedPercentage alphaOffArray = CTHslColorImpl.this.getAlphaOffArray(n);
                ...
                public void add(final int n, final CTFixedPercentage ctFixedPercentage) {
                    CTHslColorImpl.this.insertNewAlphaOff(n).set((XmlObject)ctFixedPercentage);
                }
    ...
    public CTFixedPercentage[] getAlphaOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.ALPHAOFF$12, (List)list);
    ...
    public void setAlphaOffArray(final CTFixedPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.ALPHAOFF$12);
    }
    
    public void setAlphaOffArray(final int n, final CTFixedPercentage ctFixedPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctFixedPercentage, CTHslColorImpl.ALPHAOFF$12, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class AlphaModList extends AbstractList<CTPositivePercentage>
            {
                ...
                public CTPositivePercentage set(final int n, final CTPositivePercentage ctPositivePercentage) {
                    final CTPositivePercentage alphaModArray = CTHslColorImpl.this.getAlphaModArray(n);
                ...
                public void add(final int n, final CTPositivePercentage ctPositivePercentage) {
                    CTHslColorImpl.this.insertNewAlphaMod(n).set((XmlObject)ctPositivePercentage);
                }
    ...
    public CTPositivePercentage[] getAlphaModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.ALPHAMOD$14, (List)list);
    ...
    public void setAlphaModArray(final CTPositivePercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.ALPHAMOD$14);
    }
    
    public void setAlphaModArray(final int n, final CTPositivePercentage ctPositivePercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPositivePercentage, CTHslColorImpl.ALPHAMOD$14, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class HueList extends AbstractList<CTPositiveFixedAngle>
            {
                ...
                public CTPositiveFixedAngle set(final int n, final CTPositiveFixedAngle ctPositiveFixedAngle) {
                    final CTPositiveFixedAngle hueArray = CTHslColorImpl.this.getHueArray(n);
    ...
    public CTPositiveFixedAngle[] getHueArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.HUE$16, (List)list);
    ...
    public void setHueArray(final CTPositiveFixedAngle[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.HUE$16);
    }
    
    public void setHueArray(final int n, final CTPositiveFixedAngle ctPositiveFixedAngle) {
        this.generatedSetterHelperImpl((XmlObject)ctPositiveFixedAngle, CTHslColorImpl.HUE$16, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class HueOffList extends AbstractList<CTAngle>
            {
                ...
                public CTAngle set(final int n, final CTAngle ctAngle) {
                    final CTAngle hueOffArray = CTHslColorImpl.this.getHueOffArray(n);
    ...
    public CTAngle[] getHueOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.HUEOFF$18, (List)list);
    ...
    public void setHueOffArray(final CTAngle[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.HUEOFF$18);
    }
    
    public void setHueOffArray(final int n, final CTAngle ctAngle) {
        this.generatedSetterHelperImpl((XmlObject)ctAngle, CTHslColorImpl.HUEOFF$18, n, (short)2);
    }
    ...
    public List<CTPositivePercentage> getHueModList() {
        synchronized (this.monitor()) {
            ...
            final class HueModList extends AbstractList<CTPositivePercentage>
            {
                ...
                @Override
                public CTPositivePercentage set(final int n, final CTPositivePercentage ctPositivePercentage) {
                    final CTPositivePercentage hueModArray = CTHslColorImpl.this.getHueModArray(n);
                ...
                @Override
                public void add(final int n, final CTPositivePercentage ctPositivePercentage) {
                    CTHslColorImpl.this.insertNewHueMod(n).set((XmlObject)ctPositivePercentage);
                }
    ...
    public CTPositivePercentage[] getHueModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.HUEMOD$20, (List)list);
            final CTPositivePercentage[] array = new CTPositivePercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setHueModArray(final CTPositivePercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.HUEMOD$20);
    }
    
    public void setHueModArray(final int n, final CTPositivePercentage ctPositivePercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPositivePercentage, CTHslColorImpl.HUEMOD$20, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class SatList extends AbstractList<CTPercentage>
            {
                ...
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage satArray = CTHslColorImpl.this.getSatArray(n);
                ...
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewSat(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getSatArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.SAT$22, (List)list);
    ...
    public void setSatArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.SAT$22);
    }
    
    public void setSatArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.SAT$22, n, (short)2);
    }
    ...
    public List<CTPercentage> getSatOffList() {
        synchronized (this.monitor()) {
            ...
            final class SatOffList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage satOffArray = CTHslColorImpl.this.getSatOffArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewSatOff(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getSatOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.SATOFF$24, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setSatOffArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.SATOFF$24);
    }
    
    public void setSatOffArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.SATOFF$24, n, (short)2);
    }
    ...
    public List<CTPercentage> getSatModList() {
        synchronized (this.monitor()) {
            ...
            final class SatModList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage satModArray = CTHslColorImpl.this.getSatModArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewSatMod(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getSatModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.SATMOD$26, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setSatModArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.SATMOD$26);
    }
    
    public void setSatModArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.SATMOD$26, n, (short)2);
    }
    ...
    public List<CTPercentage> getLumList() {
        synchronized (this.monitor()) {
            ...
            final class LumList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage lumArray = CTHslColorImpl.this.getLumArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewLum(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getLumArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.LUM$28, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setLumArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.LUM$28);
    }
    
    public void setLumArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.LUM$28, n, (short)2);
    }
    ...
    public List<CTPercentage> getLumOffList() {
        synchronized (this.monitor()) {
            ...
            final class LumOffList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage lumOffArray = CTHslColorImpl.this.getLumOffArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewLumOff(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getLumOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.LUMOFF$30, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setLumOffArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.LUMOFF$30);
    }
    
    public void setLumOffArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.LUMOFF$30, n, (short)2);
    }
    ...
    public List<CTPercentage> getLumModList() {
        synchronized (this.monitor()) {
            ...
            final class LumModList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage lumModArray = CTHslColorImpl.this.getLumModArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewLumMod(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getLumModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.LUMMOD$32, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setLumModArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.LUMMOD$32);
    }
    
    public void setLumModArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.LUMMOD$32, n, (short)2);
    }
    ...
    public List<CTPercentage> getRedList() {
        synchronized (this.monitor()) {
            ...
            final class RedList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage redArray = CTHslColorImpl.this.getRedArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewRed(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getRedArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.RED$34, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setRedArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.RED$34);
    }
    
    public void setRedArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.RED$34, n, (short)2);
    }
    ...
    public List<CTPercentage> getRedOffList() {
        synchronized (this.monitor()) {
            ...
            final class RedOffList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage redOffArray = CTHslColorImpl.this.getRedOffArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewRedOff(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getRedOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.REDOFF$36, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setRedOffArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.REDOFF$36);
    }
    
    public void setRedOffArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.REDOFF$36, n, (short)2);
    }
    ...
    public List<CTPercentage> getRedModList() {
        synchronized (this.monitor()) {
            ...
            final class RedModList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage redModArray = CTHslColorImpl.this.getRedModArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewRedMod(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getRedModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.REDMOD$38, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setRedModArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.REDMOD$38);
    }
    
    public void setRedModArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.REDMOD$38, n, (short)2);
    }
    ...
    public List<CTPercentage> getGreenList() {
        synchronized (this.monitor()) {
            ...
            final class GreenList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage greenArray = CTHslColorImpl.this.getGreenArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewGreen(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getGreenArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.GREEN$40, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setGreenArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.GREEN$40);
    }
    
    public void setGreenArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.GREEN$40, n, (short)2);
    }
    ...
    public List<CTPercentage> getGreenOffList() {
        synchronized (this.monitor()) {
            ...
            final class GreenOffList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage greenOffArray = CTHslColorImpl.this.getGreenOffArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewGreenOff(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getGreenOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.GREENOFF$42, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setGreenOffArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.GREENOFF$42);
    }
    
    public void setGreenOffArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.GREENOFF$42, n, (short)2);
    }
    ...
    public List<CTPercentage> getGreenModList() {
        synchronized (this.monitor()) {
            ...
            final class GreenModList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage greenModArray = CTHslColorImpl.this.getGreenModArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewGreenMod(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getGreenModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.GREENMOD$44, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setGreenModArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.GREENMOD$44);
    }
    
    public void setGreenModArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.GREENMOD$44, n, (short)2);
    }
    ...
    public List<CTPercentage> getBlueList() {
        synchronized (this.monitor()) {
            ...
            final class BlueList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage blueArray = CTHslColorImpl.this.getBlueArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewBlue(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getBlueArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.BLUE$46, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setBlueArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.BLUE$46);
    }
    
    public void setBlueArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.BLUE$46, n, (short)2);
    }
    ...
    public List<CTPercentage> getBlueOffList() {
        synchronized (this.monitor()) {
            ...
            final class BlueOffList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage blueOffArray = CTHslColorImpl.this.getBlueOffArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewBlueOff(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getBlueOffArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.BLUEOFF$48, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setBlueOffArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.BLUEOFF$48);
    }
    
    public void setBlueOffArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.BLUEOFF$48, n, (short)2);
    }
    ...
    public List<CTPercentage> getBlueModList() {
        synchronized (this.monitor()) {
            ...
            final class BlueModList extends AbstractList<CTPercentage>
            {
                ...
                @Override
                public CTPercentage set(final int n, final CTPercentage ctPercentage) {
                    final CTPercentage blueModArray = CTHslColorImpl.this.getBlueModArray(n);
                ...
                @Override
                public void add(final int n, final CTPercentage ctPercentage) {
                    CTHslColorImpl.this.insertNewBlueMod(n).set((XmlObject)ctPercentage);
                }
    ...
    public CTPercentage[] getBlueModArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.BLUEMOD$50, (List)list);
            final CTPercentage[] array = new CTPercentage[list.size()];
            list.toArray(array);
            return array;
        }
    ...
    public void setBlueModArray(final CTPercentage[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.BLUEMOD$50);
    }
    
    public void setBlueModArray(final int n, final CTPercentage ctPercentage) {
        this.generatedSetterHelperImpl((XmlObject)ctPercentage, CTHslColorImpl.BLUEMOD$50, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class GammaList extends AbstractList<CTGammaTransform>
            {
                ...
                public CTGammaTransform set(final int n, final CTGammaTransform ctGammaTransform) {
                    final CTGammaTransform gammaArray = CTHslColorImpl.this.getGammaArray(n);
    ...
    public CTGammaTransform[] getGammaArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.GAMMA$52, (List)list);
    ...
    public void setGammaArray(final CTGammaTransform[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.GAMMA$52);
    }
    
    public void setGammaArray(final int n, final CTGammaTransform ctGammaTransform) {
        this.generatedSetterHelperImpl((XmlObject)ctGammaTransform, CTHslColorImpl.GAMMA$52, n, (short)2);
    }
        ...
        synchronized (this.monitor()) {
            ...
            final class InvGammaList extends AbstractList<CTInverseGammaTransform>
            {
                ...
                public CTInverseGammaTransform set(final int n, final CTInverseGammaTransform ctInverseGammaTransform) {
                    final CTInverseGammaTransform invGammaArray = CTHslColorImpl.this.getInvGammaArray(n);
    ...
    public CTInverseGammaTransform[] getInvGammaArray() {
        synchronized (this.monitor()) {
            this.check_orphaned();
            final ArrayList list = new ArrayList();
            this.get_store().find_all_element_users(CTHslColorImpl.INVGAMMA$54, (List)list);
    ...
    public void setInvGammaArray(final CTInverseGammaTransform[] array) {
        this.check_orphaned();
        this.arraySetterHelper((XmlObject[])array, CTHslColorImpl.INVGAMMA$54);
    }
    
    public void setInvGammaArray(final int n, final CTInverseGammaTransform ctInverseGammaTransform) {
        this.generatedSetterHelperImpl((XmlObject)ctInverseGammaTransform, CTHslColorImpl.INVGAMMA$54, n, (short)2);
    }
