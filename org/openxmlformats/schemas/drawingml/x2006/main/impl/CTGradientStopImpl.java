...
public class CTGradientStopImpl extends XmlComplexContentImpl implements CTGradientStop
{
    ...
    public CTGradientStopImpl(final SchemaType schemaType) {
        super(schemaType);
    }
    ...
    public void setScrgbClr(final CTScRgbColor ctScRgbColor) {
        this.generatedSetterHelperImpl((XmlObject)ctScRgbColor, CTGradientStopImpl.SCRGBCLR$0, 0, (short)1);
    }
    ...
    public void setSrgbClr(final CTSRgbColor ctsRgbColor) {
        this.generatedSetterHelperImpl((XmlObject)ctsRgbColor, CTGradientStopImpl.SRGBCLR$2, 0, (short)1);
    }
    ...
    public void setHslClr(final CTHslColor ctHslColor) {
        this.generatedSetterHelperImpl((XmlObject)ctHslColor, CTGradientStopImpl.HSLCLR$4, 0, (short)1);
    }
    ...
    public void setSysClr(final CTSystemColor ctSystemColor) {
        this.generatedSetterHelperImpl((XmlObject)ctSystemColor, CTGradientStopImpl.SYSCLR$6, 0, (short)1);
    }
    ...
    public void setSchemeClr(final CTSchemeColor ctSchemeColor) {
        this.generatedSetterHelperImpl((XmlObject)ctSchemeColor, CTGradientStopImpl.SCHEMECLR$8, 0, (short)1);
    }
    ...
    public void setPrstClr(final CTPresetColor ctPresetColor) {
        this.generatedSetterHelperImpl((XmlObject)ctPresetColor, CTGradientStopImpl.PRSTCLR$10, 0, (short)1);
    }
