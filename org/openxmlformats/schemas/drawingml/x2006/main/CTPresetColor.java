...
public interface CTPresetColor extends XmlObject
{
    ...
    void setVal(final STPresetColorVal.Enum p0);
    
    void xsetVal(final STPresetColorVal p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTPresetColor.class.getClassLoader());
        ...
        public static CTPresetColor newInstance() {
            return (CTPresetColor)getTypeLoader().newInstance(CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor newInstance(final XmlOptions xmlOptions) {
            return (CTPresetColor)getTypeLoader().newInstance(CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final String s) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(s, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(s, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final File file) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(file, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(file, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final URL url) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(url, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(url, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(inputStream, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(inputStream, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final Reader reader) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(reader, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTPresetColor)getTypeLoader().parse(reader, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(xmlStreamReader, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(xmlStreamReader, CTPresetColor.type, xmlOptions);
        }
        
        public static CTPresetColor parse(final Node node) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(node, CTPresetColor.type, (XmlOptions)null);
        }
        
        public static CTPresetColor parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTPresetColor)getTypeLoader().parse(node, CTPresetColor.type, xmlOptions);
        }
        
        @Deprecated
        public static CTPresetColor parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTPresetColor)getTypeLoader().parse(xmlInputStream, CTPresetColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTPresetColor parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTPresetColor)getTypeLoader().parse(xmlInputStream, CTPresetColor.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTPresetColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTPresetColor.type, xmlOptions);
        }
