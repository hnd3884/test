...
public interface CTSchemeColor extends XmlObject
{
    ...
    void setVal(final STSchemeColorVal.Enum p0);
    
    void xsetVal(final STSchemeColorVal p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSchemeColor.class.getClassLoader());
        ...
        public static CTSchemeColor newInstance() {
            return (CTSchemeColor)getTypeLoader().newInstance(CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor newInstance(final XmlOptions xmlOptions) {
            return (CTSchemeColor)getTypeLoader().newInstance(CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final String s) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(s, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(s, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final File file) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(file, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(file, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final URL url) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(url, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(url, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(inputStream, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(inputStream, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final Reader reader) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(reader, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSchemeColor)getTypeLoader().parse(reader, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(xmlStreamReader, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(xmlStreamReader, CTSchemeColor.type, xmlOptions);
        }
        
        public static CTSchemeColor parse(final Node node) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(node, CTSchemeColor.type, (XmlOptions)null);
        }
        
        public static CTSchemeColor parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSchemeColor)getTypeLoader().parse(node, CTSchemeColor.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSchemeColor parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSchemeColor)getTypeLoader().parse(xmlInputStream, CTSchemeColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSchemeColor parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSchemeColor)getTypeLoader().parse(xmlInputStream, CTSchemeColor.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSchemeColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSchemeColor.type, xmlOptions);
        }
