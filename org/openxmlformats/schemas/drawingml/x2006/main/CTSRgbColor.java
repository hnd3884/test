...
public interface CTSRgbColor extends XmlObject
{
    ...
    void xsetVal(final STHexBinary3 p0);
    ...
    public static final class Factory
    {
        ...
        private static synchronized SchemaTypeLoader getTypeLoader() {
            ...
            if (typeLoaderForClassLoader == null) {
                typeLoaderForClassLoader = XmlBeans.typeLoaderForClassLoader(CTSRgbColor.class.getClassLoader());
        ...
        public static CTSRgbColor newInstance() {
            return (CTSRgbColor)getTypeLoader().newInstance(CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor newInstance(final XmlOptions xmlOptions) {
            return (CTSRgbColor)getTypeLoader().newInstance(CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final String s) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(s, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final String s, final XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(s, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final File file) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(file, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final File file, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(file, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final URL url) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(url, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final URL url, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(url, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final InputStream inputStream) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(inputStream, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final InputStream inputStream, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(inputStream, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final Reader reader) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(reader, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final Reader reader, final XmlOptions xmlOptions) throws XmlException, IOException {
            return (CTSRgbColor)getTypeLoader().parse(reader, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final XMLStreamReader xmlStreamReader) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(xmlStreamReader, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final XMLStreamReader xmlStreamReader, final XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(xmlStreamReader, CTSRgbColor.type, xmlOptions);
        }
        
        public static CTSRgbColor parse(final Node node) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(node, CTSRgbColor.type, (XmlOptions)null);
        }
        
        public static CTSRgbColor parse(final Node node, final XmlOptions xmlOptions) throws XmlException {
            return (CTSRgbColor)getTypeLoader().parse(node, CTSRgbColor.type, xmlOptions);
        }
        
        @Deprecated
        public static CTSRgbColor parse(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return (CTSRgbColor)getTypeLoader().parse(xmlInputStream, CTSRgbColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static CTSRgbColor parse(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return (CTSRgbColor)getTypeLoader().parse(xmlInputStream, CTSRgbColor.type, xmlOptions);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSRgbColor.type, (XmlOptions)null);
        }
        
        @Deprecated
        public static XMLInputStream newValidatingXMLInputStream(final XMLInputStream xmlInputStream, final XmlOptions xmlOptions) throws XmlException, XMLStreamException {
            return getTypeLoader().newValidatingXMLInputStream(xmlInputStream, CTSRgbColor.type, xmlOptions);
        }
