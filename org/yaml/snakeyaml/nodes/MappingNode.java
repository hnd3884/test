...
public class MappingNode extends CollectionNode<NodeTuple>
{
    ...
    public MappingNode(final Tag tag, final boolean resolved, final List<NodeTuple> value, final Mark startMark, final Mark endMark, final DumperOptions.FlowStyle flowStyle) {
    ...
    public MappingNode(final Tag tag, final List<NodeTuple> value, final DumperOptions.FlowStyle flowStyle) {
    ...
    public void setValue(final List<NodeTuple> mergedValue) {
