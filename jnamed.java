...
public class jnamed
{
    ...
    public jnamed(final String conffile) throws IOException, ZoneTransferException {
        ...
        try {
            ...
            final Iterator iaddr = addresses.iterator();
            while (iaddr.hasNext()) {
                final InetAddress addr2 = iaddr.next();
                final Iterator iport = ports.iterator();
                while (iport.hasNext()) {
                    final int port = iport.next();
    ...
    public static void main(final String[] args) {
        ...
        catch (final ZoneTransferException e2) {
