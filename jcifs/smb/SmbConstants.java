...
interface SmbConstants
{
    ...
    public static final boolean USE_EXTSEC = Config.getBoolean("jcifs.smb.client.useExtendedSecurity", false);
    ...
    public static final int DEFAULT_FLAGS2 = 0x3 | (SmbConstants.USE_EXTSEC ? 2048 : 0) | (SmbConstants.SIGNPREF ? 4 : 0) | (SmbConstants.USE_NTSTATUS ? 16384 : 0) | (SmbConstants.USE_UNICODE ? 32768 : 0);
    public static final int DEFAULT_CAPABILITIES = (SmbConstants.USE_NTSMBS ? 16 : 0) | (SmbConstants.USE_NTSTATUS ? 64 : 0) | (SmbConstants.USE_UNICODE ? 4 : 0) | 0x1000;
    public static final int FLAGS2 = Config.getInt("jcifs.smb.client.flags2", SmbConstants.DEFAULT_FLAGS2);
    public static final int CAPABILITIES = Config.getInt("jcifs.smb.client.capabilities", SmbConstants.DEFAULT_CAPABILITIES);
