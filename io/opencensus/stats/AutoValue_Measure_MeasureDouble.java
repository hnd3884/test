...
final class AutoValue_Measure_MeasureDouble extends MeasureDouble
{
    ...
    AutoValue_Measure_MeasureDouble(final String name, final String description, final String unit) {
        if (name == null) {
    ...
    public boolean equals(final Object o) {
        ...
        if (o instanceof MeasureDouble) {
            final MeasureDouble that = (MeasureDouble)o;
