...
public final class KQueueDomainSocketChannelConfig extends KQueueChannelConfig implements DomainSocketChannelConfig, DuplexChannelConfig
{
    ...
    public KQueueDomainSocketChannelConfig setSendBufferSize(final int sendBufferSize) {
        try {
    ...
    public KQueueDomainSocketChannelConfig setReceiveBufferSize(final int receiveBufferSize) {
        try {
    ...
    @Override
    public KQueueDomainSocketChannelConfig setAllowHalfClosure(final boolean allowHalfClosure) {
