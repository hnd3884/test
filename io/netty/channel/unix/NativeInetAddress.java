...
public final class NativeInetAddress
{
    ...
    public static void copyIpv4MappedIpv6Address(final byte[] ipv4, final byte[] ipv6) {
        System.arraycopy(NativeInetAddress.IPV4_MAPPED_IPV6_PREFIX, 0, ipv6, 0, NativeInetAddress.IPV4_MAPPED_IPV6_PREFIX.length);
