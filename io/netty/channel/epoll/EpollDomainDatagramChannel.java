...
public final class EpollDomainDatagramChannel extends AbstractEpollChannel implements DomainDatagramChannel
{
    ...
    public EpollDomainDatagramChannel(final int fd) {
        this(new LinuxSocket(fd), true);
    }
    
    private EpollDomainDatagramChannel(final LinuxSocket socket, final boolean active) {
    ...
    protected Object filterOutboundMessage(final Object msg) {
        ...
        throw new UnsupportedOperationException("unsupported message type: " + StringUtil.simpleClassName(msg) + EpollDomainDatagramChannel.EXPECTED_TYPES);
    }
    ...
    public ChannelMetadata metadata() {
        return EpollDomainDatagramChannel.METADATA;
    }
    ...
    final class EpollDomainDatagramChannelUnsafe extends AbstractEpollUnsafe
    {
        ...
        void epollInReady() {
            ...
            final DomainDatagramChannelConfig config = EpollDomainDatagramChannel.this.config();
            ...
            final ChannelPipeline pipeline = EpollDomainDatagramChannel.this.pipeline();
            ...
            try {
                ...
                try {
                    final boolean connected = EpollDomainDatagramChannel.this.isConnected();
                    do {
