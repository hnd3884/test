...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel
{
    ...
    protected final int maxMessagesPerWrite() {
        ...
        final Integer value = config.getOption(ChannelOption.MAX_MESSAGES_PER_WRITE);
        if (value == null) {
    ...
    protected void validateFileRegion(final DefaultFileRegion region, final long position) throws IOException {
    ...
    protected abstract class AbstractUnsafe implements Unsafe
    {
        ...
        public void close(final ChannelPromise promise) {
            this.assertEventLoop();
            final ClosedChannelException closedChannelException = StacklessClosedChannelException.newInstance(AbstractChannel.class, "close(ChannelPromise)");
        ...
        protected final void handleWriteError(final Throwable t) {
        ...
        private ClosedChannelException newClosedChannelException(final Throwable cause, final String method) {
            final ClosedChannelException exception = StacklessClosedChannelException.newInstance(AbstractUnsafe.class, method);
            if (cause != null) {
