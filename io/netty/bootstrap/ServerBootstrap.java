...
public class ServerBootstrap extends AbstractBootstrap<ServerBootstrap, ServerChannel>
{
    ...
    public ServerBootstrap() {
        ...
        this.childAttrs = new ConcurrentHashMap<AttributeKey<?>, Object>();
    ...
    @Override
    void init(final Channel channel) {
        AbstractBootstrap.setChannelOptions(channel, this.newOptionsArray(), ServerBootstrap.logger);
        AbstractBootstrap.setAttributes(channel, this.newAttributesArray());
        final ChannelPipeline p = channel.pipeline();
        final EventLoopGroup currentChildGroup = this.childGroup;
        final ChannelHandler currentChildHandler = this.childHandler;
        final Map.Entry<ChannelOption<?>, Object>[] currentChildOptions = AbstractBootstrap.newOptionsArray(this.childOptions);
        final Map.Entry<AttributeKey<?>, Object>[] currentChildAttrs = AbstractBootstrap.newAttributesArray(this.childAttrs);
