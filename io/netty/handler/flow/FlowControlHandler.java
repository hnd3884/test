...
public class FlowControlHandler extends ChannelDuplexHandler
{
    ...
    private static final class RecyclableArrayDeque extends ArrayDeque<Object>
    {
        ...
        private static final ObjectPool<RecyclableArrayDeque> RECYCLER;
        ...
        private RecyclableArrayDeque(final int numElements, final ObjectPool.Handle<RecyclableArrayDeque> handle) {
            super(numElements);
            this.handle = handle;
        }
        ...
        static {
            RECYCLER = ObjectPool.newPool((ObjectPool.ObjectCreator<RecyclableArrayDeque>)new ObjectPool.ObjectCreator<RecyclableArrayDeque>() {
                @Override
                public RecyclableArrayDeque newObject(final ObjectPool.Handle<RecyclableArrayDeque> handle) {
                    return new RecyclableArrayDeque(2, (ObjectPool.Handle)handle);
                }
            });
        }
    }
