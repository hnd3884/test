...
abstract class ExtendedOpenSslSession extends ExtendedSSLSession implements OpenSslSession
{
    ...
    ExtendedOpenSslSession(final OpenSslSession wrapped) {
    ...
    @Override
    public final void setLocalCertificate(final Certificate[] localCertificate) {
    ...
    @Override
    public final void tryExpandApplicationBufferSize(final int packetLengthDataOnly) {
        this.wrapped.tryExpandApplicationBufferSize(packetLengthDataOnly);
    }
    
    @Override
    public final String[] getLocalSupportedSignatureAlgorithms() {
        return ExtendedOpenSslSession.LOCAL_SUPPORTED_SIGNATURE_ALGORITHMS.clone();
    }
    ...
    @Override
    public final void putValue(final String name, Object value) {
    ...
    public final Object getValue(final String s) {
        final Object value = this.wrapped.getValue(s);
    ...
    @Override
    public final void removeValue(final String s) {
    ...
    static {
        LOCAL_SUPPORTED_SIGNATURE_ALGORITHMS = new String[] { "SHA512withRSA", "SHA512withECDSA", "SHA384withRSA", "SHA384withECDSA", "SHA256withRSA", "SHA256withECDSA", "SHA224withRSA", "SHA224withECDSA", "SHA1withRSA", "SHA1withECDSA", "RSASSA-PSS" };
    }
    ...
    private final class SSLSessionBindingListenerDecorator implements SSLSessionBindingListener
    {
        ...
        SSLSessionBindingListenerDecorator(final SSLSessionBindingListener delegate) {
