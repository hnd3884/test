...
public class DefaultFullBinaryMemcacheRequest extends DefaultBinaryMemcacheRequest implements FullBinaryMemcacheRequest
{
    ...
    private DefaultFullBinaryMemcacheRequest newInstance(final ByteBuf key, final ByteBuf extras, final ByteBuf content) {
        final DefaultFullBinaryMemcacheRequest newInstance = new DefaultFullBinaryMemcacheRequest(key, extras, content);
