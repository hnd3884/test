...
public class ContextBoundUnmarshallerProvider extends DefaultUnmarshallerProvider
{
    ...
    public Unmarshaller getUnmarshaller(final ChannelHandlerContext ctx) throws Exception {
        final Attribute<Unmarshaller> attr = ctx.channel().attr(ContextBoundUnmarshallerProvider.UNMARSHALLER);
    ...
    static {
        UNMARSHALLER = AttributeKey.valueOf(ContextBoundUnmarshallerProvider.class, "UNMARSHALLER");
    }
}
