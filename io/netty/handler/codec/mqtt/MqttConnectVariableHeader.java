...
public final class MqttConnectVariableHeader
{
    ...
    public MqttConnectVariableHeader(final String name, final int version, final boolean hasUserName, final boolean hasPassword, final boolean isWillRetain, final int willQos, final boolean isWillFlag, final boolean isCleanSession, final int keepAliveTimeSeconds, final MqttProperties properties) {
        this.name = name;
