        ...
        while (headerBlock.isReadable()) {
            switch (this.state) {
                ...
                case READ_NAME: {
                    ...
                    if (((Headers<String, V, T>)frame.headers()).contains(this.name)) {
                        this.state = State.ERROR;
                        frame.setInvalid();
                        continue;
                    }
                ...
                case READ_VALUE_LENGTH: {
                    ...
                    if (this.length == 0) {
                        if (!frame.isTruncated()) {
                            ((Headers<String, String, Headers>)frame.headers()).add(this.name, "");
                        }
                        this.name = null;
                        if (--this.numHeaders == 0) {
                            this.state = State.END_HEADER_BLOCK;
                ...
                case READ_VALUE: {
                    ...
                    while (index < this.length) {
                        ...
                        try {
                            ((Headers<String, String, Headers>)frame.headers()).add(this.name, value);
                        }
