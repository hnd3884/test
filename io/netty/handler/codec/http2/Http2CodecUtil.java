...
public final class Http2CodecUtil
{
    ...
    static boolean isStreamIdValid(final int streamId, final boolean server) {
        return isStreamIdValid(streamId) && server == ((streamId & 0x1) == 0x0);
    }
    ...
    static {
        HTTP_UPGRADE_SETTINGS_HEADER = AsciiString.cached("HTTP2-Settings");
    ...
    static final class SimpleChannelPromiseAggregator extends DefaultChannelPromise
    {
        ...
        private void setAggregateFailure(final Throwable cause) {
            if (this.aggregateFailure == null) {
