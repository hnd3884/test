...
public class Http2Exception extends Exception
{
    ...
    static Http2Exception newStatic(final Http2Error error, final String message, final ShutdownHint shutdownHint, final Class<?> clazz, final String method) {
    ...
    private Http2Exception(final Http2Error error, final String message, final ShutdownHint shutdownHint, final boolean shared) {
    ...
    private static final class StacklessHttp2Exception extends Http2Exception
    {
        ...
        StacklessHttp2Exception(final Http2Error error, final String message, final ShutdownHint shutdownHint) {
            super(error, message, shutdownHint);
        }
        
        StacklessHttp2Exception(final Http2Error error, final String message, final ShutdownHint shutdownHint, final boolean shared) {
