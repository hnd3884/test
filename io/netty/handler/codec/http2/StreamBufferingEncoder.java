...
public class StreamBufferingEncoder extends DecoratingHttp2ConnectionEncoder
{
    ...
    private void cancelGoAwayStreams(final GoAwayDetail goAwayDetail) {
        final Iterator<PendingStream> iter = this.pendingStreams.values().iterator();
        final Exception e = new Http2GoAwayException(goAwayDetail);
        while (iter.hasNext()) {
    ...
    private static final class GoAwayDetail
    {
        ...
        GoAwayDetail(final int lastStreamId, final long errorCode, final byte[] debugData) {
    ...
    public static final class Http2GoAwayException extends Http2Exception
    {
        ...
        Http2GoAwayException(final GoAwayDetail goAwayDetail) {
        ...
        public byte[] debugData() {
            return this.goAwayDetail.debugData.clone();
        }
    }
