...
public interface Http2FrameListener
{
    ...
    void onPingRead(final ChannelHandlerContext p0, final long p1) throws Http2Exception;
    
    void onPingAckRead(final ChannelHandlerContext p0, final long p1) throws Http2Exception;
