...
public interface Http2Connection
{
    ...
    void goAwayReceived(final int p0, final long p1, final ByteBuf p2) throws Http2Exception;
    
    boolean goAwaySent();
    
    boolean goAwaySent(final int p0, final long p1, final ByteBuf p2) throws Http2Exception;
