...
public final class HttpConversionUtil
{
    ...
    public static FullHttpResponse toFullHttpResponse(final int streamId, final Http2Headers http2Headers, final ByteBuf content, final boolean validateHttpHeaders) throws Http2Exception {
    ...
    private static String extractPath(final CharSequence method, final Http2Headers headers) {
    ...
    public static FullHttpRequest toFullHttpRequest(final int streamId, final Http2Headers http2Headers, final ByteBuf content, final boolean validateHttpHeaders) throws Http2Exception {
    ...
    public static void addHttp2ToHttpHeaders(final int streamId, final Http2Headers inputHeaders, final FullHttpMessage destinationMessage, final boolean addToTrailer) throws Http2Exception {
    ...
    public static void toHttp2Headers(final HttpHeaders inHeaders, final Http2Headers out) {
        ...
        while (iter.hasNext()) {
            ...
            if (!HttpConversionUtil.HTTP_TO_HTTP2_HEADER_BLACKLIST.contains(aName) && !connectionBlacklist.contains(aName)) {
    ...
    private static final class Http2ToHttpHeaderTranslator
    {
        ...
        void translateHeaders(final Iterable<Map.Entry<CharSequence, CharSequence>> inputHeaders) throws Http2Exception {
