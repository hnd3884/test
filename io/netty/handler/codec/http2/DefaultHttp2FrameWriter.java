...
public class DefaultHttp2FrameWriter implements Http2FrameWriter, Http2FrameSizePolicy, Configuration
{
        ...
        try {
            ...
            if (padding == 0) {
                ...
                if (remainingData != this.maxFrameSize) {
                    ...
                    lastFrame2 = ((data.readableBytes() != this.maxFrameSize) ? data.readSlice(this.maxFrameSize) : data);
                    data = null;
                    ctx.write(lastFrame2, promiseAggregator.newPromise());
                }
                do {
    ...
    public ChannelFuture writeSettings(final ChannelHandlerContext ctx, final Http2Settings settings, final ChannelPromise promise) {
        try {
            ...
            final ByteBuf buf = ctx.alloc().buffer(9 + payloadLength);
    ...
    private ChannelFuture writeContinuationFrames(final ChannelHandlerContext ctx, final int streamId, final ByteBuf headerBlock, final Http2CodecUtil.SimpleChannelPromiseAggregator promiseAggregator) {
