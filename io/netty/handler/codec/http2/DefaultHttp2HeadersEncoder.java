...
public class DefaultHttp2HeadersEncoder implements Http2HeadersEncoder, Configuration
{
    ...
    public DefaultHttp2HeadersEncoder(final SensitivityDetector sensitivityDetector, final boolean ignoreMaxHeaderListSize, final int dynamicTableArraySizeHint, final int huffCodeThreshold) {
