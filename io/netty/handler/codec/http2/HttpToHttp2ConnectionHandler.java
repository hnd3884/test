...
public class HttpToHttp2ConnectionHandler extends Http2ConnectionHandler
{
    ...
    protected HttpToHttp2ConnectionHandler(final Http2ConnectionDecoder decoder, final Http2ConnectionEncoder encoder, final Http2Settings initialSettings, final boolean validateHeaders, final boolean decoupleCloseAndGoAway) {
        this(decoder, encoder, initialSettings, validateHeaders, decoupleCloseAndGoAway, null);
    }
    
    protected HttpToHttp2ConnectionHandler(final Http2ConnectionDecoder decoder, final Http2ConnectionEncoder encoder, final Http2Settings initialSettings, final boolean validateHeaders, final boolean decoupleCloseAndGoAway, final HttpScheme httpScheme) {
