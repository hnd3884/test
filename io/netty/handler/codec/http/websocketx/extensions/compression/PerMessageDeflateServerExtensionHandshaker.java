...
public final class PerMessageDeflateServerExtensionHandshaker implements WebSocketServerExtensionHandshaker
{
    ...
    public PerMessageDeflateServerExtensionHandshaker(final int compressionLevel, final boolean allowServerWindowSize, final int preferredClientWindowSize, final boolean allowServerNoContext, final boolean preferredClientNoContext, final WebSocketExtensionFilterProvider extensionFilterProvider) {
    ...
    private static class PermessageDeflateExtension implements WebSocketServerExtension
    {
        ...
        PermessageDeflateExtension(final int compressionLevel, final boolean serverNoContext, final int serverWindowSize, final boolean clientNoContext, final int clientWindowSize, final WebSocketExtensionFilterProvider extensionFilterProvider) {
            this.compressionLevel = compressionLevel;
