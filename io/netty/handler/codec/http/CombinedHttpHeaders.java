...
public class CombinedHttpHeaders extends DefaultHttpHeaders
{
    ...
    private static final class CombinedHttpHeadersImpl extends DefaultHeaders<CharSequence, CharSequence, CombinedHttpHeadersImpl>
    {
        ...
        CombinedHttpHeadersImpl(final HashingStrategy<CharSequence> nameHashingStrategy, final ValueConverter<CharSequence> valueConverter, final NameValidator<CharSequence> nameValidator) {
