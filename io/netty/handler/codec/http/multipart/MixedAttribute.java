...
public class MixedAttribute implements Attribute
{
        ...
        if (this.attribute instanceof MemoryAttribute) {
            try {
                ...
                if (this.attribute.length() + buffer.readableBytes() > this.limitSize) {
                    final DiskAttribute diskAttribute = new DiskAttribute(this.attribute.getName(), this.attribute.definedLength(), this.baseDir, this.deleteOnExit);
    ...
    public void setContent(final ByteBuf buffer) throws IOException {
        ...
        if (buffer.readableBytes() > this.limitSize && this.attribute instanceof MemoryAttribute) {
            (this.attribute = new DiskAttribute(this.attribute.getName(), this.attribute.definedLength(), this.baseDir, this.deleteOnExit)).setMaxSize(this.maxSize);
        }
