...
public final class DateFormatter
{
    ...
    private boolean tryParseMonth(final CharSequence txt, final int tokenStart, final int tokenEnd) {
        ...
        final char monthChar1 = AsciiString.toLowerCase(txt.charAt(tokenStart));
        final char monthChar2 = AsciiString.toLowerCase(txt.charAt(tokenStart + 1));
        final char monthChar3 = AsciiString.toLowerCase(txt.charAt(tokenStart + 2));
