...
abstract class AbstractPooledDerivedByteBuf extends AbstractReferenceCountedByteBuf
{
    ...
    AbstractPooledDerivedByteBuf(final ObjectPool.Handle<? extends AbstractPooledDerivedByteBuf> recyclerHandle) {
        super(0);
        this.recyclerHandle = (ObjectPool.Handle<AbstractPooledDerivedByteBuf>)recyclerHandle;
    }
    ...
    private static final class PooledNonRetainedDuplicateByteBuf extends UnpooledDuplicatedByteBuf
    {
        ...
        PooledNonRetainedDuplicateByteBuf(final ByteBuf referenceCountDelegate, final AbstractByteBuf buffer) {
            super(buffer);
    ...
    private static final class PooledNonRetainedSlicedByteBuf extends UnpooledSlicedByteBuf
    {
        ...
        PooledNonRetainedSlicedByteBuf(final ByteBuf referenceCountDelegate, final AbstractByteBuf buffer, final int index, final int length) {
