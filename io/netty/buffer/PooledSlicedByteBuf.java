...
final class PooledSlicedByteBuf extends AbstractPooledDerivedByteBuf
{
    ...
    private PooledSlicedByteBuf(final ObjectPool.Handle<PooledSlicedByteBuf> handle) {
        super(handle);
    }
    ...
    static {
        RECYCLER = ObjectPool.newPool((ObjectPool.ObjectCreator<PooledSlicedByteBuf>)new ObjectPool.ObjectCreator<PooledSlicedByteBuf>() {
            @Override
            public PooledSlicedByteBuf newObject(final ObjectPool.Handle<PooledSlicedByteBuf> handle) {
