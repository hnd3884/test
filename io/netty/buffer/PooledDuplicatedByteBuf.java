...
final class PooledDuplicatedByteBuf extends AbstractPooledDerivedByteBuf
{
    ...
    private PooledDuplicatedByteBuf(final ObjectPool.Handle<PooledDuplicatedByteBuf> handle) {
        super(handle);
    }
    ...
    static {
        RECYCLER = ObjectPool.newPool((ObjectPool.ObjectCreator<PooledDuplicatedByteBuf>)new ObjectPool.ObjectCreator<PooledDuplicatedByteBuf>() {
            @Override
            public PooledDuplicatedByteBuf newObject(final ObjectPool.Handle<PooledDuplicatedByteBuf> handle) {
