    ...
    public PooledByteBufAllocator(final boolean preferDirect, final int nHeapArena, final int nDirectArena, int pageSize, final int maxOrder, final int smallCacheSize, final int normalCacheSize, final boolean useCacheForAllThreads, final int directMemoryCacheAlignment) {
        ...
        if (nHeapArena > 0) {
            ...
            for (int i = 0; i < this.heapArenas.length; ++i) {
                final PoolArena.HeapArena arena = new PoolArena.HeapArena(this, pageSize, pageShifts, this.chunkSize, directMemoryCacheAlignment);
        ...
        if (nDirectArena > 0) {
            ...
            for (int i = 0; i < this.directArenas.length; ++i) {
                final PoolArena.DirectArena arena2 = new PoolArena.DirectArena(this, pageSize, pageShifts, this.chunkSize, directMemoryCacheAlignment);
    ...
    final class PoolThreadLocalCache extends FastThreadLocal<PoolThreadCache>
    {
        ...
        protected synchronized PoolThreadCache initialValue() {
            ...
            if (this.useCacheForAllThreads || current instanceof FastThreadLocalThread) {
                final PoolThreadCache cache = new PoolThreadCache(heapArena, directArena, PooledByteBufAllocator.this.smallCacheSize, PooledByteBufAllocator.this.normalCacheSize, PooledByteBufAllocator.DEFAULT_MAX_CACHED_BUFFER_CAPACITY, PooledByteBufAllocator.DEFAULT_CACHE_TRIM_INTERVAL);
