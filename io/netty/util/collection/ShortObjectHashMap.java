...
public class ShortObjectHashMap<V> implements ShortObjectMap<V>
{
    ...
    private final class KeySet extends AbstractSet<Short>
    {
        ...
        public boolean retainAll(final Collection<?> retainedKeys) {
            ...
            final Iterator<PrimitiveEntry<V>> iter = ShortObjectHashMap.this.entries().iterator();
            while (iter.hasNext()) {
    ...
    private final class PrimitiveIterator implements Iterator<PrimitiveEntry<V>>, PrimitiveEntry<V>
    {
        ...
        @Override
        public V value() {
            return (V)toExternal(ShortObjectHashMap.this.values[this.entryIndex]);
        }
        
        @Override
        public void setValue(final V value) {
            ShortObjectHashMap.this.values[this.entryIndex] = (V)toInternal(value);
        }
    }
    ...
    final class MapEntry implements Map.Entry<Short, V>
    {
        ...
        public V setValue(final V value) {
            this.verifyExists();
            final V prevValue = (V)toExternal(ShortObjectHashMap.this.values[this.entryIndex]);
            ShortObjectHashMap.this.values[this.entryIndex] = (V)toInternal(value);
            return prevValue;
        }
