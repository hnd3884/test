...
public class CharObjectHashMap<V> implements CharObjectMap<V>
{
    ...
    private final class KeySet extends AbstractSet<Character>
    {
        ...
        public boolean retainAll(final Collection<?> retainedKeys) {
            ...
            final Iterator<PrimitiveEntry<V>> iter = CharObjectHashMap.this.entries().iterator();
            while (iter.hasNext()) {
    ...
    private final class PrimitiveIterator implements Iterator<PrimitiveEntry<V>>, PrimitiveEntry<V>
    {
        ...
        @Override
        public V value() {
            return (V)toExternal(CharObjectHashMap.this.values[this.entryIndex]);
        }
        
        @Override
        public void setValue(final V value) {
            CharObjectHashMap.this.values[this.entryIndex] = (V)toInternal(value);
        }
    }
    ...
    final class MapEntry implements Map.Entry<Character, V>
    {
        ...
        public V setValue(final V value) {
            this.verifyExists();
            final V prevValue = (V)toExternal(CharObjectHashMap.this.values[this.entryIndex]);
            CharObjectHashMap.this.values[this.entryIndex] = (V)toInternal(value);
            return prevValue;
        }
