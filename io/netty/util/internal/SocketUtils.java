...
public final class SocketUtils
{
    ...
    private static <T> Enumeration<T> empty() {
        return (Enumeration<T>)SocketUtils.EMPTY;
    }
    ...
    public static Enumeration<InetAddress> addressesFromNetworkInterface(final NetworkInterface intf) {
        final Enumeration<InetAddress> addresses = AccessController.doPrivileged((PrivilegedAction<Enumeration<InetAddress>>)new PrivilegedAction<Enumeration<InetAddress>>() {
            @Override
