...
public interface OpenType
{
    ...
    byte[] getFontTable(final int p0);
    
    byte[] getFontTable(final String p0);
    
    byte[] getFontTable(final int p0, final int p1, final int p2);
    
    byte[] getFontTable(final String p0, final int p1, final int p2);
    
    int getFontTableSize(final int p0);
    
    int getFontTableSize(final String p0);
}
