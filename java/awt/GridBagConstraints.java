...
public class GridBagConstraints implements Cloneable, Serializable
{
    ...
    public GridBagConstraints(final int gridx, final int gridy, final int gridwidth, final int gridheight, final double weightx, final double weighty, final int anchor, final int fill, final Insets insets, final int ipadx, final int ipady) {
        this.gridx = gridx;
        this.gridy = gridy;
    ...
    public Object clone() {
        try {
            final GridBagConstraints gridBagConstraints = (GridBagConstraints)super.clone();
