...
class ByteBufferAsDoubleBufferL extends DoubleBuffer
{
    ...
    ByteBufferAsDoubleBufferL(final ByteBuffer bb) {
    ...
    ByteBufferAsDoubleBufferL(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public DoubleBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsDoubleBufferL(this.bb, -1, 0, n, n, n2);
    }
    ...
    public DoubleBuffer put(final double n) {
        Bits.putDoubleL(this.bb, this.ix(this.nextPutIndex()), n);
        return this;
    }
    
    @Override
    public DoubleBuffer put(final int n, final double n2) {
        Bits.putDoubleL(this.bb, this.ix(this.checkIndex(n)), n2);
        return this;
    }
