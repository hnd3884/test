...
class ByteBufferAsCharBufferB extends CharBuffer
{
    ...
    ByteBufferAsCharBufferB(final ByteBuffer bb) {
    ...
    ByteBufferAsCharBufferB(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public CharBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsCharBufferB(this.bb, -1, 0, n, n, n2);
    }
    ...
    public char get(final int n) {
        return Bits.getCharB(this.bb, this.ix(this.checkIndex(n)));
    }
    
    @Override
    char getUnchecked(final int n) {
        return Bits.getCharB(this.bb, this.ix(n));
    }
    
    @Override
    public CharBuffer put(final char c) {
        Bits.putCharB(this.bb, this.ix(this.nextPutIndex()), c);
        return this;
    }
    
    @Override
    public CharBuffer put(final int n, final char c) {
        Bits.putCharB(this.bb, this.ix(this.checkIndex(n)), c);
        return this;
    }
    ...
    public CharBuffer subSequence(final int n, final int n2) {
        ...
        return new ByteBufferAsCharBufferB(this.bb, -1, n3 + n, n3 + n2, this.capacity(), this.offset);
    }
