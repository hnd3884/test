...
class ByteBufferAsFloatBufferB extends FloatBuffer
{
    ...
    ByteBufferAsFloatBufferB(final ByteBuffer bb) {
    ...
    ByteBufferAsFloatBufferB(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public FloatBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsFloatBufferB(this.bb, -1, 0, n, n, n2);
    }
    ...
    public FloatBuffer put(final float n) {
        Bits.putFloatB(this.bb, this.ix(this.nextPutIndex()), n);
        return this;
    }
    
    @Override
    public FloatBuffer put(final int n, final float n2) {
        Bits.putFloatB(this.bb, this.ix(this.checkIndex(n)), n2);
        return this;
    }
