...
class ByteBufferAsLongBufferL extends LongBuffer
{
    ...
    ByteBufferAsLongBufferL(final ByteBuffer bb) {
    ...
    ByteBufferAsLongBufferL(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public LongBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsLongBufferL(this.bb, -1, 0, n, n, n2);
    }
    ...
    public LongBuffer put(final long n) {
        Bits.putLongL(this.bb, this.ix(this.nextPutIndex()), n);
        return this;
    }
    
    @Override
    public LongBuffer put(final int n, final long n2) {
        Bits.putLongL(this.bb, this.ix(this.checkIndex(n)), n2);
        return this;
    }
