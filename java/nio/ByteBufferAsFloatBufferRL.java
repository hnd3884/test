...
{
    ByteBufferAsFloatBufferRL(final ByteBuffer byteBuffer) {
        super(byteBuffer);
    }
    
    ByteBufferAsFloatBufferRL(final ByteBuffer byteBuffer, final int n, final int n2, final int n3, final int n4, final int n5) {
    ...
    public FloatBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsFloatBufferRL(this.bb, -1, 0, n, n, n2);
    }
