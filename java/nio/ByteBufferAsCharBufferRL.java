...
{
    ByteBufferAsCharBufferRL(final ByteBuffer byteBuffer) {
        super(byteBuffer);
    }
    
    ByteBufferAsCharBufferRL(final ByteBuffer byteBuffer, final int n, final int n2, final int n3, final int n4, final int n5) {
    ...
    public CharBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsCharBufferRL(this.bb, -1, 0, n, n, n2);
    }
    ...
    public CharBuffer subSequence(final int n, final int n2) {
        ...
        return new ByteBufferAsCharBufferRL(this.bb, -1, n3 + n, n3 + n2, this.capacity(), this.offset);
    }
