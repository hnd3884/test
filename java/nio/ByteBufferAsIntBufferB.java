...
class ByteBufferAsIntBufferB extends IntBuffer
{
    ...
    ByteBufferAsIntBufferB(final ByteBuffer bb) {
    ...
    ByteBufferAsIntBufferB(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public IntBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsIntBufferB(this.bb, -1, 0, n, n, n2);
    }
    
    @Override
    public IntBuffer duplicate() {
        return new ByteBufferAsIntBufferB(this.bb, this.markValue(), this.position(), this.limit(), this.capacity(), this.offset);
    }
    ...
    @Override
    public int get() {
        return Bits.getIntB(this.bb, this.ix(this.nextGetIndex()));
    }
    
    @Override
    public int get(final int n) {
        return Bits.getIntB(this.bb, this.ix(this.checkIndex(n)));
    }
    
    @Override
    public IntBuffer put(final int n) {
        Bits.putIntB(this.bb, this.ix(this.nextPutIndex()), n);
        return this;
    }
    
    @Override
    public IntBuffer put(final int n, final int n2) {
        Bits.putIntB(this.bb, this.ix(this.checkIndex(n)), n2);
        return this;
    }
