...
class ByteBufferAsShortBufferL extends ShortBuffer
{
    ...
    ByteBufferAsShortBufferL(final ByteBuffer bb) {
    ...
    ByteBufferAsShortBufferL(final ByteBuffer bb, final int n, final int n2, final int n3, final int n4, final int offset) {
        super(n, n2, n3, n4);
        this.bb = bb;
        this.offset = offset;
    }
    ...
    public ShortBuffer slice() {
        ...
        assert n2 >= 0;
        return new ByteBufferAsShortBufferL(this.bb, -1, 0, n, n, n2);
    }
    ...
    public ShortBuffer put(final short n) {
        Bits.putShortL(this.bb, this.ix(this.nextPutIndex()), n);
        return this;
    }
    
    @Override
    public ShortBuffer put(final int n, final short n2) {
        Bits.putShortL(this.bb, this.ix(this.checkIndex(n)), n2);
        return this;
    }
