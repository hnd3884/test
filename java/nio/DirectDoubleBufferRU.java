...
{
    DirectDoubleBufferRU(final DirectBuffer directBuffer, final int n, final int n2, final int n3, final int n4, final int n5) {
    ...
    public DoubleBuffer slice() {
        ...
        assert n2 >= 0;
        return new DirectDoubleBufferRU(this, -1, 0, n, n, n2);
    }
