...
{
    DirectCharBufferRU(final DirectBuffer directBuffer, final int n, final int n2, final int n3, final int n4, final int n5) {
    ...
    public CharBuffer slice() {
        ...
        assert n2 >= 0;
        return new DirectCharBufferRU(this, -1, 0, n, n, n2);
    }
    ...
    public CharBuffer subSequence(final int n, final int n2) {
        ...
        return new DirectCharBufferRU(this, -1, n3 + n, n3 + n2, this.capacity(), this.offset);
    }
