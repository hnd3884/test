    ...
    private void writeObject(final ObjectOutputStream objectOutputStream) throws IOException {
        ...
        synchronized (this.map) {
            for (final Map.Entry entry : this.map.getEntries()) {
                ...
                if (s == null) {
                    array = (PropertyChangeListener[])entry.getValue();
                }
                else {
                    if (hashtable == null) {
                    ...
                    propertyChangeSupport.map.set(null, (PropertyChangeListener[])entry.getValue());
    ...
    private void readObject(final ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        if (hashtable != null) {
            for (final Map.Entry entry : hashtable.entrySet()) {
                final PropertyChangeListener[] propertyChangeListeners = ((PropertyChangeSupport)entry.getValue()).getPropertyChangeListeners();
