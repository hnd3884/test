...
public final class Duration implements TemporalAmount, Comparable<Duration>, Serializable
{
    ...
    private static long parseNumber(final CharSequence charSequence, final String s, final int n, final String s2) {
        ...
        try {
            ...
            throw (DateTimeParseException)new DateTimeParseException("Text cannot be parsed to a Duration: " + s2, charSequence, 0).initCause((Throwable)ex);
        }
    }
    ...
    private static int parseFraction(final CharSequence charSequence, String substring, final int n) {
        ...
        try {
            ...
            throw (DateTimeParseException)new DateTimeParseException("Text cannot be parsed to a Duration: fraction", charSequence, 0).initCause((Throwable)ex);
        }
    }
    ...
    public boolean isZero() {
        return (this.seconds | (long)this.nanos) == 0x0L;
    }
