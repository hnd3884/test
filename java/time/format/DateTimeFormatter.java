...
public final class DateTimeFormatter
{
    ...
    public TemporalAccessor parse(final CharSequence charSequence, final ParsePosition parsePosition) {
        ...
        catch (final DateTimeParseException | IndexOutOfBoundsException ex) {
            throw ex;
        }
        catch (final RuntimeException ex2) {
            throw this.createError(charSequence, ex2);
    ...
    public TemporalAccessor parseBest(final CharSequence charSequence, final TemporalQuery<?>... array) {
        ...
        try {
            ...
            throw this.createError(charSequence, ex3);
        }
    }
    ...
    static {
        ...
        PARSED_LEAP_SECOND = (temporalAccessor3 -> {
            if (temporalAccessor3 instanceof Parsed) {
                return Boolean.valueOf(((Parsed)temporalAccessor3).leapSecond);
            }
            else {
