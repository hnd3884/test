...
final class Parsed implements TemporalAccessor
{
        ...
        Label_0026:
            while (i < 50) {
                ...
                while (iterator.hasNext()) {
                    final TemporalField temporalField = ((Map.Entry<TemporalField, V>)iterator.next()).getKey();
                    TemporalAccessor temporalAccessor = temporalField.resolve(this.fieldValues, this, this.resolverStyle);
                    if (temporalAccessor != null) {
                        if (temporalAccessor instanceof ChronoZonedDateTime) {
                            final ChronoZonedDateTime chronoZonedDateTime = (ChronoZonedDateTime)temporalAccessor;
                            if (this.zone == null) {
                        ...
                        if (temporalAccessor instanceof ChronoLocalDateTime) {
                            final ChronoLocalDateTime chronoLocalDateTime = (ChronoLocalDateTime)temporalAccessor;
    ...
    private void resolveInstantFields0(final ZoneId zoneId) {
        ...
        this.updateCheckConflict(zonedDateTime.toLocalDate());
    ...
    private void resolveTimeLenient() {
        ...
        if (this.resolverStyle != ResolverStyle.LENIENT && this.fieldValues.size() > 0) {
            for (final Map.Entry entry : this.fieldValues.entrySet()) {
                final TemporalField temporalField = (TemporalField)entry.getKey();
