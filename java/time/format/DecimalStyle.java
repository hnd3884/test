...
public final class DecimalStyle
{
    ...
    public static Set<Locale> getAvailableLocales() {
        ...
        final HashSet set = new HashSet<Object>(availableLocales.length);
        Collections.addAll((Collection<? super Locale>)set, availableLocales);
