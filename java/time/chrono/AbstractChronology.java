...
public abstract class AbstractChronology implements Chronology
{
    ...
    static Set<Chronology> getAvailableChronologies() {
        initCache();
        final HashSet set = new HashSet((Collection<? extends E>)AbstractChronology.CHRONOS_BY_ID.values());
        ...
        if (n != null) {
            ...
            if (n2 != null) {
                ...
                if (eras.isEmpty()) {
                    ...
                    this.addFieldValue(map, ChronoField.YEAR, this.prolepticYear((Era)eras.get(eras.size() - 1), n3));
                }
            }
        }
