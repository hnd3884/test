...
public class BigInteger extends Number implements Comparable<BigInteger>
{
    ...
    private static void destructiveMulAdd(final int[] array, final int n, final int n2) {
        ...
        for (int i = length - 1; i >= 0; --i) {
            final long n6 = n3 * ((long)array[i] & 0xFFFFFFFFL) + n5;
            array[i] = (int)n6;
            n5 = n6 >>> 32;
        }
        final long n7 = ((long)array[length - 1] & 0xFFFFFFFFL) + n4;
        array[length - 1] = (int)n7;
        long n8 = n7 >>> 32;
        for (int j = length - 2; j >= 0; --j) {
            final long n9 = ((long)array[j] & 0xFFFFFFFFL) + n8;
            array[j] = (int)n9;
            n8 = n9 >>> 32;
        }
    }
    ...
    private static int[] add(final int[] array, final long n) {
        ...
        if (n2 == 0) {
            array2 = new int[i];
            n3 = ((long)array[--i] & 0xFFFFFFFFL) + n;
            array2[i] = (int)n3;
        }
        else {
            if (i == 1) {
                final int[] array3 = new int[2];
                final long n4 = n + ((long)array[0] & 0xFFFFFFFFL);
                array3[1] = (int)n4;
                array3[0] = (int)(n4 >>> 32);
                return array3;
            }
            array2 = new int[i];
            final long n5 = ((long)array[--i] & 0xFFFFFFFFL) + (n & 0xFFFFFFFFL);
            array2[i] = (int)n5;
            n3 = ((long)array[--i] & 0xFFFFFFFFL) + ((long)n2 & 0xFFFFFFFFL) + (n5 >>> 32);
            array2[i] = (int)n3;
        }
        boolean b;
        int[] array4;
    ...
    private static int[] add(int[] array, int[] array2) {
        ...
        long n = 0L;
        if (j == 1) {
            n = ((long)array[--i] & 0xFFFFFFFFL) + ((long)array2[0] & 0xFFFFFFFFL);
            array4[i] = (int)n;
        }
        else {
            while (j > 0) {
                n = ((long)array[--i] & 0xFFFFFFFFL) + ((long)array2[--j] & 0xFFFFFFFFL) + (n >>> 32);
                array4[i] = (int)n;
            }
        }
        boolean b;
    ...
    private static int[] subtract(final long n, final int[] array) {
        final int n2 = (int)(n >>> 32);
        if (n2 == 0) {
            return new int[] { (int)(n - ((long)array[0] & 0xFFFFFFFFL)) };
        }
        final int[] array2 = new int[2];
        if (array.length == 1) {
            final long n3 = ((long)(int)n & 0xFFFFFFFFL) - ((long)array[0] & 0xFFFFFFFFL);
            array2[1] = (int)n3;
            if (n3 >> 32 != 0L) {
                array2[0] = n2 - 1;
            }
        ...
        final long n4 = ((long)(int)n & 0xFFFFFFFFL) - ((long)array[1] & 0xFFFFFFFFL);
        array2[1] = (int)n4;
        array2[0] = (int)(((long)n2 & 0xFFFFFFFFL) - ((long)array[0] & 0xFFFFFFFFL) + (n4 >> 32));
        return array2;
    }
    ...
    private static int[] subtract(final int[] array, final long n) {
        ...
        if (n2 == 0) {
            ...
            final long n4 = ((long)array[--i] & 0xFFFFFFFFL) - (n & 0xFFFFFFFFL);
            array2[i] = (int)n4;
            n3 = ((long)array[--i] & 0xFFFFFFFFL) - ((long)n2 & 0xFFFFFFFFL) + (n4 >> 32);
            array2[i] = (int)n3;
        }
        int[] array3;
        int n5;
    ...
    private static int[] subtract(final int[] array, final int[] array2) {
        ...
        int j;
        long n;
        for (i = array.length, array3 = new int[i], j = array2.length, n = 0L; j > 0; n = ((long)array[--i] & 0xFFFFFFFFL) - ((long)array2[--j] & 0xFFFFFFFFL) + (n >> 32), array3[i] = (int)n) {}
        int[] array4;
        int n2;
        int n3;
    ...
    private static BigInteger multiplyByInt(final int[] array, final int n, final int n2) {
        ...
        for (int i = length - 1; i >= 0; --i) {
            final long n6 = ((long)array[i] & 0xFFFFFFFFL) * n4 + n3;
    ...
    BigInteger multiply(long n) {
        ...
        for (int i = length - 1; i >= 0; --i) {
            final long n7 = ((long)mag[i] & 0xFFFFFFFFL) * n4 + n5;
        ...
        if (n3 != 0L) {
            ...
            for (int j = length - 1; j >= 0; --j) {
                final long n9 = ((long)mag[j] & 0xFFFFFFFFL) * n3 + ((long)copyOfRange[n8] & 0xFFFFFFFFL) + n5;
    ...
    private static int[] multiplyToLen(final int[] array, final int n, final int[] array2, final int n2, int[] array3) {
        ...
        for (int i = n4, n6 = n4 + 1 + n3; i >= 0; --i, --n6) {
            final long n7 = ((long)array2[i] & 0xFFFFFFFFL) * ((long)array[n3] & 0xFFFFFFFFL) + n5;
            array3[n6] = (int)n7;
            n5 = n7 >>> 32;
        }
        array3[n3] = (int)n5;
        for (int j = n3 - 1; j >= 0; --j) {
            ...
            for (int k = n4, n9 = n4 + 1 + j; k >= 0; --k, --n9) {
                final long n10 = ((long)array2[k] & 0xFFFFFFFFL) * ((long)array[j] & 0xFFFFFFFFL) + ((long)array3[n9] & 0xFFFFFFFFL) + n8;
                array3[n9] = (int)n10;
                n8 = n10 >>> 32;
            }
            array3[j] = (int)n8;
    ...
    private BigInteger exactDivideBy3() {
        ...
        long n = 0L;
        for (int i = length - 1; i >= 0; --i) {
            final long n2 = (long)this.mag[i] & 0xFFFFFFFFL;
            final long n3 = n2 - n;
            if (n > n2) {
                n = 1L;
            }
    ...
    public BigInteger pow(final int n) {
        ...
        if (bigInteger.mag.length == 1 && n5 <= 62L) {
            ...
            if (this.bitLength() * (long)n / 32L > 67108864L) {
                reportOverflow();
            }
    ...
    private BigInteger oddModPow(final BigInteger bigInteger, final BigInteger bigInteger2) {
        ...
        final long n3 = -MutableBigInteger.inverseMod64(((long)mag2[length - 1] & 0xFFFFFFFFL) + (((long)mag2[length - 2] & 0xFFFFFFFFL) << 32));
    ...
    private static int[] montReduce(final int[] array, final int[] array2, final int n, final int n2) {
        ...
        int n4 = 0;
        do {
            i += addOne(array, n4, n, mulAdd(array, array2, n4, n, n2 * array[array.length - 1 - n4]));
            ++n4;
        } while (--n3 > 0);
        while (i > 0) {
    ...
    private static int intArrayCmpToLen(final int[] array, final int[] array2, final int n) {
        for (int i = 0; i < n; ++i) {
            final long n2 = (long)array[i] & 0xFFFFFFFFL;
            final long n3 = (long)array2[i] & 0xFFFFFFFFL;
            if (n2 < n3) {
                return -1;
            }
            if (n2 > n3) {
    ...
    private static int implMulAdd(final int[] array, final int[] array2, int n, final int n2, final int n3) {
        ...
        for (int i = n2 - 1; i >= 0; --i) {
            final long n6 = ((long)array2[i] & 0xFFFFFFFFL) * n4 + ((long)array[n] & 0xFFFFFFFFL) + n5;
            array[n--] = (int)n6;
            n5 = n6 >>> 32;
        }
        return (int)n5;
    ...
    private BigInteger mod2(final int n) {
        ...
        final int[] array2 = array;
        final int n4 = 0;
        array2[n4] = (int)((long)array2[n4] & (1L << 32 - n3) - 1L);
    ...
    final int compareMagnitude(final BigInteger bigInteger) {
        ...
        for (int i = 0; i < length; ++i) {
            ...
            final int n2 = mag2[i];
            if (n != n2) {
                return (((long)n & 0xFFFFFFFFL) < ((long)n2 & 0xFFFFFFFFL)) ? -1 : 1;
            }
        }
        return 0;
    }
    ...
    final int compareMagnitude(long n) {
        ...
        if (n2 == 0) {
            ...
            final int n6 = n2;
            if (n5 != n6) {
                return (((long)n5 & 0xFFFFFFFFL) < ((long)n6 & 0xFFFFFFFFL)) ? -1 : 1;
            }
            final int n7 = mag[1];
            final int n8 = (int)n;
            if (n7 != n8) {
                return (((long)n7 & 0xFFFFFFFFL) < ((long)n8 & 0xFFFFFFFFL)) ? -1 : 1;
            }
            return 0;
        }
    }
    ...
    public int hashCode() {
        int n = 0;
        for (int i = 0; i < this.mag.length; ++i) {
            n = (int)(31 * n + ((long)this.mag[i] & 0xFFFFFFFFL));
        }
    ...
    public long longValue() {
        long n = 0L;
        for (int i = 1; i >= 0; --i) {
            n = (n << 32) + ((long)this.getInt(i) & 0xFFFFFFFFL);
        }
        return n;
    }
    ...
    public double doubleValue() {
        ...
        final long n7 = ((long)n5 & 0xFFFFFFFFL) << 32 | ((long)n6 & 0xFFFFFFFFL);
        final long n8 = n7 >> 1 & 0xFFFFFFFFFFFFFL;
        return Double.longBitsToDouble(((long)(n + 1023) << 52) + (((n7 & 0x1L) != 0x0L && ((n8 & 0x1L) != 0x0L || this.abs().getLowestSetBit() < n2)) ? (n8 + 1L) : n8) | ((long)this.signum & Long.MIN_VALUE));
    }
    ...
    private static int[] makePositive(final byte[] array) {
        ...
        for (int k = array2.length - 1; k >= 0; --k) {
            array2[k] = (int)(((long)array2[k] & 0xFFFFFFFFL) + 1L);
            if (array2[k] != 0) {
                break;
            }
        }
