...
public class DateFormatSymbols implements Serializable, Cloneable
{
    ...
    private void initializeData(final Locale locale) {
        final SoftReference softReference = DateFormatSymbols.cachedInstances.get(locale);
        ...
        if (softReference == null || (dateFormatSymbols = (DateFormatSymbols)softReference.get()) == null) {
            ...
            SoftReference softReference2 = new SoftReference<DateFormatSymbols>(dateFormatSymbols);
            final SoftReference softReference3 = DateFormatSymbols.cachedInstances.putIfAbsent(locale, softReference2);
            if (softReference3 != null) {
                final DateFormatSymbols dateFormatSymbols2 = (DateFormatSymbols)softReference3.get();
            ...
            if (!locale2.equals(locale)) {
                final SoftReference softReference4 = DateFormatSymbols.cachedInstances.putIfAbsent(locale2, softReference2);
