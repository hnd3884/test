...
public class DecimalFormat extends NumberFormat
{
    ...
    private StringBuffer subformat(final StringBuffer sb, final FieldDelegate fieldDelegate, final boolean b, final boolean b2, final int n, final int n2, final int n3, final int n4) {
        ...
        if (this.useExponentialNotation) {
            ...
            final int n11 = this.digitList.isZero() ? n8 : (this.digitList.decimalAt - n9);
            if (n10 < n11) {
                n10 = n11;
            }
            ...
            for (int i = 0; i < count; ++i) {
                ...
                sb.append((i < this.digitList.count) ? ((char)(this.digitList.digits[i] + n5)) : zeroDigit);
            }
            if (this.decimalSeparatorAlwaysShown && count == n11) {
                n6 = sb.length();
                sb.append(c);
                b3 = true;
                n7 = sb.length();
            ...
            fieldDelegate.formatted(0, Field.INTEGER, Field.INTEGER, length, n6, sb);
            if (b3) {
                fieldDelegate.formatted(Field.DECIMAL_SEPARATOR, Field.DECIMAL_SEPARATOR, n6, n7, sb);
            }
            if (n7 == -1) {
                n7 = sb.length();
            }
            fieldDelegate.formatted(1, Field.FRACTION, Field.FRACTION, n7, sb.length(), sb);
            final int length2 = sb.length();
            ...
            for (int k = 0; k < this.digitList.decimalAt; ++k) {
                sb.append((k < this.digitList.count) ? ((char)(this.digitList.digits[k] + n5)) : zeroDigit);
            }
            ...
            if (decimalAt2 > n) {
                decimalAt2 = n;
                n12 = this.digitList.decimalAt - decimalAt2;
            }
            final int length6 = sb.length();
            for (int l = decimalAt2 - 1; l >= 0; --l) {
                if (l < this.digitList.decimalAt && n12 < this.digitList.count) {
                    sb.append((char)(this.digitList.digits[n12++] + n5));
                }
                else {
                    sb.append(zeroDigit);
                }
            ...
            final boolean b5 = n4 > 0 || (!b2 && n12 < this.digitList.count);
            ...
            for (int n13 = 0; n13 < n3; ++n13) {
                if (n13 >= n4) {
                    ...
                    if (n12 >= this.digitList.count) {
                        break;
                    }
                }
                if (-1 - n13 > this.digitList.decimalAt - 1) {
                    sb.append(zeroDigit);
                }
                else if (!b2 && n12 < this.digitList.count) {
                    sb.append((char)(this.digitList.digits[n12++] + n5));
                }
                else {
                    sb.append(zeroDigit);
        ...
        if (array[0]) {
            ...
            if (this.multiplier != 1) {
                if (n != 0) {
                    ...
                    double1 = long1 / (double)this.multiplier;
                    n = 1;
                }
            }
            if (!array[1] && !b) {
        ...
        if (!b && s.regionMatches(i, this.symbols.getInfinity(), 0, this.symbols.getInfinity().length())) {
            ...
            while (i < s.length()) {
                ...
                if (digit == 0) {
                    ...
                    if (b || !s.regionMatches(i, exponentSeparator, 0, exponentSeparator.length()) || b4) {
                        break;
                    }
