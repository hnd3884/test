            ...
            synchronized (this) {
                if ((declaredAnnotations = this.declaredAnnotations) == null) {
                    ...
                    if (root != null) {
                        ...
                        declaredAnnotations = AnnotationParser.parseAnnotations(this.annotations, SharedSecrets.getJavaLangAccess().getConstantPool(this.getDeclaringClass()), this.getDeclaringClass());
                    }
