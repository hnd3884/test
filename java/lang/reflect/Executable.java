...
public abstract class Executable extends AccessibleObject implements Member, GenericDeclaration
{
    ...
    private Map<Class<? extends Annotation>, Annotation> declaredAnnotations() {
        ...
        if ((declaredAnnotations = this.declaredAnnotations) == null) {
            synchronized (this) {
                if ((declaredAnnotations = this.declaredAnnotations) == null) {
                    ...
                    if (root != null) {
                        ...
                        declaredAnnotations = AnnotationParser.parseAnnotations(this.getAnnotationBytes(), SharedSecrets.getJavaLangAccess().getConstantPool(this.getDeclaringClass()), this.getDeclaringClass());
                    }
