...
public final class Long extends Number implements Comparable<Long>
{
    ...
    static int formatUnsignedLong(long n, final int n2, final char[] array, final int n3, final int n4) {
        int n5 = n4;
        final int n6 = (1 << n2) - 1;
        do {
            array[n3 + --n5] = Integer.digits[(int)n & n6];
            n >>>= n2;
        } while (n != 0L && n5 > 0);
        return n5;
    }
    ...
    static void getChars(long n, final int n2, final char[] array) {
        int n3 = n2;
        char c = '\0';
        if (n < 0L) {
            c = '-';
        ...
        while (n > 2147483647L) {
            ...
            final int n5 = (int)(n - ((n4 << 6) + (n4 << 5) + (n4 << 2)));
            n = n4;
            array[--n3] = Integer.DigitOnes[n5];
            array[--n3] = Integer.DigitTens[n5];
        }
        int i;
        int n6;
        int n7;
        for (i = (int)n; i >= 65536; i = n6, array[--n3] = Integer.DigitOnes[n7], array[--n3] = Integer.DigitTens[n7]) {
            n6 = i / 100;
            n7 = i - ((n6 << 6) + (n6 << 5) + (n6 << 2));
        }
        do {
            final int n8 = i * 52429 >>> 19;
            array[--n3] = Integer.digits[i - ((n8 << 3) + (n8 << 1))];
            i = n8;
        } while (i != 0);
        if (c != '\0') {
            array[--n3] = c;
    ...
    public static Long getLong(final String s, final long n) {
        ...
        return (long1 == null) ? Long.valueOf(n) : long1;
    }
