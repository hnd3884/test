...
public final class MethodType implements Serializable
{
    ...
    MethodType asCollectorType(final Class<?> clazz, final int n) {
        ...
        if (clazz == Object[].class) {
            ...
            final Class componentType = clazz.getComponentType();
            assert componentType != null;
            methodType = methodType(this.rtype, (List<Class<?>>)Collections.nCopies(n, componentType));
        }
    ...
    private static class ConcurrentWeakInternSet<T>
    {
        ...
        public T get(final T t) {
            ...
            final WeakEntry weakEntry = this.map.get(new WeakEntry(t));
            if (weakEntry != null) {
                final Object value = weakEntry.get();
                if (value != null) {
                    return (T)value;
                }
            }
        ...
        public T add(final T t) {
            ...
            final WeakEntry weakEntry = new WeakEntry((T)t, (ReferenceQueue<T>)this.stale);
            Object o;
            do {
                this.expungeStaleElements();
                final WeakEntry weakEntry2 = this.map.putIfAbsent(weakEntry, weakEntry);
                o = ((weakEntry2 == null) ? t : weakEntry2.get());
            } while (o == null);
            return (T)o;
        }
