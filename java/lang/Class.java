...
public final class Class<T> implements Serializable, GenericDeclaration, Type, AnnotatedElement
{
    ...
    public T newInstance() throws InstantiationException, IllegalAccessException {
        ...
        try {
            return (T)cachedConstructor.newInstance((Object[])null);
        }
    ...
    public TypeVariable<Class<T>>[] getTypeParameters() {
        ...
        if (genericInfo != null) {
            return (TypeVariable[])genericInfo.getTypeParameters();
        }
    ...
    public Class<?>[] getClasses() {
        ...
        return AccessController.doPrivileged((PrivilegedAction<Class[]>)new PrivilegedAction<Class<?>[]>() {
            ...
            public Class<?>[] run() {
                ...
                for (Class<? super T> clazz = Class.this; clazz != null; clazz = clazz.getSuperclass()) {
    ...
    private ReflectionData<T> reflectionData() {
        ...
        final ReflectionData reflectionData2;
    ...
    private ReflectionData<T> newReflectionData(SoftReference<ReflectionData<T>> reflectionData, int classRedefinedCount) {
        ...
        while (true) {
            ...
            final ReflectionData reflectionData3;
    ...
    private Constructor<T>[] privateGetDeclaredConstructors(final boolean b) {
        ...
        if (this.isInterface()) {
            ...
            declaredConstructors0 = this.getDeclaredConstructors0(b);
        }
        if (reflectionData != null) {
            if (b) {
    ...
    private static <U> Constructor<U>[] copyConstructors(final Constructor<U>[] array) {
        ...
        for (int i = 0; i < array2.length; ++i) {
            array2[i] = reflectionFactory.copyConstructor((Constructor<Object>)array2[i]);
        }
        return array2;
    }
    ...
    T[] getEnumConstantsShared() {
        if (this.enumConstants == null) {
            ...
            try {
                ...
                this.enumConstants = (T[])method.invoke(null, new Object[0]);
            }
    ...
    Map<String, T> enumConstantDirectory() {
        if (this.enumConstantDirectory == null) {
            ...
            final HashMap enumConstantDirectory = new HashMap(2 * enumConstantsShared.length);
            for (final Object o : enumConstantsShared) {
                enumConstantDirectory.put((Object)((Enum)o).name(), o);
            }
    ...
    private AnnotationData createAnnotationData(final int n) {
        ...
        if (superclass != null) {
            ...
            for (final Map.Entry entry : annotations2.entrySet()) {
                final Class clazz = (Class)entry.getKey();
                if (AnnotationType.getInstance(clazz).isInherited()) {
                    if (map == null) {
                        map = new LinkedHashMap((Math.max(annotations.size(), Math.min(12, annotations.size() + annotations2.size())) * 4 + 2) / 3);
                    }
