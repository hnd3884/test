...
public final class URL implements Serializable
{
    ...
    public URL(final URL url, final String s, URLStreamHandler handler) throws MalformedURLException {
        ...
        try {
            ...
            final MalformedURLException ex3 = new MalformedURLException(ex2.getMessage());
            ex3.initCause(ex2);
            throw ex3;
        }
    }
    ...
    private URL fabricateNewURL() throws InvalidObjectException {
        ...
        try {
            ...
            this.resetState();
            final InvalidObjectException ex2 = new InvalidObjectException("Malformed URL: " + reconstituteUrlString);
            ex2.initCause(ex);
            throw ex2;
        }
    ...
    boolean isBuiltinStreamHandler(final URLStreamHandler urlStreamHandler) {
        ...
        return this.isBuiltinStreamHandler(class1.getName()) || VM.isSystemDomainLoader(class1.getClassLoader());
    }
