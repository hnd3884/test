...
public abstract class URLConnection
{
    ...
    public static synchronized FileNameMap getFileNameMap() {
        if (URLConnection.fileNameMap == null && !URLConnection.fileNameMapLoaded) {
            URLConnection.fileNameMap = MimeTable.loadTable();
            URLConnection.fileNameMapLoaded = true;
        }
        return new FileNameMap() {
            ...
            public String getContentTypeFor(final String s) {
                return this.map.getContentTypeFor(s);
            }
        };
    }
    ...
    private static boolean checkfpx(final InputStream inputStream) throws IOException {
        ...
        inputStream.reset();
        final long n7 = 512L + (1 << n4) * (long)n6 + 80L;
        if (n7 < 0L) {
            return false;
        }
    ...
    static {
        ...
        URLConnection.fileNameMapLoaded = false;
