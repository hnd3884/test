...
public final class URI implements Comparable<URI>, Serializable
{
    ...
    public String getRawSchemeSpecificPart() {
        ...
        if (string != null) {
            ...
            if (this.scheme != null) {
                n = this.scheme.length() + 1;
            }
            if (this.fragment != null) {
                length -= this.fragment.length() + 1;
            }
            if (this.path != null && this.path.length() == length - n) {
                schemeSpecificPart2 = this.path;
            }
            else {
                schemeSpecificPart2 = string.substring(n, length);
            }
        }
        else {
            ...
            schemeSpecificPart2 = sb.toString();
        }
        return this.schemeSpecificPart = schemeSpecificPart2;
    }
    ...
    private void readObject(final ObjectInputStream objectInputStream) throws ClassNotFoundException, IOException {
        ...
        try {
            ...
            final InvalidObjectException ex2 = new InvalidObjectException("Invalid URI");
            ex2.initCause(ex);
            throw ex2;
        }
    }
