...
public class WeakHashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>
{
    ...
    public V get(final Object o) {
        ...
        for (Entry<K, V> next = table[indexFor(hash, table.length)]; next != null; next = next.next) {
    ...
    public V put(final K k, final V value) {
        ...
        for (Entry<K, V> next = table[index]; next != null; next = next.next) {
    ...
    boolean removeMapping(final Object o) {
        ...
        Entry<K, V> entry3;
        Entry<K, V> next;
        for (Entry<K, V> entry2 = entry3 = table[index]; entry3 != null; entry3 = (Entry<K, V>)next) {
            next = (Entry<K, V>)entry3.next;
            if (hash == entry3.hash && entry3.equals(entry)) {
                ++this.modCount;
                --this.size;
                if (entry2 == entry3) {
                    table[index] = (Entry<K, V>)next;
                }
                else {
                    entry2.next = (Entry<K, V>)next;
                }
                return true;
            }
            entry2 = entry3;
    ...
    public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        for (Entry<K, V> next : this.getTable()) {
            while (next != null) {
                final Object value = next.get();
                if (value != null) {
                    biConsumer.accept((Object)unmaskNull(value), next.value);
                }
                next = next.next;
    ...
    public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        for (Entry<K, V> next : this.getTable()) {
            while (next != null) {
                final Object value = next.get();
                if (value != null) {
                    next.value = (V)biFunction.apply((Object)unmaskNull(value), next.value);
                }
                next = next.next;
                if (modCount != this.modCount) {
                    throw new ConcurrentModificationException();
    ...
    private class EntrySet extends AbstractSet<Map.Entry<K, V>>
    {
        ...
        private List<Map.Entry<K, V>> deepCopy() {
            ...
            while (iterator.hasNext()) {
                list.add(new SimpleEntry(iterator.next()));
            }
            return list;
        }
    ...
    static class WeakHashMapSpliterator<K, V>
    {
        ...
        final int getFence() {
            ...
            if ((fence = this.fence) < 0) {
                ...
                final int length = ((Entry<K, V>[])map.table).length;
                this.fence = length;
                fence = length;
            }
            return fence;
                ...
                if (n < index2 || this.current != null) {
                    ...
                    do {
                        if (entry == null) {
                            ...
                            consumer.accept((SimpleImmutableEntry)new SimpleImmutableEntry(WeakHashMap.unmaskNull(value), value2));
                        }
                    } while (entry != null || index < fence);
                }
            }
