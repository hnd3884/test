...
public class ConcurrentSkipListMap<K, V> extends AbstractMap<K, V> implements ConcurrentNavigableMap<K, V>, Cloneable, Serializable
{
        ...
        while (true) {
            ...
            if ((nextSecondarySeed & 0x80000001) == 0x0) {
                ...
                if (n <= (level = headIndex.level)) {
                    for (int i = 1; i <= n; ++i) {
                        index = new Index((Node<Object, Object>)node, index, null);
                    }
                }
                else {
                    n = level + 1;
                    ...
                    for (int j = 1; j <= n; ++j) {
                        index = (array[j] = new Index((Node<K, V>)node, index, null));
                    }
                    while (true) {
                        headIndex = this.head;
                        ...
                        final Node<K, V> node2 = headIndex.node;
                        for (int l = level2 + 1; l <= n; ++l) {
                            headIndex2 = (HeadIndex<K, V>)new HeadIndex<Object, Object>((Node<Object, Object>)node2, (Index<Object, Object>)headIndex2, array[l], l);
                        }
                        if (this.casHead(headIndex, headIndex2)) {
                            headIndex = headIndex2;
                            index = array[n = level2];
                            break;
                        }
                    }
                }
            ...
            Label_0437:
                while (true) {
                    ...
                    Object down = headIndex;
                    Object o = ((Index)down).right;
                    Index down2 = index;
                    while (down != null) {
                        if (down2 == null) {
                            break;
                        ...
                        if (o != null) {
                            final Node<K, V> node3 = ((Index)o).node;
                            final int cpr2 = cpr(comparator, k, node3.key);
                            if (node3.value == null) {
                                if (!((Index<Object, Object>)down).unlink((Index<Object, Object>)o)) {
                                    continue Label_0641;
                                }
                                o = ((Index)down).right;
                                continue Label_0183_Outer;
                        ...
                        if (level3 == n2) {
                            if (!((Index<Object, Object>)down).link((Index<Object, Object>)o, (Index<Object, Object>)down2)) {
                                continue Label_0641;
                            }
    ...
    final Node<K, V> findFirst() {
        Node node;
        Node<K, V> next;
        while ((next = (Node<K, V>)(node = this.head.node).next) != null) {
            if (next.value != null) {
                return next;
            }
    ...
    private Map.Entry<K, V> doRemoveFirstEntry() {
        ...
        while ((next = (Node<K, V>)(node = this.head.node).next) != null) {
            ...
            if (value == null) {
                next.helpDelete(node, (Node<K, V>)next2);
            }
            else {
                if (!next.casValue(value, null)) {
                    continue;
                }
                if (!next.appendMarker((Node<K, V>)next2) || !node.casNext(next, next2)) {
                    this.findFirst();
                }
    ...
    Block_3:
        while (true) {
            Object o = this.head;
            while (true) {
                final Index<K, V> right = ((Index)o).right;
                if (right != null && right.indexesDeletedNode() && !((Index)o).unlink(right)) {
                    break;
                }
                if ((o = ((Index)o).down) == null) {
                    break Block_3;
                }
            }
        }
        ...
        while (true) {
            ...
            if ((right = headIndex.right) != null) {
                ...
                if ((down = headIndex.down) == null) {
                    node = headIndex.node;
                    Node<K, V> next = (Node<K, V>)node.next;
                    while (next != null) {
                        final Node<K, V> next2 = next.next;
                        if (next == node.next) {
                            final Object value = next.value;
                            if (value == null) {
                                next.helpDelete((Node<Object, Object>)node, (Node<Object, Object>)next2);
                            }
    ...
    Label_0012:
        while (true) {
            Node<K, V> predecessor = this.findPredecessor(k, comparator);
            Node<K, V> next = (Node<K, V>)predecessor.next;
            while (next != null) {
                final Node<K, V> next2 = next.next;
                if (next == predecessor.next) {
                    final Object value;
                    if ((value = next.value) == null) {
                        next.helpDelete((Node<Object, Object>)predecessor, (Node<Object, Object>)next2);
                    }
                    else if (predecessor.value != null) {
                        if (value != next) {
                            final int cpr = cpr(comparator, k, next.key);
    ...
    private void buildFromSorted(final SortedMap<K, ? extends V> sortedMap) {
        ...
        for (final Map.Entry entry : sortedMap.entrySet()) {
            ...
            final Node next = new Node<Object, Object>(key, value, null);
            ...
            for (int k = 1; k <= n; ++k) {
                ...
                if (k < list.size()) {
                    list.set(k, ((Index)list.get(k)).right = (Index<K, V>)right);
                }
                else {
                    list.add(right);
                }
    ...
    private void readObject(final ObjectInputStream objectInputStream) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            final Node next = new Node<Object, Object>(o, o2, null);
            node.next = (Node<K, V>)next;
            node = (Node<K, V>)next;
            if (n <= 0) {
                continue;
        ...
        while (true) {
            ...
            if (headIndex != null) {
                ...
                if (value == null) {
                    ...
                    if (!next.casValue(value, null) || !next.appendMarker((Node<K, V>)next2)) {
                        continue;
                    }
                    node.casNext(next, (Node<K, V>)next2);
                }
            }
        }
    }
    ...
    public V compute(final K k, final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        while (true) {
            ...
            if ((node = this.findNode(k)) == null) {
                final V apply;
                if ((apply = (V)biFunction.apply(k, null)) == null) {
                    break;
                }
    ...
    public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        for (Node<K, V> node = this.findFirst(); node != null; node = node.next) {
            final V validValue;
            if ((validValue = node.getValidValue()) != null) {
    ...
    public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        for (Node<K, V> node = this.findFirst(); node != null; node = node.next) {
            V validValue;
            while ((validValue = (V)node.getValidValue()) != null) {
    ...
    final KeySpliterator<K, V> keySpliterator() {
        ...
        Node<K, V> next;
        while (true) {
            final Node<K, V> node = (Node<K, V>)(head = this.head).node;
            if ((next = (Node<K, V>)node.next) == null || next.value != null) {
                break;
            }
            next.helpDelete((Node<K, V>)node, next.next);
        }
    ...
    static final class KeySet<E> extends AbstractSet<E> implements NavigableSet<E>
    {
        ...
        public Spliterator<E> spliterator() {
            ...
            return (Spliterator)((SubMap)this.m).keyIterator();
        }
    }
    ...
    static final class Values<E> extends AbstractCollection<E>
    {
        ...
        public Spliterator<E> spliterator() {
            ...
            return (Spliterator)((SubMap)this.m).valueIterator();
        }
    }
    ...
    static final class EntrySet<K1, V1> extends AbstractSet<Map.Entry<K1, V1>>
    {
        ...
        public Spliterator<Map.Entry<K1, V1>> spliterator() {
            ...
            return (Spliterator)((SubMap)this.m).entryIterator();
        }
    }
    ...
    static final class EntrySpliterator<K, V> extends CSLMSpliterator<K, V> implements Spliterator<Map.Entry<K, V>>
    {
        ...
        public void forEachRemaining(final Consumer<? super Map.Entry<K, V>> consumer) {
            ...
            while (node != null && ((key = node.key) == null || fence == null || ConcurrentSkipListMap.cpr(comparator, fence, key) > 0)) {
                final Object value;
                if ((value = node.value) != null && value != node) {
                    consumer.accept((SimpleImmutableEntry)new SimpleImmutableEntry(key, value));
                }
                node = node.next;
            }
        }
        ...
        public final Comparator<Map.Entry<K, V>> getComparator() {
            ...
            return (entry, entry2) -> entry.getKey().compareTo(entry2.getKey());
        }
    }
}
