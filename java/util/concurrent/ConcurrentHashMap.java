...
public class ConcurrentHashMap<K, V> extends AbstractMap<K, V> implements ConcurrentMap<K, V>, Serializable
{
    ...
    static final <K, V> Node<K, V> tabAt(final Node<K, V>[] array, final int n) {
        return (Node)ConcurrentHashMap.U.getObjectVolatile(array, ((long)n << ConcurrentHashMap.ASHIFT) + ConcurrentHashMap.ABASE);
    }
    
    static final <K, V> boolean casTabAt(final Node<K, V>[] array, final int n, final Node<K, V> node, final Node<K, V> node2) {
        return ConcurrentHashMap.U.compareAndSwapObject(array, ((long)n << ConcurrentHashMap.ASHIFT) + ConcurrentHashMap.ABASE, node, node2);
    }
    
    static final <K, V> void setTabAt(final Node<K, V>[] array, final int n, final Node<K, V> node) {
        ConcurrentHashMap.U.putObjectVolatile(array, ((long)n << ConcurrentHashMap.ASHIFT) + ConcurrentHashMap.ABASE, node);
    }
    ...
    final V putVal(final K k, final V v, final boolean b) {
        ...
        while (true) {
            ...
            if (array == null || (length = array.length) == 0) {
                ...
                final int n2;
                final Node<K, V> tab;
                if ((tab = tabAt(array, n2 = (length - 1 & spread))) == null) {
                    if (casTabAt(array, n2, null, new Node<K, V>(spread, k, v, null))) {
                        break;
                    }
                    continue;
                }
                            ...
                            if (hash >= 0) {
                                ...
                                if (o2 == null || o2 == val || (val != null && o2.equals(val))) {
                                    ...
                                    if (v != null) {
                                        ...
                                        setTabAt((Node<K, V>[])array, n, (Node<K, V>)next.next);
                                    }
                                }
                            }
                            else if (tab instanceof TreeBin) {
                                ...
                                if ((root = treeBin.root) != null && (treeNode = ((TreeNode)root).findTreeNode(spread, o, null)) != null) {
                                    final V val2 = treeNode.val;
                                    if (o2 == null || o2 == val2 || (val2 != null && o2.equals(val2))) {
                                        ...
                                        if (v != null) {
                                            ...
                                            setTabAt(array, n, (Node<K, V>)untreeify((Node<K, V>)treeBin.first));
                                        }
                                    }
                                }
                            }
    ...
    public void clear() {
        ...
        int n2 = 0;
        Node<K, V>[] array = this.table;
        while (array != null && n2 < array.length) {
            final Node<K, V> tab = tabAt(array, n2);
            if (tab == null) {
                ++n2;
            }
            else {
        ...
        if (n == 0L) {
            ...
            while (node != null) {
                ...
                if ((tab = tabAt((Node<K, V>[])table, n4)) == null) {
                    ...
                    final K key = node.key;
                    if (((Node)tab).hash < 0) {
                        if (((TreeBin<K, V>)tab).putTreeVal(hash, key, node.val) == null) {
                            ++baseCount;
                        }
                        n5 = 0;
                    }
                        ...
                        int n6 = 0;
                        n5 = 1;
                        for (Node<K, V> next2 = (Node<K, V>)tab; next2 != null; next2 = next2.next) {
                            final K key2;
                        ...
                        if (n5 != 0 && n6 >= 8) {
                            n5 = 0;
                            ++baseCount;
                            node.next = (Node<K, V>)tab;
                            TreeNode<Object, Object> treeNode = null;
                            TreeNode prev = null;
                            for (Node next3 = node; next3 != null; next3 = next3.next) {
                                final TreeNode next4 = new TreeNode(next3.hash, next3.key, next3.val, null, null);
                                if ((next4.prev = prev) == null) {
                                    treeNode = (TreeNode<Object, Object>)next4;
                                }
                                else {
                                    prev.next = (Node<K, V>)next4;
                                }
                                prev = next4;
                            }
                            setTabAt(table, n4, new TreeBin<Object, Object>(treeNode));
                        }
                    }
                }
                if (n5 != 0) {
                    ++baseCount;
                    node.next = (Node<K, V>)tab;
                    setTabAt(table, n4, (Node<Object, Object>)node);
                }
                node = next;
            }
            this.table = table;
    ...
    public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        if ((table = this.table) != null) {
            Node advance;
            while ((advance = new Traverser(table, table.length, 0, table.length).advance()) != null) {
                biConsumer.accept((Object)advance.key, (Object)advance.val);
            }
        }
    }
    ...
    public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        if ((table = this.table) != null) {
            ...
            while ((advance = new Traverser(table, table.length, 0, table.length).advance()) != null) {
                ...
                V apply;
                do {
                    apply = (V)biFunction.apply((Object)key, (Object)o);
                    if (apply == null) {
                        throw new NullPointerException();
                    }
    ...
    public V computeIfAbsent(final K k, final Function<? super K, ? extends V> function) {
        ...
        while (true) {
            ...
            if (array == null || (length = array.length) == 0) {
                ...
                final Node<K, V> tab;
                if ((tab = tabAt(array, n2 = (length - 1 & spread))) == null) {
                    final ReservationNode<K, V> reservationNode = new ReservationNode<K, V>();
                    synchronized (reservationNode) {
                        if (casTabAt(array, n2, null, reservationNode)) {
                            n = 1;
                            Node<K, V> node = null;
                            try {
                                if ((o = function.apply(k)) != null) {
                                    node = new Node<K, V>(spread, k, (V)o, null);
                                }
                            }
                            finally {
                                setTabAt(array, n2, node);
                            }
                        }
                    }
                    if (n != 0) {
                            ...
                            Label_0433: {
                                if (tabAt(array, n2) == tab) {
                                    if (hash >= 0) {
                                        ...
                                        final Object root;
                                        final TreeNode treeNode;
                                        if ((root = treeBin.root) != null && (treeNode = ((TreeNode)root).findTreeNode(spread, k, null)) != null) {
                                            o = treeNode.val;
                                        }
    ...
    public V computeIfPresent(final K k, final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        while (true) {
            ...
            if (array == null || (length = array.length) == 0) {
                ...
                final int n3;
                final Node<K, V> tab;
                if ((tab = tabAt(array, n3 = (length - 1 & spread))) == null) {
                    break;
                }
                final int hash;
                if ((hash = tab.hash) == -1) {
                        ...
                        Label_0371: {
                            if (tabAt(array, n3) == tab) {
                                if (hash >= 0) {
                                    ...
                                    final TreeNode treeNode;
                                    if ((root = treeBin.root) != null && (treeNode = ((TreeNode)root).findTreeNode(spread, k, null)) != null) {
                                        v = (V)biFunction.apply(k, (V)treeNode.val);
                                        if (v != null) {
                                            treeNode.val = (V)v;
                                        }
                                        else {
                                            ...
                                            if (treeBin.removeTreeNode(treeNode)) {
                                                setTabAt(array, n3, (Node<K, V>)untreeify((Node<K, V>)treeBin.first));
                                            }
                                        }
                                    }
                                }
        ...
        while (true) {
            ...
            if (array == null || (length = array.length) == 0) {
                ...
                if ((tab = tabAt(array, n3 = (length - 1 & spread))) == null) {
                    final ReservationNode<K, V> reservationNode = new ReservationNode<K, V>();
                    synchronized (reservationNode) {
                        if (casTabAt(array, n3, null, reservationNode)) {
                            n2 = 1;
                            Node<K, V> node = null;
                            try {
                                if ((v = (V)biFunction.apply(k, null)) != null) {
                                    n = 1;
                                    node = new Node<K, V>(spread, k, v, null);
                                }
                            }
                            finally {
                                setTabAt(array, n3, node);
                            }
                        }
                    }
                    if (n2 != 0) {
                                    ...
                                    if (hash >= 0) {
                                        ...
                                        while (tab.hash != spread || ((key = tab.key) != k && (key == null || !k.equals(key)))) {
                                            ...
                                            if ((next = tab.next) == null) {
                                                ...
                                                if (v != null) {
                                                    n = 1;
                                                    tab.next = (Node<K, V>)new Node<Object, Object>(spread, (K)k, (V)v, null);
                                                }
                                                break Label_0560;
                                            }
                                            ++n2;
                                        ...
                                        final TreeBin treeBin = (TreeBin)tab;
                                        final Node<K, V> root;
                                        TreeNode<Object, Object> treeNode;
                                        if ((root = (Node<K, V>)treeBin.root) != null) {
                                            treeNode = ((TreeNode<Object, Object>)root).findTreeNode(spread, k, null);
                                        }
                                        else {
                                            treeNode = null;
                                        }
                                        v = (V)biFunction.apply(k, (V)((treeNode == null) ? null : treeNode.val));
                                        if (v != null) {
                                            if (treeNode != null) {
                                                treeNode.val = v;
                                            }
    ...
    public V merge(final K k, final V v, final BiFunction<? super V, ? super V, ? extends V> biFunction) {
        ...
        while (true) {
            ...
            if (array == null || (length = array.length) == 0) {
                ...
                final Node<K, V> tab;
                if ((tab = tabAt(array, n3 = (length - 1 & spread))) == null) {
                    if (casTabAt(array, n3, null, new Node<K, V>(spread, k, v, null))) {
                        n = 1;
                        apply = v;
                        break;
                    }
                                    ...
                                    if (hash >= 0) {
                                        ...
                                        while (tab.hash != spread || ((key = tab.key) != k && (key == null || !k.equals(key)))) {
                                            ...
                                            if ((next = tab.next) == null) {
                                                n = 1;
                                                apply = v;
                                                tab.next = (Node<K, V>)new Node<Object, Object>(spread, (K)k, (V)apply, null);
                                                break Label_0469;
                                            }
                                            ++n2;
                                        }
                                        apply = (V)biFunction.apply(tab.val, v);
                                        if (apply != null) {
                                            tab.val = apply;
                                        }
                                        else {
    ...
    private final void transfer(final Node<K, V>[] array, Node<K, V>[] array2) {
        ...
        while (true) {
            if (casTab != 0) {
                if (--n3 >= n4 || n2 != 0) {
                    ...
                    if ((transferIndex = this.transferIndex) <= 0) {
                        ...
                        final int n5;
                        final int n6;
                        if (!ConcurrentHashMap.U.compareAndSwapInt(this, ConcurrentHashMap.TRANSFERINDEX, n5, n6 = (((n5 = transferIndex) > n) ? (transferIndex - n) : 0))) {
                            continue;
                        }
                        n4 = n6;
                        n3 = transferIndex - 1;
            ...
            else if (n3 < 0 || n3 >= length || n3 + length >= length2) {
                if (n2 != 0) {
                    this.nextTable = null;
                    this.table = array2;
                ...
                final Node<K, V> tab;
                if ((tab = tabAt(array, n3)) == null) {
                    casTab = (casTabAt(array, n3, null, (Node<K, V>)forwardingNode) ? 1 : 0);
                }
                else {
                    final int hash;
                    if ((hash = tab.hash) == -1) {
                        ...
                        synchronized (tab) {
                            ...
                            if (hash >= 0) {
                                ...
                                setTabAt(array2, n3, tab);
                                setTabAt(array2, n3 + length, tab);
                                setTabAt(array, n3, (Node<K, V>)forwardingNode);
                                casTab = 1;
                            }
                            else {
                                ...
                                int n9 = 0;
                                int n10 = 0;
                                for (Object o = treeBin.first; o != null; o = ((Node)o).next) {
                                    final int hash3 = ((Node)o).hash;
                                    final TreeNode treeNode3 = new TreeNode<Object, Object>(hash3, ((Node)o).key, ((Node)o).val, null, null);
                                    if ((hash3 & length) == 0x0) {
                                        if ((treeNode3.prev = prev) == null) {
                                            treeNode = (TreeNode<K, V>)treeNode3;
                                        }
                                        else {
                                            prev.next = (Node<K, V>)treeNode3;
                                        }
                                        prev = treeNode3;
                                        ++n9;
                                    }
                                        ...
                                        if ((treeNode3.prev = prev2) == null) {
                                            treeNode2 = (TreeNode<K, V>)treeNode3;
                                        }
                                        else {
                                ...
                                final Node<K, V> node4 = (n9 <= 6) ? untreeify((Node<K, V>)treeNode) : ((n10 != 0) ? new TreeBin<K, V>((TreeNode<K, V>)treeNode) : treeBin);
                                final Node<K, V> node5 = (n10 <= 6) ? untreeify((Node<K, V>)treeNode2) : ((n9 != 0) ? new TreeBin<K, V>((TreeNode<K, V>)treeNode2) : treeBin);
                                setTabAt(array2, n3, node4);
                                setTabAt(array2, n3 + length, node5);
                                setTabAt(array, n3, (Node<K, V>)forwardingNode);
                                casTab = 1;
                            }
                        }
    ...
    public void forEach(final long n, final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        new ForEachMappingTask(null, this.batchFor(n), 0, 0, this.table, biConsumer).invoke();
    }
    ...
    public <U> void forEach(final long n, final BiFunction<? super K, ? super V, ? extends U> biFunction, final Consumer<? super U> consumer) {
        ...
        new ForEachTransformedMappingTask(null, this.batchFor(n), 0, 0, this.table, biFunction, consumer).invoke();
    }
    ...
    public void forEachKey(final long n, final Consumer<? super K> consumer) {
        ...
        new ForEachKeyTask(null, this.batchFor(n), 0, 0, this.table, consumer).invoke();
    }
    ...
    public <U> void forEachKey(final long n, final Function<? super K, ? extends U> function, final Consumer<? super U> consumer) {
        ...
        new ForEachTransformedKeyTask(null, this.batchFor(n), 0, 0, this.table, function, consumer).invoke();
    }
    ...
    public void forEachValue(final long n, final Consumer<? super V> consumer) {
        ...
        new ForEachValueTask(null, this.batchFor(n), 0, 0, this.table, consumer).invoke();
    }
    ...
    public <U> void forEachValue(final long n, final Function<? super V, ? extends U> function, final Consumer<? super U> consumer) {
        ...
        new ForEachTransformedValueTask(null, this.batchFor(n), 0, 0, this.table, function, consumer).invoke();
    }
    ...
    public void forEachEntry(final long n, final Consumer<? super Map.Entry<K, V>> consumer) {
        ...
        new ForEachEntryTask(null, this.batchFor(n), 0, 0, this.table, consumer).invoke();
    }
    ...
    public <U> void forEachEntry(final long n, final Function<Map.Entry<K, V>, ? extends U> function, final Consumer<? super U> consumer) {
        ...
        new ForEachTransformedEntryTask(null, this.batchFor(n), 0, 0, this.table, function, consumer).invoke();
    }
    ...
    static final class ForwardingNode<K, V> extends Node<K, V>
    {
        ...
        Label_0005:
            while (o != null && array != null && (length = array.length) != 0 && (node = ConcurrentHashMap.tabAt(array, length - 1 & n)) != null) {
                int hash;
                K key;
                while ((hash = node.hash) != n || ((key = (K)node.key) != o && (key == null || !o.equals(key)))) {
                    if (hash < 0) {
    ...
    static final class TreeBin<K, V> extends Node<K, V>
    {
        ...
        TreeBin(final TreeNode<K, V> first) {
            ...
            TreeNode treeNode2;
            for (TreeNode<K, V> treeNode = first; treeNode != null; treeNode = treeNode2) {
        ...
        final Node<K, V> find(final int n, final Object o) {
            if (o != null) {
                Object o2 = this.first;
                while (o2 != null) {
                    final int lockState;
                    if (((lockState = this.lockState) & 0x3) != 0x0) {
                        final K key;
                        if (((Node)o2).hash == n && ((key = ((Node)o2).key) == o || (key != null && o.equals(key)))) {
                            return (Node<K, V>)o2;
                        }
                        o2 = ((Node)o2).next;
                    }
            ...
            while (true) {
                while (root != null) {
                    ...
                    if ((hash = root.hash) > n) {
                        ...
                        final K key;
                        if ((key = root.key) == k || (key != null && k.equals(key))) {
                            return root;
                        }
                        if ((comparableClass == null && (comparableClass = ConcurrentHashMap.comparableClassFor(k)) == null) || (n3 = ConcurrentHashMap.compareComparables(comparableClass, k, key)) == 0) {
                            if (n2 == 0) {
                                ...
                                if (((left = root.left) != null && (treeNode = left.findTreeNode(n, k, comparableClass)) != null) || ((right = root.right) != null && (treeNode = right.findTreeNode(n, k, comparableClass)) != null)) {
                                    return treeNode;
                                }
                            }
                    ...
                    final TreeNode<K, V> treeNode2 = root;
                    if ((root = ((n3 <= 0) ? root.left : root.right)) == null) {
        ...
        static <K, V> TreeNode<K, V> balanceInsertion(TreeNode<K, V> node, TreeNode<K, V> treeNode) {
            treeNode.red = true;
            Node<K, V> node2;
            while ((node2 = treeNode.parent) != null) {
                Node<K, V> parent;
                if (!((TreeNode)node2).red || (parent = ((TreeNode)node2).parent) == null) {
                    return (TreeNode<K, V>)node;
                }
                final Node<K, V> left;
                if (node2 == (left = ((TreeNode)parent).left)) {
                    final Node<K, V> right;
                    if ((right = ((TreeNode)parent).right) != null && ((TreeNode)right).red) {
                        ((TreeNode)right).red = false;
                        ...
                        if (treeNode == ((TreeNode)node2).right) {
                            node = rotateLeft((TreeNode<K, V>)node, treeNode = (TreeNode)node2);
                            parent = (((node2 = treeNode.parent) == null) ? null : ((TreeNode)node2).parent);
                        }
                        if (node2 == null) {
                            continue;
                        }
                        ...
                        ((TreeNode)parent).red = true;
                        node = rotateRight((TreeNode<K, V>)node, (TreeNode<K, V>)parent);
                    }
                }
                else if (left != null && ((TreeNode)left).red) {
                    ((TreeNode)left).red = false;
                    ((TreeNode)node2).red = false;
                    ((TreeNode)parent).red = true;
                    treeNode = (TreeNode)parent;
                    ...
                    if (treeNode == ((TreeNode)node2).left) {
                        node = rotateRight((TreeNode<K, V>)node, treeNode = (TreeNode)node2);
                        parent = (((node2 = treeNode.parent) == null) ? null : ((TreeNode)node2).parent);
                    }
                    if (node2 == null) {
                        continue;
                    ...
                    ((TreeNode)parent).red = true;
                    node = rotateLeft((TreeNode<K, V>)node, (TreeNode<K, V>)parent);
                }
            }
            treeNode.red = false;
            return treeNode;
        ...
        static <K, V> TreeNode<K, V> balanceDeletion(TreeNode<K, V> node, TreeNode<K, V> treeNode) {
            while (treeNode != null && treeNode != node) {
                TreeNode<Object, Object> treeNode2;
                if ((treeNode2 = treeNode.parent) == null) {
                    treeNode.red = false;
                ...
                Object left;
                if ((left = treeNode2.left) == treeNode) {
                    Object right;
                    if ((right = treeNode2.right) != null && ((TreeNode)right).red) {
                        ((TreeNode)right).red = false;
                        treeNode2.red = true;
                        node = rotateLeft((TreeNode<K, V>)node, (TreeNode<K, V>)treeNode2);
                        right = (((treeNode2 = treeNode.parent) == null) ? null : treeNode2.right);
                    }
                    if (right == null) {
                        treeNode = treeNode2;
                    }
                        ...
                        if ((right2 == null || !right2.red) && (left2 == null || !left2.red)) {
                            ...
                            if (right != null) {
                                ((TreeNode)right).red = (treeNode2 != null && treeNode2.red);
                            ...
                            treeNode = (TreeNode<Object, Object>)node;
                        }
                    }
                }
                else {
                    if (left != null && ((TreeNode)left).red) {
                        ((TreeNode)left).red = false;
                        treeNode2.red = true;
                        node = rotateRight((TreeNode<K, V>)node, (TreeNode<K, V>)treeNode2);
                        left = (((treeNode2 = treeNode.parent) == null) ? null : treeNode2.left);
                    }
                    if (left == null) {
                        treeNode = treeNode2;
                    }
                        ...
                        if ((left3 == null || !left3.red) && (right4 == null || !right4.red)) {
                            ...
                            if (left != null) {
                                ((TreeNode)left).red = (treeNode2 != null && treeNode2.red);
    ...
    static final class EntrySpliterator<K, V> extends Traverser<K, V> implements Spliterator<Map.Entry<K, V>>
    {
        ...
        public void forEachRemaining(final Consumer<? super Map.Entry<K, V>> consumer) {
            ...
            Node<K, V> advance;
            while ((advance = this.advance()) != null) {
                consumer.accept((MapEntry)new MapEntry(advance.key, advance.val, (ConcurrentHashMap<Object, Object>)this.map));
            }
        }
    ...
    public static class KeySetView<K, V> extends CollectionView<K, V, K> implements Set<K>, Serializable
    {
        ...
        public void forEach(final Consumer<? super K> consumer) {
            ...
            if ((table = this.map.table) != null) {
                Node advance;
                while ((advance = new Traverser(table, ((Node<Object, Object>[])table).length, 0, ((Node<Object, Object>[])table).length).advance()) != null) {
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    final U apply;
                    if ((apply = (U)searchFunction.apply(advance.key)) == null) {
                        continue;
                    }
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    final U apply;
                    if ((apply = (U)searchFunction.apply(advance.val)) == null) {
                        continue;
                    }
                    if (result.compareAndSet(null, apply)) {
                        this.quietlyCompleteRoot();
        ...
        public final void compute() {
            ...
            if ((searchFunction = this.searchFunction) != null && (result = this.result) != null) {
                ...
                while (result.get() == null) {
                    ...
                    final U apply;
                    if ((apply = (U)searchFunction.apply(advance.key, advance.val)) == null) {
                        continue;
                    }
                    if (result.compareAndSet(null, apply)) {
                        this.quietlyCompleteRoot();
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    ReduceKeysTask<K, V> nextRight;
                    for (ReduceKeysTask<K, V> rights = reduceKeysTask.rights; rights != null; rights = nextRight) {
                        final K result2;
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    ReduceValuesTask<K, V> nextRight;
                    for (ReduceValuesTask<K, V> rights = reduceValuesTask.rights; rights != null; rights = nextRight) {
                        final V result2;
                        if ((result2 = rights.result) != null) {
                            final V result3;
    ...
    static final class ReduceEntriesTask<K, V> extends BulkTask<K, V, Map.Entry<K, V>>
    {
        ...
        public final void compute() {
            ...
            if ((reducer = this.reducer) != null) {
                ...
                Node<K, V> advance;
                while ((advance = this.advance()) != null) {
                    result = ((result == null) ? advance : ((Map.Entry)reducer.apply((Map.Entry<K, V>)result, advance)));
                }
                this.result = (Map.Entry<K, V>)result;
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    final ReduceEntriesTask reduceEntriesTask = (ReduceEntriesTask)countedCompleter;
                    ReduceEntriesTask<K, V> nextRight;
                    for (ReduceEntriesTask<K, V> rights = reduceEntriesTask.rights; rights != null; rights = nextRight) {
                        final Map.Entry<K, V> result2;
                        if ((result2 = rights.result) != null) {
                            final Map.Entry<K, V> result3;
                            reduceEntriesTask.result = (((result3 = reduceEntriesTask.result) == null) ? result2 : reducer.apply(result3, (Node)result2));
                        }
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceKeysTask<K, V, U> nextRight;
                    for (MapReduceKeysTask<K, V, U> rights = mapReduceKeysTask.rights; rights != null; rights = nextRight) {
                        final U result2;
                        if ((result2 = rights.result) != null) {
                            final U result3;
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceValuesTask<K, V, U> nextRight;
                    for (MapReduceValuesTask<K, V, U> rights = mapReduceValuesTask.rights; rights != null; rights = nextRight) {
                        final U result2;
                        if ((result2 = rights.result) != null) {
                            final U result3;
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceEntriesTask<K, V, U> nextRight;
                    for (MapReduceEntriesTask<K, V, U> rights = mapReduceEntriesTask.rights; rights != null; rights = nextRight) {
                        final U result2;
                        if ((result2 = rights.result) != null) {
                            final U result3;
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceMappingsTask<K, V, U> nextRight;
                    for (MapReduceMappingsTask<K, V, U> rights = mapReduceMappingsTask.rights; rights != null; rights = nextRight) {
                        final U result2;
                        if ((result2 = rights.result) != null) {
                            final U result3;
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceKeysToDoubleTask<K, V> nextRight;
                    for (MapReduceKeysToDoubleTask<K, V> rights = mapReduceKeysToDoubleTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceValuesToDoubleTask<K, V> nextRight;
                    for (MapReduceValuesToDoubleTask<K, V> rights = mapReduceValuesToDoubleTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceEntriesToDoubleTask<K, V> nextRight;
                    for (MapReduceEntriesToDoubleTask<K, V> rights = mapReduceEntriesToDoubleTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceMappingsToDoubleTask<K, V> nextRight;
                    for (MapReduceMappingsToDoubleTask<K, V> rights = mapReduceMappingsToDoubleTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceKeysToLongTask<K, V> nextRight;
                    for (MapReduceKeysToLongTask<K, V> rights = mapReduceKeysToLongTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceValuesToLongTask<K, V> nextRight;
                    for (MapReduceValuesToLongTask<K, V> rights = mapReduceValuesToLongTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceEntriesToLongTask<K, V> nextRight;
                    for (MapReduceEntriesToLongTask<K, V> rights = mapReduceEntriesToLongTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceMappingsToLongTask<K, V> nextRight;
                    for (MapReduceMappingsToLongTask<K, V> rights = mapReduceMappingsToLongTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceKeysToIntTask<K, V> nextRight;
                    for (MapReduceKeysToIntTask<K, V> rights = mapReduceKeysToIntTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceValuesToIntTask<K, V> nextRight;
                    for (MapReduceValuesToIntTask<K, V> rights = mapReduceValuesToIntTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceEntriesToIntTask<K, V> nextRight;
                    for (MapReduceEntriesToIntTask<K, V> rights = mapReduceEntriesToIntTask.rights; rights != null; rights = nextRight) {
        ...
        public final void compute() {
            ...
            if ((transformer = this.transformer) != null && (reducer = this.reducer) != null) {
                ...
                for (CountedCompleter<?> countedCompleter = this.firstComplete(); countedCompleter != null; countedCompleter = countedCompleter.nextComplete()) {
                    ...
                    MapReduceMappingsToIntTask<K, V> nextRight;
                    for (MapReduceMappingsToIntTask<K, V> rights = mapReduceMappingsToIntTask.rights; rights != null; rights = nextRight) {
