...
public class CopyOnWriteArraySet<E> extends AbstractSet<E> implements Serializable
{
    ...
    public CopyOnWriteArraySet(final Collection<? extends E> collection) {
        if (((CopyOnWriteArraySet)collection).getClass() == CopyOnWriteArraySet.class) {
            this.al = new CopyOnWriteArrayList<E>((Collection<? extends E>)((CopyOnWriteArraySet)collection).al);
        }
        else {
