...
public class Phaser
{
            ...
            if (Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, n2, n6 = n2 - n)) {
                if (n5 == 1) {
                    ...
                    if (root == this) {
                        ...
                        Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, n6, n9 | (long)(n3 + 1 & Integer.MAX_VALUE) << 32);
    ...
    private int doRegister(final int n) {
        final long n2 = (long)n << 16 | (long)n;
        ...
        while (true) {
            ...
            if (n3 != 1) {
                ...
                if (Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, state, (long)doRegister << 32 | n2)) {
                    break;
                }
                continue;
            }
                ...
                synchronized (this) {
                    ...
                    while (!Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, state, (long)doRegister << 32 | n2)) {
                        state = this.state;
    ...
    private long reconcileState() {
        ...
        if (root != this) {
            int n2;
            int n3;
            while ((n2 = (int)(root.state >>> 32)) != (int)(n >>> 32) && !Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, n, n = ((long)n2 << 32 | ((n2 < 0) ? (n & 0xFFFFFFFFL) : (((n3 = (int)n >>> 16) == 0) ? 1L : ((n & 0xFFFF0000L) | (long)n3)))))) {
                n = this.state;
            }
        }
        return n;
    ...
    public Phaser(final Phaser parent, final int n) {
        ...
        this.state = ((n == 0) ? 1L : ((long)doRegister << 32 | (long)n << 16 | (long)n));
    }
    ...
    public int arriveAndAwaitAdvance() {
        ...
        while (true) {
            ...
            if (!Phaser.UNSAFE.compareAndSwapLong(this, Phaser.stateOffset, n5, n8 | (long)n9 << 32)) {
