...
public class CompletableFuture<T> implements Future<T>, CompletionStage<T>
{
    ...
    private <V> CompletableFuture<V> uniApplyStage(final Executor executor, final Function<? super T, ? extends V> function) {
        ...
        if (executor != null || !completableFuture.uniApply(this, function, null)) {
            final UniApply uniApply = new UniApply(executor, completableFuture, this, function);
            this.push(uniApply);
            uniApply.tryFire(0);
        }
    ...
    private CompletableFuture<Void> uniAcceptStage(final Executor executor, final Consumer<? super T> consumer) {
        ...
        if (executor != null || !completableFuture.uniAccept(this, consumer, null)) {
            final UniAccept uniAccept = new UniAccept(executor, completableFuture, this, consumer);
            this.push(uniAccept);
            uniAccept.tryFire(0);
        }
        return completableFuture;
    ...
    private CompletableFuture<Void> uniRunStage(final Executor executor, final Runnable runnable) {
        ...
        if (executor != null || !completableFuture.uniRun(this, runnable, null)) {
            final UniRun uniRun = new UniRun(executor, completableFuture, this, runnable);
            this.push(uniRun);
            uniRun.tryFire(0);
        }
        return completableFuture;
    ...
    private CompletableFuture<T> uniWhenCompleteStage(final Executor executor, final BiConsumer<? super T, ? super Throwable> biConsumer) {
        ...
        if (executor != null || !completableFuture.uniWhenComplete(this, biConsumer, null)) {
            final UniWhenComplete uniWhenComplete = new UniWhenComplete(executor, completableFuture, this, biConsumer);
    ...
    private <V> CompletableFuture<V> uniHandleStage(final Executor executor, final BiFunction<? super T, Throwable, ? extends V> biFunction) {
        ...
        if (executor != null || !completableFuture.uniHandle(this, biFunction, null)) {
            final UniHandle uniHandle = new UniHandle(executor, completableFuture, this, biFunction);
            this.push(uniHandle);
            uniHandle.tryFire(0);
        }
        return completableFuture;
    ...
    private CompletableFuture<T> uniExceptionallyStage(final Function<Throwable, ? extends T> function) {
        ...
        if (!completableFuture.uniExceptionally(this, function, null)) {
            final UniExceptionally uniExceptionally = new UniExceptionally(completableFuture, this, function);
        ...
        if (this.result == null) {
            ...
            try {
                ...
                if (completableFuture2.result == null || !this.uniRelay(completableFuture2)) {
                    final UniRelay uniRelay = new UniRelay((CompletableFuture<Object>)this, completableFuture2);
    ...
    private <V> CompletableFuture<V> uniComposeStage(final Executor executor, final Function<? super T, ? extends CompletionStage<V>> function) {
        ...
        if (executor == null && (result = this.result) != null) {
            ...
            try {
                ...
                final UniRelay uniRelay = new UniRelay(completableFuture2, completableFuture);
    ...
    private <U, V> CompletableFuture<V> biApplyStage(final Executor executor, final CompletionStage<U> completionStage, final BiFunction<? super T, ? super U, ? extends V> biFunction) {
        ...
        if (executor != null || !completableFuture2.biApply(this, completableFuture, biFunction, null)) {
            final BiApply biApply = new BiApply(executor, completableFuture2, this, completableFuture, biFunction);
    ...
    private <U> CompletableFuture<Void> biAcceptStage(final Executor executor, final CompletionStage<U> completionStage, final BiConsumer<? super T, ? super U> biConsumer) {
        ...
        if (executor != null || !completableFuture2.biAccept(this, completableFuture, biConsumer, null)) {
            final BiAccept biAccept = new BiAccept(executor, completableFuture2, this, completableFuture, biConsumer);
    ...
    private CompletableFuture<Void> biRunStage(final Executor executor, final CompletionStage<?> completionStage, final Runnable runnable) {
        ...
        if (executor != null || !completableFuture2.biRun(this, completableFuture, runnable, null)) {
            final BiRun biRun = new BiRun(executor, completableFuture2, this, completableFuture, runnable);
    ...
    private <U extends T, V> CompletableFuture<V> orApplyStage(final Executor executor, final CompletionStage<U> completionStage, final Function<? super T, ? extends V> function) {
        ...
        if (executor != null || !completableFuture2.orApply(this, completableFuture, function, null)) {
            final OrApply orApply = new OrApply(executor, completableFuture2, this, completableFuture, function);
    ...
    private <U extends T> CompletableFuture<Void> orAcceptStage(final Executor executor, final CompletionStage<U> completionStage, final Consumer<? super T> consumer) {
        ...
        if (executor != null || !completableFuture2.orAccept(this, completableFuture, consumer, null)) {
            final OrAccept orAccept = new OrAccept(executor, completableFuture2, this, completableFuture, consumer);
    ...
    private CompletableFuture<Void> orRunStage(final Executor executor, final CompletionStage<?> completionStage, final Runnable runnable) {
        ...
        if (executor != null || !completableFuture2.orRun(this, completableFuture, runnable, null)) {
            final OrRun orRun = new OrRun(executor, completableFuture2, this, completableFuture, runnable);
    ...
    static final class UniAccept<T> extends UniCompletion<T, Void>
    {
        ...
        final CompletableFuture<Void> tryFire(final int n) {
            final Object dep;
            final Object src;
            if ((dep = this.dep) == null || !((CompletableFuture<Void>)dep).uniAccept((CompletableFuture<T>)(src = this.src), this.fn, (n > 0) ? null : this)) {
                return null;
            }
            this.dep = null;
            this.src = null;
    ...
    static final class BiApply<T, U, V> extends BiCompletion<T, U, V>
    {
        ...
        final CompletableFuture<V> tryFire(final int n) {
            ...
            if ((dep = this.dep) == null || !((CompletableFuture<V>)dep).biApply((CompletableFuture<T>)(src = this.src), snd = this.snd, (BiFunction<? super T, ? super U, ? extends V>)this.fn, (BiApply<T, U, V>)((n > 0) ? null : this))) {
                return null;
            }
            this.dep = null;
            this.src = null;
            this.snd = null;
            this.fn = null;
            return (CompletableFuture<V>)((CompletableFuture<V>)dep).postFire(src, (CompletableFuture<?>)snd, n);
        }
    }
    ...
    static final class BiRun<T, U> extends BiCompletion<T, U, Void>
    {
        ...
        final CompletableFuture<Void> tryFire(final int n) {
            final CompletableFuture<U> dep;
            if ((dep = this.dep) != null) {
                final CompletableFuture completableFuture = dep;
                final CompletableFuture<T> src = this.src;
                final Future<T> snd;
    ...
    static final class OrApply<T, U extends T, V> extends BiCompletion<T, U, V>
    {
        ...
        final CompletableFuture<V> tryFire(final int n) {
            ...
            final Object src;
            final CompletableFuture<U> snd;
            if ((dep = this.dep) == null || !((CompletableFuture<V>)dep).orApply((CompletableFuture<T>)(src = this.src), snd = this.snd, (Function<? super T, ? extends V>)this.fn, (OrApply<T, U, V>)((n > 0) ? null : this))) {
                return null;
            }
            this.dep = null;
            this.src = null;
        ...
        final CompletableFuture<Object> tryFire(final int n) {
            ...
            if ((dep = this.dep) != null) {
                ...
                if (completableFuture.orRelay(src, (CompletableFuture<?>)(snd = (Future<T>)this.snd))) {
                    ...
                    this.snd = null;
                    this.dep = null;
                    return dep.postFire(src, (CompletableFuture<?>)snd, n);
                }
            }
            return null;
        }
