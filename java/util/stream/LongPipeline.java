...
abstract class LongPipeline<E_IN> extends AbstractPipeline<E_IN, Long, LongStream> implements LongStream
{
    ...
    public final OptionalDouble average() {
        final long[] array = this.collect(() -> new long[2], (array2, n) -> {
            final int n3;
            ++array2[n3];
            final int n4;
            array2[n4] += n;
        ...
        return (array[0] > 0L) ? OptionalDouble.of(array[1] / (double)array[0]) : OptionalDouble.empty();
    }
    ...
    public final <R> R collect(final Supplier<R> supplier, final ObjLongConsumer<R> objLongConsumer, final BiConsumer<R, R> biConsumer) {
        ...
        return this.evaluate((TerminalOp<Long, R>)ReduceOps.makeLong((Supplier<R>)supplier, (ObjLongConsumer<R>)objLongConsumer, (o2, o4) -> {
