...
abstract class DoublePipeline<E_IN> extends AbstractPipeline<E_IN, Double, DoubleStream> implements DoubleStream
{
    ...
    public final OptionalDouble average() {
        final double[] array = this.collect(() -> new double[4], (array2, n) -> {
            final int n3;
            ++array2[n3];
            Collectors.sumWithCompensation(array2, n);
            final int n4;
            array2[n4] += n;
            return;
        }, (array3, array4) -> {
            Collectors.sumWithCompensation(array3, array4[0]);
            Collectors.sumWithCompensation(array3, array4[1]);
            final int n5;
            array3[n5] += array4[2];
            final int n6;
            array3[n6] += array4[3];
        ...
        return (array[2] > 0.0) ? OptionalDouble.of(Collectors.computeFinalSum(array) / array[2]) : OptionalDouble.empty();
    }
    ...
    public final <R> R collect(final Supplier<R> supplier, final ObjDoubleConsumer<R> objDoubleConsumer, final BiConsumer<R, R> biConsumer) {
        ...
        return this.evaluate((TerminalOp<Double, R>)ReduceOps.makeDouble((Supplier<R>)supplier, (ObjDoubleConsumer<R>)objDoubleConsumer, (o2, o4) -> {
            biConsumer2.accept(o2, o4);
            return o2;
        }));
    }
