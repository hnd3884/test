...
abstract class AbstractPipeline<E_IN, E_OUT, S extends BaseStream<E_OUT, S>> extends PipelineHelper<E_OUT> implements BaseStream<E_OUT, S>
{
    ...
    private Spliterator<?> sourceSpliterator(final int n) {
        ...
        if (this.isParallel() && this.sourceStage.sourceAnyStateful) {
            int n2 = 1;
            for (AbstractPipeline sourceStage = this.sourceStage, abstractPipeline = this.sourceStage.nextStage; sourceStage != this; sourceStage = abstractPipeline, abstractPipeline = abstractPipeline.nextStage) {
    ...
    final <P_IN> Sink<P_IN> wrapSink(final Sink<E_OUT> p0) {
        ...
        //    StackMapTable: 00 02 FC 00 07 07 00 78 FA 00 1B
        // 
        ...
        //     at com.strobel.decompiler.ast.TypeAnalysis.doInferTypeForExpression(TypeAnalysis.java:943)
    ...
    final <P_IN> Spliterator<E_OUT> wrapSpliterator(final Spliterator<P_IN> spliterator) {
        ...
        return this.wrap((PipelineHelper<E_OUT>)this, () -> spliterator2, this.isParallel());
    }
