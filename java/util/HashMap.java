...
public class HashMap<K, V> extends AbstractMap<K, V> implements Map<K, V>, Cloneable, Serializable
{
    ...
    final void putMapEntries(final Map<? extends K, ? extends V> map, final boolean b) {
        ...
        if (size > 0) {
            ...
            for (final Entry entry : map.entrySet()) {
                ...
                this.putVal(hash(key), (K)key, entry.getValue(), false, b);
            }
        }
    }
        ...
        if ((table = this.table) != null && (length = table.length) > 0 && (node = table[length - 1 & n]) != null) {
            ...
            if ((node2 = node.next) != null) {
                if (node instanceof TreeNode) {
                    return ((TreeNode)node).getTreeNode(n, o);
                }
                K key2;
            ...
            for (int i = 0; i < n; ++i) {
                ...
                if ((node = table[i]) != null) {
                    ...
                    if (node.next == null) {
                        ...
                        ((TreeNode)node).split(this, table2, i, n);
                    }
                    else {
                        Node node2 = null;
                        Node node3 = null;
    ...
    final void treeifyBin(final Node<K, V>[] array, final int n) {
        ...
        if (array == null || (length = array.length) < 64) {
            ...
            if ((next = array[n2 = (length - 1 & n)]) != null) {
                ...
                do {
                    final TreeNode<K, V> replacementTreeNode = this.replacementTreeNode(next, null);
                    if (prev == null) {
        ...
        if ((table = this.table) != null && (length = table.length) > 0 && (node = table[n2 = (length - 1 & n)]) != null) {
            ...
            Label_0171: {
                ...
                if (node.hash == n && ((key = node.key) == o || (o != null && o.equals(key)))) {
                    ...
                    if ((node2 = node.next) != null) {
                        if (node instanceof TreeNode) {
                            treeNode = ((TreeNode)node).getTreeNode(n, o);
                        }
                        else {
                            K key2;
                            while (node2.hash != n || ((key2 = node2.key) != o && (o == null || !o.equals(key2)))) {
            ...
            if (treeNode != null && (!b || (value = treeNode.value) == o2 || (o2 != null && o2.equals(value)))) {
                if (treeNode instanceof TreeNode) {
                    ((TreeNode)treeNode).removeTreeNode(this, table, b2);
                }
        ...
        if ((node = array[n3 = (n2 - 1 & hash)]) != null) {
            Label_0169: {
                if (node instanceof TreeNode) {
                    ...
                    Object next = node;
                    K key;
                    while (((Node)next).hash != hash || ((key = ((Node)next).key) != k && (k == null || !k.equals(key)))) {
                        ++n;
                        if ((next = ((Node)next).next) == null) {
                            break Label_0169;
                        }
                    }
                    treeNode2 = (Node<K, V>)next;
                }
            }
            final V value;
    ...
    static final class TreeNode<K, V> extends LinkedHashMap.Entry<K, V>
    {
        ...
        final void treeify(final Node<K, V>[] array) {
            ...
            for (TreeNode treeNode = this; treeNode != null; treeNode = treeNode2) {
                ...
                if (balanceInsertion == null) {
                    ...
                    balanceInsertion = balanceInsertion(balanceInsertion, (TreeNode<K, V>)treeNode);
                }
            }
                ...
                if ((hash = treeNode2.hash) > n) {
                    ...
                    if ((comparableClass == null && (comparableClass = HashMap.comparableClassFor(k)) == null) || (n3 = HashMap.compareComparables(comparableClass, k, key)) == 0) {
                        if (n2 == 0) {
                            ...
                            if (((left = treeNode2.left) != null && (treeNode3 = left.find(n, k, comparableClass)) != null) || ((right = treeNode2.right) != null && (treeNode3 = right.find(n, k, comparableClass)) != null)) {
                                return treeNode3;
                            }
                        }
        ...
        final void removeTreeNode(final HashMap<K, V> hashMap, final Node<K, V>[] array, final boolean b) {
            ...
            final TreeNode<K, V> left;
            if (root == null || (b && (root.right == null || (left = root.left) == null || left.left == null))) {
            ...
            final TreeNode<K, V> treeNode4 = this.red ? root : balanceDeletion(root, treeNode);
            if (treeNode == this) {
        ...
        static <K, V> TreeNode<K, V> balanceInsertion(TreeNode<K, V> treeNode, TreeNode<K, V> treeNode2) {
            ...
            while ((entry = treeNode2.parent) != null) {
                LinkedHashMap.Entry<K, V> parent;
                if (!((TreeNode)entry).red || (parent = ((TreeNode)entry).parent) == null) {
                    return (TreeNode<K, V>)treeNode;
                }
                final LinkedHashMap.Entry<K, V> left;
                if (entry == (left = ((TreeNode)parent).left)) {
                    ...
                    if ((right = ((TreeNode)parent).right) != null && ((TreeNode)right).red) {
                        ...
                        if (treeNode2 == ((TreeNode)entry).right) {
                            treeNode = rotateLeft(treeNode, treeNode2 = (TreeNode)entry);
                            parent = (((entry = treeNode2.parent) == null) ? null : ((TreeNode)entry).parent);
                        }
                        if (entry == null) {
                            continue;
                        }
                    ...
                    if (treeNode2 == ((TreeNode)entry).left) {
                        treeNode = rotateRight(treeNode, treeNode2 = (TreeNode)entry);
                        parent = (((entry = treeNode2.parent) == null) ? null : ((TreeNode)entry).parent);
                    }
                    if (entry == null) {
                        continue;
        ...
        static <K, V> TreeNode<K, V> balanceDeletion(TreeNode<K, V> treeNode, TreeNode<K, V> treeNode2) {
            while (treeNode2 != null && treeNode2 != treeNode) {
                TreeNode<Object, Object> treeNode3;
                ...
                if ((left = treeNode3.left) == treeNode2) {
                    Object right;
                    if ((right = treeNode3.right) != null && ((TreeNode)right).red) {
                        ((TreeNode)right).red = false;
                        treeNode3.red = true;
                    ...
                    if (right == null) {
                        ...
                        if ((right2 == null || !right2.red) && (left2 == null || !left2.red)) {
                            ...
                            if (right != null) {
                                ((TreeNode)right).red = (treeNode3 != null && treeNode3.red);
                    ...
                    if (left == null) {
                        ...
                        if ((left3 == null || !left3.red) && (right4 == null || !right4.red)) {
                            ...
                            if (left != null) {
                                ((TreeNode)left).red = (treeNode3 != null && treeNode3.red);
