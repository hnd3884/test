...
public abstract class Calendar implements Serializable, Cloneable, Comparable<Calendar>
{
    ...
    public boolean equals(final Object o) {
        ...
        try {
            ...
            return this.compareTo(getMillisOf(calendar)) == 0 && this.lenient == calendar.lenient && this.firstDayOfWeek == calendar.firstDayOfWeek && this.minimalDaysInFirstWeek == calendar.minimalDaysInFirstWeek && ((this.zone instanceof ZoneInfo) ? this.zone.equals(calendar.zone) : this.zone.equals(calendar.getTimeZone()));
        }
