...
public class TreeMap<K, V> extends AbstractMap<K, V> implements NavigableMap<K, V>, Cloneable, Serializable
{
    ...
    public boolean containsValue(final Object o) {
        for (Map.Entry<K, V> entry = (Map.Entry<K, V>)this.getFirstEntry(); entry != null; entry = (Map.Entry<K, V>)successor((Entry<Object, Object>)entry)) {
            if (valEquals(o, ((Entry)entry).value)) {
                return true;
            }
        }
        return false;
    ...
    public V put(final K k, final V v) {
        ...
        final Entry entry3 = new Entry<K, V>(k, v, entry2);
        if (n < 0) {
            entry2.left = (Entry<K, V>)entry3;
        }
        else {
            entry2.right = (Entry<K, V>)entry3;
        }
        this.fixAfterInsertion((Entry<K, V>)entry3);
        ++this.size;
        ++this.modCount;
        return null;
    }
    ...
    public void forEach(final BiConsumer<? super K, ? super V> biConsumer) {
        ...
        for (Map.Entry<K, V> entry = (Map.Entry<K, V>)this.getFirstEntry(); entry != null; entry = (Map.Entry<K, V>)successor((Entry<Object, Object>)entry)) {
            biConsumer.accept((Object)((Entry)entry).key, (Object)((Entry)entry).value);
    ...
    public void replaceAll(final BiFunction<? super K, ? super V, ? extends V> biFunction) {
        ...
        final int modCount = this.modCount;
        for (Map.Entry<K, V> entry = (Map.Entry<K, V>)this.getFirstEntry(); entry != null; entry = (Map.Entry<K, V>)successor((Entry<Object, Object>)entry)) {
            ((Entry)entry).value = (V)biFunction.apply((Object)((Entry)entry).key, (Object)((Entry)entry).value);
            if (modCount != this.modCount) {
                throw new ConcurrentModificationException();
            }
        }
    ...
    private final Entry<K, V> buildFromSorted(final int n, final int n2, final int n3, final int n4, final Iterator<?> iterator, final ObjectInputStream objectInputStream, final V v) throws IOException, ClassNotFoundException {
        ...
        final Entry entry2 = new Entry(o, value, null);
        if (n == n4) {
            entry2.color = false;
        }
        ...
        if (n5 < n3) {
            final Entry<K, V> buildFromSorted2 = this.buildFromSorted(n + 1, n5 + 1, n3, n4, iterator, objectInputStream, v);
