...
public class Collections
{
    ...
    private static <T> int indexedBinarySearch(final List<? extends Comparable<? super T>> list, final T t) {
        ...
        while (i <= n) {
            final int n2 = i + n >>> 1;
            final int compareTo = list.get(n2).compareTo(t);
            if (compareTo < 0) {
                i = n2 + 1;
            }
            else {
    ...
    private static <T> int indexedBinarySearch(final List<? extends T> list, final T t, final Comparator<? super T> comparator) {
        ...
        while (i <= n) {
            final int n2 = i + n >>> 1;
            final int compare = comparator.compare((Object)list.get(n2), (Object)t);
            if (compare < 0) {
                i = n2 + 1;
            }
            else {
    ...
    private static <T> int iteratorBinarySearch(final List<? extends T> list, final T t, final Comparator<? super T> comparator) {
        ...
        while (i <= n) {
            final int n2 = i + n >>> 1;
            final int compare = comparator.compare(get((ListIterator<? extends T>)listIterator, n2), t);
            if (compare < 0) {
                i = n2 + 1;
            }
            else {
    ...
    public static <T extends Object & Comparable<? super T>> T min(final Collection<? extends T> collection) {
        final Iterator<? extends T> iterator = collection.iterator();
        Object & Comparable<? super T> next = iterator.next();
        while (iterator.hasNext()) {
            final T next2 = (T)iterator.next();
            if (((Comparable<T>)next2).compareTo((T)next) < 0) {
                next = next2;
            }
        }
        return (T)next;
    ...
    public static int indexOfSubList(final List<?> list, final List<?> list2) {
        ...
        Label_0119:
            while (k <= n) {
                final ListIterator<Object> listIterator2 = list2.listIterator();
    ...
    private static class UnmodifiableMap<K, V> implements Map<K, V>, Serializable
    {
        ...
        static class UnmodifiableEntrySet<K, V> extends UnmodifiableSet<Entry<K, V>>
        {
            ...
            static <K, V> Consumer<Entry<K, V>> entryConsumer(final Consumer<? super Entry<K, V>> consumer) {
                return entry -> consumer2.accept(new UnmodifiableEntry(entry));
            }
    ...
    static class CheckedList<E> extends CheckedCollection<E> implements List<E>
    {
        ...
        public void replaceAll(final UnaryOperator<E> unaryOperator) {
            ...
            this.list.replaceAll(o2 -> this.typeCheck(unaryOperator2.apply(o2)));
        }
    ...
    private static class CheckedMap<K, V> implements Map<K, V>, Serializable
    {
        ...
        public void putAll(final Map<? extends K, ? extends V> map) {
            ...
            for (int length = array2.length, i = 0; i < length; ++i) {
                final Entry entry = (Entry)array2[i];
                final Object key = entry.getKey();
                final Object value = entry.getValue();
                this.typeCheck(key, value);
                list.add((Object)new AbstractMap.SimpleImmutableEntry(key, value));
            }
    ...
    private static class SingletonMap<K, V> extends AbstractMap<K, V> implements Serializable
    {
        ...
        public Set<Map.Entry<K, V>> entrySet() {
            if (this.entrySet == null) {
                this.entrySet = (Set<Map.Entry<K, V>>)Collections.singleton(new SimpleImmutableEntry(this.k, this.v));
            }
            return this.entrySet;
        }
