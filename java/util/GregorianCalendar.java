...
public class GregorianCalendar extends Calendar
{
    ...
    public void roll(final int n, int n2) {
        ...
        switch (n) {
            ...
            case 11: {
                int rolledValue;
                final int n4 = rolledValue = getRolledValue(this.internalGet(n), n2, minimum, n3);
                if (n == 10 && this.internalGet(9) == 1) {
                    rolledValue += 12;
                }
                final CalendarDate calendarDate = this.calsys.getCalendarDate(this.time, this.getZone());
                calendarDate.setHours(rolledValue);
                this.time = this.calsys.getTime(calendarDate);
                if (this.internalGet(11) == calendarDate.getHours()) {
                    int rolledValue2 = getRolledValue(n4, (n2 > 0) ? 1 : -1, minimum, n3);
                    if (n == 10 && this.internalGet(9) == 1) {
                        rolledValue2 += 12;
                    }
                    calendarDate.setHours(rolledValue2);
                    this.time = this.calsys.getTime(calendarDate);
                }
            ...
            case 2: {
                if (!this.isCutoverYear(this.cdate.getNormalizedYear())) {
                    ...
                    this.set(2, n5);
                    final int monthLength = this.monthLength(n5);
                    if (this.internalGet(5) > monthLength) {
                        this.set(5, monthLength);
                    }
                }
                else {
                    final int n6 = this.getActualMaximum(2) + 1;
                    int n7 = (this.internalGet(2) + n2) % n6;
                    if (n7 < 0) {
                        n7 += n6;
                    }
                    this.set(2, n7);
            ...
            case 3: {
                ...
                int internalGet = this.internalGet(3);
                final int n8 = internalGet + n2;
                if (!this.isCutoverYear(normalizedYear)) {
                    final int weekYear = this.getWeekYear();
                    if (weekYear == normalizedYear) {
                        if (n8 > minimum && n8 < actualMaximum2) {
                            this.set(3, n8);
                            return;
                        }
                        final long currentFixedDate = this.getCurrentFixedDate();
                        if (this.calsys.getYearFromFixedDate(currentFixedDate - 7 * (internalGet - minimum)) != normalizedYear) {
                            ++minimum;
                        }
                        ...
                        internalGet = actualMaximum2;
                    }
                    else {
                        if (n2 > 0) {
                            n2 -= internalGet - actualMaximum2;
                        }
                        internalGet = minimum;
                    }
                    this.set(n, getRolledValue(internalGet, n2, minimum, actualMaximum2));
                    return;
                }
                ...
                final long n9 = currentFixedDate2 - 7 * (internalGet - minimum);
                if (baseCalendar.getYearFromFixedDate(n9) != normalizedYear) {
                    ++minimum;
                }
                final long n10 = currentFixedDate2 + 7 * (actualMaximum2 - internalGet);
                if (((n10 >= this.gregorianCutoverDate) ? GregorianCalendar.gcal : getJulianCalendarSystem()).getYearFromFixedDate(n10) != normalizedYear) {
                    --actualMaximum2;
                }
                final BaseCalendar.Date calendarDate2 = this.getCalendarDate(n9 + (getRolledValue(internalGet, n2, minimum, actualMaximum2) - 1) * 7);
            ...
            case 4: {
                ...
                if (cutoverYear) {
                    ...
                    n12 = this.actualMonthLength();
                }
                else {
                    fixedDateMonth1 = currentFixedDate3 - this.internalGet(5) + 1L;
                    n12 = this.calsys.getMonthLength(this.cdate);
                }
                ...
                long n13 = dayOfWeekDateOnOrBefore + (getRolledValue(this.internalGet(n), n2, 1, this.getActualMaximum(n)) - 1) * 7 + n11;
                if (n13 < fixedDateMonth1) {
                    n13 = fixedDateMonth1;
                }
                else if (n13 >= fixedDateMonth1 + n12) {
                    n13 = fixedDateMonth1 + n12 - 1L;
                }
                int dayOfMonth;
                if (cutoverYear) {
                    dayOfMonth = this.getCalendarDate(n13).getDayOfMonth();
                }
                else {
                    dayOfMonth = (int)(n13 - fixedDateMonth1) + 1;
                }
            ...
            case 6: {
                ...
                final long n14 = currentFixedDate5 - this.internalGet(6) + 1L;
                final BaseCalendar.Date calendarDate4 = this.getCalendarDate(n14 + getRolledValue((int)(currentFixedDate5 - n14) + 1, n2, minimum, n3) - 1L);
            ...
            case 7: {
                if (!this.isCutoverYear(this.cdate.getNormalizedYear())) {
                    ...
                    if (internalGet2 > 1 && internalGet2 < 52) {
                        this.set(3, internalGet2);
                        n3 = 7;
                        break;
                    }
                }
                ...
                long n15 = currentFixedDate6 + n2;
                if (n15 < dayOfWeekDateOnOrBefore2) {
                    n15 += 7L;
                }
                else if (n15 >= dayOfWeekDateOnOrBefore2 + 7L) {
                    n15 -= 7L;
                }
                final BaseCalendar.Date calendarDate5 = this.getCalendarDate(n15);
            ...
            case 8: {
                minimum = 1;
                if (!this.isCutoverYear(this.cdate.getNormalizedYear())) {
                    final int internalGet3 = this.internalGet(5);
                    final int monthLength2 = this.calsys.getMonthLength(this.cdate);
                    final int n16 = monthLength2 % 7;
                    n3 = monthLength2 / 7;
                    if ((internalGet3 - 1) % 7 < n16) {
                        ++n3;
                    }
                    this.set(7, this.internalGet(7));
                    break;
                ...
                final int n17 = actualMonthLength % 7;
                int n18 = actualMonthLength / 7;
                final int n19 = (int)(currentFixedDate7 - fixedDateMonth3) % 7;
                if (n19 < n17) {
                    ++n18;
                }
                final long n20 = fixedDateMonth3 + (getRolledValue(this.internalGet(n), n2, minimum, n18) - 1) * 7 + n19;
                final BaseCalendar baseCalendar2 = (n20 >= this.gregorianCutoverDate) ? GregorianCalendar.gcal : getJulianCalendarSystem();
                final BaseCalendar.Date date = (BaseCalendar.Date)baseCalendar2.newCalendarDate(TimeZone.NO_TIMEZONE);
                baseCalendar2.getCalendarDateFromFixedDate(date, n20);
    ...
    private long getYearOffsetInMillis() {
        return ((((this.internalGet(6) - 1) * 24 + (long)this.internalGet(11)) * 60L + this.internalGet(12)) * 60L + this.internalGet(13)) * 1000L + this.internalGet(14) - (this.internalGet(15) + this.internalGet(16));
    }
