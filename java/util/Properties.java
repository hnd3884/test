                ...
                switch (char1) {
                    ...
                    default: {
                        if ((char1 < ' ' || char1 > '~') & b2) {
                            sb.append('\\');
                            sb.append('u');
                            sb.append(toHex(char1 >> 12 & 0xF));
                            sb.append(toHex(char1 >> 8 & 0xF));
                            sb.append(toHex(char1 >> 4 & 0xF));
    ...
    private static void writeComments(final BufferedWriter bufferedWriter, final String s) throws IOException {
        ...
        while (i < length) {
            ...
            if (char1 > '\u00ff' || char1 == '\n' || char1 == '\r') {
                ...
                if (char1 > '\u00ff') {
                    array[2] = toHex(char1 >> 12 & 0xF);
                    array[3] = toHex(char1 >> 8 & 0xF);
                    array[4] = toHex(char1 >> 4 & 0xF);
                    array[5] = toHex(char1 & '\u000f');
