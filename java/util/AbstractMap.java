...
public abstract class AbstractMap<K, V> implements Map<K, V>
{
    ...
    public boolean containsValue(final Object o) {
        ...
        if (o == null) {
            ...
            while (iterator.hasNext()) {
                if (o.equals(((Entry<K, Object>)iterator.next()).getValue())) {
                    return true;
                }
            }
        }
    ...
    public boolean containsKey(final Object o) {
        ...
        if (o == null) {
            ...
            while (iterator.hasNext()) {
                if (o.equals(((Entry<Object, V>)iterator.next()).getKey())) {
                    return true;
                }
            }
        }
    ...
    public V get(final Object o) {
        ...
        if (o == null) {
            ...
            while (iterator.hasNext()) {
                final Entry entry2 = iterator.next();
    ...
    public V remove(final Object o) {
        ...
        if (o == null) {
            ...
            while (entry == null && iterator.hasNext()) {
                final Entry entry3 = iterator.next();
                if (o.equals(entry3.getKey())) {
                    entry = entry3;
                }
            }
        }
