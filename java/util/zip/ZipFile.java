...
public class ZipFile implements ZipConstants, Closeable
{
    ...
    private Inflater getInflater() {
        if (!ZipFile.disableInflaterCache) {
        ...
        synchronized (this) {
            synchronized (this.streams) {
                if (!this.streams.isEmpty()) {
                    final HashMap hashMap = new HashMap((Map<? extends K, ? extends V>)this.streams);
                    this.streams.clear();
    ...
    static {
        ...
        final String savedProperty3 = VM.getSavedProperty("sun.zip.disableInflaterCache");
        disableInflaterCache = (savedProperty3 != null && savedProperty3.equalsIgnoreCase("true"));
