...
public final class Formatter implements Closeable, Flushable
{
    ...
    public void flush() {
        ...
        if (this.a instanceof Flushable) {
            ...
            catch (final IOException lastException) {
    ...
    private class FormatSpecifier implements FormatString
    {
        ...
        private void print(final StringBuilder sb, final double n, final Locale locale, final Flags flags, final char c, final int n2, final boolean b) throws IOException {
            if (c == 'e') {
                ...
                final char[] array2 = (n == 0.0) ? new char[] { '+', '0', '0' } : value.getExponent();
                int n4 = this.width;
                if (this.width != -1) {
                    n4 = this.adjustWidth(this.width - array2.length - 1, flags, b);
                }
                ...
                final char c2 = array2[0];
                assert c2 == '-';
                sb.append(c2);
                final char[] array3 = new char[array2.length - 1];
                System.arraycopy(array2, 1, array3, 0, array2.length - 1);
                sb.append((CharSequence)this.localizedMagnitude(null, array3, remove, -1, locale));
            }
            else if (c == 'f') {
                final int n5 = (n2 == -1) ? 6 : n2;
                char[] array4 = this.addZeros(FormattedFloatingDecimal.valueOf(n, n5, FormattedFloatingDecimal.Form.DECIMAL_FLOAT).getMantissa(), n5);
                if (flags.contains(Flags.ALTERNATE) && n5 == 0) {
                    array4 = this.addDot(array4);
                }
                int n6 = this.width;
                if (this.width != -1) {
                    n6 = this.adjustWidth(this.width, flags, b);
                }
                this.localizedMagnitude(sb, array4, flags, n6, locale);
            }
            else if (c == 'g') {
                int n7;
                if ((n7 = n2) == -1) {
                ...
                char[] array5 = this.addZeros(mantissa, n7);
                ...
                if (this.width != -1) {
                    if (exponent != null) {
                        n8 = this.adjustWidth(this.width - exponent.length - 1, flags, b);
                    }
                    else {
                        n8 = this.adjustWidth(this.width, flags, b);
                    }
                }
                this.localizedMagnitude(sb, array5, flags, n8, locale);
                if (exponent != null) {
                    sb.append(flags.contains(Flags.UPPERCASE) ? 'E' : 'e');
                    final Flags remove2 = flags.dup().remove(Flags.GROUP);
                    final char c3 = exponent[0];
                    assert c3 == '-';
                    sb.append(c3);
                    final char[] array6 = new char[exponent.length - 1];
                    System.arraycopy(exponent, 1, array6, 0, exponent.length - 1);
                    sb.append((CharSequence)this.localizedMagnitude(null, array6, remove2, -1, locale));
                }
            }
            else if (c == 'a') {
                int n9;
                ...
                char[] array7 = hexDouble.substring(0, index).toCharArray();
                if (contains) {
                    array7 = new String(array7).toUpperCase(Locale.US).toCharArray();
                }
                sb.append((n9 != 0) ? this.addZeros(array7, n9) : array7);
        ...
        private class BigDecimalLayout
        {
            ...
            private void layout(final BigInteger bigInteger, final int scale, final BigDecimalLayoutForm bigDecimalLayoutForm) {
                ...
                final long n = -scale + (long)(charArray.length - 1);
