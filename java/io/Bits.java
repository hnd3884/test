...
class Bits
{
    ...
    static long getLong(final byte[] array, final int n) {
        return ((long)array[n + 7] & 0xFFL) + (((long)array[n + 6] & 0xFFL) << 8) + (((long)array[n + 5] & 0xFFL) << 16) + (((long)array[n + 4] & 0xFFL) << 24) + (((long)array[n + 3] & 0xFFL) << 32) + (((long)array[n + 2] & 0xFFL) << 40) + (((long)array[n + 1] & 0xFFL) << 48) + ((long)array[n] << 56);
    }
