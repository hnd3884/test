    ...
    static int writeUTF(final String s, final DataOutput dataOutput) throws IOException {
        ...
        while (j < length) {
            ...
            if (char3 >= '\u0001' && char3 <= '\u007f') {
                ...
                bytearr[n2++] = (byte)(0xE0 | (char3 >> 12 & 0xF));
                bytearr[n2++] = (byte)(0x80 | (char3 >> 6 & 0x3F));
                bytearr[n2++] = (byte)(0x80 | (char3 >> 0 & 0x3F));
            }
            else {
                bytearr[n2++] = (byte)(0xC0 | (char3 >> 6 & 0x1F));
                bytearr[n2++] = (byte)(0x80 | (char3 >> 0 & 0x3F));
            }
            ++j;
        }
