...
public class X509CertSelector implements CertSelector
{
    ...
    public void setPolicy(final Set<String> set) throws IOException {
        if (set == null) {
            ...
            final Set<Object> unmodifiableSet = (Set<Object>)Collections.unmodifiableSet((Set<? extends String>)new HashSet<String>(set));
            ...
            this.policySet = (Set<String>)unmodifiableSet;
    ...
    private static Set<List<?>> cloneAndCheckNames(final Collection<List<?>> collection) throws IOException {
        ...
        while (iterator.hasNext()) {
            set.add(new ArrayList(iterator.next()));
        }
    ...
    public String toString() {
        ...
        if (this.subjectAlternativeNames != null) {
            ...
            for (final List list : this.subjectAlternativeNames) {
    ...
    private boolean matchPolicy(final X509Certificate x509Certificate) {
        ...
        try {
            ...
            final ArrayList list = new ArrayList(value.size());
            final Iterator iterator = value.iterator();
            while (iterator.hasNext()) {
                list.add((Object)((PolicyInformation)iterator.next()).getPolicyIdentifier());
            }
            if (this.policy != null) {
                boolean b = false;
    ...
    private static <T> Set<T> cloneSet(final Set<T> set) {
        if (set instanceof HashSet) {
            return (Set<T>)((HashSet)set).clone();
        }
