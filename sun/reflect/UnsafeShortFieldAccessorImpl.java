...
{
    UnsafeShortFieldAccessorImpl(final Field field) {
        super(field);
    }
    ...
    public short getShort(final Object o) throws IllegalArgumentException {
        this.ensureObj(o);
        return UnsafeShortFieldAccessorImpl.unsafe.getShort(o, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeShortFieldAccessorImpl.unsafe.putShort(o, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeShortFieldAccessorImpl.unsafe.putShort(o, this.fieldOffset, (short)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setShort(final Object o, final short n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeShortFieldAccessorImpl.unsafe.putShort(o, this.fieldOffset, n);
    }
