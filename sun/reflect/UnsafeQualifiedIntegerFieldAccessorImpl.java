...
{
    UnsafeQualifiedIntegerFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public int getInt(final Object o) throws IllegalArgumentException {
        this.ensureObj(o);
        return UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.getIntVolatile(o, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.putIntVolatile(o, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.putIntVolatile(o, this.fieldOffset, (short)o2);
            return;
        }
        if (o2 instanceof Character) {
            UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.putIntVolatile(o, this.fieldOffset, (char)o2);
            return;
        }
        if (o2 instanceof Integer) {
            UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.putIntVolatile(o, this.fieldOffset, (int)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setInt(final Object o, final int n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedIntegerFieldAccessorImpl.unsafe.putIntVolatile(o, this.fieldOffset, n);
    }
