...
{
    UnsafeQualifiedStaticObjectFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    
    @Override
    public Object get(final Object o) throws IllegalArgumentException {
        return UnsafeQualifiedStaticObjectFieldAccessorImpl.unsafe.getObjectVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedStaticObjectFieldAccessorImpl.unsafe.putObjectVolatile(this.base, this.fieldOffset, o2);
    }
