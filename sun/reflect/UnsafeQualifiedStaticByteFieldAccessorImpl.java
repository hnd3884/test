...
{
    UnsafeQualifiedStaticByteFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public byte getByte(final Object o) throws IllegalArgumentException {
        return UnsafeQualifiedStaticByteFieldAccessorImpl.unsafe.getByteVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeQualifiedStaticByteFieldAccessorImpl.unsafe.putByteVolatile(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setByte(final Object o, final byte b) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedStaticByteFieldAccessorImpl.unsafe.putByteVolatile(this.base, this.fieldOffset, b);
    }
