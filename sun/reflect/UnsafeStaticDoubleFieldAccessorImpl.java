...
{
    UnsafeStaticDoubleFieldAccessorImpl(final Field field) {
        super(field);
    }
    ...
    public double getDouble(final Object o) throws IllegalArgumentException {
        return UnsafeStaticDoubleFieldAccessorImpl.unsafe.getDouble(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (short)o2);
            return;
        }
        if (o2 instanceof Character) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (char)o2);
            return;
        }
        if (o2 instanceof Integer) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (int)o2);
            return;
        }
        if (o2 instanceof Long) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (double)(long)o2);
            return;
        }
        if (o2 instanceof Float) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (float)o2);
            return;
        }
        if (o2 instanceof Double) {
            UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, (double)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setDouble(final Object o, final double n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeStaticDoubleFieldAccessorImpl.unsafe.putDouble(this.base, this.fieldOffset, n);
    }
}
