...
{
    UnsafeQualifiedBooleanFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public boolean getBoolean(final Object o) throws IllegalArgumentException {
        this.ensureObj(o);
        return UnsafeQualifiedBooleanFieldAccessorImpl.unsafe.getBooleanVolatile(o, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Boolean) {
            UnsafeQualifiedBooleanFieldAccessorImpl.unsafe.putBooleanVolatile(o, this.fieldOffset, (boolean)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setBoolean(final Object o, final boolean b) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedBooleanFieldAccessorImpl.unsafe.putBooleanVolatile(o, this.fieldOffset, b);
    }
