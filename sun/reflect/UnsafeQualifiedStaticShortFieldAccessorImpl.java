...
{
    UnsafeQualifiedStaticShortFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public short getShort(final Object o) throws IllegalArgumentException {
        return UnsafeQualifiedStaticShortFieldAccessorImpl.unsafe.getShortVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeQualifiedStaticShortFieldAccessorImpl.unsafe.putShortVolatile(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeQualifiedStaticShortFieldAccessorImpl.unsafe.putShortVolatile(this.base, this.fieldOffset, (short)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setShort(final Object o, final short n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedStaticShortFieldAccessorImpl.unsafe.putShortVolatile(this.base, this.fieldOffset, n);
    }
