...
{
    UnsafeQualifiedCharacterFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public char getChar(final Object o) throws IllegalArgumentException {
        this.ensureObj(o);
        return UnsafeQualifiedCharacterFieldAccessorImpl.unsafe.getCharVolatile(o, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Character) {
            UnsafeQualifiedCharacterFieldAccessorImpl.unsafe.putCharVolatile(o, this.fieldOffset, (char)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setChar(final Object o, final char c) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedCharacterFieldAccessorImpl.unsafe.putCharVolatile(o, this.fieldOffset, c);
    }
