...
{
    UnsafeStaticObjectFieldAccessorImpl(final Field field) {
        super(field);
    }
    
    @Override
    public Object get(final Object o) throws IllegalArgumentException {
        return UnsafeStaticObjectFieldAccessorImpl.unsafe.getObject(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeStaticObjectFieldAccessorImpl.unsafe.putObject(this.base, this.fieldOffset, o2);
    }
