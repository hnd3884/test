...
{
    UnsafeStaticIntegerFieldAccessorImpl(final Field field) {
        super(field);
    }
    ...
    public int getInt(final Object o) throws IllegalArgumentException {
        return UnsafeStaticIntegerFieldAccessorImpl.unsafe.getInt(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeStaticIntegerFieldAccessorImpl.unsafe.putInt(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeStaticIntegerFieldAccessorImpl.unsafe.putInt(this.base, this.fieldOffset, (short)o2);
            return;
        }
        if (o2 instanceof Character) {
            UnsafeStaticIntegerFieldAccessorImpl.unsafe.putInt(this.base, this.fieldOffset, (char)o2);
            return;
        }
        if (o2 instanceof Integer) {
            UnsafeStaticIntegerFieldAccessorImpl.unsafe.putInt(this.base, this.fieldOffset, (int)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setInt(final Object o, final int n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeStaticIntegerFieldAccessorImpl.unsafe.putInt(this.base, this.fieldOffset, n);
    }
