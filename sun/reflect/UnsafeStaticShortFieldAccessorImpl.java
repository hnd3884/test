...
{
    UnsafeStaticShortFieldAccessorImpl(final Field field) {
        super(field);
    }
    ...
    public short getShort(final Object o) throws IllegalArgumentException {
        return UnsafeStaticShortFieldAccessorImpl.unsafe.getShort(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeStaticShortFieldAccessorImpl.unsafe.putShort(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeStaticShortFieldAccessorImpl.unsafe.putShort(this.base, this.fieldOffset, (short)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setShort(final Object o, final short n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeStaticShortFieldAccessorImpl.unsafe.putShort(this.base, this.fieldOffset, n);
    }
