...
{
    UnsafeQualifiedObjectFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public Object get(final Object o) throws IllegalArgumentException {
        this.ensureObj(o);
        return UnsafeQualifiedObjectFieldAccessorImpl.unsafe.getObjectVolatile(o, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedObjectFieldAccessorImpl.unsafe.putObjectVolatile(o, this.fieldOffset, o2);
    }
