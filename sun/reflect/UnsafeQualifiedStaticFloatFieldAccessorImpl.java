...
{
    UnsafeQualifiedStaticFloatFieldAccessorImpl(final Field field, final boolean b) {
        super(field, b);
    }
    ...
    public float getFloat(final Object o) throws IllegalArgumentException {
        return UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.getFloatVolatile(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (short)o2);
            return;
        }
        if (o2 instanceof Character) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (char)o2);
            return;
        }
        if (o2 instanceof Integer) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (float)(int)o2);
            return;
        }
        if (o2 instanceof Long) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (float)(long)o2);
            return;
        }
        if (o2 instanceof Float) {
            UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, (float)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setFloat(final Object o, final float n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeQualifiedStaticFloatFieldAccessorImpl.unsafe.putFloatVolatile(this.base, this.fieldOffset, n);
    }
