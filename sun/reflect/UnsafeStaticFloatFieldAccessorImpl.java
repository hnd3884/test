...
{
    UnsafeStaticFloatFieldAccessorImpl(final Field field) {
        super(field);
    }
    ...
    public float getFloat(final Object o) throws IllegalArgumentException {
        return UnsafeStaticFloatFieldAccessorImpl.unsafe.getFloat(this.base, this.fieldOffset);
    }
    ...
    public void set(final Object o, final Object o2) throws IllegalArgumentException, IllegalAccessException {
        ...
        if (o2 instanceof Byte) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (byte)o2);
            return;
        }
        if (o2 instanceof Short) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (short)o2);
            return;
        }
        if (o2 instanceof Character) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (char)o2);
            return;
        }
        if (o2 instanceof Integer) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (float)(int)o2);
            return;
        }
        if (o2 instanceof Long) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (float)(long)o2);
            return;
        }
        if (o2 instanceof Float) {
            UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, (float)o2);
            return;
        }
        this.throwSetIllegalArgumentException(o2);
    }
    ...
    public void setFloat(final Object o, final float n) throws IllegalArgumentException, IllegalAccessException {
        ...
        UnsafeStaticFloatFieldAccessorImpl.unsafe.putFloat(this.base, this.fieldOffset, n);
    }
