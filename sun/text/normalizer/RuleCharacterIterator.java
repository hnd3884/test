...
public class RuleCharacterIterator
{
    ...
    public int next(final int n) {
        ...
        while (true) {
            ...
            if (n2 == 36 && this.buf == null && (n & 0x1) != 0x0 && this.sym != null) {
                ...
                if ((n & 0x4) != 0x0 && UCharacterProperty.isRuleWhiteSpace(n2)) {
                    continue;
                }
                if (n2 != 92 || (n & 0x2) == 0x0) {
                    break;
                ...
                final int[] array = { 0 };
                n2 = Utility.unescapeAt(this.lookahead(), array);
    ...
    public void skipIgnored(final int n) {
        if ((n & 0x4) != 0x0) {
            while (true) {
                ...
                if (!UCharacterProperty.isRuleWhiteSpace(current)) {
                    break;
                }
