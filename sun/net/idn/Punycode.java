...
public final class Punycode
{
    ...
    public static StringBuffer encode(final StringBuffer sb, final boolean[] array) throws ParseException {
        ...
        for (int i = 0; i < length; ++i) {
            ...
            if (isBasic(char1)) {
                ...
                if (!UTF16.isSurrogate(char1)) {
                    ...
                    final char char2;
                    if (!UTF16.isLeadSurrogate(char1) || i + 1 >= length || !UTF16.isTrailSurrogate(char2 = sb.charAt(i + 1))) {
    ...
    public static StringBuffer decode(final StringBuffer sb, final boolean[] array) throws ParseException {
        final int length = sb.length();
        final StringBuffer sb2 = new StringBuffer();
        final int n = 256;
    ...
    Label_0155:
        while (j < length) {
            ...
            int n10 = 36;
            while (j < length) {
                final int n11 = Punycode.basicToDigit[(byte)sb.charAt(j++)];
                if (n11 < 0) {
                ...
                if (n11 < n12) {
                    ...
                    if (n3 + charCount < n) {
                        ...
                        if (array != null) {
                            array[moveCodePointOffset] = isBasicUpperCase(sb.charAt(j - 1));
                            if (charCount == 2) {
