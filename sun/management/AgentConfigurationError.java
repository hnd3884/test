...
public class AgentConfigurationError extends Error
{
    ...
    public AgentConfigurationError(final String error) {
        this.error = error;
        this.params = null;
    }
    
    public AgentConfigurationError(final String error, final Throwable t) {
        super(t);
        this.error = error;
        this.params = null;
    }
    
    public AgentConfigurationError(final String error, final String... array) {
        this.error = error;
        this.params = array.clone();
    }
    
    public AgentConfigurationError(final String error, final Throwable t, final String... array) {
        super(t);
        this.error = error;
        this.params = array.clone();
    }
