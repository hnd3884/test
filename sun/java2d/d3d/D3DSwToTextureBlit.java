...
class D3DSwToTextureBlit extends Blit
{
    ...
    D3DSwToTextureBlit(final SurfaceType surfaceType, final int typeval) {
    ...
    public void Blit(final SurfaceData surfaceData, final SurfaceData surfaceData2, final Composite composite, final Region region, final int n, final int n2, final int n3, final int n4, final int n5, final int n6) {
        D3DBlitLoops.Blit(surfaceData, surfaceData2, composite, region, null, 1, n, n2, n + n5, n2 + n6, n3, n4, n3 + n5, n4 + n6, this.typeval, true);
    }
}
