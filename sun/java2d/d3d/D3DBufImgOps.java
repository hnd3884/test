...
class D3DBufImgOps extends BufferedBufImgOps
{
    static boolean renderImageWithOp(final SunGraphics2D sunGraphics2D, final BufferedImage bufferedImage, final BufferedImageOp bufferedImageOp, final int n, final int n2) {
        ...
        D3DBlitLoops.IsoBlit(surfaceData2, surfaceData, bufferedImage, bufferedImageOp, sunGraphics2D.composite, sunGraphics2D.getCompClip(), sunGraphics2D.transform, sunGraphics2D.interpolationType, 0, 0, width, height, n, n2, n + width, n2 + height, true);
        return true;
    }
}
