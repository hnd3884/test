...
public class ValidatorException extends CertificateException
{
    ...
    public ValidatorException(final String s) {
        super(s);
    }
    
    public ValidatorException(final String s, final Throwable t) {
        super(s);
        this.initCause(t);
    }
    
    public ValidatorException(final Object o) {
        this(o, null);
    }
    ...
    public ValidatorException(final Object o, final X509Certificate x509Certificate, final Throwable t) {
        this(o, x509Certificate);
        this.initCause(t);
    }
    
    public ValidatorException(final String s, final Object type, final X509Certificate cert) {
        super(s);
        this.type = type;
        this.cert = cert;
    }
    
    public ValidatorException(final String s, final Object o, final X509Certificate x509Certificate, final Throwable t) {
        this(s, o, x509Certificate);
        this.initCause(t);
    }
