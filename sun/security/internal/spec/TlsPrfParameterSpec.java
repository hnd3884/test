...
public class TlsPrfParameterSpec implements AlgorithmParameterSpec
{
    ...
    public TlsPrfParameterSpec(final SecretKey secret, final String label, final byte[] array, final int outputLength, final String prfHashAlg, final int prfHashLength, final int prfBlockSize) {
