...
public class PKIXExtendedParameters extends PKIXBuilderParameters
{
    ...
    public PKIXExtendedParameters(final PKIXBuilderParameters p3, final Timestamp jarTimestamp, final String variant) throws InvalidAlgorithmParameterException {
        super(p3.getTrustAnchors(), null);
        this.p = p3;
