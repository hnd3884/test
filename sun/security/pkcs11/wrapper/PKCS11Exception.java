...
public class PKCS11Exception extends Exception
{
    ...
    public PKCS11Exception(final long errorCode_) {
        this.errorCode_ = errorCode_;
    }
    
    @Override
    public String getMessage() {
        String string = PKCS11Exception.errorMap.get(this.errorCode_);
        if (string == null) {
            string = "0x" + Functions.toFullHexString((int)this.errorCode_);
        }
        return string;
    }
