...
public class CertException extends SecurityException
{
    ...
    public CertException(final int verfCode, final String moreData) {
        this.verfCode = verfCode;
        this.moreData = moreData;
    }
    
    public CertException(final int verfCode) {
        this.verfCode = verfCode;
    }
    ...
    public String toString() {
        return "[Certificate Exception: " + this.getMessage() + "]";
    }
    
    @Override
    public String getMessage() {
        return this.getVerfDescription() + ((this.moreData != null) ? ("\n  (" + this.moreData + ")") : "");
    }
}
