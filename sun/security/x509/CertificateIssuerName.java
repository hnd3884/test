...
public class CertificateIssuerName implements CertAttrSet<String>
{
    ...
    public CertificateIssuerName(final X500Name dnName) {
        this.dnName = dnName;
    }
    
    public CertificateIssuerName(final DerInputStream derInputStream) throws IOException {
        this.dnName = new X500Name(derInputStream);
    }
    
    public CertificateIssuerName(final InputStream inputStream) throws IOException {
