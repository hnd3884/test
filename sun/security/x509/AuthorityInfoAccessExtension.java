...
public class AuthorityInfoAccessExtension extends Extension implements CertAttrSet<String>
{
    ...
    public AuthorityInfoAccessExtension(final List<AccessDescription> accessDescriptions) throws IOException {
    ...
    public AuthorityInfoAccessExtension(final Boolean b, final Object o) throws IOException {
        this.extensionId = PKIXExtensions.AuthInfoAccess_Id;
        this.critical = b;
    ...
    public void set(final String s, final Object o) throws IOException {
        if (!s.equalsIgnoreCase("descriptions")) {
            throw new IOException("Attribute name [" + s + "] not recognized by CertAttrSet:AuthorityInfoAccessExtension.");
        }
