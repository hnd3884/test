...
public class Krb5
{
    ...
    public static final HexDumpEncoder hexDumper;
    
    public static String getErrorMessage(final int n) {
        return Krb5.errMsgList.get(n);
    }
    ...
    static {
        ...
        (Krb5.errMsgList = new Hashtable<Integer, String>()).put(0, "No error");
        Krb5.errMsgList.put(1, "Client's entry in database expired");
        Krb5.errMsgList.put(2, "Server's entry in database has expired");
        Krb5.errMsgList.put(3, "Requested protocol version number not supported");
        Krb5.errMsgList.put(4, "Client's key encrypted in old master key");
        Krb5.errMsgList.put(5, "Server's key encrypted in old master key");
        Krb5.errMsgList.put(6, "Client not found in Kerberos database");
        Krb5.errMsgList.put(7, "Server not found in Kerberos database");
        Krb5.errMsgList.put(8, "Multiple principal entries in database");
        Krb5.errMsgList.put(9, "The client or server has a null key");
        Krb5.errMsgList.put(10, "Ticket not eligible for postdating");
        Krb5.errMsgList.put(11, "Requested start time is later than end time");
        Krb5.errMsgList.put(12, "KDC policy rejects request");
        Krb5.errMsgList.put(13, "KDC cannot accommodate requested option");
        Krb5.errMsgList.put(14, "KDC has no support for encryption type");
        Krb5.errMsgList.put(15, "KDC has no support for checksum type");
        Krb5.errMsgList.put(16, "KDC has no support for padata type");
        Krb5.errMsgList.put(17, "KDC has no support for transited type");
        Krb5.errMsgList.put(18, "Clients credentials have been revoked");
        Krb5.errMsgList.put(19, "Credentials for server have been revoked");
        Krb5.errMsgList.put(20, "TGT has been revoked");
        Krb5.errMsgList.put(21, "Client not yet valid - try again later");
        Krb5.errMsgList.put(22, "Server not yet valid - try again later");
        Krb5.errMsgList.put(23, "Password has expired - change password to reset");
        Krb5.errMsgList.put(24, "Pre-authentication information was invalid");
        Krb5.errMsgList.put(25, "Additional pre-authentication required");
        Krb5.errMsgList.put(31, "Integrity check on decrypted field failed");
        Krb5.errMsgList.put(32, "Ticket expired");
        Krb5.errMsgList.put(33, "Ticket not yet valid");
        Krb5.errMsgList.put(34, "Request is a replay");
        Krb5.errMsgList.put(35, "The ticket isn't for us");
        Krb5.errMsgList.put(36, "Ticket and authenticator don't match");
        Krb5.errMsgList.put(37, "Clock skew too great");
        Krb5.errMsgList.put(38, "Incorrect net address");
        Krb5.errMsgList.put(39, "Protocol version mismatch");
        Krb5.errMsgList.put(40, "Invalid msg type");
        Krb5.errMsgList.put(41, "Message stream modified");
        Krb5.errMsgList.put(42, "Message out of order");
        Krb5.errMsgList.put(44, "Specified version of key is not available");
        Krb5.errMsgList.put(45, "Service key not available");
        Krb5.errMsgList.put(46, "Mutual authentication failed");
        Krb5.errMsgList.put(47, "Incorrect message direction");
        Krb5.errMsgList.put(48, "Alternative authentication method required");
        Krb5.errMsgList.put(49, "Incorrect sequence number in message");
        Krb5.errMsgList.put(50, "Inappropriate type of checksum in message");
        Krb5.errMsgList.put(52, "Response too big for UDP, retry with TCP");
        Krb5.errMsgList.put(60, "Generic error (description in e-text)");
        Krb5.errMsgList.put(61, "Field is too long for this implementation");
        Krb5.errMsgList.put(62, "Realm name not available");
        Krb5.errMsgList.put(400, "Invalid argument");
        Krb5.errMsgList.put(500, "BitString size does not match input byte array");
        Krb5.errMsgList.put(501, "BitString bit index does not fall within size");
        Krb5.errMsgList.put(502, "BitString length is wrong for the expected type");
        Krb5.errMsgList.put(600, "Illegal character in realm name; one of: '/', ':', '\u0000'");
        Krb5.errMsgList.put(601, "Null realm name");
        Krb5.errMsgList.put(900, "Input not in GeneralizedTime format");
        Krb5.errMsgList.put(901, "Structure is missing a required field");
        Krb5.errMsgList.put(902, "Unexpected field number");
        Krb5.errMsgList.put(903, "Type numbers are inconsistent");
        Krb5.errMsgList.put(904, "Value too large");
        Krb5.errMsgList.put(905, "Encoding ended unexpectedly");
        Krb5.errMsgList.put(906, "Identifier doesn't match expected value");
        Krb5.errMsgList.put(907, "Length doesn't match expected value");
        Krb5.errMsgList.put(908, "Badly-formatted encoding");
        Krb5.errMsgList.put(909, "Parse error");
        Krb5.errMsgList.put(910, "Bad class number");
        Krb5.errMsgList.put(911, "Bad type number");
        Krb5.errMsgList.put(912, "Bad tag number");
        Krb5.errMsgList.put(913, "Unsupported ASN.1 type encountered");
        Krb5.errMsgList.put(914, "Encoding failed due to invalid parameter(s)");
        Krb5.errMsgList.put(100, "Client has no support for crypto type");
        Krb5.errMsgList.put(101, "Invalid option setting in ticket request.");
        Krb5.errMsgList.put(63, "Fail to create credential.");
    }
}
