...
class CESU_8 extends Unicode
{
    ...
    private static class Decoder extends CharsetDecoder implements ArrayDecoder
    {
        ...
        private static boolean isMalformed4_2(final int n, final int n2) {
            return (n == 240 && n2 == 144) || (n2 & 0xC0) != 0x80;
        }
            ...
            while (i < n) {
                ...
                if (b >= 0) {
                    ...
                    if (n4 < 3 || n2 >= n3) {
                        ...
                        array2[n2++] = (char)(b << 12 ^ b3 << 6 ^ (b4 ^ 0xFFFE1F80));
                        i += 3;
                    }
                }
            }
            ...
            while (i < limit) {
                ...
                if (value >= 0) {
                    ...
                    if (n < 3 || charBuffer.remaining() < 1) {
                        ...
                        charBuffer.put((char)(value << 12 ^ value3 << 6 ^ (value4 ^ 0xFFFE1F80)));
                        i += 3;
                    }
                }
            }
                ...
                if (b >= 0) {
                    ...
                    if (i + 1 < n2) {
                        ...
                        if (isMalformed3(b, b3, b4)) {
                            ...
                            array2[n3++] = (char)(b << 12 ^ b3 << 6 ^ (b4 ^ 0xFFFE1F80));
                        }
                    }
                    else {
                        if (this.malformedInputAction() != CodingErrorAction.REPLACE) {
    ...
    private static class Encoder extends CharsetEncoder implements ArrayEncoder
    {
        ...
        private static void to3Bytes(final byte[] array, final int n, final char c) {
            array[n] = (byte)(0xE0 | c >> 12);
            array[n + 1] = (byte)(0x80 | (c >> 6 & 0x3F));
            array[n + 2] = (byte)(0x80 | (c & '?'));
        }
        
        private static void to3Bytes(final ByteBuffer byteBuffer, final char c) {
            byteBuffer.put((byte)(0xE0 | c >> 12));
            byteBuffer.put((byte)(0x80 | (c >> 6 & 0x3F)));
            byteBuffer.put((byte)(0x80 | (c & '?')));
        }
        ...
        private CoderResult encodeArrayLoop(final CharBuffer charBuffer, final ByteBuffer byteBuffer) {
            ...
            while (i < n) {
                ...
                if (c < '\u0080') {
                    ...
                    to3Bytes(array2, n2, Character.highSurrogate(parse));
                    n2 += 3;
                    to3Bytes(array2, n2, Character.lowSurrogate(parse));
                    n2 += 3;
                    ++i;
                }
                else {
            ...
            while (i < n2) {
                ...
                if (c < '\u0080') {
                    ...
                    if (parse < 0) {
                        ...
                        array2[n3++] = this.replacement()[0];
                    }
                    else {
                        to3Bytes(array2, n3, Character.highSurrogate(parse));
                        n3 += 3;
                        to3Bytes(array2, n3, Character.lowSurrogate(parse));
                        n3 += 3;
                        ++i;
                    }
                }
                else {
                    to3Bytes(array2, n3, c);
                    n3 += 3;
                }
            }
            return n3;
