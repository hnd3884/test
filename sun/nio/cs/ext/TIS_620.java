...
public class TIS_620 extends Charset implements HistoricallyNamedCharset
{
    ...
    public CharsetDecoder newDecoder() {
        return new SingleByte.Decoder(this, TIS_620.b2c);
    }
    
    @Override
    public CharsetEncoder newEncoder() {
        return new SingleByte.Encoder(this, TIS_620.c2b, TIS_620.c2bIndex);
    }
    ...
    static {
        ...
        SingleByte.initC2B(TIS_620.b2c, null, TIS_620.c2b, TIS_620.c2bIndex);
    }
}
