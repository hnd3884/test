...
public class IBM285 extends Charset implements HistoricallyNamedCharset
{
    ...
    public CharsetDecoder newDecoder() {
        return new SingleByte.Decoder(this, IBM285.b2c);
    }
    
    @Override
    public CharsetEncoder newEncoder() {
        return new SingleByte.Encoder(this, IBM285.c2b, IBM285.c2bIndex);
    }
    ...
    static {
        ...
        charArray[165] = '\ufffd';
        SingleByte.initC2B(charArray, new char[] { '\u0015', '\u0085' }, IBM285.c2b, IBM285.c2bIndex);
    }
}
