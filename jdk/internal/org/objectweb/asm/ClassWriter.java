...
public class ClassWriter extends ClassVisitor
{
    ...
    public ClassWriter(final int n) {
        ...
        this.key3 = new Item();
        this.key4 = new Item();
        this.computeMaxs = ((n & 0x1) != 0x0);
        this.computeFrames = ((n & 0x2) != 0x0);
    }
    ...
    public final MethodVisitor visitMethod(final int n, final String s, final String s2, final String s3, final String[] array) {
        return new MethodWriter(this, n, s, s2, s3, array, this.computeMaxs, this.computeFrames);
    }
    ...
    Item newHandleItem(final int n, final String s, final String s2, final String s3) {
        ...
        if (value == null) {
            if (n <= 4) {
                ...
                this.put112(15, n, this.newMethod(s, s2, s3, n == 9));
            }
    ...
    public int newHandle(final int n, final String s, final String s2, final String s3) {
        return this.newHandleItem(n, s, s2, s3).index;
    }
    ...
    Item newInvokeDynamicItem(final String s, final String s2, final Handle handle, final Object... array) {
        ...
        bootstrapMethods.putShort(this.newHandle(handle.tag, handle.owner, handle.name, handle.desc));
