...
public class ClassReader
{
    ...
    private void readCode(final MethodVisitor methodVisitor, final Context context, int i) {
            ...
            if ("LocalVariableTable".equals(utf8)) {
                ...
                if ((context.flags & 0x2) == 0x0) {
                    ...
                    while (unsignedShort6 > 0) {
                        ...
                        array[unsignedShort7].line = this.readUnsignedShort(n14 + 12);
                        n14 += 4;
                        --unsignedShort6;
                    }
                }
        ...
        while (i < n2) {
            ...
            while (context2 != null && (context2.offset == n17 || context2.offset == -1)) {
            ...
            switch (ClassWriter.TYPE[n18]) {
                ...
                case 6:
                case 7: {
                    final int n24 = this.items[this.readUnsignedShort(i + 1)];
                    final boolean b4 = b[n24 - 1] == 11;
                    final String class1 = this.readClass(n24, buffer);
                    final int n25 = this.items[this.readUnsignedShort(n24 + 2)];
                    final String utf9 = this.readUTF8(n25, buffer);
                    final String utf10 = this.readUTF8(n25 + 2, buffer);
                    if (n18 < 182) {
                ...
                case 8: {
                    final int n26 = this.items[this.readUnsignedShort(i + 1)];
                    int n27 = context.bootstrapMethods[this.readUnsignedShort(n26)];
                    final Handle handle = (Handle)this.readConst(this.readUnsignedShort(n27), buffer);
                    ...
                    for (int n28 = 0; n28 < unsignedShort9; ++n28) {
                        array5[n28] = this.readConst(this.readUnsignedShort(n27), buffer);
                        n27 += 2;
                    }
                    final int n29 = this.items[this.readUnsignedShort(n26 + 2)];
                    methodVisitor.visitInvokeDynamicInsn(this.readUTF8(n29, buffer), this.readUTF8(n29 + 2, buffer), handle, array5);
                    i += 5;
                    break;
                }
                case 5: {
                    methodVisitor.visitTypeInsn(n18, this.readClass(i + 1, buffer));
                    i += 3;
                    break;
                }
                case 13: {
            ...
            while (typeAnnotations != null && n4 < typeAnnotations.length && n6 <= n17) {
                if (n6 == n17) {
            ...
            while (typeAnnotations2 != null && n5 < typeAnnotations2.length && n7 <= n17) {
                if (n7 == n17) {
                ...
                if (array6 != null) {
                    for (int n30 = 0; n30 < array6.length; n30 += 3) {
                        if (array6[n30] == unsignedShort11 && array6[n30 + 1] == unsignedShort13) {
                            utf11 = this.readUTF8(array6[n30 + 2], buffer);
                            break;
                        }
                    }
                }
        ...
        if (typeAnnotations != null) {
            for (int n31 = 0; n31 < typeAnnotations.length; ++n31) {
                if (this.readByte(typeAnnotations[n31]) >> 1 == 32) {
                    final int annotationTarget3 = this.readAnnotationTarget(context, typeAnnotations[n31]);
        ...
        if (typeAnnotations2 != null) {
            for (int n32 = 0; n32 < typeAnnotations2.length; ++n32) {
                if (this.readByte(typeAnnotations2[n32]) >> 1 == 32) {
                    final int annotationTarget4 = this.readAnnotationTarget(context, typeAnnotations2[n32]);
