...
class MethodWriter extends MethodVisitor
{
    ...
    MethodWriter(final ClassWriter cw, final int access, final String s, final String descriptor, final String signature, final String[] array, final boolean b, final boolean b2) {
        super(327680);
    ...
    public void visitLabel(final Label previousBlock) {
        this.resize |= previousBlock.resolve(this, this.code.length, this.code.data);
    ...
    private void resizeInstructions() {
        final byte[] data = this.code.data;
        int[] array = new int[0];
        int[] array2 = new int[0];
        final boolean[] array3 = new boolean[this.code.length];
        int i = 3;
        do {
            if (i == 3) {
                i = 2;
            ...
            while (j < data.length) {
                ...
                switch (ClassWriter.TYPE[n]) {
                    ...
                    case 9: {
                        ...
                        if (n > 201) {
                            n = ((n < 218) ? (n - 49) : (n - 20));
                            n3 = j + readUnsignedShort(data, j + 1);
                        }
                        else {
                            n3 = j + readShort(data, j + 1);
                        }
                        final int newOffset = getNewOffset(array, array2, j, n3);
                        if ((newOffset < -32768 || newOffset > 32767) && !array3[j]) {
                            if (n == 167 || n == 168) {
                                n2 = 2;
                            }
                            else {
                    ...
                    case 14: {
                        if (i == 1) {
                            n2 = -(getNewOffset(array, array2, 0, j) & 0x3);
                        }
                        else if (!array3[j]) {
                            n2 = (j & 0x3);
                            array3[j] = true;
                        ...
                        j = n4 + (4 * (readInt(data, n4 + 8) - readInt(data, n4 + 4) + 1) + 12);
                        break;
                    }
                    case 15: {
                        if (i == 1) {
                        ...
                        j = n5 + (8 * readInt(data, n5 + 4) + 8);
                        break;
                    }
                    case 17: {
                        if ((data[j + 1] & 0xFF) == 0x84) {
                            j += 6;
                            break;
                        }
                        j += 4;
        ...
        final ByteVector code = new ByteVector(this.code.length);
        int k = 0;
            ...
            switch (ClassWriter.TYPE[n6]) {
                ...
                case 9: {
                    ...
                    if (n6 > 201) {
                        ...
                        n7 = k + readUnsignedShort(data, k + 1);
                    }
                    else {
                        n7 = k + readShort(data, k + 1);
                    }
                    int newOffset2 = getNewOffset(array, array2, k, n7);
                    if (array3[k]) {
                        if (n6 == 167) {
                            code.putByte(200);
                        }
                            ...
                            code.putByte((n6 <= 166) ? ((n6 + 1 ^ 0x1) - 1) : (n6 ^ 0x1));
                            code.putShort(8);
                            code.putByte(200);
                            newOffset2 -= 3;
                        }
                        code.putInt(newOffset2);
                    }
                    else {
                        code.putByte(n6);
                        code.putShort(newOffset2);
                    }
                    k += 3;
                    continue;
                }
                case 10: {
                    final int newOffset3 = getNewOffset(array, array2, k, k + readInt(data, k + 1));
                    code.putByte(n6);
                    code.putInt(newOffset3);
                    k += 5;
                    continue;
                }
                case 14: {
                    ...
                    final int n9 = n8 + readInt(data, k);
                    k += 4;
                    code.putInt(getNewOffset(array, array2, n8, n9));
                    final int int1 = readInt(data, k);
                    k += 4;
                    code.putInt(int1);
                    int l = readInt(data, k) - int1 + 1;
                    k += 4;
                    code.putInt(readInt(data, k - 4));
                    while (l > 0) {
                        final int n10 = n8 + readInt(data, k);
                        k += 4;
                        code.putInt(getNewOffset(array, array2, n8, n10));
                        --l;
                    }
                    continue;
                }
                case 15: {
                    ...
                    code.putByte(171);
                    code.putByteArray(null, 0, (4 - code.length % 4) % 4);
                    final int n12 = n11 + readInt(data, k);
                    k += 4;
                    code.putInt(getNewOffset(array, array2, n11, n12));
                    int int2 = readInt(data, k);
                    k += 4;
                    code.putInt(int2);
                    while (int2 > 0) {
                        code.putInt(readInt(data, k));
                        k += 4;
                        final int n13 = n11 + readInt(data, k);
                        k += 4;
                        code.putInt(getNewOffset(array, array2, n11, n13));
                        --int2;
                    }
                    continue;
                }
                case 17: {
                    if ((data[k + 1] & 0xFF) == 0x84) {
                        code.putByteArray(data, k, 6);
                        k += 6;
                        continue;
                    }
                    code.putByteArray(data, k, 4);
                    k += 4;
                    continue;
                }
                case 1:
                ...
                case 12:
                case 13: {
                    code.putByteArray(data, k, 3);
                    k += 3;
                    continue;
                }
                case 7:
                case 8: {
                    code.putByteArray(data, k, 5);
                    k += 5;
                    continue;
                }
                default: {
        ...
        if (this.compute == 0) {
            for (Label label = this.labels; label != null; label = label.successor) {
                final int n14 = label.position - 3;
                if (n14 >= 0 && array3[n14]) {
                    final Label label2 = label;
                    label2.status |= 0x10;
                }
                getNewOffset(array, array2, label);
            }
            for (int n15 = 0; n15 < this.cw.typeTable.length; ++n15) {
                final Item item = this.cw.typeTable[n15];
                if (item != null && item.type == 31) {
                    item.intVal = getNewOffset(array, array2, 0, item.intVal);
                }
            }
        }
        ...
        for (Handler handler = this.firstHandler; handler != null; handler = handler.next) {
            getNewOffset(array, array2, handler.start);
            getNewOffset(array, array2, handler.end);
            getNewOffset(array, array2, handler.handler);
        }
        for (int n16 = 0; n16 < 2; ++n16) {
            final ByteVector byteVector = (n16 == 0) ? this.localVar : this.localVarType;
            if (byteVector != null) {
                final byte[] data2 = byteVector.data;
                for (int n17 = 0; n17 < byteVector.length; n17 += 10) {
                    final int unsignedShort = readUnsignedShort(data2, n17);
                    final int newOffset4 = getNewOffset(array, array2, 0, unsignedShort);
                    writeShort(data2, n17, newOffset4);
                    writeShort(data2, n17 + 2, getNewOffset(array, array2, 0, unsignedShort + readUnsignedShort(data2, n17 + 2)) - newOffset4);
                }
            }
        }
        if (this.lineNumber != null) {
            final byte[] data3 = this.lineNumber.data;
            for (int n18 = 0; n18 < this.lineNumber.length; n18 += 4) {
                writeShort(data3, n18, getNewOffset(array, array2, 0, readUnsignedShort(data3, n18)));
            }
        }
        for (Attribute attribute = this.cattrs; attribute != null; attribute = attribute.next) {
            ...
            if (labels != null) {
                for (int n19 = labels.length - 1; n19 >= 0; --n19) {
                    getNewOffset(array, array2, labels[n19]);
                }
            }
        }
        this.code = code;
    ...
    static int readUnsignedShort(final byte[] array, final int n) {
        return (array[n] & 0xFF) << 8 | (array[n + 1] & 0xFF);
    }
    
    static short readShort(final byte[] array, final int n) {
        return (short)((array[n] & 0xFF) << 8 | (array[n + 1] & 0xFF));
    }
    
    static int readInt(final byte[] array, final int n) {
        return (array[n] & 0xFF) << 24 | (array[n + 1] & 0xFF) << 16 | (array[n + 2] & 0xFF) << 8 | (array[n + 3] & 0xFF);
    }
    
    static void writeShort(final byte[] array, final int n, final int n2) {
        array[n] = (byte)(n2 >>> 8);
        array[n + 1] = (byte)n2;
    }
    
    static int getNewOffset(final int[] array, final int[] array2, final int n, final int n2) {
        int n3 = n2 - n;
        for (int i = 0; i < array.length; ++i) {
    ...
    static void getNewOffset(final int[] array, final int[] array2, final Label label) {
        if ((label.status & 0x4) == 0x0) {
            label.position = getNewOffset(array, array2, 0, label.position);
            label.status |= 0x4;
        }
    }
}
