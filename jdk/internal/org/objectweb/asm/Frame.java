...
final class Frame
{
    ...
    void initInputFrame(final ClassWriter classWriter, final int n, final Type[] array, final int n2) {
    ...
    boolean merge(final ClassWriter classWriter, final Frame frame, final int n) {
        boolean b = false;
