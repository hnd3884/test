    ...
    private GuardedInvocationComponent getPropertySetter(final CallSiteDescriptor callSiteDescriptor, final LinkerServices linkerServices, final List<String> operations) throws Exception {
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2: {
                ...
                final MethodType type = (origType.returnType() == Void.TYPE) ? origType : origType.changeReturnType(Object.class);
                ...
                final MethodHandle typedGetter = linkerServices.asType(boundGetter, type.changeReturnType(MethodHandle.class));
                ...
                if (nextComponent == null) {
                    fallbackFolded = MethodHandles.dropArguments(AbstractJavaLinker.CONSTANT_NULL_DROP_METHOD_HANDLE, 1, type.parameterList()).asType(type.insertParameterTypes(0, MethodHandle.class));
                }
                else {
    ...
    private GuardedInvocationComponent getPropertyGetter(final CallSiteDescriptor callSiteDescriptor, final LinkerServices linkerServices, final List<String> ops) throws Exception {
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2: {
                ...
                assertParameterCount(callSiteDescriptor, 2);
                final MethodHandle typedGetter = linkerServices.asType(this.getPropertyGetterHandle, type.changeReturnType(AnnotatedDynamicMethod.class));
                ...
                MethodHandle fallbackFolded;
                if (nextComponent == null) {
                    fallbackFolded = MethodHandles.dropArguments(AbstractJavaLinker.CONSTANT_NULL_DROP_ANNOTATED_METHOD, 1, type.parameterList()).asType(type.insertParameterTypes(0, AnnotatedDynamicMethod.class));
                }
                else {
    ...
    private GuardedInvocationComponent getMethodGetter(final CallSiteDescriptor callSiteDescriptor, final LinkerServices linkerServices, final List<String> ops) throws Exception {
        ...
        switch (callSiteDescriptor.getNameTokenCount()) {
            case 2: {
                ...
                final MethodHandle returnMethodHandle = linkerServices.asType(MethodHandles.dropArguments(AbstractJavaLinker.OBJECT_IDENTITY, 1, type.parameterList()), type.insertParameterTypes(0, Object.class));
