...
public final class OptimisticReturnFilters
{
    ...
    static {
        ...
        ENSURE_NUMBER = new MethodHandle[] { null, null, findOwnMH("ensureNumber", Double.TYPE, Object.class, Integer.TYPE), OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.VOID_TYPE_INDEX].asType(OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.VOID_TYPE_INDEX].type().changeReturnType(Double.TYPE)), OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.BOOLEAN_TYPE_INDEX].asType(OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.BOOLEAN_TYPE_INDEX].type().changeReturnType(Double.TYPE)), OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.CHAR_TYPE_INDEX].asType(OptimisticReturnFilters.ENSURE_INT[OptimisticReturnFilters.CHAR_TYPE_INDEX].type().changeReturnType(Double.TYPE)), findOwnMH("ensureNumber", Double.TYPE, Long.TYPE, Integer.TYPE), null };
    }
}
