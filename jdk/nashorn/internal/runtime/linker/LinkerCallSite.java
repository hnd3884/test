...
public class LinkerCallSite extends ChainedCallSite
{
    ...
    private static class TracingLinkerCallSite extends LinkerCallSite
    {
        ...
        private MethodHandle getFallbackLoggingRelink(final MethodHandle relink) {
            ...
            return Lookup.MH.foldArguments(relink, Lookup.MH.asType(Lookup.MH.asCollector(Lookup.MH.insertArguments(TracingLinkerCallSite.TRACEMISS, 0, this, "MISS " + getScriptLocation() + " "), Object[].class, type.parameterCount()), type.changeReturnType(Void.TYPE)));
        }
