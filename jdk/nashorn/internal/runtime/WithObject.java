...
public final class WithObject extends Scope
{
    ...
    private static GuardedInvocation fixExpressionCallSite(final NashornCallSiteDescriptor desc, final GuardedInvocation link) {
        ...
        return link.replaceMethods(Lookup.MH.foldArguments(linkReturnsFunction ? WithObject.BIND_TO_EXPRESSION_FN : WithObject.BIND_TO_EXPRESSION_OBJ, filterReceiver(linkInvocation.asType(linkType.changeReturnType((Class<?>)(linkReturnsFunction ? ScriptFunction.class : Object.class)).changeParameterType(0, Object.class)), WithObject.WITHEXPRESSIONFILTER)), filterGuardReceiver(link, WithObject.WITHEXPRESSIONFILTER));
    }
