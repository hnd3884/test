...
public abstract class MultiKeyPipelineBase extends PipelineBase implements BasicRedisPipeline, MultiKeyBinaryRedisPipeline, MultiKeyCommandsPipeline, ClusterPipeline
{
    protected Client client;
    
    public MultiKeyPipelineBase() {
        this.client = null;
    }
    ...
    @Override
    public Response<List<String>> configGet(final String pattern) {
