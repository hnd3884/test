...
public abstract class PipelineBase extends Queable implements BinaryRedisPipeline, RedisPipeline
{
    ...
    @Override
    public Response<Set<String>> zrevrangeByLex(final String key, final String max, final String min, final int offset, final int count) {
        this.getClient(key).zrevrangeByLex(key, max, min, offset, count);
        return this.getResponse(BuilderFactory.STRING_ZSET);
    }
    ...
    public Response<String> eval(final String script, final int numKeys, final String... args) {
    ...
    public Response<String> evalsha(final String sha1, final int numKeys, final String... args) {
